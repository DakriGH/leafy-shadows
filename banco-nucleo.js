function Re(i,{antialias:e=!0,dprMax:a=1.5}={}){let o=i.getContext("webgl2",{antialias:e,alpha:!1,depth:!0,stencil:!1,preserveDrawingBuffer:!1,powerPreference:"high-performance",desynchronized:!1});if(!o)throw new Error("WebGL2 non disponibile");let t=Math.min(a,devicePixelRatio||1),r=()=>{let n=Math.max(1,Math.round(i.clientWidth*t)),s=Math.max(1,Math.round(i.clientHeight*t));return i.width!==n||i.height!==s?(i.width=n,i.height=s,o.viewport(0,0,n,s),!0):!1};return r(),{gl:o,dpr:t,ridimensiona:r}}function J(i,e,a){let o=(r,n)=>{let s=i.createShader(r);if(i.shaderSource(s,n),i.compileShader(s),!i.getShaderParameter(s,i.COMPILE_STATUS))throw new Error(`shader: ${i.getShaderInfoLog(s)}
${n.split(`
`).map((f,c)=>`${c+1}: ${f}`).join(`
`)}`);return s},t=i.createProgram();if(i.attachShader(t,o(i.VERTEX_SHADER,e)),i.attachShader(t,o(i.FRAGMENT_SHADER,a)),i.linkProgram(t),!i.getProgramParameter(t,i.LINK_STATUS))throw new Error(`programma: ${i.getProgramInfoLog(t)}`);return t}function Vo(i){let e=i.getExtension("WEBGL_debug_renderer_info");return e?i.getParameter(e.UNMASKED_RENDERER_WEBGL):i.getParameter(i.RENDERER)}function K(i,e,a){return(Math.sign(i)+1)*9+(Math.sign(e)+1)*3+(Math.sign(a)+1)}var _t=K(1,0,0),zt=K(-1,0,0),St=K(0,1,0),Ct=K(0,-1,0),Ot=K(0,0,1),Lt=K(0,0,-1);var _e=[_t,zt,St,Ct,Ot,Lt],Ao=class{constructor(e=1024){this.byte=new Uint8Array(e*4*12),this.u32=new Uint32Array(this.byte.buffer),this.n=0,this.quad=0}_spazio(e){let a=(this.n+e)*12;if(a<=this.byte.length)return;let o=this.byte.length*2;for(;o<a;)o*=2;let t=new Uint8Array(o);t.set(this.byte),this.byte=t,this.u32=new Uint32Array(t.buffer)}vertice(e,a,o,t,r,n,s,f=0,c=0){let u=Math.round(e*16)+16,h=Math.round(o*16)+16,m=Math.round(a*16);if(u<0||u>511||h<0||h>511||m<0||m>65535)throw new RangeError(`vertice fuori dal chunk: ${e},${a},${o}`);if(t<0||t>26||t===13)throw new RangeError(`normale non valida: ${t}`);this._spazio(1);let l=this.n*3,d=this.byte,b=this.u32;b[l]=(u|h<<9|(t&31)<<18|(f&1)<<23|(c&15)<<24)>>>0,b[l+1]=(m|(r&15)<<16|(n&15)<<20)>>>0;let p=this.n*12+8;d[p]=s>>16&255,d[p+1]=s>>8&255,d[p+2]=s&255,d[p+3]=0,this.n++}quadDa(e,a,o,t){if(this.quad>=16384)throw new RangeError("troppi quad per un chunk");for(let r of[e,a,o,t])this.vertice(...r);this.quad++}dati(){return{byte:this.byte.subarray(0,this.n*12),quad:this.quad,vertici:this.n,triangoli:this.quad*2}}};function ze(i=16384){let e=new Uint16Array(i*6);for(let a=0,o=0,t=0;a<i;a++,t+=4)e[o++]=t,e[o++]=t+1,e[o++]=t+2,e[o++]=t,e[o++]=t+2,e[o++]=t+3;return e}function Se(i,e,a,o){let t=1/Math.tan(i/2),r=1/(a-o);return new Float32Array([t/e,0,0,0,0,t,0,0,0,0,(o+a)*r,-1,0,0,2*o*a*r,0])}function se(i,e,a){let o=1/(a-e);return new Float32Array([1/i,0,0,0,0,1/i,0,0,0,0,-2*o,0,0,0,-(a+e)*o,1])}function ko(i,e,a=[0,1,0]){let o=i[0]-e[0],t=i[1]-e[1],r=i[2]-e[2],n=Math.hypot(o,t,r)||1;o/=n,t/=n,r/=n;let s=a[1]*r-a[2]*t,f=a[2]*o-a[0]*r,c=a[0]*t-a[1]*o;n=Math.hypot(s,f,c)||1,s/=n,f/=n,c/=n;let u=t*c-r*f,h=r*s-o*c,m=o*f-t*s;return new Float32Array([s,u,o,0,f,h,t,0,c,m,r,0,-(s*i[0]+f*i[1]+c*i[2]),-(u*i[0]+h*i[1]+m*i[2]),-(o*i[0]+t*i[1]+r*i[2]),1])}function Ce(i,e=new Float32Array(16)){let[a,o,t,r,n,s,f,c,u,h,m,l,d,b,p,g]=i,E=a*s-o*n,v=a*f-t*n,R=a*c-r*n,z=o*f-t*s,_=o*c-r*s,C=t*c-r*f,x=u*b-h*d,A=u*p-m*d,M=u*g-l*d,S=h*p-m*b,N=h*g-l*b,I=m*g-l*p,O=E*I-v*N+R*S+z*M-_*A+C*x;return O?(O=1/O,e[0]=(s*I-f*N+c*S)*O,e[1]=(t*N-o*I-r*S)*O,e[2]=(b*C-p*_+g*z)*O,e[3]=(m*_-h*C-l*z)*O,e[4]=(f*M-n*I-c*A)*O,e[5]=(a*I-t*M+r*A)*O,e[6]=(p*R-d*C-g*v)*O,e[7]=(u*C-m*R+l*v)*O,e[8]=(n*N-s*M+c*x)*O,e[9]=(o*M-a*N-r*x)*O,e[10]=(d*_-b*R+g*E)*O,e[11]=(h*R-u*_-l*E)*O,e[12]=(s*A-n*S-f*x)*O,e[13]=(a*S-o*A+t*x)*O,e[14]=(b*v-d*z-p*E)*O,e[15]=(u*z-h*v+m*E)*O,e):null}function No(i,e,a=new Float32Array(16)){for(let o=0;o<4;o++)for(let t=0;t<4;t++)a[o*4+t]=i[t]*e[o*4]+i[4+t]*e[o*4+1]+i[8+t]*e[o*4+2]+i[12+t]*e[o*4+3];return a}function le(i,e=new Float32Array(24)){let a=f=>[i[f],i[4+f],i[8+f],i[12+f]],o=a(0),t=a(1),r=a(2),n=a(3),s=[[n[0]+o[0],n[1]+o[1],n[2]+o[2],n[3]+o[3]],[n[0]-o[0],n[1]-o[1],n[2]-o[2],n[3]-o[3]],[n[0]+t[0],n[1]+t[1],n[2]+t[2],n[3]+t[3]],[n[0]-t[0],n[1]-t[1],n[2]-t[2],n[3]-t[3]],[n[0]+r[0],n[1]+r[1],n[2]+r[2],n[3]+r[3]],[n[0]-r[0],n[1]-r[1],n[2]-r[2],n[3]-r[3]]];for(let f=0;f<6;f++){let[c,u,h,m]=s[f],l=Math.hypot(c,u,h)||1;e[f*4]=c/l,e[f*4+1]=u/l,e[f*4+2]=h/l,e[f*4+3]=m/l}return e}function ce(i,e,a,o,t,r,n){for(let s=0;s<6;s++){let f=i[s*4],c=i[s*4+1],u=i[s*4+2],h=i[s*4+3],m=f>0?t:e,l=c>0?r:a,d=u>0?n:o;if(f*m+c*l+u*d+h<0)return!1}return!0}var Ft=`#version 300 es
...
void main() { colore = vec4(texture(uTex, vUv).rgb, 1.0); }`),this.uQuad=e.getUniformLocation(this.programmaQuad,"uTex"),this.vaoQuad=e.createVertexArray()),e.useProgram(this.programmaQuad),e.activeTexture(e.TEXTURE0),e.bindTexture(e.TEXTURE_2D,a.tex),e.uniform1i(this.uQuad,0),e.bindVertexArray(this.vaoQuad),e.disable(e.DEPTH_TEST),e.drawArrays(e.TRIANGLE_STRIP,0,4),e.enable(e.DEPTH_TEST),e.bindVertexArray(null)}_preparaSpecchio(e,a){let o=this.gl,t=this.specchio;t.fbo||(t.fbo=o.createFramebuffer(),t.tex=o.createTexture(),t.rbo=o.createRenderbuffer()),o.bindTexture(o.TEXTURE_2D,t.tex),o.texImage2D(o.TEXTURE_2D,0,o.RGBA8,e,a,0,o.RGBA,o.UNSIGNED_BYTE,null),o.texParameteri(o.TEXTURE_2D,o.TEXTURE_MIN_FILTER,o.LINEAR),o.texParameteri(o.TEXTURE_2D,o.TEXTURE_MAG_FILTER,o.LINEAR),o.texParameteri(o.TEXTURE_2D,o.TEXTURE_WRAP_S,o.CLAMP_TO_EDGE),o.texParameteri(o.TEXTURE_2D,o.TEXTURE_WRAP_T,o.CLAMP_TO_EDGE),o.bindRenderbuffer(o.RENDERBUFFER,t.rbo),o.renderbufferStorage(o.RENDERBUFFER,o.DEPTH_COMPONENT16,e,a),o.bindFramebuffer(o.FRAMEBUFFER,t.fbo),o.framebufferTexture2D(o.FRAMEBUFFER,o.COLOR_ATTACHMENT0,o.TEXTURE_2D,t.tex,0),o.framebufferRenderbuffer(o.FRAMEBUFFER,o.DEPTH_ATTACHMENT,o.RENDERBUFFER,t.rbo),o.checkFramebufferStatus(o.FRAMEBUFFER)!==o.FRAMEBUFFER_COMPLETE&&(t.attivo=!1,console.warn("specchio: framebuffer incompleto, spento")),o.bindFramebuffer(o.FRAMEBUFFER,null),o.bindTexture(o.TEXTURE_2D,null),t.w=e,t.h=a}disegnaAcqua(){let e=this.gl,a=this.ua,o=this.sole,t=this._camera,r=this.specchio;if(!t||this._visibili.length===0){this.statistiche.disegniAcqua=0;return}e.useProgram(this.programmaAcqua),e.uniformMatrix4fv(a.uVP,!1,this.vp),e.uniform1f(a.uTempo,this.tempo),e.uniform3f(a.uCam,t.occhio[0],t.occhio[1],t.occhio[2]),e.uniform2f(a.uNebbia,this.nebbia.da,this.nebbia.a),e.uniform3f(a.uSoleVerso,o.verso[0],o.verso[1],o.verso[2]),e.uniform3f(a.uSoleCol,o.colore[0],o.colore[1],o.colore[2]),e.uniform1f(a.uSoleForza,o.forza),e.uniform3f(a.uCieloCol,o.cielo[0],o.cielo[1],o.cielo[2]),e.uniform3f(a.uNebbiaCol,this.nebbia.colore[0],this.nebbia.colore[1],this.nebbia.colore[2]);let n=r.pelo!=null&&r.tex;e.activeTexture(e.TEXTURE1),e.bindTexture(e.TEXTURE_2D,n?r.tex:null),e.uniform1i(a.uSpecchio,1),e.uniform3f(a.uSchermo,1/e.drawingBufferWidth,1/e.drawingBufferHeight,n?1:0),e.uniform1f(a.uMare,this.mare),e.uniform4fv(a.uGalleggianti,this.galleggianti),e.uniform1i(a.uNGalleggianti,this.nGalleggianti),this.altezze&&this.altRett?(e.activeTexture(e.TEXTURE2),e.bindTexture(e.TEXTURE_2D,this.altezze),e.uniform1i(a.uAltezze,2),e.uniform4f(a.uAltRett,this.altRett[0],this.altRett[1],this.altRett[2],this.altRett[3])):e.uniform4f(a.uAltRett,0,0,0,0),e.enable(e.BLEND),e.blendFunc(e.SRC_ALPHA,e.ONE_MINUS_SRC_ALPHA),e.depthMask(!1),e.disable(e.CULL_FACE);let s=0,f=0;for(let c of this._visibili)e.uniform3f(a.uChunk,c.chunk[0],c.chunk[1],c.chunk[2]),e.bindVertexArray(c.vaoAcqua),e.drawElements(e.TRIANGLES,c.quadAcqua*6,e.UNSIGNED_SHORT,0),s++,f+=c.quadAcqua*2;e.bindVertexArray(null),e.depthMask(!0),e.enable(e.CULL_FACE),e.disable(e.BLEND),e.activeTexture(e.TEXTURE0),this.statistiche.disegniAcqua=s,this.statistiche.triangoliAcqua=f,r.mostra&&n&&this._mostraSpecchio()}};var me=class extends Ao{vertice(e,a,o,t,r,n,s,f=0,c=0){super.vertice(e,a,o,_e[t],r,n,s,f,c)}},eo={erba:1,terra:2,sabbia:3,roccia:4,filo:5,tronco:6,chioma:7,lampada:8},Yo=[0,6072381,8739896,14403468,9211013,5086771,6043679,2714414,16767347],Bt=1;function ue(i,e){let a=o=>Math.max(0,Math.min(255,Math.round(o*e)));return a(i>>16&255)<<16|a(i>>8&255)<<8|a(i&255)}function uo(i,e,a){let o=i*374761393+e*668265263+a*1442695041|0;return o=Math.imul(o^o>>>13,1274126177),((o^o>>>16)>>>0)/4294967296}function fe(i,e,a,o){let t=i/a,r=e/a,n=Math.floor(t),s=Math.floor(r),f=t-n,c=r-s,u=f*f*(3-2*f),h=c*c*(3-2*c),m=uo(n,s,o),l=uo(n+1,s,o),d=uo(n,s+1,o),b=uo(n+1,s+1,o);return m+(l-m)*u+(d+(b-d)*u-(m+(l-m)*u))*h}function So(i,e,a=7){let o=fe(i,e,48,a)*14+fe(i,e,17,a+1)*5+fe(i,e,6,a+2)*1.5;return 8+Math.floor(o)}function Fe(i){return i<11?eo.sabbia:i>24?eo.roccia:eo.erba}function Le(i,e,a=7){let o=[];for(let t=0;t<2;t++){if(uo(i*3+t,e*5-t,a+9)<.35)continue;let n=i*16+Math.floor(uo(i,e,a+11+t)*15)+.5,s=e*16+Math.floor(uo(e,i,a+13+t)*15)+.5,f=So(Math.floor(n),Math.floor(s),a);Fe(f)===eo.erba&&o.push({x:n,y:f+3,z:s})}return o}function ye(i,e,a,o){let t=0;for(let r of o){let s=15-Math.sqrt((i-r.x)**2+(e-r.y)**2+(a-r.z)**2);s>t&&(t=s)}return Math.max(0,Math.min(15,Math.round(t)))}function Ie(i,e,{seme:a=7,erba:o=2,raggioLampade:t=2}={}){let r=new me(1600),n=i*16,s=e*16,f=255,c=0,u=[];for(let m=-t;m<=t;m++)for(let l=-t;l<=t;l++)u.push(...Le(i+m,e+l,a));for(let m=0;m<16;m++)for(let l=0;l<16;l++){let d=n+m,b=s+l,p=So(d,b,a);p<f&&(f=p),p+1>c&&(c=p+1);let g=Fe(p),E=.94+.12*uo(d,b,a+3),v=ye(d+.5,p+1,b+.5,u),R=ue(Yo[g],E);r.quadDa([m,p+1,l,2,15,v,R],[m,p+1,l+1,2,15,v,R],[m+1,p+1,l+1,2,15,v,R],[m+1,p+1,l,2,15,v,R]);let z=[[1,0,0],[-1,0,1],[0,1,4],[0,-1,5]];for(let[_,C,x]of z){let A=So(d+_,b+C,a);for(let M=A+1;M<=p;M++){let S=Math.max(6,15-(p-M)*2),N=M===p&&g===eo.erba?eo.erba:p>24?eo.roccia:eo.terra,I=ye(d+.5+_*.5,M+.5,b+.5+C*.5,u),O=M,Q=M+1,F=ue(Yo[N],E);_===1?r.quadDa([m+1,O,l,x,S,I,F],[m+1,Q,l,x,S,I,F],[m+1,Q,l+1,x,S,I,F],[m+1,O,l+1,x,S,I,F]):_===-1?r.quadDa([m,O,l+1,x,S,I,F],[m,Q,l+1,x,S,I,F],[m,Q,l,x,S,I,F],[m,O,l,x,S,I,F]):C===1?r.quadDa([m+1,O,l+1,x,S,I,F],[m+1,Q,l+1,x,S,I,F],[m,Q,l+1,x,S,I,F],[m,O,l+1,x,S,I,F]):r.quadDa([m,O,l,x,S,I,F],[m,Q,l,x,S,I,F],[m+1,Q,l,x,S,I,F],[m+1,O,l,x,S,I,F]),M<f&&(f=M)}}if(g===eo.erba)for(let _=0;_<o;_++){if(uo(d,b,a+20+_)<.25)continue;let x=1,A=m,M=l,S=ue(Yo[eo.filo],.94+.12*uo(d,b,a+30+_));r.quadDa([A,p+1,M,2,15,v,S],[A,p+1+x,M,2,15,v,S,1],[A+1,p+1+x,M+1,2,15,v,S,1],[A+1,p+1,M+1,2,15,v,S]),r.quadDa([A+1,p+1,M,2,15,v,S],[A+1,p+1+x,M,2,15,v,S,1],[A,p+1+x,M+1,2,15,v,S,1],[A,p+1,M+1,2,15,v,S]),p+2>c&&(c=p+2)}}for(let m of Le(i,e,a)){let l=Math.floor(m.x)-n,d=Math.floor(m.z)-s,b=m.y-3;for(let p=b+1;p<=m.y;p++){let g=p===m.y?eo.lampada:eo.tronco,E=p===m.y?15:12,v=Yo[g],R=p===m.y?Bt:0,z=l+.5-.15,_=l+.5+.15,C=Math.floor(z),x=Math.min(16,Math.floor(z)+1),A=d,M=d+1;r.quadDa([x,p,A,0,12,E,v,0,R],[x,p+1,A,0,12,E,v,0,R],[x,p+1,M,0,12,E,v,0,R],[x,p,M,0,12,E,v,0,R]),r.quadDa([C,p,M,1,12,E,v,0,R],[C,p+1,M,1,12,E,v,0,R],[C,p+1,A,1,12,E,v,0,R],[C,p,A,1,12,E,v,0,R]),r.quadDa([x,p,M,4,12,E,v,0,R],[x,p+1,M,4,12,E,v,0,R],[C,p+1,M,4,12,E,v,0,R],[C,p,M,4,12,E,v,0,R]),r.quadDa([C,p,A,5,12,E,v,0,R],[C,p+1,A,5,12,E,v,0,R],[x,p+1,A,5,12,E,v,0,R],[x,p,A,5,12,E,v,0,R]),p===m.y&&r.quadDa([C,p+1,A,2,15,E,v,0,R],[C,p+1,M,2,15,E,v,0,R],[x,p+1,M,2,15,E,v,0,R],[x,p+1,A,2,15,E,v,0,R]),p+1>c&&(c=p+1)}}return{...r.dati(),minY:f,maxY:c,cx:i,cz:e}}var Ne={erba:{nome:"Erba",cima:5949008,lato:15047529,fondo:12546123,orlo:3446604,solido:!0,nav:10,cappello:!0,fam:"scavo"},terra:{nome:"Terra",cima:12546123,lato:12546123,fondo:11034431,solido:!0,nav:10,fam:"scavo"},sabbia:{nome:"Sabbia",cima:15324316,lato:14599048,fondo:13808246,solido:!0,nav:12,fam:"scavo"},ghiaia:{nome:"Ghiaia",cima:10130572,lato:9143677,fondo:8354162,solido:!0,nav:12,fam:"scavo"},neve:{nome:"Neve",cima:15923191,lato:14740202,fondo:13688028,solido:!0,nav:12,fam:"scavo"},roccia:{nome:"Roccia",cima:11054778,lato:9673384,fondo:8883868,solido:!0,nav:10,fam:"mina"},pietra:{nome:"Pietra liscia",cima:12436429,lato:11449535,fondo:10660019,solido:!0,nav:10,fam:"mina"},mattoni:{nome:"Mattoni",cima:11555645,lato:10570294,fondo:9650735,solido:!0,nav:10,fam:"mina"},legno:{nome:"Legno",cima:11568720,lato:10252866,fondo:9266489,solido:!0,nav:10,fam:"taglia"},tronco:{nome:"Tronco",cima:12622434,lato:8016432,fondo:12622434,solido:!0,nav:10,fam:"taglia"},asse:{nome:"Assi chiare",cima:14268798,lato:13150317,fondo:12163422,solido:!0,nav:10,fam:"taglia"},lanaBianca:{nome:"Lana bianca",cima:15724786,lato:14869478,fondo:14014170,solido:!0,nav:10,fam:"scavo"},lanaRossa:{nome:"Lana rossa",cima:14703182,lato:13388608,fondo:12206648,solido:!0,nav:10,fam:"scavo"},lanaBlu:{nome:"Lana blu",cima:4882388,lato:4157120,fondo:3629227,solido:!0,nav:10,fam:"scavo"},lanaGialla:{nome:"Lana gialla",cima:15911244,lato:14727230,fondo:13477428,solido:!0,nav:10,fam:"scavo"},lanaVerde:{nome:"Lana verde",cima:5813096,lato:4890714,fondo:4165454,solido:!0,nav:10,fam:"scavo"},ferro:{nome:"Ferro",cima:12174028,lato:10792376,fondo:9410723,solido:!0,nav:10,fam:"scavo",materia:"metallo"},fanghiglia:{nome:"Fanghiglia",cima:11569756,lato:10517842,fondo:9268551,solido:!0,nav:10,fam:"scavo",materia:"fango"},ghiaccio:{nome:"Ghiaccio",cima:12576498,lato:11131114,fondo:9685472,solido:!0,nav:10,fam:"scavo",materia:"ghiaccio"},cristallo:{nome:"Cristallo",cima:16771496,lato:16243851,fondo:15256437,solido:!0,nav:10,fam:"mina",salute:100,materia:"accesa",luce:{colore:16767370,raggio:6,intensita:1,ombra:!0}},ottone:{nome:"Ottone",cima:14267482,lato:12820556,fondo:11044927,solido:!0,nav:10,fam:"scavo",materia:"specchio"},lucciola:{nome:"Lucciola verde",cima:11075504,lato:6280814,fondo:4634967,solido:!0,nav:10,fam:"mina",salute:100,luce:{colore:8257440,raggio:5,intensita:1.1,ombra:!0}},lampadaPesante:{nome:"Lampada pesante (con ombra)",cima:16771764,lato:15777891,fondo:14264132,solido:!0,nav:10,fam:"mina",salute:100,luce:{colore:16767113,raggio:8,intensita:1.1,ombra:!0}},lampadaLeggera:{nome:"Lampada leggera (trapassa i muri)",cima:16771764,lato:15777891,fondo:14264132,solido:!0,nav:10,fam:"mina",salute:100,luce:{colore:16767113,raggio:8,intensita:1.1,ombra:!1}},lampadaRossa:{nome:"Lampada rossa",cima:16759213,lato:15224892,fondo:13187624,solido:!0,nav:10,fam:"mina",salute:100,luce:{colore:16722458,raggio:8,intensita:1.1,ombra:!0}},lampadaVerde:{nome:"Lampada verde",cima:11993028,lato:4183135,fondo:3124809,solido:!0,nav:10,fam:"mina",salute:100,luce:{colore:1769274,raggio:8,intensita:1.1,ombra:!0}},lampadaBlu:{nome:"Lampada blu",cima:11584767,lato:4220128,fondo:3099837,solido:!0,nav:10,fam:"mina",salute:100,luce:{colore:2771711,raggio:8,intensita:1.1,ombra:!0}},fuochiFatui:{nome:"Nido di fuochi fatui",cima:13498111,lato:5083048,fondo:3500413,solido:!0,nav:10,fam:"mina",salute:100,luce:{colore:9430271,raggio:3,intensita:.7,ombra:!1},fuochiFatui:{numero:7,raggio:3.2,quota:1.9,luce:{colore:10477823,raggio:4.2,intensita:1}}},acqua:{nome:"Acqua",cima:5227244,lato:4042208,fondo:3184332,solido:!1,nav:null,acqua:!0}},Pe=[{id:"naturali",nome:"Naturali",emoji:"\u{1F33F}",blocchi:["erba","terra","sabbia","ghiaia","neve","roccia","lucciola","acqua"]},{id:"costruzione",nome:"Costruzione",emoji:"\u{1F9F1}",blocchi:["legno","tronco","asse","pietra","mattoni"]},{id:"lane",nome:"Lane",emoji:"\u{1F3A8}",blocchi:["lanaBianca","lanaRossa","lanaBlu","lanaGialla","lanaVerde"]},{id:"luci",nome:"Luci",emoji:"\u{1F4A1}",blocchi:["lucciola","lampadaPesante","lampadaLeggera","lampadaRossa","lampadaVerde","lampadaBlu","fuochiFatui"]}],$o={id:"officina",nome:"Officina",emoji:"\u{1F6E0}\uFE0F",blocchi:[]};Pe.push($o);var Vt={id:"prove",nome:"Prove",emoji:"\u{1F317}",blocchi:[]};Pe.push(Vt);function we(i,e,a=$o){Ne[i]=e,a.blocchi.includes(i)||a.blocchi.push(i)}var kt={nome:"Blocco perduto",cima:12950225,lato:11305912,fondo:9924767,solido:!0,nav:10,fam:"mina"};function j(i){return Ne[i.charCodeAt(0)===97&&i.startsWith("acqua")?"acqua":i]||kt}function De(i){let e=i.indexOf("~");return e<0?i:i.slice(0,e)}function Ue(i){if(!i||!i.startsWith("acqua"))return null;let e=i.indexOf("~");return e<0?0:Number(i.slice(e+1))}var L=16,Gt=256,Ho=2048,qe=64,to=(i,e,a)=>((i+Ho)*4096+(a+Ho))*256+(e+qe),Co=i=>Math.floor(i/(256*4096))-Ho,Oo=i=>Math.floor(i/256)%4096-Ho,Lo=i=>i%256-qe;var vo=(i,e)=>Math.floor(i/L)+","+Math.floor(e/L),Ko=class{constructor(){this.chunks=new Map,this.sporchi=new Set,this.sporchiAcqua=new Set,this._rev=new Map,this.furni=new Map,this.ombreFurni=new Map,this.contaBlocchi=0,this.onEvento=null,this.cambiate=[],this.troppiCambi=!1,this._memoCx=0,this._memoCz=0,this._memoChunk=null,this.generati=new Set,this.modifiche=new Map,this.frontiera=null}segnaGenerato(e){this.generati.add(e)}_annotaModifica(e,a,o,t){if(!this.frontiera)return;let r=vo(e,o),n=this.modifiche.get(r);n||(n=new Map,this.modifiche.set(r,n)),n.set(to(e,a,o),t)}applicaModifiche(e){let a=this.modifiche.get(e);if(!a)return 0;for(let[o,t]of a){let r=Co(o),n=Lo(o),s=Oo(o);t===null?this.togli(r,n,s,!0):this.metti(r,n,s,t,!0)}return a.size}scaricaChunk(e){let a=this.chunks.get(e);if(!a)return this.generati.delete(e),[];let o=[];for(let[t,r]of a){let n=j(r);n&&n.forma==="modello"&&o.push([Co(t),Lo(t),Oo(t),r])}return this.contaBlocchi-=a.size,this.chunks.delete(e),this._scordaMemo(),this.generati.delete(e),this._tocca(e,this.sporchi),o}_cambiata(e,a,o){if(this.cambiate.length>=3*Gt){this.troppiCambi=!0;return}this.cambiate.push(e,a,o)}scordaCambi(){this.cambiate.length=0,this.troppiCambi=!1}_scordaMemo(){this._memoKc=null,this._memoChunk=null}_chunkDi(e,a){let o=Math.floor(e/L),t=Math.floor(a/L);if(this._memoChunk!==null&&this._memoCx===o&&this._memoCz===t)return this._memoChunk;let r=this.chunks.get(o+","+t)||null;return this._memoCx=o,this._memoCz=t,this._memoChunk=r,r}tipo(e,a,o){let t=this._chunkDi(e,o);return t&&t.get(to(e,a,o))||null}pieno(e,a,o){return this.tipo(e,a,o)!==null}solido(e,a,o){let t=this.tipo(e,a,o);if(t&&j(t).solido)return!0;let r=this.furni.get(to(e,a,o));return!!r&&!(r.def&&r.def.calpestabile)}calpestabile(e,a,o){if(!this.solido(e,a-1,o)||this.solido(e,a,o)||this.solido(e,a+1,o))return!1;let t=this.tipo(e,a,o);return!(t&&j(t).acqua)}_sporca(e,a,o=this.sporchi){let t=(e%L+L)%L,r=(a%L+L)%L;this._tocca(vo(e,a),o),t===0&&this._tocca(vo(e-1,a),o),t===L-1&&this._tocca(vo(e+1,a),o),r===0&&this._tocca(vo(e,a-1),o),r===L-1&&this._tocca(vo(e,a+1),o)}_tocca(e,a){a.add(e),this._rev.set(e,(this._rev.get(e)||0)+1)}revisione(e){return this._rev.get(e)||0}metti(e,a,o,t,r=!1){let n=vo(e,o),s=this.chunks.get(n);s||(s=new Map,this.chunks.set(n,s),this._scordaMemo());let f=to(e,a,o),c=s.get(f);c===void 0&&this.contaBlocchi++,s.set(f,t);let u=t.charCodeAt(0)===97&&t.startsWith("acqua")&&(c===void 0||c.startsWith("acqua"));this._sporca(e,o,u?this.sporchiAcqua:this.sporchi),u||this._cambiata(e,a,o),r||(this._annotaModifica(e,a,o,t),this.onEvento&&this.onEvento({tipo:"metti",cella:[e,a,o],blocco:t}))}togli(e,a,o,t=!1){let r=vo(e,o),n=this.chunks.get(r);if(!n)return!1;let s=to(e,a,o),f=n.get(s);if(!n.delete(s))return!1;this.contaBlocchi--,n.size===0&&(this.chunks.delete(r),this._scordaMemo());let c=!!(f&&f.startsWith("acqua"));return this._sporca(e,o,c?this.sporchiAcqua:this.sporchi),c||this._cambiata(e,a,o),t||(this._annotaModifica(e,a,o,null),this.onEvento&&this.onEvento({tipo:"togli",cella:[e,a,o]})),!0}occupaFurni(e,a){for(let[o,t,r]of e)this.furni.set(to(o,t,r),a)}liberaFurni(e){for(let[a,o,t]of e)this.furni.delete(to(a,o,t))}furniIn(e,a,o){return this.furni.get(to(e,a,o))||null}occupaOmbra(e,a=!1){for(let[o,t,r]of e){let n=to(o,t,r),s=this.ombreFurni.get(n);if(s){s.n++,a&&s.op++===0&&this._cambiata(o,t,r);continue}this.ombreFurni.set(n,{x:o,y:t,z:r,n:1,op:a?1:0}),this._cambiata(o,t,r)}}liberaOmbra(e,a=!1){for(let[o,t,r]of e){let n=to(o,t,r),s=this.ombreFurni.get(n);s&&(a&&s.op>0&&--s.op===0&&s.n>1&&this._cambiata(o,t,r),!(--s.n>0)&&(this.ombreFurni.delete(n),this._cambiata(o,t,r)))}}ombraFurniIn(e,a,o){let t=this.ombreFurni.get(to(e,a,o));return t?t.op>0?2:1:0}appoggioInColonna(e,a,o,t=8){for(let r=o;r>o-t;r--)if(this.calpestabile(e,r,a))return r;return null}svuota(){this.chunks.clear(),this._scordaMemo(),this.furni.clear(),this.sporchi.clear(),this.sporchiAcqua.clear();for(let e of this._rev.keys())this._rev.set(e,this._rev.get(e)+1);this.scordaCambi(),this.contaBlocchi=0}*tutti(){for(let e of this.chunks.values())for(let[a,o]of e)yield{x:Co(a),y:Lo(a),z:Oo(a),tipo:o}}perOgni(e){for(let a of this.chunks.values())for(let[o,t]of a)e(Co(o),Lo(o),Oo(o),t)}*blocchiDelChunk(e){let a=this.chunks.get(e);if(a)for(let[o,t]of a)yield{x:Co(o),y:Lo(o),z:Oo(o),tipo:t}}perOgniDelChunk(e,a){let o=this.chunks.get(e);if(o)for(let[t,r]of o)a(Co(t),Lo(t),Oo(t),r)}};var Xt={primavera:{nome:"Primavera",emoji:"\u{1F338}",erba:[6738010,6343509,5949008,5553995,5158983,4763971,4434495,4105019],fogliame:null},estate:{nome:"Estate secca",emoji:"\u{1F33E}",erba:[15060862,14534259,14073193,13546335,13019733,12558668,12032068,11571261],fogliame:{h:.128,sF:.72,l:i=>i*.92+.1}},autunno:{nome:"Autunno",emoji:"\u{1F342}",erba:[15506768,15045448,14584129,14122810,13661492,13200431,12739371,12278311],fogliame:{h:.045,sF:1.2,l:i=>i*1.05+.09}},inverno:{nome:"Inverno",emoji:"\u2744\uFE0F",erba:[15988722,15462890,14871523,14279900,13622740,13031117,12439751,11848128],sabbia:{cima:15722970,lato:14932934,fondo:14077364},fogliame:{h:.42,sF:.18,l:i=>i*.38+.58}}},Po="primavera";var jo=null;function Wo(i,e,a){let o=i>>16&255,t=i>>8&255,r=i&255,n=e>>16&255,s=e>>8&255,f=e&255,c=(u,h)=>Math.round(u+(h-u)*a);return c(o,n)<<16|c(t,s)<<8|c(r,f)}function Be(i,e){if(jo){let a=Po;Po=jo.da;let o=he(i,e);Po=jo.a;let t=he(i,e);Po=a;let r=jo.mix;return{cima:Zo(o.cima,t.cima,r),lato:Zo(o.lato,t.lato,r),fondo:Zo(o.fondo,t.fondo,r),facce:o.facce,orlo:o.orlo!=null&&t.orlo!=null?Zo(o.orlo,t.orlo,r):o.orlo}}return he(i,e)}function Zo(i,e,a){let o=Math.round((i>>16&255)+((e>>16&255)-(i>>16&255))*a),t=Math.round((i>>8&255)+((e>>8&255)-(i>>8&255))*a),r=Math.round((i&255)+((e&255)-(i&255))*a);return o<<16|t<<8|r}function he(i,e){let a=j(i),o=Xt[Po],{cima:t,lato:r,fondo:n}=a;if(a.cappello&&o.erba&&!a.override&&(t=o.erba[pe(e,o.erba.length)]),a.reagisce==="stagione"&&o.erba){let s=o.erba[pe(e,o.erba.length)],f=a.reagisceForza??1;t=Wo(t,s,f),r=Wo(r,s,f*.45),n=Wo(n,s,f*.3)}else if(a.reagisce==="quota"){let s=pe(e,8)/7,f=(a.reagisceForza??1)*.5,c=u=>Wo(u,16777215,s*f);t=c(t),r=c(r),n=c(n)}return i==="sabbia"&&o.sabbia&&({cima:t,lato:r,fondo:n}=o.sabbia),{cima:t,lato:r,fondo:n,facce:a.facce||null,orlo:a.orlo!=null?a.orlo:void 0}}function ho(i,e,a){if(i.facce){let o=e*2+(a>0?0:1),t=i.facce[o];if(t!=null)return t}return e===1?a>0?i.cima:i.fondo:i.lato}function pe(i,e=8){let a=(e-1)*2,o=(Math.round(i)%a+a)%a;return o>=e&&(o=a-o),o}function de(i,e,a){let o=(i|0)*374761393+(e|0)*668265263+(a|0)*2147483647;return o=(o^o>>>13)*1274126177,o=o^o>>>16,(o>>>0)%1e3/1e3}function Yt(i,e){let a=i>>16&255,o=i>>8&255,t=i&255,r=n=>Math.max(0,Math.min(255,Math.round(n*(1+e))));return r(a)<<16|r(o)<<8|r(t)}function $t(i,e,a,o,t,r){if(!e||e==="liscio"||!a)return i;let n=0;return e==="chiazze"?n=(de(o,t,r)-.5)*2:e==="venature"?n=(de(0,t,0)-.5)*2*.7+(de(o,t,r)-.5)*.3:e==="sfumato"&&(n=(t%16+16)%16/16-.5),Yt(i,n*a*.34)}function Ve(i,e,a,o,t,r){if(!e||e==="liscio"||!a)return i;let n=s=>$t(s,e,a,o,t,r);return{cima:n(i.cima),lato:n(i.lato),fondo:n(i.fondo),facce:i.facce?i.facce.map(n):null}}var ke={metallo:{tinta:.82,satura:.55,orlo:.18,curva:1,glintR:.34,emiss:0,bagna:.2,sotto:0,riflette:.15},fango:{tinta:.72,satura:1.35,orlo:0,curva:-1,glintR:.48,emiss:0,bagna:1,sotto:0,riflette:0},ghiaccio:{tinta:1.06,satura:.62,orlo:.12,curva:.6,glintR:.3,emiss:0,bagna:.4,sotto:.3,riflette:.25},accesa:{tinta:1,satura:1,orlo:0,curva:0,glintR:0,emiss:1,bagna:0,sotto:0,riflette:0},specchio:{tinta:.95,satura:.35,orlo:.1,curva:1,glintR:.3,emiss:0,bagna:0,sotto:0,riflette:.55}},Ht=Object.keys(ke);function Ge(i){return!i||!i.materia?null:ke[i.materia]||null}function go(i,e,a=0){if(!e)return i;let o=(i>>16&255)/255,t=(i>>8&255)/255,r=(i&255)/255,n=.2126*o+.7152*t+.0722*r,s=e.satura;o=n+(o-n)*s,t=n+(t-n)*s,r=n+(r-n)*s;let f=e.tinta*(1+a),c=u=>Math.max(0,Math.min(255,Math.round(u*f*255)));return c(o)<<16|c(t)<<8|c(r)}var Kt=16;function Xe(i){let e=Ht.indexOf(i);return e<0||e+1>=Kt?0:e+1}var be=1/16,Ye=8*be,ao=9*be;function $e(i,e,a,o,t,r,n,s){let f=(u,h,m)=>[e+u,a+h,o+m];i.quad(f(-s,n,-s),f(s,n,-s),f(s,n,s),f(-s,n,s),ho(t,1,1),[0,1,0]),i.quad(f(-s,r,-s),f(s,r,-s),f(s,r,s),f(-s,r,s),ho(t,1,-1),[0,-1,0]);let c=[{d:[1,0,0],asse:0,segno:1},{d:[-1,0,0],asse:0,segno:-1},{d:[0,0,1],asse:2,segno:1},{d:[0,0,-1],asse:2,segno:-1}];for(let u of c){let[h,,m]=u.d,l=-m,d=h,b=(p,g)=>f(h*s+l*g,p,m*s+d*g);i.quad(b(r,-s),b(n,-s),b(n,s),b(r,s),ho(t,u.asse,u.segno),u.d)}}function jt(i,e,a,o,t){$e(i,e,a,o,t,-ao,0,Ye)}function Wt(i,e,a,o,t){$e(i,e,a,o,t,-ao,ao,5*be)}function Zt(i,e,a,o,t){let r=(c,u,h)=>[e+c,a+u,o+h],n=ho(t,0,1),s=Ye,f=[[[-s,-ao,-s],[s,-ao,s],[s,ao,s],[-s,ao,-s],[1,0,-1]],[[-s,-ao,s],[s,-ao,-s],[s,ao,-s],[-s,ao,s],[1,0,1]]];for(let[c,u,h,m,l]of f)i.quad(r(...c),r(...u),r(...h),r(...m),n,l),i.quad(r(...c),r(...u),r(...h),r(...m),n,[-l[0],-l[1],-l[2]])}function Qt(){}var He={lastra:jt,pilastro:Wt,croce:Zt,modello:Qt},wo=new Set(["lastra","pilastro","croce","modello"]);var Do=1/16,Jt=[[0,1],[0,2],[1,2]],oa=[[1,0],[-1,0],[0,1],[0,-1]];function xo(i,e,a,o,t,r,n,s,f){let c=[i,e,a];return c[o]+=t,c[r]+=n,c[s]+=f,c}var Ke={tinta:1,satura:1};function je(i,e,a,o,t,r,n=0){let s=8*Do,f=9*Do,c=(u,h)=>r(u===0?h:0,u===1?h:0,u===2?h:0);for(let u=0;u<3;u++)for(let h of[-1,1]){if(c(u,h))continue;let m=(u+1)%3,l=(u+2)%3,d=ho(t,u,h),b=[0,0,0];b[u]=h,i.quad(xo(e,a,o,u,h*f,m,-s,l,-s),xo(e,a,o,u,h*f,m,+s,l,-s),xo(e,a,o,u,h*f,m,+s,l,+s),xo(e,a,o,u,h*f,m,-s,l,+s),d,b)}for(let[u,h]of Jt){let m=3-u-h;for(let l of[-1,1])for(let d of[-1,1]){if(c(u,l)||c(h,d))continue;let b=u===1&&l>0||h===1&&d>0,p=u===1&&l<0||h===1&&d<0,g=b?t.cima:p?t.fondo:t.lato,E=n?go(g,Ke,n):g,v=[0,0,0];v[u]=l,v[h]=d,i.quad(xo(e,a,o,u,l*f,h,d*s,m,-s),xo(e,a,o,u,l*s,h,d*f,m,-s),xo(e,a,o,u,l*s,h,d*f,m,+s),xo(e,a,o,u,l*f,h,d*s,m,+s),E,v)}}for(let u of[-1,1])for(let h of[-1,1])for(let m of[-1,1])c(0,u)||c(1,h)||c(2,m)||i.tri([e+u*f,a+h*s,o+m*s],[e+u*s,a+h*f,o+m*s],[e+u*s,a+h*s,o+m*f],n?go(h>0?t.cima:t.fondo,Ke,n):h>0?t.cima:t.fondo,[u,h,m])}function We(i,e,a,o,t,r){let n=(l,d)=>r(l,0,d),s=r(0,-1,0),f=t.cima,c=t.lato,u=t.fondo,h=t.orlo??t.cima,m=(l,d,b)=>[e+l*Do,a+d*Do,o+b*Do];s||i.quad(m(-8,-9,-8),m(8,-9,-8),m(8,-9,8),m(-8,-9,8),u,[0,-1,0]);for(let[l,d]of oa){if(n(l,d))continue;let b=-d,p=l,g=(v,R,z)=>m(v*l+z*b,R,v*d+z*p),E=[l,0,d];s||i.quad(g(8,-9,-8),g(9,-8,-8),g(9,-8,8),g(8,-9,8),u,[l,-1,d]),i.quad(g(9,-8,-8),g(9,2,-8),g(9,2,8),g(9,-8,8),c,E),i.quad(g(9,2,-8),g(10,3,-8),g(10,3,8),g(9,2,8),h,E),i.quad(g(10,3,-8),g(10,7,-8),g(10,7,8),g(10,3,8),h,E),i.quad(g(10,7,-8),g(9,8,-8),g(9,8,8),g(10,7,8),f,[l,1,d]),i.quad(g(8,8,-8),g(9,8,-8),g(9,8,8),g(8,8,8),f,[0,1,0])}for(let l of[-1,1])for(let d of[-1,1]){if(n(l,0)||n(0,d))continue;let b=(g,E,v)=>m(g*l,E,v*d),p=[l,0,d];s||i.tri(b(9,-8,8),b(8,-9,8),b(8,-8,9),u,[l,-1,d]),i.quad(b(9,-8,8),b(8,-8,9),b(8,2,9),b(9,2,8),c,p),i.quad(b(9,2,8),b(8,2,9),b(8,3,10),b(10,3,8),h,p),i.quad(b(10,3,8),b(8,3,10),b(8,7,10),b(10,7,8),h,p),i.quad(b(10,7,8),b(8,7,10),b(8,8,9),b(9,8,8),f,[l,1,d]),i.tri(b(8,8,8),b(9,8,8),b(8,8,9),f,[0,1,0])}i.quad(m(-8,8,-8),m(8,8,-8),m(8,8,8),m(-8,8,8),f,[0,1,0])}var ve={lampione:{nome:"Lampione",modello:"lampione",altezza:3,mezza:.45,cima:16771764,lato:5988976,fondo:4672856,luce:{colore:16767113,raggio:4.6,intensita:1,ombra:!0,quota:2.6},notte:!0},albero:{nome:"Albero",modello:"albero",altezza:4.2,mezza:.7,cima:5217862,lato:8016432,fondo:6964518}};function Ze(){for(let[i,e]of Object.entries(ve))we(i,{nome:e.nome,cima:e.cima,lato:e.lato,fondo:e.fondo,solido:!1,nav:10,fam:"taglia",forma:"modello",modello:e.modello},$o)}var ea=2,ge=6,ta=256;function Qe(i){if(!i)return!1;let e=j(i);return!e.acqua&&!e.vetro&&!wo.has(e.forma)}function ot(i,e,a,o){let t=e.indexOf(","),r=+e.slice(0,t),n=+e.slice(t+1),s=r*L-ge,f=n*L-ge,c=L+2*ge,u=o-a+1,h=c,m=c*u*h,l=new Uint8Array(m),d=new Uint8Array(m),b=new Uint8Array(m),p=(z,_,C)=>((z-s)*u+(_-a))*h+(C-f),g=(z,_,C)=>z>=s&&z<s+c&&_>=a&&_<=o&&C>=f&&C<f+h,E=[];for(let z=s;z<s+c;z++)for(let _=f;_<f+h;_++){let C=!1;for(let x=o;x>=a;x--){let A=i.tipo(z,x,_),M=p(z,x,_);if(Qe(A)){b[M]=1,C=!0;continue}if(!C&&x===o){for(let S=o+1;S<ta&&S<o+40;S++)if(Qe(i.tipo(z,S,_))){C=!0;break}}if(C||(l[M]=15),A){let N=j(A).forma==="modello"&&ve[A];N&&N.luce&&E.push([z,x+Math.round(N.luce.quota??1),_])}}}let v=[];for(let z=0;z<m;z++)l[z]===15&&v.push(z);Je(v,l,b,c,u,h,1);let R=[];for(let[z,_,C]of E){if(!g(z,_,C))continue;let x=p(z,_,C);d[x]=15,R.push(x)}return Je(R,d,b,c,u,h,ea),{x0:s,z0:f,yMin:a,yMax:o,W:c,H:u,D:h,cielo:l,blocco:d,leggi(z,_,C){if(!g(z,_,C))return _>o?[15,0]:[0,0];let x=p(z,_,C);return[l[x],d[x]]}}}function Je(i,e,a,o,t,r,n){let s=[t*r,-t*r,r,-r,1,-1],f=0;for(;f<i.length;){let c=i[f++],u=e[c]-n;if(u<=0)continue;let h=Math.floor(c/(t*r)),m=Math.floor(c/r)%t,l=c%r;for(let d=0;d<6;d++){if(d===0&&h===o-1||d===1&&h===0||d===2&&m===t-1||d===3&&m===0||d===4&&l===r-1||d===5&&l===0)continue;let b=c+s[d];a[b]||e[b]>=u||(e[b]=u,i.push(b))}}}var et=[{n:5,largo:.15,alto:.32,apri:.42},{n:4,largo:.12,alto:.5,apri:.34},{n:7,largo:.1,alto:.38,apri:.46},{n:3,largo:.18,alto:.28,apri:.3}];function fo(i,e,a){let o=i*374761393+e*668265263+a*1442695041|0;return o=Math.imul(o^o>>>13,1274126177),((o^o>>>16)>>>0)/4294967296}var Qo=class{constructor(e,a=512){this.yBase=e,this.byte=new Uint8Array(a*12),this.n=0}_lamella(e,a,o,t,r,n,s,f,c,u=0,h=8){if((this.n+1)*12>this.byte.length){let d=new Uint8Array(this.byte.length*2);d.set(this.byte),this.byte=d}let m=this.n*12,l=this.byte;l[m]=e,l[m+1]=a,l[m+2]=o,l[m+3]=t,l[m+4]=r>>16&255,l[m+5]=r>>8&255,l[m+6]=r&255,l[m+7]=(n&15)<<2,l[m+8]=Math.max(1,Math.min(255,s)),l[m+9]=Math.max(1,Math.min(255,f)),l[m+10]=Math.max(0,Math.min(255,c+128)),l[m+11]=u&15|(h&15)<<4,this.n++}ciuffo(e,a,o,t,r,n,s,f=1,c=0){let u=et[Math.floor(fo(e,o,3)*et.length)],h=Math.max(1,Math.round(u.n*f*(.82+.36*fo(e,o,5)))),m=a+1-this.yBase;if(m<0||m*8>247)return 0;for(let l=0;l<h;l++){let d=fo(e,o,l*17+5),b=fo(e,o,l*17+11),p=fo(e,o,l*17+41),g=fo(e,o,l*17+59),E=Math.min(.98,.66+u.apri),v=e+.5+(d-.5)*E,R=o+.5+(b-.5)*E,z=Math.min(.8,u.alto*(.62+.8*fo(e,o,l*17+71))*(.5+.6*Math.pow(p,1.5))),_=u.largo*(.8+.4*g),C=(fo(e,o,l*17+83)-.5)*.5,x=fo(e,o,l*17+89),A=x<.15?.9+.03*x:x>.85?1.07+.03*(x-.85):.97+.06*(x-.15)/.7,M=Math.max(0,Math.min(128,Math.round((v-t)*8))),S=Math.max(0,Math.min(128,Math.round((R-r)*8))),N=Math.floor(fo(e,o,l*17+97)*255);this._lamella(M,S,Math.round(m*8),N,n,s,Math.round(z*64),Math.round(_*128),Math.round(C*128),c,Math.round((A-.9)/.2*15))}return h}dati(){return{byte:this.byte.subarray(0,this.n*12),vertici:this.n*6,fili:this.n,yBase:this.yBase}}};var Eo=64,aa=[[1,0,0,K(1,0,0),0,1],[-1,0,0,K(-1,0,0),0,-1],[0,1,0,K(0,1,0),1,1],[0,-1,0,K(0,-1,0),1,-1],[0,0,1,K(0,0,1),2,1],[0,0,-1,K(0,0,-1),2,-1]],tt=(i,e,a)=>((e+1)*3+(a+1))*3+(i+1),Ee=class{constructor(e,a,o,t,r){this.c=e,this.ox=a,this.oz=o,this._materia=0,this.luceDi=t,this.aria=r,this._cielo=15,this._cella=null}materia(e){this._materia=e|0}cella(e,a,o){this._cella=[e,a,o]}_cieloFaccia(e){let[a,o,t]=this._cella,r=-1;for(let n=0;n<3;n++){if(!e[n])continue;let s=this.luceDi(a+(n===0?e[0]:0),o+(n===1?e[1]:0),t+(n===2?e[2]:0))[0];s>r&&(r=s)}return r<0?this.luceDi(a,o+1,t)[0]:r}_bloccoVertice(e,a){let o=Math.hypot(a[0],a[1],a[2])||1,t=e[0]+a[0]/o*.5,r=e[1]+a[1]/o*.5,n=e[2]+a[2]/o*.5,s=0,f=0;for(let c of[-.45,.45])for(let u of[-.45,.45])for(let h of[-.45,.45]){let m=Math.floor(t+c),l=Math.floor(r+u),d=Math.floor(n+h);this.aria(m,l,d)&&(s+=this.luceDi(m,l,d)[1],f++)}return f?Math.round(s/f):0}_v(e,a,o,t){return[e[0]-this.ox,e[1]+Eo,e[2]-this.oz,a,this._cielo,this._bloccoVertice(e,t),o,0,this._materia]}_giro(e,a,o,t){let r=a[0]-e[0],n=a[1]-e[1],s=a[2]-e[2],f=o[0]-e[0],c=o[1]-e[1],u=o[2]-e[2],h=n*u-s*c,m=s*f-r*u,l=r*c-n*f;return h*t[0]+m*t[1]+l*t[2]<0}tri(e,a,o,t,r){if(this._giro(e,a,o,r)){let s=a;a=o,o=s}let n=K(r[0],r[1],r[2]);this._cielo=this._cieloFaccia(r),this.c.quadDa(this._v(e,n,t,r),this._v(a,n,t,r),this._v(o,n,t,r),this._v(o,n,t,r))}quad(e,a,o,t,r,n){let s=K(n[0],n[1],n[2]);if(this._cielo=this._cieloFaccia(n),this._giro(e,a,o,n)){let f=a;a=t,t=f}this.c.quadDa(this._v(e,s,r,n),this._v(a,s,r,n),this._v(o,s,r,n),this._v(t,s,r,n))}};function xe(i){if(!i)return!1;let e=j(i);return!e.acqua&&!e.vetro&&!wo.has(e.forma)}function Uo(i){return!!i&&i.charCodeAt(0)===97&&i.startsWith("acqua")}function at(i,e,{erba:a=2,luce:o=!0}={}){let t=e.indexOf(","),r=+e.slice(0,t),n=+e.slice(t+1),s=r*L,f=n*L,c=new Ao(1024),u=new Ao(64),h=-1/0,m=new Int16Array(L*L).fill(-1),l=255,d=0,b=1/0,p=-1/0;i.perOgniDelChunk(e,(x,A)=>{A<b&&(b=A),A>p&&(p=A)});let g=o&&b<=p?ot(i,e,b-2,p+3):null,E=new Qo(Number.isFinite(b)?b:0),v=(x,A,M)=>g?g.leggi(x,A,M):[15,0],R=new Ee(c,s,f,v,(x,A,M)=>!xe(i.tipo(x,A,M))),z=new Uint8Array(27),_=(x,A,M,S,N,I,O,Q)=>[x-s,A+Eo,M-f,S,I,O,N,Q?1:0,0];return i.perOgniDelChunk(e,(x,A,M,S)=>{let N=j(S);if(N.forma==="modello"&&N.modello==="albero")for(let D=-2;D<=2;D++)for(let q=-2;q<=2;q++){let G=D*D+q*q;if(G>4)continue;let Y=x+D-s,ro=M+q-f;if(Y<0||Y>=L||ro<0||ro>=L)continue;let $=Y*L+ro,V=A+(G===0?4:G<=2?3:2);V>m[$]&&(m[$]=V)}if(wo.has(N.forma))return;let I=Uo(S),O=A+Eo;if(O<0||O>254)return;let Q=(x-s)*L+(M-f);!I&&A>m[Q]&&(m[Q]=A);let F=Be(De(S),A);N.motivo&&(F=Ve(F,N.motivo,N.motivoForza??1,x,A,M));let bo=Ge(N);bo&&(F={...F,cima:go(F.cima,bo),lato:go(F.lato,bo),fondo:go(F.fondo,bo)},F.facce&&(F.facce=F.facce.map(D=>D==null?D:go(D,bo))));let Mt=bo?Xe(N.materia):0;if(!I){z.fill(0);for(let $=-1;$<=1;$++)for(let V=-1;V<=1;V++)for(let H=-1;H<=1;H++)H===0&&$===0&&V===0||xe(i.tipo(x+H,A+$,M+V))&&(z[tt(H,$,V)]=1);let D=($,V,H)=>z[tt($,V,H)]===1;R.materia(Mt),R.cella(x,A,M);let q=x+.5,G=A+.5,Y=M+.5,ro=N.forma&&He[N.forma];ro?ro(R,q,G,Y,F,()=>!1):N.cappello&&!D(0,1,0)?We(R,q,G,Y,F,D):je(R,q,G,Y,F,(V,H,P)=>D(V,H,P)?H!==0?!0:!j(i.tipo(x+V,A,M+P)).cappello||D(V,1,P):!1,bo?bo.orlo:0),O-1<l&&(l=O-1),O+2>d&&(d=O+2)}let qo=0,zo=0;if(I)for(zo=Math.max(0,Math.min(15,Ue(S)||0));qo<15&&Uo(i.tipo(x,A-1-qo,M));)qo++;let Rt=(D,q)=>{if(!Uo(i.tipo(D,A,q)))return-1;let G=0;for(;G<15&&Uo(i.tipo(D,A-1-G,q));)G++;return G},Bo=(D,q)=>{let G=0,Y=0;for(let ro of[D-1,D])for(let $ of[q-1,q]){let V=Rt(ro,$);V>=0&&(G+=V,Y++)}return Y?Math.round(G/Y):qo};if(I)for(let[D,q,G,Y,ro,$]of aa){let V=i.tipo(x+D,A+q,M+G);if(V&&(Uo(V)||xe(V)))continue;let H=ho(F,ro,$),P=x,w=A,U=M,no,so,lo,co;if(D===1?(no=[P+1,w,U],so=[P+1,w+1,U],lo=[P+1,w+1,U+1],co=[P+1,w,U+1]):D===-1?(no=[P,w,U+1],so=[P,w+1,U+1],lo=[P,w+1,U],co=[P,w,U]):q===1?(no=[P,w+1,U],so=[P,w+1,U+1],lo=[P+1,w+1,U+1],co=[P+1,w+1,U]):q===-1?(no=[P,w,U+1],so=[P,w,U],lo=[P+1,w,U],co=[P+1,w,U+1]):G===1?(no=[P+1,w,U+1],so=[P+1,w+1,U+1],lo=[P,w+1,U+1],co=[P,w,U+1]):(no=[P,w,U],so=[P,w+1,U],lo=[P+1,w+1,U],co=[P+1,w,U]),q===1){let Me=A+(15-2*zo)/16;Me>h&&(h=Me)}u.quadDa(_(...no,Y,H,Bo(no[0],no[2]),zo,no[1]===w+1),_(...so,Y,H,Bo(so[0],so[2]),zo,so[1]===w+1),_(...lo,Y,H,Bo(lo[0],lo[2]),zo,lo[1]===w+1),_(...co,Y,H,Bo(co[0],co[2]),zo,co[1]===w+1)),O<l&&(l=O),O+1>d&&(d=O+1)}if(N.cappello&&a>0&&!i.tipo(x,A+1,M)){let[D,q]=v(x,A+1,M);E.ciuffo(x,A,M,s,f,F.cima,D,a/2,q),A+2+Eo>d&&(d=A+2+Eo)}}),l>d&&(l=0,d=0),{...c.dati(),minY:l,maxY:d,y0:-Eo,cx:r,cz:n,altezze:m,acqua:{...u.dati(),pelo:h===-1/0?null:h},erba:E.dati()}}function it(i,e,a,o,t){let r=(o-e+1)*L,n=(t-a+1)*L,s=new Uint8Array(r*n);for(let f of i){if(!f.altezze)continue;let c=(f.cx-e)*L,u=(f.cz-a)*L;for(let h=0;h<L;h++)for(let m=0;m<L;m++){let l=f.altezze[h*L+m];s[(u+m)*r+(c+h)]=l<0?0:Math.max(0,Math.min(255,l+1))}}return{byte:s,x0:e*L,z0:a*L,larghezza:r,profondita:n}}function Mo(i,e,a){let o=i*374761393+e*668265263+a*1442695041|0;return o=Math.imul(o^o>>>13,1274126177),((o^o>>>16)>>>0)/4294967296}function rt(i){return i*i*(3-2*i)}function Ae(i,e,a){let o=Math.floor(i),t=Math.floor(e),r=rt(i-o),n=rt(e-t),s=Mo(o,t,a),f=Mo(o+1,t,a),c=Mo(o,t+1,a),u=Mo(o+1,t+1,a);return s+(f-s)*r+(c-s)*n+(s-f-c+u)*r*n}var yo=5;function nt(i,e=1,a=64){i.svuota();let o=[],t=[],r=new Map,n=[];for(let u=-a;u<=a;u++)for(let h=-a;h<=a;h++){let m=.55*Ae(u*.028,h*.028,e)+.3*Ae(u*.07,h*.07,e+11)+.15*Ae(u*.16,h*.16,e+29),l=Math.max(2,1+Math.round(Math.pow(Math.max(0,m),1.6)*22)),d=Math.max(Math.abs(u),Math.abs(h)),b=Math.min(1,Math.max(0,(a-2-d)/8)),p=b*b*(3-2*b);l=Math.round(l*p+(yo+1)*(1-p));let g=l<=yo+1;r.set(u+"|"+h,l);for(let E=0;E<l;E++){let R=E===l-1?g?"sabbia":"erba":E<l-3?"roccia":"terra";i.metti(u,E,h,R,!0)}if(l<=yo)for(let E=l;E<=yo;E++)i.metti(u,E,h,"acqua",!0);else if(!g){let E=Mo(u*3+1,h*3+7,e+101);if(E>.988&&o.length<90?o.push([u,l,h]):E<.004&&t.length<14&&t.push([u,l,h]),l>=yo+6){let v=Mo(u*5+3,h*5+11,e+57);v>.99&&n.push({x:u,z:h,h:l,r:v})}}}let s=ra(i,r,e,n,a),f=u=>!s.has(u[0]+"|"+u[2]),c=[...s].map(u=>{let[h,m]=u.split("|").map(Number);return[h,r.get(u)-2,m]});return{alberi:o.filter(f),lampioni:t.filter(f),fiume:c}}var ia=[[1,0],[-1,0],[0,1],[0,-1]];function ra(i,e,a,o,t=64){let r=new Set;o.sort((f,c)=>c.h-f.h||f.r-c.r);let n=[];for(let f of o){if(n.length>=5)break;n.every(c=>(c.x-f.x)**2+(c.z-f.z)**2>=784)&&n.push(f)}let s=(f,c)=>{let u=f+"|"+c;if(r.has(u))return;let h=e.get(u);i.togli(f,h-1,c,!0),i.togli(f,h-2,c,!0),i.metti(f,h-2,c,"acqua",!0),r.add(u)};for(let f of n){let c=f.x,u=f.z,h=null,m=0,l=new Set([c+"|"+u]);for(let d=0;d<500;d++){let b=e.get(c+"|"+u);if(s(c,u),h){let v=c+h[1],R=u-h[0];e.get(v+"|"+R)===b&&s(v,R)}let p=null,g=1/0,E=1/0;for(let v of ia){let R=c+v[0],z=u+v[1];if(l.has(R+"|"+z))continue;let _=e.get(R+"|"+z);if(_===void 0)continue;let C=(v===h?-.5:0)+Mo(R*7+5,z*7+13,a+71);(_<g||_===g&&C<E)&&(p=v,g=_,E=C)}if(!p||g>b||(m=g===b?m+1:0,m>24)||(c+=p[0],u+=p[1],l.add(c+"|"+u),h=p,e.get(c+"|"+u)<=yo)||Math.max(Math.abs(c),Math.abs(u))>=t-6)break}}for(let f of r){let[c,u]=f.split("|").map(Number),h=e.get(f);for(let m=-1;m<=1;m++)for(let l=-1;l<=1;l++){if(!m&&!l)continue;let d=c+m+"|"+(u+l);if(r.has(d))continue;let b=e.get(d);b===void 0||b<h||b>h+1||i.tipo(c+m,b-1,u+l)==="erba"&&(i.togli(c+m,b-1,u+l,!0),i.metti(c+m,b-1,u+l,"sabbia",!0))}}return r}function st(i){let e=new DataView(i);if(String.fromCharCode(e.getUint8(0),e.getUint8(1),e.getUint8(2),e.getUint8(3))!=="LNM1")throw new Error("non \xE8 un modello del nucleo");let a=e.getUint32(4,!0),o=a*3,t=new Uint8Array(i,8,o*16),r=new Uint8Array(i,8+o*16,o*4),n=new Uint8Array(o*20);for(let h=0;h<o;h++)n.set(t.subarray(h*16,h*16+16),h*20),n.set(r.subarray(h*4,h*4+4),h*20+16);let s=1/0,f=-1/0,c=0,u=new DataView(n.buffer);for(let h=0;h<o;h++){let m=u.getFloat32(h*20,!0),l=u.getFloat32(h*20+4,!0),d=u.getFloat32(h*20+8,!0);s=Math.min(s,l),f=Math.max(f,l),c=Math.max(c,Math.hypot(m,d))}return{byte:n,vertici:o,triangoli:a,minY:s,maxY:f,raggio:c}}var na=`#version 300 es
precision highp float;
...
void main() {
  ...
  colore = vec4(c, 1.0);
}`;function la(i,e=4){if(e===8)return i instanceof Float32Array?i:new Float32Array(i);let a=i.length/4,o=new Float32Array(a*8);for(let t=0;t<a;t++)o.set([i[t*4],i[t*4+1],i[t*4+2],i[t*4+3],1,1,1,0],t*8);return o}var ca=`#version 300 es
layout(location = 0) in vec3 aPos;
...
mandami quello.`)}}};var k=document.getElementById("tela"),ba=document.getElementById("stato"),va=document.getElementById("fps"),Z=new URLSearchParams(location.search),y={raggio:+(Z.get("raggio")||5),erba:+(Z.get("erba")??8),ombra:Z.get("ombra")!=="no",specchio:Z.get("specchio")==="no"?0:Math.max(.2,Math.min(1,+(Z.get("specchio")??.5)||.5)),dprMax:+(Z.get("dpr")||1.5),rampa:Z.has("rampa"),tutto:Z.has("tutto"),mondo:Z.has("finto")||Z.has("rampa")?0:Math.max(16,Math.min(400,+(Z.get("mondo")||48))),ora:Z.has("ora")?Math.max(0,Math.min(1,+Z.get("ora"))):null},{gl:Io,dpr:ga,ridimensiona:xa}=Re(k,{antialias:!0,dprMax:y.dprMax}),T=new Xo(Io),oo=new Jo(Io);T.ombra=y.ombra;T.specchio.attivo=y.specchio>0;T.specchio.scala=y.specchio||.5;T.specchio.mostra=Z.has("vedi");var re=0,_o=0;function bt(i,e){let a=performance.now();for(let r of[...T.chunks.keys()])T.rimuovi(r);re=0;for(let r=-i;r<i;r++)for(let n=-i;n<i;n++)T.carica(r+","+n,Ie(r,n,{erba:e})),re+=256;let o=i*2*16,t=new Uint8Array(o*o);for(let r=0;r<o;r++)for(let n=0;n<o;n++)t[r*o+n]=So(n-i*16,r-i*16)+1;T.impostaAltezze(t,-i*16,-i*16,o,o),_o=performance.now()-a}var io=null,vt=0,gt=0;function Ea(i,e){let a=performance.now();for(let m of[...T.chunks.keys()])T.rimuovi(m);Ze(),io=new Ko;let{alberi:o,lampioni:t}=nt(io,4242,i);for(let[m,l,d]of o)io.metti(m,l,d,"albero",!0);for(let[m,l,d]of t)io.metti(m,l,d,"lampione",!0);let r=performance.now()-a,n=[],s=1e9,f=1e9,c=-1e9,u=-1e9;for(let m of io.chunks.keys()){let l=at(io,m,{erba:e});T.carica(m,l),n.push(l),s=Math.min(s,l.cx),c=Math.max(c,l.cx),f=Math.min(f,l.cz),u=Math.max(u,l.cz)}let h=it(n,s,f,c,u);return T.impostaAltezze(h.byte,h.x0,h.z0,h.larghezza,h.profondita),re=vt=io.contaBlocchi,gt=n.length,_o=performance.now()-a,{tGen:r,tMesh:_o-r}}var Te=null;y.mondo?Te=Ea(y.mondo,y.erba):bt(y.raggio,y.erba);async function Aa(){if(!io)return;let i=new Map;io.perOgni((e,a,o,t)=>{let r=j(t);r.forma!=="modello"||!r.modello||(i.has(r.modello)||i.set(r.modello,[]),i.get(r.modello).push(e+.5,a,o+.5,1))});for(let[e,a]of i)try{let o=await fetch(`./modelli/nucleo/${e}.bin`);if(!o.ok)throw new Error(`${o.status}`);oo.registra(e,st(await o.arrayBuffer())),oo.istanze(e,a)}catch(o){console.warn(`modello ${e}: ${o.message}`)}}Aa();T.tutto=y.tutto;var Ta=()=>{if(!io)return So(0,0)+2;for(let i=120;i>-Eo;i--)if(io.tipo(0,i,0))return i+2;return 8},B={alpha:-.8,beta:1.05,raggio:46,centro:[0,Ta(),0],fov:.9};function xt(){let i=Math.sin(B.beta),e=Math.cos(B.beta);return[B.centro[0]+B.raggio*i*Math.cos(B.alpha),B.centro[1]+B.raggio*e,B.centro[2]+B.raggio*i*Math.sin(B.alpha)]}var Fo=null,ee=0;k.addEventListener("pointerdown",i=>{Fo={x:i.clientX,y:i.clientY},k.setPointerCapture(i.pointerId)});k.addEventListener("pointermove",i=>{Fo&&(B.alpha+=(i.clientX-Fo.x)*.006,B.beta=Math.max(.15,Math.min(1.5,B.beta-(i.clientY-Fo.y)*.006)),Fo={x:i.clientX,y:i.clientY})});k.addEventListener("pointerup",()=>{Fo=null});k.addEventListener("wheel",i=>{B.raggio=Math.max(8,Math.min(140,B.raggio*(i.deltaY>0?1.1:.9))),i.preventDefault()},{passive:!1});k.addEventListener("touchstart",i=>{i.touches.length===2&&(ee=Math.hypot(i.touches[0].clientX-i.touches[1].clientX,i.touches[0].clientY-i.touches[1].clientY))},{passive:!0});k.addEventListener("touchmove",i=>{if(i.touches.length!==2)return;let e=Math.hypot(i.touches[0].clientX-i.touches[1].clientX,i.touches[0].clientY-i.touches[1].clientY);ee>0&&(B.raggio=Math.max(8,Math.min(140,B.raggio*ee/e))),ee=e},{passive:!0});var te=y.ora??.35;function Ma(i){y.ora===null&&(te=(te+i/300)%1);let e=te*Math.PI*2-Math.PI/2,a=.24+.5*Math.max(0,Math.sin(e)),o=e*.5;T.sole.verso=[-Math.cos(o)*Math.cos(Math.asin(a)),-a,-Math.sin(o)*Math.cos(Math.asin(a))];let t=Math.max(0,Math.min(1,(Math.sin(e)+.1)*2));T.sole.forza=t;let r=Math.min(1,Math.max(0,(a-.24)/.4));T.sole.colore=[1,.78+.22*r,.55+.45*r],T.sole.cielo=[.36+.64*t,.38+.62*t,.57+.43*t],T.nebbia.colore=[.25+.47*t,.35+.5*t,.5+.42*t],Io.clearColor(T.nebbia.colore[0],T.nebbia.colore[1],T.nebbia.colore[2],1)}var W=[],po=[],ae=[],ht=performance.now(),Et=0,pt=0;function At(i){let e=Math.min(.1,(i-ht)/1e3);ht=i;let a=performance.now();xa(),Ma(e);let t={occhio:xt(),centro:B.centro,fov:B.fov,rapporto:k.width/k.height};T.disegna(t,e,oo),oo.disegna(T,t),T.disegnaAcqua();let r=performance.now()-a;W.push(e*1e3),W.length>240&&W.shift(),po.push(r),po.length>240&&po.shift(),Et++,i-pt>500&&(pt=i,Tt()),y.rampa&&!y.mondo&&Ra(i),requestAnimationFrame(At)}var ie=[{raggio:5,erba:2,tutto:!1},{raggio:6,erba:3,tutto:!1},{raggio:7,erba:4,tutto:!1},{raggio:6,erba:3,tutto:!0},{raggio:8,erba:4,tutto:!0}],ne=[],Ro=-1,dt=0;function Ra(i){if(Ro>=0&&i-dt<6e3)return;if(Ro>=0){let a=W.slice(-Math.min(W.length,200)),o=ie[Ro];ne.push({...o,fps:+(1e3/(X(a,.5)||1)).toFixed(0),p50:+X(a,.5).toFixed(1),p99:+X(a,.99).toFixed(1),js:+X(po,.5).toFixed(2),disegni:T.statistiche.disegni,triangoli:T.statistiche.triangoli})}if(Ro++,Ro>=ie.length){y.rampa=!1,Tt();return}let e=ie[Ro];bt(e.raggio,e.erba),T.tutto=e.tutto,y.erba=e.erba,y.raggio=e.raggio,W.length=0,po.length=0,dt=i}var X=(i,e)=>{if(!i.length)return 0;let a=i.slice().sort((o,t)=>o-t);return a[Math.min(a.length-1,Math.floor(a.length*e))]};function Tt(){let i=X(W,.5),e=X(W,.99),a=i?1e3/i:0;ae.push(Math.round(a)),ae.length>120&&ae.shift();let o={disegni:T.statistiche.disegni+oo.statistiche.disegni+T.statistiche.disegniAcqua+T.statistiche.disegniErba+T.statistiche.disegniSpecchio,triangoli:T.statistiche.triangoli+oo.statistiche.triangoli+T.statistiche.triangoliAcqua+T.statistiche.triangoliErba+T.statistiche.triangoliSpecchio,chunkVisti:T.statistiche.chunkVisti,chunkTotali:T.statistiche.chunkTotali};va.textContent=`${a.toFixed(0)} fps
${i.toFixed(1)} / ${e.toFixed(1)} ms
JS ${X(po,.5).toFixed(2)} ms`,ba.textContent=`NUCLEO ${y.mondo?`F1 \xB7 open world vero (semilato ${y.mondo}, ${gt} chunk, ${vt.toLocaleString("it")} blocchi, gen ${Te.tGen.toFixed(0)} ms + mesh ${Te.tMesh.toFixed(0)} ms)`:"F0"} \xB7 ${k.width}\xD7${k.height} (dpr ${ga.toFixed(2)})
disegni ${o.disegni}  triangoli ${o.triangoli.toLocaleString("it")}  chunk ${o.chunkVisti}/${o.chunkTotali}
ombra del sole: ${T.ombra?"horizon mapping":"spenta"} \xB7 erba ${y.erba} \xB7 modelli ${oo.statistiche.istanze} istanze in ${oo.statistiche.disegni} disegni \xB7 acqua ${T.statistiche.disegniAcqua} disegni${T.statistiche.pelo!=null?` + specchio ${T.statistiche.disegniSpecchio} disegni (pelo ${T.statistiche.pelo.toFixed(2)}, scala ${T.specchio.scala})`:" (senza specchio)"} \xB7 erba ${T.statistiche.triangoliErba.toLocaleString("it")} fili in ${T.statistiche.disegniErba} disegni \xB7 costruzione ${_o.toFixed(0)} ms
${Vo(Io)}
?mondo=96 ?ora=0.95 ?finto ?raggio=${y.raggio} ?erba=${y.erba} ?ombra=${y.ombra?"s\xEC":"no"} ?specchio=${y.specchio||"no"} ?dpr=${y.dprMax} ?rampa ?tutto  \xB7  tocca lo schermo per girare`+(ne.length?`

...
${n.split(`
`).map((f,l)=>`${l+1}: ${f}`).join(`
`)}`);return s},t=i.createProgram();if(i.attachShader(t,o(i.VERTEX_SHADER,e)),i.attachShader(t,o(i.FRAGMENT_SHADER,a)),i.linkProgram(t),!i.getProgramParameter(t,i.LINK_STATUS))throw new Error(`programma: ${i.getProgramInfoLog(t)}`);return t}function Vo(i){let e=i.getExtension("WEBGL_debug_renderer_info");return e?i.getParameter(e.UNMASKED_RENDERER_WEBGL):i.getParameter(i.RENDERER)}function K(i,e,a){return(Math.sign(i)+1)*9+(Math.sign(e)+1)*3+(Math.sign(a)+1)}var St=K(1,0,0),Rt=K(-1,0,0),Ct=K(0,1,0),zt=K(0,-1,0),Ot=K(0,0,1),Ft=K(0,0,-1);var Se=[St,Rt,Ct,zt,Ot,Ft],Ao=class{constructor(e=1024){this.byte=new Uint8Array(e*4*12),this.u32=new Uint32Array(this.byte.buffer),this.n=0,this.quad=0}_spazio(e){let a=(this.n+e)*12;if(a<=this.byte.length)return;let o=this.byte.length*2;for(;o<a;)o*=2;let t=new Uint8Array(o);t.set(this.byte),this.byte=t,this.u32=new Uint32Array(t.buffer)}vertice(e,a,o,t,r,n,s,f=0,l=0){let u=Math.round(e*16)+16,h=Math.round(o*16)+16,m=Math.round(a*16);if(u<0||u>511||h<0||h>511||m<0||m>65535)throw new RangeError(`vertice fuori dal chunk: ${e},${a},${o}`);if(t<0||t>26||t===13)throw new RangeError(`normale non valida: ${t}`);this._spazio(1);let c=this.n*3,d=this.byte,b=this.u32;b[c]=(u|h<<9|(t&31)<<18|(f&1)<<23|(l&15)<<24)>>>0,b[c+1]=(m|(r&15)<<16|(n&15)<<20)>>>0;let p=this.n*12+8;d[p]=s>>16&255,d[p+1]=s>>8&255,d[p+2]=s&255,d[p+3]=0,this.n++}quadDa(e,a,o,t){if(this.quad>=16384)throw new RangeError("troppi quad per un chunk");for(let r of[e,a,o,t])this.vertice(...r);this.quad++}dati(){return{byte:this.byte.subarray(0,this.n*12),quad:this.quad,vertici:this.n,triangoli:this.quad*2}}};function Re(i=16384){let e=new Uint16Array(i*6);for(let a=0,o=0,t=0;a<i;a++,t+=4)e[o++]=t,e[o++]=t+1,e[o++]=t+2,e[o++]=t,e[o++]=t+2,e[o++]=t+3;return e}function Ce(i,e,a,o){let t=1/Math.tan(i/2),r=1/(a-o);return new Float32Array([t/e,0,0,0,0,t,0,0,0,0,(o+a)*r,-1,0,0,2*o*a*r,0])}function se(i,e,a){let o=1/(a-e);return new Float32Array([1/i,0,0,0,0,1/i,0,0,0,0,-2*o,0,0,0,-(a+e)*o,1])}function ko(i,e,a=[0,1,0]){let o=i[0]-e[0],t=i[1]-e[1],r=i[2]-e[2],n=Math.hypot(o,t,r)||1;o/=n,t/=n,r/=n;let s=a[1]*r-a[2]*t,f=a[2]*o-a[0]*r,l=a[0]*t-a[1]*o;n=Math.hypot(s,f,l)||1,s/=n,f/=n,l/=n;let u=t*l-r*f,h=r*s-o*l,m=o*f-t*s;return new Float32Array([s,u,o,0,f,h,t,0,l,m,r,0,-(s*i[0]+f*i[1]+l*i[2]),-(u*i[0]+h*i[1]+m*i[2]),-(o*i[0]+t*i[1]+r*i[2]),1])}function ze(i,e=new Float32Array(16)){let[a,o,t,r,n,s,f,l,u,h,m,c,d,b,p,g]=i,E=a*s-o*n,v=a*f-t*n,_=a*l-r*n,R=o*f-t*s,S=o*l-r*s,z=t*l-r*f,x=u*b-h*d,A=u*p-m*d,T=u*g-c*d,C=h*p-m*b,N=h*g-c*b,I=m*g-c*p,O=E*I-v*N+_*C+R*T-S*A+z*x;return O?(O=1/O,e[0]=(s*I-f*N+l*C)*O,e[1]=(t*N-o*I-r*C)*O,e[2]=(b*z-p*S+g*R)*O,e[3]=(m*S-h*z-c*R)*O,e[4]=(f*T-n*I-l*A)*O,e[5]=(a*I-t*T+r*A)*O,e[6]=(p*_-d*z-g*v)*O,e[7]=(u*z-m*_+c*v)*O,e[8]=(n*N-s*T+l*x)*O,e[9]=(o*T-a*N-r*x)*O,e[10]=(d*S-b*_+g*E)*O,e[11]=(h*_-u*S-c*E)*O,e[12]=(s*A-n*C-f*x)*O,e[13]=(a*C-o*A+t*x)*O,e[14]=(b*v-d*R-p*E)*O,e[15]=(u*R-h*v+m*E)*O,e):null}function No(i,e,a=new Float32Array(16)){for(let o=0;o<4;o++)for(let t=0;t<4;t++)a[o*4+t]=i[t]*e[o*4]+i[4+t]*e[o*4+1]+i[8+t]*e[o*4+2]+i[12+t]*e[o*4+3];return a}function ce(i,e=new Float32Array(24)){let a=f=>[i[f],i[4+f],i[8+f],i[12+f]],o=a(0),t=a(1),r=a(2),n=a(3),s=[[n[0]+o[0],n[1]+o[1],n[2]+o[2],n[3]+o[3]],[n[0]-o[0],n[1]-o[1],n[2]-o[2],n[3]-o[3]],[n[0]+t[0],n[1]+t[1],n[2]+t[2],n[3]+t[3]],[n[0]-t[0],n[1]-t[1],n[2]-t[2],n[3]-t[3]],[n[0]+r[0],n[1]+r[1],n[2]+r[2],n[3]+r[3]],[n[0]-r[0],n[1]-r[1],n[2]-r[2],n[3]-r[3]]];for(let f=0;f<6;f++){let[l,u,h,m]=s[f],c=Math.hypot(l,u,h)||1;e[f*4]=l/c,e[f*4+1]=u/c,e[f*4+2]=h/c,e[f*4+3]=m/c}return e}function le(i,e,a,o,t,r,n){for(let s=0;s<6;s++){let f=i[s*4],l=i[s*4+1],u=i[s*4+2],h=i[s*4+3],m=f>0?t:e,c=l>0?r:a,d=u>0?n:o;if(f*m+l*c+u*d+h<0)return!1}return!0}var Lt=`#version 300 es
...
float pozza(highp vec3 pos, float cotto) {
  ...
  for (int i = 0; i < 8; i++) {
    ...
    // valere circa 1 - q; se \xE8 molto meno, fra qui e il lampione c'\xE8 qualcosa
...
void main() {
  ...
  // \u26A0 LA SCHIUMA AI BORDI: dove l'acqua \xE8 bassa (la riva) una fascia bianca

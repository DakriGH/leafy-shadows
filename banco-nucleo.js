function Se(i,{antialias:o=!0,dprMax:t=1.5}={}){let e=i.getContext("webgl2",{antialias:o,alpha:!1,depth:!0,stencil:!1,preserveDrawingBuffer:!1,powerPreference:"high-performance",desynchronized:!1});if(!e)throw new Error("WebGL2 non disponibile");let a=Math.min(t,devicePixelRatio||1),n=()=>{let r=Math.max(1,Math.round(i.clientWidth*a)),l=Math.max(1,Math.round(i.clientHeight*a));return i.width!==r||i.height!==l?(i.width=r,i.height=l,e.viewport(0,0,r,l),!0):!1};return n(),{gl:e,dpr:a,ridimensiona:n}}function oo(i,o,t){let e=(n,r)=>{let l=i.createShader(n);if(i.shaderSource(l,r),i.compileShader(l),!i.getShaderParameter(l,i.COMPILE_STATUS))throw new Error(`shader: ${i.getShaderInfoLog(l)}
${r.split(`
`).map((f,c)=>`${c+1}: ${f}`).join(`
`)}`);return l},a=i.createProgram();if(i.attachShader(a,e(i.VERTEX_SHADER,o)),i.attachShader(a,e(i.FRAGMENT_SHADER,t)),i.linkProgram(a),!i.getProgramParameter(a,i.LINK_STATUS))throw new Error(`programma: ${i.getProgramInfoLog(a)}`);return a}function ko(i){let o=i.getExtension("WEBGL_debug_renderer_info");return o?i.getParameter(o.UNMASKED_RENDERER_WEBGL):i.getParameter(i.RENDERER)}function K(i,o,t){return(Math.sign(i)+1)*9+(Math.sign(o)+1)*3+(Math.sign(t)+1)}var _a=K(1,0,0),Ca=K(-1,0,0),Oa=K(0,1,0),La=K(0,-1,0),Ia=K(0,0,1),Na=K(0,0,-1);var _e=[_a,Ca,Oa,La,Ia,Na],To=class{constructor(o=1024){this.byte=new Uint8Array(o*4*12),this.u32=new Uint32Array(this.byte.buffer),this.n=0,this.quad=0}_spazio(o){let t=(this.n+o)*12;if(t<=this.byte.length)return;let e=this.byte.length*2;for(;e<t;)e*=2;let a=new Uint8Array(e);a.set(this.byte),this.byte=a,this.u32=new Uint32Array(a.buffer)}vertice(o,t,e,a,n,r,l,f=0,c=0){let u=Math.round(o*16)+16,p=Math.round(e*16)+16,m=Math.round(t*16);if(u<0||u>511||p<0||p>511||m<0||m>65535)throw new RangeError(`vertice fuori dal chunk: ${o},${t},${e}`);if(a<0||a>26||a===13)throw new RangeError(`normale non valida: ${a}`);this._spazio(1);let s=this.n*3,d=this.byte,v=this.u32;v[s]=(u|p<<9|(a&31)<<18|(f&1)<<23|(c&15)<<24)>>>0,v[s+1]=(m|(n&15)<<16|(r&15)<<20)>>>0;let h=this.n*12+8;d[h]=l>>16&255,d[h+1]=l>>8&255,d[h+2]=l&255,d[h+3]=0,this.n++}quadDa(o,t,e,a){if(this.quad>=16384)throw new RangeError("troppi quad per un chunk");for(let n of[o,t,e,a])this.vertice(...n);this.quad++}dati(){return{byte:this.byte.subarray(0,this.n*12),quad:this.quad,vertici:this.n,triangoli:this.quad*2}}};function Ce(i=16384){let o=new Uint16Array(i*6);for(let t=0,e=0,a=0;t<i;t++,a+=4)o[e++]=a,o[e++]=a+1,o[e++]=a+2,o[e++]=a,o[e++]=a+2,o[e++]=a+3;return o}function Oe(i,o,t,e){let a=1/Math.tan(i/2),n=1/(t-e);return new Float32Array([a/o,0,0,0,0,a,0,0,0,0,(e+t)*n,-1,0,0,2*e*t*n,0])}function ue(i,o,t){let e=1/(t-o);return new Float32Array([1/i,0,0,0,0,1/i,0,0,0,0,-2*e,0,0,0,-(t+o)*e,1])}function Xo(i,o,t=[0,1,0]){let e=i[0]-o[0],a=i[1]-o[1],n=i[2]-o[2],r=Math.hypot(e,a,n)||1;e/=r,a/=r,n/=r;let l=t[1]*n-t[2]*a,f=t[2]*e-t[0]*n,c=t[0]*a-t[1]*e;r=Math.hypot(l,f,c)||1,l/=r,f/=r,c/=r;let u=a*c-n*f,p=n*l-e*c,m=e*f-a*l;return new Float32Array([l,u,e,0,f,p,a,0,c,m,n,0,-(l*i[0]+f*i[1]+c*i[2]),-(u*i[0]+p*i[1]+m*i[2]),-(e*i[0]+a*i[1]+n*i[2]),1])}function Le(i,o=new Float32Array(16)){let[t,e,a,n,r,l,f,c,u,p,m,s,d,v,h,b]=i,E=t*l-e*r,g=t*f-a*r,z=t*c-n*r,S=e*f-a*l,R=e*c-n*l,_=a*c-n*f,A=u*v-p*d,L=u*h-m*d,T=u*b-s*d,x=p*h-m*v,I=p*b-s*v,F=m*b-s*h,C=E*F-g*I+z*x+S*T-R*L+_*A;return C?(C=1/C,o[0]=(l*F-f*I+c*x)*C,o[1]=(a*I-e*F-n*x)*C,o[2]=(v*_-h*R+b*S)*C,o[3]=(m*R-p*_-s*S)*C,o[4]=(f*T-r*F-c*L)*C,o[5]=(t*F-a*T+n*L)*C,o[6]=(h*z-d*_-b*g)*C,o[7]=(u*_-m*z+s*g)*C,o[8]=(r*I-l*T+c*A)*C,o[9]=(e*T-t*I-n*A)*C,o[10]=(d*R-v*z+b*E)*C,o[11]=(p*z-u*R-s*E)*C,o[12]=(l*L-r*x-f*A)*C,o[13]=(t*x-e*L+a*A)*C,o[14]=(v*g-d*S-h*E)*C,o[15]=(u*S-p*g+m*E)*C,o):null}function Po(i,o,t=new Float32Array(16)){for(let e=0;e<4;e++)for(let a=0;a<4;a++)t[e*4+a]=i[a]*o[e*4]+i[4+a]*o[e*4+1]+i[8+a]*o[e*4+2]+i[12+a]*o[e*4+3];return t}function fe(i,o=new Float32Array(24)){let t=f=>[i[f],i[4+f],i[8+f],i[12+f]],e=t(0),a=t(1),n=t(2),r=t(3),l=[[r[0]+e[0],r[1]+e[1],r[2]+e[2],r[3]+e[3]],[r[0]-e[0],r[1]-e[1],r[2]-e[2],r[3]-e[3]],[r[0]+a[0],r[1]+a[1],r[2]+a[2],r[3]+a[3]],[r[0]-a[0],r[1]-a[1],r[2]-a[2],r[3]-a[3]],[r[0]+n[0],r[1]+n[1],r[2]+n[2],r[3]+n[3]],[r[0]-n[0],r[1]-n[1],r[2]-n[2],r[3]-n[3]]];for(let f=0;f<6;f++){let[c,u,p,m]=l[f],s=Math.hypot(c,u,p)||1;o[f*4]=c/s,o[f*4+1]=u/s,o[f*4+2]=p/s,o[f*4+3]=m/s}return o}function me(i,o,t,e,a,n,r){for(let l=0;l<6;l++){let f=i[l*4],c=i[l*4+1],u=i[l*4+2],p=i[l*4+3],m=f>0?a:o,s=c>0?n:t,d=u>0?r:e;if(f*m+c*s+u*d+p<0)return!1}return!0}var Fa=`#version 300 es
...
out vec2 vNdc;
void main() { vNdc = vec2((gl_VertexID == 1) ? 3.0 : -1.0, (gl_VertexID == 2) ? 3.0 : -1.0); gl_Position = vec4(vNdc, 0.999999, 1.0); }`,wa=`#version 300 es
precision highp float;
in vec2 vNdc;
uniform mat4 uInvVP;
...
}`),this.uOmbre={};for(let n of["uAltezze","uAltRett","uSole","uCodifica"])this.uOmbre[n]=e.getUniformLocation(this.programmaOmbre,n);this.vaoOmbre=e.createVertexArray()}}_calcolaOmbre(){let o=this.gl,t=this.ombre,e=this.sole;if(!this.altezze||!t.tex||(e.verso[0]*t.sole[0]+e.verso[1]*t.sole[1]+e.verso[2]*t.sole[2]<.99996&&(t.sole=e.verso.slice(),t.sporco=[0,0,t.w,t.h]),!t.sporco))return;let n=96,[r,l,f,c]=t.sporco;if(f<=r||c<=l){t.sporco=null;return}let u=Math.min(c,l+n);t.sporco=u>=c?null:[r,u,f,c];let p=Math.hypot(e.verso[0],e.verso[2])||1e-4,m=[-e.verso[0]/p,-e.verso[2]/p],s=Math.max(.05,-e.verso[1]/p);o.bindFramebuffer(o.FRAMEBUFFER,t.fbo),o.viewport(0,0,t.w,t.h),o.enable(o.SCISSOR_TEST),o.scissor(r,l,f-r,u-l),o.disable(o.DEPTH_TEST),o.disable(o.CULL_FACE),o.useProgram(this.programmaOmbre),o.activeTexture(o.TEXTURE0),o.bindTexture(o.TEXTURE_2D,this.altezze),o.uniform1i(this.uOmbre.uAltezze,0),o.uniform4f(this.uOmbre.uAltRett,0,0,1/t.w,1/t.h),o.uniform3f(this.uOmbre.uSole,m[0],m[1],s),o.uniform2f(this.uOmbre.uCodifica,t.scala,t.offset),o.bindVertexArray(this.vaoOmbre),o.drawArrays(o.TRIANGLES,0,3),o.bindVertexArray(null),o.disable(o.SCISSOR_TEST),o.enable(o.DEPTH_TEST),o.enable(o.CULL_FACE),o.bindFramebuffer(o.FRAMEBUFFER,null),o.viewport(0,0,o.drawingBufferWidth,o.drawingBufferHeight),t.calcoli++,this.statistiche.calcoliOmbre=t.calcoli}_disegnaCielo(o,t){let e=this.gl,a=this.uc,n=this.sole;if(this.cieloNero||!Le(o,this._invVP))return;e.useProgram(this.programmaCielo),e.uniformMatrix4fv(a.uInvVP,!1,this._invVP),e.uniform3f(a.uOcchio,t[0],t[1],t[2]),e.uniform3f(a.uSoleVerso,n.verso[0],n.verso[1],n.verso[2]),e.uniform1f(a.uSoleForza,n.forza),e.uniform3f(a.uNebbiaCol,this.nebbia.colore[0],this.nebbia.colore[1],this.nebbia.colore[2]);let r=n.forza;e.uniform3f(a.uZenit,.04+.32*r,.06+.56*r,.14+.82*r),e.disable(e.DEPTH_TEST),e.depthMask(!1),e.disable(e.CULL_FACE),e.bindVertexArray(this.vaoVuoto),e.drawArrays(e.TRIANGLES,0,3),e.bindVertexArray(null),e.enable(e.CULL_FACE),e.depthMask(!0),e.enable(e.DEPTH_TEST)}_preparaMappa(){let o=this.gl,t=this.mappa,e=a=>{let n=o.createTexture();o.bindTexture(o.TEXTURE_2D,n),o.texImage2D(o.TEXTURE_2D,0,o.DEPTH_COMPONENT24,a,a,0,o.DEPTH_COMPONENT,o.UNSIGNED_INT,null),o.texParameteri(o.TEXTURE_2D,o.TEXTURE_MIN_FILTER,o.LINEAR),o.texParameteri(o.TEXTURE_2D,o.TEXTURE_MAG_FILTER,o.LINEAR),o.texParameteri(o.TEXTURE_2D,o.TEXTURE_WRAP_S,o.CLAMP_TO_EDGE),o.texParameteri(o.TEXTURE_2D,o.TEXTURE_WRAP_T,o.CLAMP_TO_EDGE),o.texParameteri(o.TEXTURE_2D,o.TEXTURE_COMPARE_MODE,o.COMPARE_REF_TO_TEXTURE),o.texParameteri(o.TEXTURE_2D,o.TEXTURE_COMPARE_FUNC,o.LEQUAL);let r=o.createFramebuffer();o.bindFramebuffer(o.FRAMEBUFFER,r),o.framebufferTexture2D(o.FRAMEBUFFER,o.DEPTH_ATTACHMENT,o.TEXTURE_2D,n,0),o.drawBuffers([o.NONE]),o.readBuffer(o.NONE);let l=o.checkFramebufferStatus(o.FRAMEBUFFER)===o.FRAMEBUFFER_COMPLETE;return o.bindFramebuffer(o.FRAMEBUFFER,null),{tex:n,fbo:r,lato:a,ok:l}};t.stat=e(t.lato),t.din=e(t.latoDin),(!t.stat.ok||!t.din.ok)&&(t.attiva=!1)}legaMappa(o){let t=this.gl,e=this.mappa;t.activeTexture(t.TEXTURE1),t.bindTexture(t.TEXTURE_2D,e.stat.tex),t.uniform1i(o.uMappaStat,1),t.activeTexture(t.TEXTURE2),t.bindTexture(t.TEXTURE_2D,e.din.tex),t.uniform1i(o.uMappaDin,2),t.activeTexture(t.TEXTURE0),t.uniform1f(o.uMappaOn,e.on?1:0),t.uniformMatrix4fv(o.uLuceVP,!1,e.vp),t.uniformMatrix4fv(o.uLuceVPDin,!1,e.vpDin),t.uniform2f(o.uMappaTexel,.5/e.lato,.5/e.latoDin),t.uniform2f(o.uMappaSbieco,1.5*(2*e.raggio/e.lato),.1/220),t.uniform4fv(o.uLampade,this.lampade),t.uniform1i(o.uNLampade,this.nLampade),t.uniform3f(o.uStile,this.stile.tinta,this.stile.saturazione,this.stile.valore),this.altezze&&(t.activeTexture(t.TEXTURE3),t.bindTexture(t.TEXTURE_2D,this.altezze),t.uniform1i(o.uAltezze,3),t.activeTexture(t.TEXTURE0))}_aggiornaMappa(o,t){let e=this.gl,a=this.mappa,n=this.sole,r=this.statistiche;if(a.on=!1,!a.attiva||!this.ombra)return;let l=typeof performance<"u"?performance.now():0,f=o.centro[0],c=o.centro[2],u=!1;Math.hypot(f-a.centro[0],c-a.centro[2])>10&&(a.centro=[Math.round(f/2)*2,Math.round(o.centro[1]),Math.round(c/2)*2],u=!0);{let h=n.verso,b=o.centro,E=[b[0]-h[0]*120,b[1]-h[1]*120,b[2]-h[2]*120],g=Math.abs(h[1])>.95?[0,0,1]:[0,1,0];Po(ue(a.raggioDin,10,230),Xo(E,b,g),a.vpDin)}n.verso[0]*a.sole[0]+n.verso[1]*a.sole[1]+n.verso[2]*a.sole[2]<.99985&&(a.soleMosso=!0);let m=a.sporca||a.soleMosso||t&&t.mappaSporca,s=u||m&&l-(a.ultimo||0)>=500;if(s){a.sole=n.verso.slice(),a.soleMosso=!1,a.ultimo=l;let h=n.verso,b=a.centro,E=[b[0]-h[0]*120,b[1]-h[1]*120,b[2]-h[2]*120],g=Math.abs(h[1])>.95?[0,0,1]:[0,1,0];Po(ue(a.raggio,10,230),Xo(E,b,g),a.vp)}if(e.enable(e.POLYGON_OFFSET_FILL),e.polygonOffset(1.5,4),s){e.bindFramebuffer(e.FRAMEBUFFER,a.stat.fbo),e.viewport(0,0,a.stat.lato,a.stat.lato),e.clear(e.DEPTH_BUFFER_BIT),e.useProgram(this.programmaOmbra),e.uniformMatrix4fv(this.uo.uVP,!1,a.vp);let h=0,b=0,E=a.raggio+12;for(let g of this.chunks.values())g.quad!==0&&(Math.hypot(g.x0+8-a.centro[0],g.z0+8-a.centro[2])>E||(e.uniform3f(this.uo.uChunk,g.chunk[0],g.chunk[1],g.chunk[2]),e.bindVertexArray(g.vao),e.drawElements(e.TRIANGLES,g.quad*6,e.UNSIGNED_SHORT,0),h++,b+=g.quad*2));if(e.bindVertexArray(null),t){let[g,z]=t.disegnaOmbra(a.vp,!1);h+=g,b+=z,t.mappaSporca=!1}a.sporca=!1,a.calcoli++,a.disegni=h,a.triangoli=b}e.bindFramebuffer(e.FRAMEBUFFER,a.din.fbo),e.viewport(0,0,a.din.lato,a.din.lato),e.clear(e.DEPTH_BUFFER_BIT);let d=0,v=0;t&&([d,v]=t.disegnaOmbra(a.vpDin,!0)),e.disable(e.POLYGON_OFFSET_FILL),e.bindFramebuffer(e.FRAMEBUFFER,null),e.viewport(0,0,e.drawingBufferWidth,e.drawingBufferHeight),a.on=!0,r.calcoliMappa=a.calcoli,r.disegniOmbra=d+(s?a.disegni:0),r.triangoliOmbra=v+(s?a.triangoli:0)}impostaAltezze(o,t,e,a,n,r=null){let l=this.gl;this.altezze||(this.altezze=l.createTexture()),l.bindTexture(l.TEXTURE_2D,this.altezze),l.pixelStorei(l.UNPACK_ALIGNMENT,1);let f=new Uint8Array(a*n*4);for(let c=0;c<a*n;c++)f[c*4]=o[c],f[c*4+1]=r?r[c]:o[c];l.texImage2D(l.TEXTURE_2D,0,l.RGBA8,a,n,0,l.RGBA,l.UNSIGNED_BYTE,f),l.texParameteri(l.TEXTURE_2D,l.TEXTURE_MIN_FILTER,l.NEAREST),l.texParameteri(l.TEXTURE_2D,l.TEXTURE_MAG_FILTER,l.NEAREST),l.texParameteri(l.TEXTURE_2D,l.TEXTURE_WRAP_S,l.CLAMP_TO_EDGE),l.texParameteri(l.TEXTURE_2D,l.TEXTURE_WRAP_T,l.CLAMP_TO_EDGE),this.altRett=[t,e,1/a,1/n],this._preparaOmbre(a,n)}impostaMaterie(o){let t=new Float32Array(64);for(let e=0;e<16&&e<o.length;e++)for(let a=0;a<4;a++)t[e*4+a]=o[e][a]||0;this.materie=t}disegna(o,t,e=null){let a=this.gl,n=this.statistiche;this.tempo+=t;let r=Oe(o.fov,o.rapporto,.3,400),l=Xo(o.occhio,o.centro);Po(r,l,this.vp),fe(this.vp,this.piani),this._camera=o,this._visibili.length=0,this._visibiliErba.length=0;let f=0;for(let s of this.chunks.values())s.quad===0&&s.quadAcqua===0||(s.visto=this.tutto||me(this.piani,s.x0,s.y0+s.minY,s.z0,s.x0+16,s.y0+s.maxY+1,s.z0+16),s.visto&&(f++,s.quadAcqua>0&&this._visibili.push(s),s.verticiErba>0&&Math.hypot(s.x0+8-o.occhio[0],s.z0+8-o.occhio[2])<=this.erbaFinoA&&this._visibiliErba.push(s)));this.ombra&&this.altezze&&this._calcolaOmbre(),this._aggiornaMappa(o,e),n.disegniSpecchio=0,n.triangoliSpecchio=0,n.pelo=null,this.specchio.pelo=null,this.specchio.attivo&&this._visibili.length&&this._specchia(o,e),a.clear(a.COLOR_BUFFER_BIT|a.DEPTH_BUFFER_BIT),this._disegnaCielo(this.vp,o.occhio),this.taglio=-1e9,this.vpCorrente=this.vp;let[c,u]=this._solidi(this.vp,this.piani,o.occhio,!1),p=0,m=0;if(this._visibiliErba.length){let s=this.ue,d=this.sole;a.useProgram(this.programmaErba),a.uniformMatrix4fv(s.uVP,!1,this.vp),a.uniform1f(s.uTempo,this.tempo),a.uniform3f(s.uSoleVerso,d.verso[0],d.verso[1],d.verso[2]),a.uniform3f(s.uSoleCol,d.colore[0],d.colore[1],d.colore[2]),a.uniform1f(s.uSoleForza,d.forza),a.uniform3f(s.uCieloCol,d.cielo[0],d.cielo[1],d.cielo[2]),a.uniform2f(s.uNebbia,this.nebbia.da,this.nebbia.a),a.uniform3f(s.uNebbiaCol,this.nebbia.colore[0],this.nebbia.colore[1],this.nebbia.colore[2]),a.uniform3f(s.uCam,o.occhio[0],o.occhio[1],o.occhio[2]),a.uniform2f(s.uVento,Math.cos(this.tempo*.045),Math.sin(this.tempo*.045)),a.uniform1f(s.uOmbra,this.ombra&&this.altezze?1:0),a.uniform1f(s.uTaglio,-1e9),a.uniform1f(s.uErbaFinoA,this.erbaFinoA),a.uniform4f(s.uBuco,this.buco[0],this.buco[1],this.buco[2],this.buco[3]),a.uniform3f(s.uOcchio,o.occhio[0],o.occhio[1],o.occhio[2]),this.altezze&&(a.activeTexture(a.TEXTURE0),a.bindTexture(a.TEXTURE_2D,this.ombre.tex),a.uniform1i(s.uOmbre,0),a.uniform2f(s.uOmbreScala,this.ombre.scala,this.ombre.offset),a.uniform4f(s.uAltRett,this.altRett[0],this.altRett[1],this.altRett[2],this.altRett[3])),this.legaMappa(s),a.disable(a.CULL_FACE);for(let v of this._visibiliErba)a.uniform3f(s.uChunk,v.chunk[0],v.yBaseErba,v.chunk[2]),a.bindVertexArray(v.vaoErba),a.drawArraysInstanced(a.TRIANGLES,0,6,v.lamelle),p++,m+=v.lamelle*2;a.enable(a.CULL_FACE),a.bindVertexArray(null)}n.disegni=c,n.triangoli=u,n.chunkVisti=f,n.chunkTotali=this.chunks.size,n.disegniErba=p,n.triangoliErba=m}_solidi(o,t,e,a){let n=this.gl,r=this.u,l=this.sole;n.useProgram(this.programma),n.uniformMatrix4fv(r.uVP,!1,o),n.uniform1f(r.uTempo,this.tempo),n.uniform3f(r.uSoleVerso,l.verso[0],l.verso[1],l.verso[2]),n.uniform3f(r.uSoleCol,l.colore[0],l.colore[1],l.colore[2]),n.uniform1f(r.uSoleForza,l.forza),n.uniform3f(r.uCieloCol,l.cielo[0],l.cielo[1],l.cielo[2]),n.uniform4fv(r.uMaterie,this.materie),n.uniform2f(r.uNebbia,this.nebbia.da,this.nebbia.a),n.uniform3f(r.uNebbiaCol,this.nebbia.colore[0],this.nebbia.colore[1],this.nebbia.colore[2]),n.uniform3f(r.uCam,e[0],e[1],e[2]),n.uniform1f(r.uOmbra,this.ombra&&this.altezze?1:0),n.uniform1f(r.uTaglio,this.taglio);let f=a?[0,0,0,0]:this.buco;n.uniform4f(r.uBuco,f[0],f[1],f[2],f[3]),n.uniform3f(r.uOcchio,e[0],e[1],e[2]),this.altezze&&(n.activeTexture(n.TEXTURE0),n.bindTexture(n.TEXTURE_2D,this.ombre.tex),n.uniform1i(r.uOmbre,0),n.uniform2f(r.uOmbreScala,this.ombre.scala,this.ombre.offset),n.uniform4f(r.uAltRett,this.altRett[0],this.altRett[1],this.altRett[2],this.altRett[3])),this.legaMappa(r);let c=0,u=0;for(let p of this.chunks.values())if(p.quad!==0){if(a){if(!this.tutto&&!me(t,p.x0,p.y0+p.minY,p.z0,p.x0+16,p.y0+p.maxY+1,p.z0+16))continue}else if(!p.visto)continue;n.uniform3f(r.uChunk,p.chunk[0],p.chunk[1],p.chunk[2]),n.bindVertexArray(p.vao),n.drawElements(n.TRIANGLES,p.quad*6,n.UNSIGNED_SHORT,0),c++,u+=p.quad*2}return n.bindVertexArray(null),[c,u]}_peloVicino(o){let t=this._voti;t.clear();for(let n of this._visibili){if(n.peloAcqua==null)continue;let r=Math.hypot(n.x0+8-o[0],n.z0+8-o[2])+2.2*Math.abs(n.peloAcqua-o[1]);t.set(n.peloAcqua,(t.get(n.peloAcqua)||0)+n.quadAcqua/(1+r))}let e=null,a=0;for(let[n,r]of t)r>a&&(a=r,e=n);return e}_specchia(o,t){let e=this.gl,a=this.specchio,n=this.statistiche,r=this._peloVicino(o.occhio);if(r==null||o.occhio[1]<=r+.2)return;let l=Math.max(1,Math.round(e.drawingBufferWidth*a.scala)),f=Math.max(1,Math.round(e.drawingBufferHeight*a.scala));(!a.fbo||a.w!==l||a.h!==f)&&this._preparaSpecchio(l,f);let c=this._riflessione;c.fill(0),c[0]=1,c[5]=-1,c[10]=1,c[13]=2*r,c[15]=1,Po(this.vp,c,this.vpSpecchio),fe(this.vpSpecchio,this.pianiSpecchio);let u=[o.occhio[0],2*r-o.occhio[1],o.occhio[2]];e.bindFramebuffer(e.FRAMEBUFFER,a.fbo),e.viewport(0,0,l,f),e.clear(e.COLOR_BUFFER_BIT|e.DEPTH_BUFFER_BIT),this._disegnaCielo(this.vpSpecchio,u),e.cullFace(e.FRONT),this.taglio=r-.05,this.vpCorrente=this.vpSpecchio;let[p,m]=this._solidi(this.vpSpecchio,this.pianiSpecchio,u,!0);n.disegniSpecchio=p,n.triangoliSpecchio=m,t&&(t.disegna(this,{occhio:u,centro:o.centro,fov:o.fov,rapporto:o.rapporto}),n.disegniSpecchio+=t.statistiche.disegni,n.triangoliSpecchio+=t.statistiche.triangoli),e.cullFace(e.BACK),e.bindFramebuffer(e.FRAMEBUFFER,null),e.viewport(0,0,e.drawingBufferWidth,e.drawingBufferHeight),this.taglio=-1e9,a.pelo=r,n.pelo=r}_mostraSpecchio(){let o=this.gl,t=this.specchio;this.programmaQuad||(this.programmaQuad=oo(o,`#version 300 es
out vec2 vUv;
...
void main() { colore = vec4(texture(uTex, vUv).rgb, 1.0); }`),this.uQuad=o.getUniformLocation(this.programmaQuad,"uTex"),this.vaoQuad=o.createVertexArray()),o.useProgram(this.programmaQuad),o.activeTexture(o.TEXTURE0),o.bindTexture(o.TEXTURE_2D,t.tex),o.uniform1i(this.uQuad,0),o.bindVertexArray(this.vaoQuad),o.disable(o.DEPTH_TEST),o.drawArrays(o.TRIANGLE_STRIP,0,4),o.enable(o.DEPTH_TEST),o.bindVertexArray(null)}_preparaSpecchio(o,t){let e=this.gl,a=this.specchio;a.fbo||(a.fbo=e.createFramebuffer(),a.tex=e.createTexture(),a.rbo=e.createRenderbuffer()),e.bindTexture(e.TEXTURE_2D,a.tex),e.texImage2D(e.TEXTURE_2D,0,e.RGBA8,o,t,0,e.RGBA,e.UNSIGNED_BYTE,null),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MIN_FILTER,e.LINEAR),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MAG_FILTER,e.LINEAR),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_S,e.CLAMP_TO_EDGE),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_T,e.CLAMP_TO_EDGE),e.bindRenderbuffer(e.RENDERBUFFER,a.rbo),e.renderbufferStorage(e.RENDERBUFFER,e.DEPTH_COMPONENT16,o,t),e.bindFramebuffer(e.FRAMEBUFFER,a.fbo),e.framebufferTexture2D(e.FRAMEBUFFER,e.COLOR_ATTACHMENT0,e.TEXTURE_2D,a.tex,0),e.framebufferRenderbuffer(e.FRAMEBUFFER,e.DEPTH_ATTACHMENT,e.RENDERBUFFER,a.rbo),e.checkFramebufferStatus(e.FRAMEBUFFER)!==e.FRAMEBUFFER_COMPLETE&&(a.attivo=!1,console.warn("specchio: framebuffer incompleto, spento")),e.bindFramebuffer(e.FRAMEBUFFER,null),e.bindTexture(e.TEXTURE_2D,null),a.w=o,a.h=t}disegnaAcqua(){let o=this.gl,t=this.ua,e=this.sole,a=this._camera,n=this.specchio;if(!a||this._visibili.length===0){this.statistiche.disegniAcqua=0;return}o.useProgram(this.programmaAcqua),o.uniformMatrix4fv(t.uVP,!1,this.vp),o.uniform1f(t.uTempo,this.tempo),o.uniform3f(t.uCam,a.occhio[0],a.occhio[1],a.occhio[2]),o.uniform2f(t.uNebbia,this.nebbia.da,this.nebbia.a),o.uniform3f(t.uSoleVerso,e.verso[0],e.verso[1],e.verso[2]),o.uniform3f(t.uSoleCol,e.colore[0],e.colore[1],e.colore[2]),o.uniform1f(t.uSoleForza,e.forza),o.uniform3f(t.uCieloCol,e.cielo[0],e.cielo[1],e.cielo[2]),o.uniform3f(t.uNebbiaCol,this.nebbia.colore[0],this.nebbia.colore[1],this.nebbia.colore[2]);let r=n.pelo!=null&&n.tex;o.activeTexture(o.TEXTURE1),o.bindTexture(o.TEXTURE_2D,r?n.tex:null),o.uniform1i(t.uSpecchio,1),o.uniform3f(t.uSchermo,1/o.drawingBufferWidth,1/o.drawingBufferHeight,r?1:0),o.uniform1f(t.uMare,this.mare),o.uniform4fv(t.uGalleggianti,this.galleggianti),o.uniform1i(t.uNGalleggianti,this.nGalleggianti),this.altezze&&this.altRett?(o.activeTexture(o.TEXTURE2),o.bindTexture(o.TEXTURE_2D,this.altezze),o.uniform1i(t.uAltezze,2),o.bindSampler(2,this.campionatoreLiscio),o.uniform4f(t.uAltRett,this.altRett[0],this.altRett[1],this.altRett[2],this.altRett[3])):o.uniform4f(t.uAltRett,0,0,0,0),o.enable(o.BLEND),o.blendFunc(o.SRC_ALPHA,o.ONE_MINUS_SRC_ALPHA),o.depthMask(!1),o.disable(o.CULL_FACE);let l=0,f=0;for(let c of this._visibili)o.uniform3f(t.uChunk,c.chunk[0],c.chunk[1],c.chunk[2]),o.bindVertexArray(c.vaoAcqua),o.drawElements(o.TRIANGLES,c.quadAcqua*6,o.UNSIGNED_SHORT,0),l++,f+=c.quadAcqua*2;o.bindVertexArray(null),o.depthMask(!0),o.enable(o.CULL_FACE),o.disable(o.BLEND),o.bindSampler(2,null),o.activeTexture(o.TEXTURE0),this.statistiche.disegniAcqua=l,this.statistiche.triangoliAcqua=f,n.mostra&&r&&this._mostraSpecchio()}};var de=class extends To{vertice(o,t,e,a,n,r,l,f=0,c=0){super.vertice(o,t,e,_e[a],n,r,l,f,c)}},ao={erba:1,terra:2,sabbia:3,roccia:4,filo:5,tronco:6,chioma:7,lampada:8},Ho=[0,6072381,8739896,14403468,9211013,5086771,6043679,2714414,16767347],Ga=1;function pe(i,o){let t=e=>Math.max(0,Math.min(255,Math.round(e*o)));return t(i>>16&255)<<16|t(i>>8&255)<<8|t(i&255)}function fo(i,o,t){let e=i*374761393+o*668265263+t*1442695041|0;return e=Math.imul(e^e>>>13,1274126177),((e^e>>>16)>>>0)/4294967296}function he(i,o,t,e){let a=i/t,n=o/t,r=Math.floor(a),l=Math.floor(n),f=a-r,c=n-l,u=f*f*(3-2*f),p=c*c*(3-2*c),m=fo(r,l,e),s=fo(r+1,l,e),d=fo(r,l+1,e),v=fo(r+1,l+1,e);return m+(s-m)*u+(d+(v-d)*u-(m+(s-m)*u))*p}function Oo(i,o,t=7){let e=he(i,o,48,t)*14+he(i,o,17,t+1)*5+he(i,o,6,t+2)*1.5;return 8+Math.floor(e)}function Fe(i){return i<11?ao.sabbia:i>24?ao.roccia:ao.erba}function Ne(i,o,t=7){let e=[];for(let a=0;a<2;a++){if(fo(i*3+a,o*5-a,t+9)<.35)continue;let r=i*16+Math.floor(fo(i,o,t+11+a)*15)+.5,l=o*16+Math.floor(fo(o,i,t+13+a)*15)+.5,f=Oo(Math.floor(r),Math.floor(l),t);Fe(f)===ao.erba&&e.push({x:r,y:f+3,z:l})}return e}function ye(i,o,t,e){let a=0;for(let n of e){let l=15-Math.sqrt((i-n.x)**2+(o-n.y)**2+(t-n.z)**2);l>a&&(a=l)}return Math.max(0,Math.min(15,Math.round(a)))}function qe(i,o,{seme:t=7,erba:e=2,raggioLampade:a=2}={}){let n=new de(1600),r=i*16,l=o*16,f=255,c=0,u=[];for(let m=-a;m<=a;m++)for(let s=-a;s<=a;s++)u.push(...Ne(i+m,o+s,t));for(let m=0;m<16;m++)for(let s=0;s<16;s++){let d=r+m,v=l+s,h=Oo(d,v,t);h<f&&(f=h),h+1>c&&(c=h+1);let b=Fe(h),E=.94+.12*fo(d,v,t+3),g=ye(d+.5,h+1,v+.5,u),z=pe(Ho[b],E);n.quadDa([m,h+1,s,2,15,g,z],[m,h+1,s+1,2,15,g,z],[m+1,h+1,s+1,2,15,g,z],[m+1,h+1,s,2,15,g,z]);let S=[[1,0,0],[-1,0,1],[0,1,4],[0,-1,5]];for(let[R,_,A]of S){let L=Oo(d+R,v+_,t);for(let T=L+1;T<=h;T++){let x=Math.max(6,15-(h-T)*2),I=T===h&&b===ao.erba?ao.erba:h>24?ao.roccia:ao.terra,F=ye(d+.5+R*.5,T+.5,v+.5+_*.5,u),C=T,$=T+1,q=pe(Ho[I],E);R===1?n.quadDa([m+1,C,s,A,x,F,q],[m+1,$,s,A,x,F,q],[m+1,$,s+1,A,x,F,q],[m+1,C,s+1,A,x,F,q]):R===-1?n.quadDa([m,C,s+1,A,x,F,q],[m,$,s+1,A,x,F,q],[m,$,s,A,x,F,q],[m,C,s,A,x,F,q]):_===1?n.quadDa([m+1,C,s+1,A,x,F,q],[m+1,$,s+1,A,x,F,q],[m,$,s+1,A,x,F,q],[m,C,s+1,A,x,F,q]):n.quadDa([m,C,s,A,x,F,q],[m,$,s,A,x,F,q],[m+1,$,s,A,x,F,q],[m+1,C,s,A,x,F,q]),T<f&&(f=T)}}if(b===ao.erba)for(let R=0;R<e;R++){if(fo(d,v,t+20+R)<.25)continue;let A=1,L=m,T=s,x=pe(Ho[ao.filo],.94+.12*fo(d,v,t+30+R));n.quadDa([L,h+1,T,2,15,g,x],[L,h+1+A,T,2,15,g,x,1],[L+1,h+1+A,T+1,2,15,g,x,1],[L+1,h+1,T+1,2,15,g,x]),n.quadDa([L+1,h+1,T,2,15,g,x],[L+1,h+1+A,T,2,15,g,x,1],[L,h+1+A,T+1,2,15,g,x,1],[L,h+1,T+1,2,15,g,x]),h+2>c&&(c=h+2)}}for(let m of Ne(i,o,t)){let s=Math.floor(m.x)-r,d=Math.floor(m.z)-l,v=m.y-3;for(let h=v+1;h<=m.y;h++){let b=h===m.y?ao.lampada:ao.tronco,E=h===m.y?15:12,g=Ho[b],z=h===m.y?Ga:0,S=s+.5-.15,R=s+.5+.15,_=Math.floor(S),A=Math.min(16,Math.floor(S)+1),L=d,T=d+1;n.quadDa([A,h,L,0,12,E,g,0,z],[A,h+1,L,0,12,E,g,0,z],[A,h+1,T,0,12,E,g,0,z],[A,h,T,0,12,E,g,0,z]),n.quadDa([_,h,T,1,12,E,g,0,z],[_,h+1,T,1,12,E,g,0,z],[_,h+1,L,1,12,E,g,0,z],[_,h,L,1,12,E,g,0,z]),n.quadDa([A,h,T,4,12,E,g,0,z],[A,h+1,T,4,12,E,g,0,z],[_,h+1,T,4,12,E,g,0,z],[_,h,T,4,12,E,g,0,z]),n.quadDa([_,h,L,5,12,E,g,0,z],[_,h+1,L,5,12,E,g,0,z],[A,h+1,L,5,12,E,g,0,z],[A,h,L,5,12,E,g,0,z]),h===m.y&&n.quadDa([_,h+1,L,2,15,E,g,0,z],[_,h+1,T,2,15,E,g,0,z],[A,h+1,T,2,15,E,g,0,z],[A,h+1,L,2,15,E,g,0,z]),h+1>c&&(c=h+1)}}return{...n.dati(),minY:f,maxY:c,cx:i,cz:o}}var Pe={erba:{nome:"Erba",cima:5949008,lato:15047529,fondo:12546123,orlo:3446604,solido:!0,nav:10,cappello:!0,fam:"scavo"},terra:{nome:"Terra",cima:12546123,lato:12546123,fondo:11034431,solido:!0,nav:10,fam:"scavo"},sabbia:{nome:"Sabbia",cima:15324316,lato:14599048,fondo:13808246,solido:!0,nav:12,fam:"scavo"},ghiaia:{nome:"Ghiaia",cima:10130572,lato:9143677,fondo:8354162,solido:!0,nav:12,fam:"scavo"},neve:{nome:"Neve",cima:15923191,lato:14740202,fondo:13688028,solido:!0,nav:12,fam:"scavo"},roccia:{nome:"Roccia",cima:11054778,lato:9673384,fondo:8883868,solido:!0,nav:10,fam:"mina"},pietra:{nome:"Pietra liscia",cima:12436429,lato:11449535,fondo:10660019,solido:!0,nav:10,fam:"mina"},mattoni:{nome:"Mattoni",cima:11555645,lato:10570294,fondo:9650735,solido:!0,nav:10,fam:"mina"},legno:{nome:"Legno",cima:11568720,lato:10252866,fondo:9266489,solido:!0,nav:10,fam:"taglia"},tronco:{nome:"Tronco",cima:12622434,lato:8016432,fondo:12622434,solido:!0,nav:10,fam:"taglia"},asse:{nome:"Assi chiare",cima:14268798,lato:13150317,fondo:12163422,solido:!0,nav:10,fam:"taglia"},lanaBianca:{nome:"Lana bianca",cima:15724786,lato:14869478,fondo:14014170,solido:!0,nav:10,fam:"scavo"},lanaRossa:{nome:"Lana rossa",cima:14703182,lato:13388608,fondo:12206648,solido:!0,nav:10,fam:"scavo"},lanaBlu:{nome:"Lana blu",cima:4882388,lato:4157120,fondo:3629227,solido:!0,nav:10,fam:"scavo"},lanaGialla:{nome:"Lana gialla",cima:15911244,lato:14727230,fondo:13477428,solido:!0,nav:10,fam:"scavo"},lanaVerde:{nome:"Lana verde",cima:5813096,lato:4890714,fondo:4165454,solido:!0,nav:10,fam:"scavo"},ferro:{nome:"Ferro",cima:12174028,lato:10792376,fondo:9410723,solido:!0,nav:10,fam:"scavo",materia:"metallo"},fanghiglia:{nome:"Fanghiglia",cima:11569756,lato:10517842,fondo:9268551,solido:!0,nav:10,fam:"scavo",materia:"fango"},ghiaccio:{nome:"Ghiaccio",cima:12576498,lato:11131114,fondo:9685472,solido:!0,nav:10,fam:"scavo",materia:"ghiaccio"},cristallo:{nome:"Cristallo",cima:16771496,lato:16243851,fondo:15256437,solido:!0,nav:10,fam:"mina",salute:100,materia:"accesa",luce:{colore:16767370,raggio:6,intensita:1,ombra:!0}},ottone:{nome:"Ottone",cima:14267482,lato:12820556,fondo:11044927,solido:!0,nav:10,fam:"scavo",materia:"specchio"},lucciola:{nome:"Lucciola verde",cima:11075504,lato:6280814,fondo:4634967,solido:!0,nav:10,fam:"mina",salute:100,luce:{colore:8257440,raggio:5,intensita:1.1,ombra:!0}},lampadaPesante:{nome:"Lampada pesante (con ombra)",cima:16771764,lato:15777891,fondo:14264132,solido:!0,nav:10,fam:"mina",salute:100,luce:{colore:16767113,raggio:8,intensita:1.1,ombra:!0}},lampadaLeggera:{nome:"Lampada leggera (trapassa i muri)",cima:16771764,lato:15777891,fondo:14264132,solido:!0,nav:10,fam:"mina",salute:100,luce:{colore:16767113,raggio:8,intensita:1.1,ombra:!1}},lampadaRossa:{nome:"Lampada rossa",cima:16759213,lato:15224892,fondo:13187624,solido:!0,nav:10,fam:"mina",salute:100,luce:{colore:16722458,raggio:8,intensita:1.1,ombra:!0}},lampadaVerde:{nome:"Lampada verde",cima:11993028,lato:4183135,fondo:3124809,solido:!0,nav:10,fam:"mina",salute:100,luce:{colore:1769274,raggio:8,intensita:1.1,ombra:!0}},lampadaBlu:{nome:"Lampada blu",cima:11584767,lato:4220128,fondo:3099837,solido:!0,nav:10,fam:"mina",salute:100,luce:{colore:2771711,raggio:8,intensita:1.1,ombra:!0}},fuochiFatui:{nome:"Nido di fuochi fatui",cima:13498111,lato:5083048,fondo:3500413,solido:!0,nav:10,fam:"mina",salute:100,luce:{colore:9430271,raggio:3,intensita:.7,ombra:!1},fuochiFatui:{numero:7,raggio:3.2,quota:1.9,luce:{colore:10477823,raggio:4.2,intensita:1}}},acqua:{nome:"Acqua",cima:5227244,lato:4042208,fondo:3184332,solido:!1,nav:null,acqua:!0}},Ue=[{id:"naturali",nome:"Naturali",emoji:"\u{1F33F}",blocchi:["erba","terra","sabbia","ghiaia","neve","roccia","lucciola","acqua"]},{id:"costruzione",nome:"Costruzione",emoji:"\u{1F9F1}",blocchi:["legno","tronco","asse","pietra","mattoni"]},{id:"lane",nome:"Lane",emoji:"\u{1F3A8}",blocchi:["lanaBianca","lanaRossa","lanaBlu","lanaGialla","lanaVerde"]},{id:"luci",nome:"Luci",emoji:"\u{1F4A1}",blocchi:["lucciola","lampadaPesante","lampadaLeggera","lampadaRossa","lampadaVerde","lampadaBlu","fuochiFatui"]}],Zo={id:"officina",nome:"Officina",emoji:"\u{1F6E0}\uFE0F",blocchi:[]};Ue.push(Zo);var ka={id:"prove",nome:"Prove",emoji:"\u{1F317}",blocchi:[]};Ue.push(ka);function De(i,o,t=Zo){Pe[i]=o,t.blocchi.includes(i)||t.blocchi.push(i)}var Xa={nome:"Blocco perduto",cima:12950225,lato:11305912,fondo:9924767,solido:!0,nav:10,fam:"mina"};function W(i){return Pe[i.charCodeAt(0)===97&&i.startsWith("acqua")?"acqua":i]||Xa}function we(i){let o=i.indexOf("~");return o<0?i:i.slice(0,o)}function Be(i){if(!i||!i.startsWith("acqua"))return null;let o=i.indexOf("~");return o<0?0:Number(i.slice(o+1))}var O=16,Ya=256,jo=2048,Ve=64,to=(i,o,t)=>((i+jo)*4096+(t+jo))*256+(o+Ve),Lo=i=>Math.floor(i/(256*4096))-jo,Io=i=>Math.floor(i/256)%4096-jo,No=i=>i%256-Ve;var bo=(i,o)=>Math.floor(i/O)+","+Math.floor(o/O),Ko=class{constructor(){this.chunks=new Map,this.sporchi=new Set,this.sporchiAcqua=new Set,this._rev=new Map,this.furni=new Map,this.ombreFurni=new Map,this.contaBlocchi=0,this.onEvento=null,this.cambiate=[],this.troppiCambi=!1,this._memoCx=0,this._memoCz=0,this._memoChunk=null,this.generati=new Set,this.modifiche=new Map,this.frontiera=null}segnaGenerato(o){this.generati.add(o)}_annotaModifica(o,t,e,a){if(!this.frontiera)return;let n=bo(o,e),r=this.modifiche.get(n);r||(r=new Map,this.modifiche.set(n,r)),r.set(to(o,t,e),a)}applicaModifiche(o){let t=this.modifiche.get(o);if(!t)return 0;for(let[e,a]of t){let n=Lo(e),r=No(e),l=Io(e);a===null?this.togli(n,r,l,!0):this.metti(n,r,l,a,!0)}return t.size}scaricaChunk(o){let t=this.chunks.get(o);if(!t)return this.generati.delete(o),[];let e=[];for(let[a,n]of t){let r=W(n);r&&r.forma==="modello"&&e.push([Lo(a),No(a),Io(a),n])}return this.contaBlocchi-=t.size,this.chunks.delete(o),this._scordaMemo(),this.generati.delete(o),this._tocca(o,this.sporchi),e}_cambiata(o,t,e){if(this.cambiate.length>=3*Ya){this.troppiCambi=!0;return}this.cambiate.push(o,t,e)}scordaCambi(){this.cambiate.length=0,this.troppiCambi=!1}_scordaMemo(){this._memoKc=null,this._memoChunk=null}_chunkDi(o,t){let e=Math.floor(o/O),a=Math.floor(t/O);if(this._memoChunk!==null&&this._memoCx===e&&this._memoCz===a)return this._memoChunk;let n=this.chunks.get(e+","+a)||null;return this._memoCx=e,this._memoCz=a,this._memoChunk=n,n}tipo(o,t,e){let a=this._chunkDi(o,e);return a&&a.get(to(o,t,e))||null}pieno(o,t,e){return this.tipo(o,t,e)!==null}solido(o,t,e){let a=this.tipo(o,t,e);if(a&&W(a).solido)return!0;let n=this.furni.get(to(o,t,e));return!!n&&!(n.def&&n.def.calpestabile)}calpestabile(o,t,e){if(!this.solido(o,t-1,e)||this.solido(o,t,e)||this.solido(o,t+1,e))return!1;let a=this.tipo(o,t,e);return!(a&&W(a).acqua)}_sporca(o,t,e=this.sporchi){let a=(o%O+O)%O,n=(t%O+O)%O;this._tocca(bo(o,t),e),a===0&&this._tocca(bo(o-1,t),e),a===O-1&&this._tocca(bo(o+1,t),e),n===0&&this._tocca(bo(o,t-1),e),n===O-1&&this._tocca(bo(o,t+1),e)}_tocca(o,t){t.add(o),this._rev.set(o,(this._rev.get(o)||0)+1)}revisione(o){return this._rev.get(o)||0}metti(o,t,e,a,n=!1){let r=bo(o,e),l=this.chunks.get(r);l||(l=new Map,this.chunks.set(r,l),this._scordaMemo());let f=to(o,t,e),c=l.get(f);c===void 0&&this.contaBlocchi++,l.set(f,a);let u=a.charCodeAt(0)===97&&a.startsWith("acqua")&&(c===void 0||c.startsWith("acqua"));this._sporca(o,e,u?this.sporchiAcqua:this.sporchi),u||this._cambiata(o,t,e),n||(this._annotaModifica(o,t,e,a),this.onEvento&&this.onEvento({tipo:"metti",cella:[o,t,e],blocco:a}))}togli(o,t,e,a=!1){let n=bo(o,e),r=this.chunks.get(n);if(!r)return!1;let l=to(o,t,e),f=r.get(l);if(!r.delete(l))return!1;this.contaBlocchi--,r.size===0&&(this.chunks.delete(n),this._scordaMemo());let c=!!(f&&f.startsWith("acqua"));return this._sporca(o,e,c?this.sporchiAcqua:this.sporchi),c||this._cambiata(o,t,e),a||(this._annotaModifica(o,t,e,null),this.onEvento&&this.onEvento({tipo:"togli",cella:[o,t,e]})),!0}occupaFurni(o,t){for(let[e,a,n]of o)this.furni.set(to(e,a,n),t)}liberaFurni(o){for(let[t,e,a]of o)this.furni.delete(to(t,e,a))}furniIn(o,t,e){return this.furni.get(to(o,t,e))||null}occupaOmbra(o,t=!1){for(let[e,a,n]of o){let r=to(e,a,n),l=this.ombreFurni.get(r);if(l){l.n++,t&&l.op++===0&&this._cambiata(e,a,n);continue}this.ombreFurni.set(r,{x:e,y:a,z:n,n:1,op:t?1:0}),this._cambiata(e,a,n)}}liberaOmbra(o,t=!1){for(let[e,a,n]of o){let r=to(e,a,n),l=this.ombreFurni.get(r);l&&(t&&l.op>0&&--l.op===0&&l.n>1&&this._cambiata(e,a,n),!(--l.n>0)&&(this.ombreFurni.delete(r),this._cambiata(e,a,n)))}}ombraFurniIn(o,t,e){let a=this.ombreFurni.get(to(o,t,e));return a?a.op>0?2:1:0}appoggioInColonna(o,t,e,a=8){for(let n=e;n>e-a;n--)if(this.calpestabile(o,n,t))return n;return null}svuota(){this.chunks.clear(),this._scordaMemo(),this.furni.clear(),this.sporchi.clear(),this.sporchiAcqua.clear();for(let o of this._rev.keys())this._rev.set(o,this._rev.get(o)+1);this.scordaCambi(),this.contaBlocchi=0}*tutti(){for(let o of this.chunks.values())for(let[t,e]of o)yield{x:Lo(t),y:No(t),z:Io(t),tipo:e}}perOgni(o){for(let t of this.chunks.values())for(let[e,a]of t)o(Lo(e),No(e),Io(e),a)}*blocchiDelChunk(o){let t=this.chunks.get(o);if(t)for(let[e,a]of t)yield{x:Lo(e),y:No(e),z:Io(e),tipo:a}}perOgniDelChunk(o,t){let e=this.chunks.get(o);if(e)for(let[a,n]of e)t(Lo(a),No(a),Io(a),n)}};var $a={primavera:{nome:"Primavera",emoji:"\u{1F338}",erba:[6738010,6343509,5949008,5553995,5158983,4763971,4434495,4105019],fogliame:null},estate:{nome:"Estate secca",emoji:"\u{1F33E}",erba:[15060862,14534259,14073193,13546335,13019733,12558668,12032068,11571261],fogliame:{h:.128,sF:.72,l:i=>i*.92+.1}},autunno:{nome:"Autunno",emoji:"\u{1F342}",erba:[15506768,15045448,14584129,14122810,13661492,13200431,12739371,12278311],fogliame:{h:.045,sF:1.2,l:i=>i*1.05+.09}},inverno:{nome:"Inverno",emoji:"\u2744\uFE0F",erba:[15988722,15462890,14871523,14279900,13622740,13031117,12439751,11848128],sabbia:{cima:15722970,lato:14932934,fondo:14077364},fogliame:{h:.42,sF:.18,l:i=>i*.38+.58}}},Uo="primavera";var Wo=null;function Qo(i,o,t){let e=i>>16&255,a=i>>8&255,n=i&255,r=o>>16&255,l=o>>8&255,f=o&255,c=(u,p)=>Math.round(u+(p-u)*t);return c(e,r)<<16|c(a,l)<<8|c(n,f)}function Ge(i,o){if(Wo){let t=Uo;Uo=Wo.da;let e=ve(i,o);Uo=Wo.a;let a=ve(i,o);Uo=t;let n=Wo.mix;return{cima:Jo(e.cima,a.cima,n),lato:Jo(e.lato,a.lato,n),fondo:Jo(e.fondo,a.fondo,n),facce:e.facce,orlo:e.orlo!=null&&a.orlo!=null?Jo(e.orlo,a.orlo,n):e.orlo}}return ve(i,o)}function Jo(i,o,t){let e=Math.round((i>>16&255)+((o>>16&255)-(i>>16&255))*t),a=Math.round((i>>8&255)+((o>>8&255)-(i>>8&255))*t),n=Math.round((i&255)+((o&255)-(i&255))*t);return e<<16|a<<8|n}function ve(i,o){let t=W(i),e=$a[Uo],{cima:a,lato:n,fondo:r}=t;if(t.cappello&&e.erba&&!t.override&&(a=e.erba[ge(o,e.erba.length)]),t.reagisce==="stagione"&&e.erba){let l=e.erba[ge(o,e.erba.length)],f=t.reagisceForza??1;a=Qo(a,l,f),n=Qo(n,l,f*.45),r=Qo(r,l,f*.3)}else if(t.reagisce==="quota"){let l=ge(o,8)/7,f=(t.reagisceForza??1)*.5,c=u=>Qo(u,16777215,l*f);a=c(a),n=c(n),r=c(r)}return i==="sabbia"&&e.sabbia&&({cima:a,lato:n,fondo:r}=e.sabbia),{cima:a,lato:n,fondo:r,facce:t.facce||null,orlo:t.orlo!=null?t.orlo:void 0}}function ho(i,o,t){if(i.facce){let e=o*2+(t>0?0:1),a=i.facce[e];if(a!=null)return a}return o===1?t>0?i.cima:i.fondo:i.lato}function ge(i,o=8){let t=(o-1)*2,e=(Math.round(i)%t+t)%t;return e>=o&&(e=t-e),e}function be(i,o,t){let e=(i|0)*374761393+(o|0)*668265263+(t|0)*2147483647;return e=(e^e>>>13)*1274126177,e=e^e>>>16,(e>>>0)%1e3/1e3}function Ha(i,o){let t=i>>16&255,e=i>>8&255,a=i&255,n=r=>Math.max(0,Math.min(255,Math.round(r*(1+o))));return n(t)<<16|n(e)<<8|n(a)}function Za(i,o,t,e,a,n){if(!o||o==="liscio"||!t)return i;let r=0;return o==="chiazze"?r=(be(e,a,n)-.5)*2:o==="venature"?r=(be(0,a,0)-.5)*2*.7+(be(e,a,n)-.5)*.3:o==="sfumato"&&(r=(a%16+16)%16/16-.5),Ha(i,r*t*.34)}function ke(i,o,t,e,a,n){if(!o||o==="liscio"||!t)return i;let r=l=>Za(l,o,t,e,a,n);return{cima:r(i.cima),lato:r(i.lato),fondo:r(i.fondo),facce:i.facce?i.facce.map(r):null}}var Xe={metallo:{tinta:.82,satura:.55,orlo:.18,curva:1,glintR:.34,emiss:0,bagna:.2,sotto:0,riflette:.15},fango:{tinta:.72,satura:1.35,orlo:0,curva:-1,glintR:.48,emiss:0,bagna:1,sotto:0,riflette:0},ghiaccio:{tinta:1.06,satura:.62,orlo:.12,curva:.6,glintR:.3,emiss:0,bagna:.4,sotto:.3,riflette:.25},accesa:{tinta:1,satura:1,orlo:0,curva:0,glintR:0,emiss:1,bagna:0,sotto:0,riflette:0},specchio:{tinta:.95,satura:.35,orlo:.1,curva:1,glintR:.3,emiss:0,bagna:0,sotto:0,riflette:.55}},ja=Object.keys(Xe);function Ye(i){return!i||!i.materia?null:Xe[i.materia]||null}function xo(i,o,t=0){if(!o)return i;let e=(i>>16&255)/255,a=(i>>8&255)/255,n=(i&255)/255,r=.2126*e+.7152*a+.0722*n,l=o.satura;e=r+(e-r)*l,a=r+(a-r)*l,n=r+(n-r)*l;let f=o.tinta*(1+t),c=u=>Math.max(0,Math.min(255,Math.round(u*f*255)));return c(e)<<16|c(a)<<8|c(n)}var Ka=16;function $e(i){let o=ja.indexOf(i);return o<0||o+1>=Ka?0:o+1}var xe=1/16,He=8*xe,io=9*xe;function Ze(i,o,t,e,a,n,r,l){let f=(u,p,m)=>[o+u,t+p,e+m];i.quad(f(-l,r,-l),f(l,r,-l),f(l,r,l),f(-l,r,l),ho(a,1,1),[0,1,0]),i.quad(f(-l,n,-l),f(l,n,-l),f(l,n,l),f(-l,n,l),ho(a,1,-1),[0,-1,0]);let c=[{d:[1,0,0],asse:0,segno:1},{d:[-1,0,0],asse:0,segno:-1},{d:[0,0,1],asse:2,segno:1},{d:[0,0,-1],asse:2,segno:-1}];for(let u of c){let[p,,m]=u.d,s=-m,d=p,v=(h,b)=>f(p*l+s*b,h,m*l+d*b);i.quad(v(n,-l),v(r,-l),v(r,l),v(n,l),ho(a,u.asse,u.segno),u.d)}}function Wa(i,o,t,e,a){Ze(i,o,t,e,a,-io,0,He)}function Qa(i,o,t,e,a){Ze(i,o,t,e,a,-io,io,5*xe)}function Ja(i,o,t,e,a){let n=(c,u,p)=>[o+c,t+u,e+p],r=ho(a,0,1),l=He,f=[[[-l,-io,-l],[l,-io,l],[l,io,l],[-l,io,-l],[1,0,-1]],[[-l,-io,l],[l,-io,-l],[l,io,-l],[-l,io,l],[1,0,1]]];for(let[c,u,p,m,s]of f)i.quad(n(...c),n(...u),n(...p),n(...m),r,s),i.quad(n(...c),n(...u),n(...p),n(...m),r,[-s[0],-s[1],-s[2]])}function ot(){}var je={lastra:Wa,pilastro:Qa,croce:Ja,modello:ot},Do=new Set(["lastra","pilastro","croce","modello"]);var wo=1/16,et=[[0,1],[0,2],[1,2]],at=[[1,0],[-1,0],[0,1],[0,-1]];function Eo(i,o,t,e,a,n,r,l,f){let c=[i,o,t];return c[e]+=a,c[n]+=r,c[l]+=f,c}var Ke={tinta:1,satura:1};function We(i,o,t,e,a,n,r=0){let l=8*wo,f=9*wo,c=(u,p)=>n(u===0?p:0,u===1?p:0,u===2?p:0);for(let u=0;u<3;u++)for(let p of[-1,1]){if(c(u,p))continue;let m=(u+1)%3,s=(u+2)%3,d=ho(a,u,p),v=[0,0,0];v[u]=p,i.quad(Eo(o,t,e,u,p*f,m,-l,s,-l),Eo(o,t,e,u,p*f,m,+l,s,-l),Eo(o,t,e,u,p*f,m,+l,s,+l),Eo(o,t,e,u,p*f,m,-l,s,+l),d,v)}for(let[u,p]of et){let m=3-u-p;for(let s of[-1,1])for(let d of[-1,1]){if(c(u,s)||c(p,d))continue;let v=u===1&&s>0||p===1&&d>0,h=u===1&&s<0||p===1&&d<0,b=v?a.cima:h?a.fondo:a.lato,E=r?xo(b,Ke,r):b,g=[0,0,0];g[u]=s,g[p]=d,i.quad(Eo(o,t,e,u,s*f,p,d*l,m,-l),Eo(o,t,e,u,s*l,p,d*f,m,-l),Eo(o,t,e,u,s*l,p,d*f,m,+l),Eo(o,t,e,u,s*f,p,d*l,m,+l),E,g)}}for(let u of[-1,1])for(let p of[-1,1])for(let m of[-1,1])c(0,u)||c(1,p)||c(2,m)||i.tri([o+u*f,t+p*l,e+m*l],[o+u*l,t+p*f,e+m*l],[o+u*l,t+p*l,e+m*f],r?xo(p>0?a.cima:a.fondo,Ke,r):p>0?a.cima:a.fondo,[u,p,m])}function Qe(i,o,t,e,a,n){let r=(s,d)=>n(s,0,d),l=n(0,-1,0),f=a.cima,c=a.lato,u=a.fondo,p=a.orlo??a.cima,m=(s,d,v)=>[o+s*wo,t+d*wo,e+v*wo];l||i.quad(m(-8,-9,-8),m(8,-9,-8),m(8,-9,8),m(-8,-9,8),u,[0,-1,0]);for(let[s,d]of at){if(r(s,d))continue;let v=-d,h=s,b=(g,z,S)=>m(g*s+S*v,z,g*d+S*h),E=[s,0,d];l||i.quad(b(8,-9,-8),b(9,-8,-8),b(9,-8,8),b(8,-9,8),u,[s,-1,d]),i.quad(b(9,-8,-8),b(9,2,-8),b(9,2,8),b(9,-8,8),c,E),i.quad(b(9,2,-8),b(10,3,-8),b(10,3,8),b(9,2,8),p,E),i.quad(b(10,3,-8),b(10,7,-8),b(10,7,8),b(10,3,8),p,E),i.quad(b(10,7,-8),b(9,8,-8),b(9,8,8),b(10,7,8),f,[s,1,d]),i.quad(b(8,8,-8),b(9,8,-8),b(9,8,8),b(8,8,8),f,[0,1,0])}for(let s of[-1,1])for(let d of[-1,1]){if(r(s,0)||r(0,d))continue;let v=(b,E,g)=>m(b*s,E,g*d),h=[s,0,d];l||i.tri(v(9,-8,8),v(8,-9,8),v(8,-8,9),u,[s,-1,d]),i.quad(v(9,-8,8),v(8,-8,9),v(8,2,9),v(9,2,8),c,h),i.quad(v(9,2,8),v(8,2,9),v(8,3,10),v(10,3,8),p,h),i.quad(v(10,3,8),v(8,3,10),v(8,7,10),v(10,7,8),p,h),i.quad(v(10,7,8),v(8,7,10),v(8,8,9),v(9,8,8),f,[s,1,d]),i.tri(v(8,8,8),v(9,8,8),v(8,8,9),f,[0,1,0])}i.quad(m(-8,8,-8),m(8,8,-8),m(8,8,8),m(-8,8,8),f,[0,1,0])}var Ee={lampione:{nome:"Lampione",modello:"lampione",altezza:3,mezza:.45,cima:16771764,lato:5988976,fondo:4672856,luce:{colore:16767113,raggio:4.6,intensita:1,ombra:!0,quota:2.6},notte:!0},albero:{nome:"Albero",modello:"albero",altezza:4.2,mezza:.7,cima:5217862,lato:8016432,fondo:6964518}};function Je(){for(let[i,o]of Object.entries(Ee))De(i,{nome:o.nome,cima:o.cima,lato:o.lato,fondo:o.fondo,solido:!1,nav:10,fam:"taglia",forma:"modello",modello:o.modello,altezza:o.altezza,mezza:o.mezza},Zo)}var tt=2,Ae=6,it=256;function oa(i){if(!i)return!1;let o=W(i);return!o.acqua&&!o.vetro&&!Do.has(o.forma)}function aa(i,o,t,e){let a=o.indexOf(","),n=+o.slice(0,a),r=+o.slice(a+1),l=n*O-Ae,f=r*O-Ae,c=O+2*Ae,u=e-t+1,p=c,m=c*u*p,s=new Uint8Array(m),d=new Uint8Array(m),v=new Uint8Array(m),h=(S,R,_)=>((S-l)*u+(R-t))*p+(_-f),b=(S,R,_)=>S>=l&&S<l+c&&R>=t&&R<=e&&_>=f&&_<f+p,E=[];for(let S=l;S<l+c;S++)for(let R=f;R<f+p;R++){let _=!1;for(let A=e;A>=t;A--){let L=i.tipo(S,A,R),T=h(S,A,R);if(oa(L)){v[T]=1,_=!0;continue}if(!_&&A===e){for(let x=e+1;x<it&&x<e+40;x++)if(oa(i.tipo(S,x,R))){_=!0;break}}if(_||(s[T]=15),L){let I=W(L).forma==="modello"&&Ee[L];I&&I.luce&&E.push([S,A+Math.round(I.luce.quota??1),R])}}}let g=[];for(let S=0;S<m;S++)s[S]===15&&g.push(S);ea(g,s,v,c,u,p,1);let z=[];for(let[S,R,_]of E){if(!b(S,R,_))continue;let A=h(S,R,_);d[A]=15,z.push(A)}return ea(z,d,v,c,u,p,tt),{x0:l,z0:f,yMin:t,yMax:e,W:c,H:u,D:p,cielo:s,blocco:d,leggi(S,R,_){if(!b(S,R,_))return R>e?[15,0]:[0,0];let A=h(S,R,_);return[s[A],d[A]]}}}function ea(i,o,t,e,a,n,r){let l=[a*n,-a*n,n,-n,1,-1],f=0;for(;f<i.length;){let c=i[f++],u=o[c]-r;if(u<=0)continue;let p=Math.floor(c/(a*n)),m=Math.floor(c/n)%a,s=c%n;for(let d=0;d<6;d++){if(d===0&&p===e-1||d===1&&p===0||d===2&&m===a-1||d===3&&m===0||d===4&&s===n-1||d===5&&s===0)continue;let v=c+l[d];t[v]||o[v]>=u||(o[v]=u,i.push(v))}}}var ta=[{n:5,largo:.15,alto:.32,apri:.42},{n:4,largo:.12,alto:.5,apri:.34},{n:7,largo:.1,alto:.38,apri:.46},{n:3,largo:.18,alto:.28,apri:.3}];function mo(i,o,t){let e=i*374761393+o*668265263+t*1442695041|0;return e=Math.imul(e^e>>>13,1274126177),((e^e>>>16)>>>0)/4294967296}var oe=class{constructor(o,t=512){this.yBase=o,this.byte=new Uint8Array(t*12),this.n=0}_lamella(o,t,e,a,n,r,l,f,c,u=0,p=8){if((this.n+1)*12>this.byte.length){let d=new Uint8Array(this.byte.length*2);d.set(this.byte),this.byte=d}let m=this.n*12,s=this.byte;s[m]=o,s[m+1]=t,s[m+2]=e,s[m+3]=a,s[m+4]=n>>16&255,s[m+5]=n>>8&255,s[m+6]=n&255,s[m+7]=(r&15)<<2,s[m+8]=Math.max(1,Math.min(255,l)),s[m+9]=Math.max(1,Math.min(255,f)),s[m+10]=Math.max(0,Math.min(255,c+128)),s[m+11]=u&15|(p&15)<<4,this.n++}ciuffo(o,t,e,a,n,r,l,f=1,c=0){let u=ta[Math.floor(mo(o,e,3)*ta.length)],p=Math.max(1,Math.round(u.n*f*(.82+.36*mo(o,e,5)))),m=t+1-this.yBase;if(m<0||m*8>247)return 0;for(let s=0;s<p;s++){let d=mo(o,e,s*17+5),v=mo(o,e,s*17+11),h=mo(o,e,s*17+41),b=mo(o,e,s*17+59),E=Math.min(.98,.66+u.apri),g=o+.5+(d-.5)*E,z=e+.5+(v-.5)*E,S=Math.min(.8,u.alto*(.62+.8*mo(o,e,s*17+71))*(.5+.6*Math.pow(h,1.5))),R=u.largo*(.8+.4*b),_=(mo(o,e,s*17+83)-.5)*.5,A=mo(o,e,s*17+89),L=A<.15?.9+.03*A:A>.85?1.07+.03*(A-.85):.97+.06*(A-.15)/.7,T=Math.max(0,Math.min(128,Math.round((g-a)*8))),x=Math.max(0,Math.min(128,Math.round((z-n)*8))),I=Math.floor(mo(o,e,s*17+97)*255);this._lamella(T,x,Math.round(m*8),I,r,l,Math.round(S*64),Math.round(R*128),Math.round(_*128),c,Math.round((L-.9)/.2*15))}return p}dati(){return{byte:this.byte.subarray(0,this.n*12),vertici:this.n*6,fili:this.n,yBase:this.yBase}}};var Ao=64,nt=[[1,0,0,K(1,0,0),0,1],[-1,0,0,K(-1,0,0),0,-1],[0,1,0,K(0,1,0),1,1],[0,-1,0,K(0,-1,0),1,-1],[0,0,1,K(0,0,1),2,1],[0,0,-1,K(0,0,-1),2,-1]],ia=(i,o,t)=>((o+1)*3+(t+1))*3+(i+1),Te=class{constructor(o,t,e,a,n){this.c=o,this.ox=t,this.oz=e,this._materia=0,this.luceDi=a,this.aria=n,this._cielo=15,this._cella=null}materia(o){this._materia=o|0}cella(o,t,e){this._cella=[o,t,e]}_cieloFaccia(o){let[t,e,a]=this._cella,n=-1;for(let r=0;r<3;r++){if(!o[r])continue;let l=this.luceDi(t+(r===0?o[0]:0),e+(r===1?o[1]:0),a+(r===2?o[2]:0))[0];l>n&&(n=l)}return n<0?this.luceDi(t,e+1,a)[0]:n}_bloccoVertice(o,t){let e=Math.hypot(t[0],t[1],t[2])||1,a=o[0]+t[0]/e*.5,n=o[1]+t[1]/e*.5,r=o[2]+t[2]/e*.5,l=0,f=0;for(let c of[-.45,.45])for(let u of[-.45,.45])for(let p of[-.45,.45]){let m=Math.floor(a+c),s=Math.floor(n+u),d=Math.floor(r+p);this.aria(m,s,d)&&(l+=this.luceDi(m,s,d)[1],f++)}return f?Math.round(l/f):0}_v(o,t,e,a){return[o[0]-this.ox,o[1]+Ao,o[2]-this.oz,t,this._cielo,this._bloccoVertice(o,a),e,0,this._materia]}_giro(o,t,e,a){let n=t[0]-o[0],r=t[1]-o[1],l=t[2]-o[2],f=e[0]-o[0],c=e[1]-o[1],u=e[2]-o[2],p=r*u-l*c,m=l*f-n*u,s=n*c-r*f;return p*a[0]+m*a[1]+s*a[2]<0}tri(o,t,e,a,n){if(this._giro(o,t,e,n)){let l=t;t=e,e=l}let r=K(n[0],n[1],n[2]);this._cielo=this._cieloFaccia(n),this.c.quadDa(this._v(o,r,a,n),this._v(t,r,a,n),this._v(e,r,a,n),this._v(e,r,a,n))}quad(o,t,e,a,n,r){let l=K(r[0],r[1],r[2]);if(this._cielo=this._cieloFaccia(r),this._giro(o,t,e,r)){let f=t;t=a,a=f}this.c.quadDa(this._v(o,l,n,r),this._v(t,l,n,r),this._v(e,l,n,r),this._v(a,l,n,r))}};function ee(i){if(!i)return!1;let o=W(i);return!o.acqua&&!o.vetro&&!Do.has(o.forma)}function Bo(i){return!!i&&i.charCodeAt(0)===97&&i.startsWith("acqua")}function na(i,o,{erba:t=2,luce:e=!0}={}){let a=o.indexOf(","),n=+o.slice(0,a),r=+o.slice(a+1),l=n*O,f=r*O,c=new To(1024),u=new To(64),p=-1/0,m=new Int16Array(O*O).fill(-1),s=new Int16Array(O*O).fill(-1),d=new Int16Array(O*O).fill(-1),v=255,h=0,b=1/0,E=-1/0;i.perOgniDelChunk(o,(T,x)=>{x<b&&(b=x),x>E&&(E=x)});let g=e&&b<=E?aa(i,o,b-2,E+3):null,z=new oe(Number.isFinite(b)?b:0),S=(T,x,I)=>g?g.leggi(T,x,I):[15,0],R=new Te(c,l,f,S,(T,x,I)=>!ee(i.tipo(T,x,I))),_=new Uint8Array(27),A=(T,x,I,F,C,$,q,_o)=>[T-l,x+Ao,I-f,F,$,q,C,_o?1:0,0];return i.perOgniDelChunk(o,(T,x,I,F)=>{let C=W(F);if(C.forma==="modello"&&C.modello==="albero")for(let y=-2;y<=2;y++)for(let D=-2;D<=2;D++){let V=y*y+D*D;if(V>4)continue;let k=T+y-l,ro=I+D-f;if(k<0||k>=O||ro<0||ro>=O)continue;let Z=k*O+ro,G=x+(V===0?4:V<=2?3:2);G>m[Z]&&(m[Z]=G)}if(C.forma==="modello"){let y=T-l,D=I-f;if(y>=0&&y<O&&D>=0&&D<O){let V=y*O+D,k=x+Math.max(1,Math.round(C.altezza||1));k>d[V]&&(d[V]=k)}}if(Do.has(C.forma))return;let $=Bo(F),q=x+Ao;if(q<0||q>254)return;let _o=(T-l)*O+(I-f);!$&&x>m[_o]&&(m[_o]=x),!$&&ee(F)&&x>s[_o]&&(s[_o]=x);let H=Ge(we(F),x);C.motivo&&(H=ke(H,C.motivo,C.motivoForza??1,T,x,I));let go=Ye(C);go&&(H={...H,cima:xo(H.cima,go),lato:xo(H.lato,go),fondo:xo(H.fondo,go)},H.facce&&(H.facce=H.facce.map(y=>y==null?y:xo(y,go))));let Ra=go?$e(C.materia):0;if(!$){_.fill(0);for(let Z=-1;Z<=1;Z++)for(let G=-1;G<=1;G++)for(let j=-1;j<=1;j++)j===0&&Z===0&&G===0||ee(i.tipo(T+j,x+Z,I+G))&&(_[ia(j,Z,G)]=1);let y=(Z,G,j)=>_[ia(Z,G,j)]===1;R.materia(Ra),R.cella(T,x,I);let D=T+.5,V=x+.5,k=I+.5,ro=C.forma&&je[C.forma];ro?ro(R,D,V,k,H,()=>!1):C.cappello&&!y(0,1,0)?Qe(R,D,V,k,H,y):We(R,D,V,k,H,(G,j,P)=>y(G,j,P)?j!==0?!0:!W(i.tipo(T+G,x,I+P)).cappello||y(G,1,P):!1,go?go.orlo:0),q-1<v&&(v=q-1),q+2>h&&(h=q+2)}let Vo=0,Co=0;if($)for(Co=Math.max(0,Math.min(15,Be(F)||0));Vo<15&&Bo(i.tipo(T,x-1-Vo,I));)Vo++;let Sa=(y,D)=>{if(!Bo(i.tipo(y,x,D)))return-1;let V=0;for(;V<15&&Bo(i.tipo(y,x-1-V,D));)V++;return V},Go=(y,D)=>{let V=0,k=0;for(let ro of[y-1,y])for(let Z of[D-1,D]){let G=Sa(ro,Z);G>=0&&(V+=G,k++)}return k?Math.round(V/k):Vo};if($)for(let[y,D,V,k,ro,Z]of nt){let G=i.tipo(T+y,x+D,I+V);if(G&&(Bo(G)||ee(G)))continue;let j=ho(H,ro,Z),P=T,U=x,w=I,lo,so,co,uo;if(y===1?(lo=[P+1,U,w],so=[P+1,U+1,w],co=[P+1,U+1,w+1],uo=[P+1,U,w+1]):y===-1?(lo=[P,U,w+1],so=[P,U+1,w+1],co=[P,U+1,w],uo=[P,U,w]):D===1?(lo=[P,U+1,w],so=[P,U+1,w+1],co=[P+1,U+1,w+1],uo=[P+1,U+1,w]):D===-1?(lo=[P,U,w+1],so=[P,U,w],co=[P+1,U,w],uo=[P+1,U,w+1]):V===1?(lo=[P+1,U,w+1],so=[P+1,U+1,w+1],co=[P,U+1,w+1],uo=[P,U,w+1]):(lo=[P,U,w],so=[P,U+1,w],co=[P+1,U+1,w],uo=[P+1,U,w]),D===1){let Re=x+(15-2*Co)/16;Re>p&&(p=Re)}u.quadDa(A(...lo,k,j,Go(lo[0],lo[2]),Co,lo[1]===U+1),A(...so,k,j,Go(so[0],so[2]),Co,so[1]===U+1),A(...co,k,j,Go(co[0],co[2]),Co,co[1]===U+1),A(...uo,k,j,Go(uo[0],uo[2]),Co,uo[1]===U+1)),q<v&&(v=q),q+1>h&&(h=q+1)}if(C.cappello&&t>0&&!i.tipo(T,x+1,I)){let[y,D]=S(T,x+1,I);z.ciuffo(T,x,I,l,f,H.cima,y,t/2,D),x+2+Ao>h&&(h=x+2+Ao)}}),v>h&&(v=0,h=0),{...c.dati(),minY:v,maxY:h,y0:-Ao,cx:n,cz:r,altezze:m,solide:s,impronte:d,acqua:{...u.dati(),pelo:p===-1/0?null:p},erba:z.dati()}}function ra(i,o,t,e,a){let n=(e-o+1)*O,r=(a-t+1)*O,l=new Uint8Array(n*r);for(let f of i){if(!f.altezze)continue;let c=(f.cx-o)*O,u=(f.cz-t)*O;for(let p=0;p<O;p++)for(let m=0;m<O;m++){let s=f.altezze[p*O+m];l[(u+m)*n+(c+p)]=s<0?0:Math.max(0,Math.min(255,s+1))}}return{byte:l,x0:o*O,z0:t*O,larghezza:n,profondita:r}}function zo(i,o,t){let e=i*374761393+o*668265263+t*1442695041|0;return e=Math.imul(e^e>>>13,1274126177),((e^e>>>16)>>>0)/4294967296}function la(i){return i*i*(3-2*i)}function Me(i,o,t){let e=Math.floor(i),a=Math.floor(o),n=la(i-e),r=la(o-a),l=zo(e,a,t),f=zo(e+1,a,t),c=zo(e,a+1,t),u=zo(e+1,a+1,t);return l+(f-l)*n+(c-l)*r+(l-f-c+u)*n*r}var yo=5;function sa(i,o=1,t=64){i.svuota();let e=[],a=[],n=new Map,r=[];for(let u=-t;u<=t;u++)for(let p=-t;p<=t;p++){let m=.55*Me(u*.028,p*.028,o)+.3*Me(u*.07,p*.07,o+11)+.15*Me(u*.16,p*.16,o+29),s=Math.max(2,1+Math.round(Math.pow(Math.max(0,m),1.6)*22)),d=Math.max(Math.abs(u),Math.abs(p)),v=Math.min(1,Math.max(0,(t-2-d)/8)),h=v*v*(3-2*v);s=Math.round(s*h+(yo+1)*(1-h));let b=s<=yo+1;n.set(u+"|"+p,s);for(let E=0;E<s;E++){let z=E===s-1?b?"sabbia":"erba":E<s-3?"roccia":"terra";i.metti(u,E,p,z,!0)}if(s<=yo)for(let E=s;E<=yo;E++)i.metti(u,E,p,"acqua",!0);else if(!b){let E=zo(u*3+1,p*3+7,o+101);if(E>.988&&e.length<90?e.push([u,s,p]):E<.004&&a.length<14&&a.push([u,s,p]),s>=yo+6){let g=zo(u*5+3,p*5+11,o+57);g>.99&&r.push({x:u,z:p,h:s,r:g})}}}let l=lt(i,n,o,r,t),f=u=>!l.has(u[0]+"|"+u[2]),c=[...l].map(u=>{let[p,m]=u.split("|").map(Number);return[p,n.get(u)-2,m]});return{alberi:e.filter(f),lampioni:a.filter(f),fiume:c}}var rt=[[1,0],[-1,0],[0,1],[0,-1]];function lt(i,o,t,e,a=64){let n=new Set;e.sort((f,c)=>c.h-f.h||f.r-c.r);let r=[];for(let f of e){if(r.length>=5)break;r.every(c=>(c.x-f.x)**2+(c.z-f.z)**2>=784)&&r.push(f)}let l=(f,c)=>{let u=f+"|"+c;if(n.has(u))return;let p=o.get(u);i.togli(f,p-1,c,!0),i.togli(f,p-2,c,!0),i.metti(f,p-2,c,"acqua",!0),n.add(u)};for(let f of r){let c=f.x,u=f.z,p=null,m=0,s=new Set([c+"|"+u]);for(let d=0;d<500;d++){let v=o.get(c+"|"+u);if(l(c,u),p){let g=c+p[1],z=u-p[0];o.get(g+"|"+z)===v&&l(g,z)}let h=null,b=1/0,E=1/0;for(let g of rt){let z=c+g[0],S=u+g[1];if(s.has(z+"|"+S))continue;let R=o.get(z+"|"+S);if(R===void 0)continue;let _=(g===p?-.5:0)+zo(z*7+5,S*7+13,t+71);(R<b||R===b&&_<E)&&(h=g,b=R,E=_)}if(!h||b>v||(m=b===v?m+1:0,m>24)||(c+=h[0],u+=h[1],s.add(c+"|"+u),p=h,o.get(c+"|"+u)<=yo)||Math.max(Math.abs(c),Math.abs(u))>=a-6)break}}for(let f of n){let[c,u]=f.split("|").map(Number),p=o.get(f);for(let m=-1;m<=1;m++)for(let s=-1;s<=1;s++){if(!m&&!s)continue;let d=c+m+"|"+(u+s);if(n.has(d))continue;let v=o.get(d);v===void 0||v<p||v>p+1||i.tipo(c+m,v-1,u+s)==="erba"&&(i.togli(c+m,v-1,u+s,!0),i.metti(c+m,v-1,u+s,"sabbia",!0))}}return n}function ca(i){let o=new DataView(i);if(String.fromCharCode(o.getUint8(0),o.getUint8(1),o.getUint8(2),o.getUint8(3))!=="LNM1")throw new Error("non \xE8 un modello del nucleo");let t=o.getUint32(4,!0),e=t*3,a=new Uint8Array(i,8,e*16),n=new Uint8Array(i,8+e*16,e*4),r=new Uint8Array(e*20);for(let p=0;p<e;p++)r.set(a.subarray(p*16,p*16+16),p*20),r.set(n.subarray(p*4,p*4+4),p*20+16);let l=1/0,f=-1/0,c=0,u=new DataView(r.buffer);for(let p=0;p<e;p++){let m=u.getFloat32(p*20,!0),s=u.getFloat32(p*20+4,!0),d=u.getFloat32(p*20+8,!0);l=Math.min(l,s),f=Math.max(f,s),c=Math.max(c,Math.hypot(m,d))}return{byte:r,vertici:e,triangoli:t,minY:l,maxY:f,raggio:c}}var st=`#version 300 es
precision highp float;
...
void main() {
  ...
  colore = vec4(c, 1.0);
}`;function ut(i,o=4){if(o===8)return i instanceof Float32Array?i:new Float32Array(i);let t=i.length/4,e=new Float32Array(t*8);for(let a=0;a<t;a++)e.set([i[a*4],i[a*4+1],i[a*4+2],i[a*4+3],1,1,1,0],a*8);return e}var ft=`#version 300 es
layout(location = 0) in vec3 aPos;
...
precision mediump float;
void main() {}`,ae=class{constructor(o){this.gl=o,this.programma=oo(o,st,ct),this.u={};for(let t of["uVP","uTempo","uSoleVerso","uSoleCol","uSoleForza","uCieloCol","uMaterie","uNebbia","uCam","uNebbiaCol","uOmbra","uOmbre","uOmbreScala","uAltRett","uTaglio","uBuco","uOcchio","uSagoma","uMappaStat","uMappaDin","uLuceVP","uLuceVPDin","uMappaTexel","uMappaOn","uMappaSbieco","uLampade","uNLampade","uStile","uAltezze"])this.u[t]=o.getUniformLocation(this.programma,t);this.programmaOmbra=oo(o,ft,mt),this.uoVP=o.getUniformLocation(this.programmaOmbra,"uVP"),this.dinamici=new Set(["omino","cubo"]),this.mappaSporca=!0,this.sagoma="omino",this.tipi=new Map,this.statistiche={disegni:0,triangoli:0,istanze:0}}registra(o,t){let e=this.gl,a={vao:e.createVertexArray(),vbo:e.createBuffer(),ibo:e.createBuffer(),vertici:t.vertici,triangoli:t.triangoli,istanze:new Float32Array(0),n:0,sporco:!1,raggio:t.raggio,maxY:t.maxY};return e.bindVertexArray(a.vao),e.bindBuffer(e.ARRAY_BUFFER,a.vbo),e.bufferData(e.ARRAY_BUFFER,t.byte,e.STATIC_DRAW),e.enableVertexAttribArray(0),e.vertexAttribPointer(0,3,e.FLOAT,!1,20,0),e.enableVertexAttribArray(1),e.vertexAttribPointer(1,3,e.BYTE,!0,20,12),e.enableVertexAttribArray(4),e.vertexAttribIPointer(4,1,e.UNSIGNED_BYTE,20,15),e.enableVertexAttribArray(2),e.vertexAttribPointer(2,4,e.UNSIGNED_BYTE,!0,20,16),e.bindBuffer(e.ARRAY_BUFFER,a.ibo),e.enableVertexAttribArray(3),e.vertexAttribPointer(3,4,e.FLOAT,!1,32,0),e.vertexAttribDivisor(3,1),e.enableVertexAttribArray(5),e.vertexAttribPointer(5,4,e.FLOAT,!1,32,16),e.vertexAttribDivisor(5,1),e.bindVertexArray(null),this.tipi.set(o,a),a}istanze(o,t,e=4){let a=this.tipi.get(o);a&&(a.istanze=ut(t,e),a.n=a.istanze.length/8,a.sporco=!0,this.dinamici.has(o)||(this.mappaSporca=!0))}disegnaOmbra(o,t){let e=this.gl;e.useProgram(this.programmaOmbra),e.uniformMatrix4fv(this.uoVP,!1,o);let a=0,n=0;for(let[r,l]of this.tipi)l.n===0||this.dinamici.has(r)!==t||(e.bindVertexArray(l.vao),l.sporco&&(e.bindBuffer(e.ARRAY_BUFFER,l.ibo),e.bufferData(e.ARRAY_BUFFER,l.istanze,e.DYNAMIC_DRAW),l.sporco=!1),e.drawArraysInstanced(e.TRIANGLES,0,l.vertici,l.n),a++,n+=l.triangoli*l.n);return e.bindVertexArray(null),[a,n]}disegna(o,t){let e=this.gl,a=this.u,n=o.sole;e.useProgram(this.programma),e.uniformMatrix4fv(a.uVP,!1,o.vpCorrente||o.vp),e.uniform1f(a.uTaglio,o.taglio??-1e9);let r=o.vpCorrente===o.vpSpecchio?[0,0,0,0]:o.buco||[0,0,0,0];e.uniform3f(a.uOcchio,t.occhio[0],t.occhio[1],t.occhio[2]),e.uniform1f(a.uTempo,o.tempo),e.uniform3f(a.uSoleVerso,n.verso[0],n.verso[1],n.verso[2]),e.uniform3f(a.uSoleCol,n.colore[0],n.colore[1],n.colore[2]),e.uniform1f(a.uSoleForza,n.forza),e.uniform3f(a.uCieloCol,n.cielo[0],n.cielo[1],n.cielo[2]),e.uniform4fv(a.uMaterie,o.materie),e.uniform2f(a.uNebbia,o.nebbia.da,o.nebbia.a),e.uniform3f(a.uNebbiaCol,o.nebbia.colore[0],o.nebbia.colore[1],o.nebbia.colore[2]),e.uniform3f(a.uCam,t.occhio[0],t.occhio[1],t.occhio[2]),e.uniform1f(a.uOmbra,o.ombra&&o.altezze?1:0),o.altezze&&(e.activeTexture(e.TEXTURE0),e.bindTexture(e.TEXTURE_2D,o.ombre.tex),e.uniform1i(a.uOmbre,0),e.uniform2f(a.uOmbreScala,o.ombre.scala,o.ombre.offset),e.uniform4f(a.uAltRett,o.altRett[0],o.altRett[1],o.altRett[2],o.altRett[3])),o.legaMappa(a);let l=0,f=0,c=0;e.uniform1f(a.uSagoma,0);for(let[p,m]of this.tipi)m.n!==0&&(e.uniform4f(a.uBuco,r[0],r[1],r[2],p==="omino"?0:r[3]),e.bindVertexArray(m.vao),m.sporco&&(e.bindBuffer(e.ARRAY_BUFFER,m.ibo),e.bufferData(e.ARRAY_BUFFER,m.istanze,e.DYNAMIC_DRAW),m.sporco=!1),e.drawArraysInstanced(e.TRIANGLES,0,m.vertici,m.n),l++,f+=m.triangoli*m.n,c+=m.n);let u=this.sagoma&&this.tipi.get(this.sagoma);u&&u.n>0&&o.vpCorrente!==o.vpSpecchio&&(e.uniform1f(a.uSagoma,1),e.depthFunc(e.GREATER),e.depthMask(!1),e.enable(e.BLEND),e.blendFunc(e.ONE,e.ONE_MINUS_SRC_ALPHA),e.bindVertexArray(u.vao),e.drawArraysInstanced(e.TRIANGLES,0,u.vertici,u.n),e.disable(e.BLEND),e.depthMask(!0),e.depthFunc(e.LESS),e.uniform1f(a.uSagoma,0),l++),e.bindVertexArray(null),this.statistiche.disegni=l,this.statistiche.triangoli=f,this.statistiche.istanze=c}};function ua(i={}){let o=(t,e=1)=>typeof t=="number"&&isFinite(t)?+t.toFixed(e):null;return{quando:i.quando||null,gioco:"Leafy-Shadows",versione:i.versione||"in sviluppo",nota:typeof i.nota=="string"?i.nota.slice(0,400):"",dispositivo:{classe:i.mobile?"mobile":"desktop",tocco:!!i.tocco,modoGui:i.modoGui||"auto",ua:(i.ua||"").slice(0,220),cpu:i.cpu||null,memoriaGB:i.memoriaGB||null},schermo:{css:i.css||null,reso:i.reso||null,dpr:o(i.dpr,3),rapporto:i.css&&i.reso&&i.css[0]?o(i.reso[0]/i.css[0],2):null},qualita:{livello:i.livello,di:i.quantiLivelli,manuale:!!i.manuale,profilo:i.profilo||null,ombreLampade:!!i.ombreLampade,antialias:!!i.antialias},prestazioni:{fps:o(i.fps,0),p50ms:o(i.p50,2),p99ms:o(i.p99,2),disegni:i.disegni??null,triangoli:i.triangoli??null,ombreMs:o(i.ombreMs,2),storiaFps:Array.isArray(i.storiaFps)?i.storiaFps.slice(-60).map(t=>Math.round(t)):[],storiaLivelli:Array.isArray(i.storiaLivelli)?i.storiaLivelli.slice(-20):[]},scheda:{nome:(i.scheda||"").slice(0,120),software:!!i.software},mondo:{chunk:i.chunk??null,blocchi:i.blocchi??null,luci:i.luci??null,decorazioni:i.decorazioni??null,erba:i.erba??null,ora:i.ora||null,giorno:i.giorno??null,worldgenMs:o(i.worldgenMs,0),meshMs:o(i.meshMs,0)},errori:(i.errori||[]).slice(-12).map(t=>String(t).slice(0,500)),scatto:i.scatto||null}}function fa(i){return Math.round(JSON.stringify(i).length/1024)}var pt=new Uint32Array([1116352408,1899447441,3049323471,3921009573,961987163,1508970993,2453635748,2870763221,3624381080,310598401,607225278,1426881987,1925078388,2162078206,2614888103,3248222580,3835390401,4022224774,264347078,604807628,770255983,1249150122,1555081692,1996064986,2554220882,2821834349,2952996808,3210313671,3336571891,3584528711,113926993,338241895,666307205,773529912,1294757372,1396182291,1695183700,1986661051,2177026350,2456956037,2730485921,2820302411,3259730800,3345764771,3516065817,3600352804,4094571909,275423344,430227734,506948616,659060556,883997877,958139571,1322822218,1537002063,1747873779,1955562222,2024104815,2227730452,2361852424,2428436474,2756734187,3204031479,3329325298]),po=(i,o)=>i>>>o|i<<32-o;function ma(i){let o=new Uint32Array([1779033703,3144134277,1013904242,2773480762,1359893119,2600822924,528734635,1541459225]),t=i.length*8,e=new Uint8Array(i.length+9+63>>6<<6);e.set(i),e[i.length]=128,new DataView(e.buffer).setUint32(e.length-4,t>>>0),new DataView(e.buffer).setUint32(e.length-8,Math.floor(t/4294967296));let a=new Uint32Array(64),n=new DataView(e.buffer);for(let l=0;l<e.length;l+=64){for(let h=0;h<16;h++)a[h]=n.getUint32(l+h*4);for(let h=16;h<64;h++){let b=po(a[h-15],7)^po(a[h-15],18)^a[h-15]>>>3,E=po(a[h-2],17)^po(a[h-2],19)^a[h-2]>>>10;a[h]=a[h-16]+b+a[h-7]+E>>>0}let[f,c,u,p,m,s,d,v]=o;for(let h=0;h<64;h++){let b=po(m,6)^po(m,11)^po(m,25),E=m&s^~m&d,g=v+b+E+pt[h]+a[h]>>>0,z=po(f,2)^po(f,13)^po(f,22),S=f&c^f&u^c&u,R=z+S>>>0;v=d,d=s,s=m,m=p+g>>>0,p=u,u=c,c=f,f=g+R>>>0}o[0]=o[0]+f>>>0,o[1]=o[1]+c>>>0,o[2]=o[2]+u>>>0,o[3]=o[3]+p>>>0,o[4]=o[4]+m>>>0,o[5]=o[5]+s>>>0,o[6]=o[6]+d>>>0,o[7]=o[7]+v>>>0}let r="";for(let l of o)r+=l.toString(16).padStart(8,"0");return r}var ht="https://ntfy.sh",dt=4096;async function vt(i){let o=new TextEncoder().encode("leafy-shadows/"+i),t;if(globalThis.crypto&&crypto.subtle){let e=await crypto.subtle.digest("SHA-256",o);t=[...new Uint8Array(e)].map(a=>a.toString(16).padStart(2,"0")).join("")}else t=ma(o);return"leafy-"+t.slice(0,24)}async function pa(i,o){let t=await vt(i),e=await fetch(`${ht}/${t}`,{method:"POST",headers:{"x-title":"Leafy-Shadows","x-filename":"rapporto.json"},body:o});if(!e.ok)return{ok:!1,dice:`il servizio ha detto no: ${e.status}`};let a=await e.json().catch(()=>({})),n=o.length>dt;return{ok:!0,id:a.id||"",dice:n?`mandato \u2714 (${Math.round(o.length/1024)} KB, come allegato: dura 3 ore)`:`mandato \u2714 (${Math.round(o.length/1024)} KB, dura 12 ore)`}}var ha="leafy.diagnostica.chiave",gt=`
...
`,te=class{constructor(o,t){this.leggi=o,this.scatta=t,this.errori=[],addEventListener("error",a=>this._errore(a.error||a.message)),addEventListener("unhandledrejection",a=>this._errore(a.reason));let e=document.createElement("style");e.textContent=gt,document.head.appendChild(e),this.nodo=document.createElement("div"),this.nodo.id="diag",this.nodo.innerHTML="<b>\u{1FA7A}</b> diagnosi",this.nodo.title="Manda la diagnostica",document.body.appendChild(this.nodo),this.nodo.addEventListener("click",()=>this.apri()),this.pannello=document.createElement("div"),this.pannello.id="diagPanel",document.body.appendChild(this.pannello)}_errore(o){let t=o&&o.stack?o.stack:String(o);this.errori.push(t),this.errori.length>40&&this.errori.shift()}get chiave(){try{return localStorage.getItem(ha)||""}catch{return""}}set chiave(o){try{localStorage.setItem(ha,o)}catch{}}apri(){let o=this.pannello;o.classList.add("aperto"),o.innerHTML=`
...
mandami quello.`)}}};var X=document.getElementById("tela"),bt=document.getElementById("stato"),xt=document.getElementById("fps"),J=new URLSearchParams(location.search),N={raggio:+(J.get("raggio")||5),erba:+(J.get("erba")??8),ombra:J.get("ombra")!=="no",specchio:J.get("specchio")==="no"?0:Math.max(.2,Math.min(1,+(J.get("specchio")??.5)||.5)),dprMax:+(J.get("dpr")||1.5),rampa:J.has("rampa"),tutto:J.has("tutto"),mondo:J.has("finto")||J.has("rampa")?0:Math.max(16,Math.min(400,+(J.get("mondo")||48))),ora:J.has("ora")?Math.max(0,Math.min(1,+J.get("ora"))):null},{gl:qo,dpr:Et,ridimensiona:At}=Se(X,{antialias:!0,dprMax:N.dprMax}),M=new $o(qo),eo=new ae(qo);M.ombra=N.ombra;M.specchio.attivo=N.specchio>0;M.specchio.scala=N.specchio||.5;M.specchio.mostra=J.has("vedi");var se=0,So=0;function ba(i,o){let t=performance.now();for(let n of[...M.chunks.keys()])M.rimuovi(n);se=0;for(let n=-i;n<i;n++)for(let r=-i;r<i;r++)M.carica(n+","+r,qe(n,r,{erba:o})),se+=256;let e=i*2*16,a=new Uint8Array(e*e);for(let n=0;n<e;n++)for(let r=0;r<e;r++)a[n*e+r]=Oo(r-i*16,n-i*16)+1;M.impostaAltezze(a,-i*16,-i*16,e,e),So=performance.now()-t}var no=null,xa=0,Ea=0;function Tt(i,o){let t=performance.now();for(let m of[...M.chunks.keys()])M.rimuovi(m);Je(),no=new Ko;let{alberi:e,lampioni:a}=sa(no,4242,i);for(let[m,s,d]of e)no.metti(m,s,d,"albero",!0);for(let[m,s,d]of a)no.metti(m,s,d,"lampione",!0);let n=performance.now()-t,r=[],l=1e9,f=1e9,c=-1e9,u=-1e9;for(let m of no.chunks.keys()){let s=na(no,m,{erba:o});M.carica(m,s),r.push(s),l=Math.min(l,s.cx),c=Math.max(c,s.cx),f=Math.min(f,s.cz),u=Math.max(u,s.cz)}let p=ra(r,l,f,c,u);return M.impostaAltezze(p.byte,p.x0,p.z0,p.larghezza,p.profondita),se=xa=no.contaBlocchi,Ea=r.length,So=performance.now()-t,{tGen:n,tMesh:So-n}}var ze=null;N.mondo?ze=Tt(N.mondo,N.erba):ba(N.raggio,N.erba);async function Mt(){if(!no)return;let i=new Map;no.perOgni((o,t,e,a)=>{let n=W(a);n.forma!=="modello"||!n.modello||(i.has(n.modello)||i.set(n.modello,[]),i.get(n.modello).push(o+.5,t,e+.5,1))});for(let[o,t]of i)try{let e=await fetch(`./modelli/nucleo/${o}.bin`);if(!e.ok)throw new Error(`${e.status}`);eo.registra(o,ca(await e.arrayBuffer())),eo.istanze(o,t)}catch(e){console.warn(`modello ${o}: ${e.message}`)}}Mt();M.tutto=N.tutto;var zt=()=>{if(!no)return Oo(0,0)+2;for(let i=120;i>-Ao;i--)if(no.tipo(0,i,0))return i+2;return 8},B={alpha:-.8,beta:1.05,raggio:46,centro:[0,zt(),0],fov:.9};function Aa(){let i=Math.sin(B.beta),o=Math.cos(B.beta);return[B.centro[0]+B.raggio*i*Math.cos(B.alpha),B.centro[1]+B.raggio*o,B.centro[2]+B.raggio*i*Math.sin(B.alpha)]}var Fo=null,ie=0;X.addEventListener("pointerdown",i=>{Fo={x:i.clientX,y:i.clientY},X.setPointerCapture(i.pointerId)});X.addEventListener("pointermove",i=>{Fo&&(B.alpha+=(i.clientX-Fo.x)*.006,B.beta=Math.max(.15,Math.min(1.5,B.beta-(i.clientY-Fo.y)*.006)),Fo={x:i.clientX,y:i.clientY})});X.addEventListener("pointerup",()=>{Fo=null});X.addEventListener("wheel",i=>{B.raggio=Math.max(8,Math.min(140,B.raggio*(i.deltaY>0?1.1:.9))),i.preventDefault()},{passive:!1});X.addEventListener("touchstart",i=>{i.touches.length===2&&(ie=Math.hypot(i.touches[0].clientX-i.touches[1].clientX,i.touches[0].clientY-i.touches[1].clientY))},{passive:!0});X.addEventListener("touchmove",i=>{if(i.touches.length!==2)return;let o=Math.hypot(i.touches[0].clientX-i.touches[1].clientX,i.touches[0].clientY-i.touches[1].clientY);ie>0&&(B.raggio=Math.max(8,Math.min(140,B.raggio*ie/o))),ie=o},{passive:!0});var ne=N.ora??.35;function Rt(i){N.ora===null&&(ne=(ne+i/300)%1);let o=ne*Math.PI*2-Math.PI/2,t=.24+.5*Math.max(0,Math.sin(o)),e=o*.5;M.sole.verso=[-Math.cos(e)*Math.cos(Math.asin(t)),-t,-Math.sin(e)*Math.cos(Math.asin(t))];let a=Math.max(0,Math.min(1,(Math.sin(o)+.1)*2));M.sole.forza=a;let n=Math.min(1,Math.max(0,(t-.24)/.4));M.sole.colore=[1,.78+.22*n,.55+.45*n],M.sole.cielo=[.36+.64*a,.38+.62*a,.57+.43*a],M.nebbia.colore=[.25+.47*a,.35+.5*a,.5+.42*a],qo.clearColor(M.nebbia.colore[0],M.nebbia.colore[1],M.nebbia.colore[2],1)}var Q=[],vo=[],re=[],da=performance.now(),Ta=0,va=0;function Ma(i){let o=Math.min(.1,(i-da)/1e3);da=i;let t=performance.now();At(),Rt(o);let a={occhio:Aa(),centro:B.centro,fov:B.fov,rapporto:X.width/X.height};M.disegna(a,o,eo),eo.disegna(M,a),M.disegnaAcqua();let n=performance.now()-t;Q.push(o*1e3),Q.length>240&&Q.shift(),vo.push(n),vo.length>240&&vo.shift(),Ta++,i-va>500&&(va=i,za()),N.rampa&&!N.mondo&&St(i),requestAnimationFrame(Ma)}var le=[{raggio:5,erba:2,tutto:!1},{raggio:6,erba:3,tutto:!1},{raggio:7,erba:4,tutto:!1},{raggio:6,erba:3,tutto:!0},{raggio:8,erba:4,tutto:!0}],ce=[],Ro=-1,ga=0;function St(i){if(Ro>=0&&i-ga<6e3)return;if(Ro>=0){let t=Q.slice(-Math.min(Q.length,200)),e=le[Ro];ce.push({...e,fps:+(1e3/(Y(t,.5)||1)).toFixed(0),p50:+Y(t,.5).toFixed(1),p99:+Y(t,.99).toFixed(1),js:+Y(vo,.5).toFixed(2),disegni:M.statistiche.disegni,triangoli:M.statistiche.triangoli})}if(Ro++,Ro>=le.length){N.rampa=!1,za();return}let o=le[Ro];ba(o.raggio,o.erba),M.tutto=o.tutto,N.erba=o.erba,N.raggio=o.raggio,Q.length=0,vo.length=0,ga=i}var Y=(i,o)=>{if(!i.length)return 0;let t=i.slice().sort((e,a)=>e-a);return t[Math.min(t.length-1,Math.floor(t.length*o))]};function za(){let i=Y(Q,.5),o=Y(Q,.99),t=i?1e3/i:0;re.push(Math.round(t)),re.length>120&&re.shift();let e={disegni:M.statistiche.disegni+eo.statistiche.disegni+M.statistiche.disegniAcqua+M.statistiche.disegniErba+M.statistiche.disegniSpecchio,triangoli:M.statistiche.triangoli+eo.statistiche.triangoli+M.statistiche.triangoliAcqua+M.statistiche.triangoliErba+M.statistiche.triangoliSpecchio,chunkVisti:M.statistiche.chunkVisti,chunkTotali:M.statistiche.chunkTotali};xt.textContent=`${t.toFixed(0)} fps
${i.toFixed(1)} / ${o.toFixed(1)} ms
JS ${Y(vo,.5).toFixed(2)} ms`,bt.textContent=`NUCLEO ${N.mondo?`F1 \xB7 open world vero (semilato ${N.mondo}, ${Ea} chunk, ${xa.toLocaleString("it")} blocchi, gen ${ze.tGen.toFixed(0)} ms + mesh ${ze.tMesh.toFixed(0)} ms)`:"F0"} \xB7 ${X.width}\xD7${X.height} (dpr ${Et.toFixed(2)})
disegni ${e.disegni}  triangoli ${e.triangoli.toLocaleString("it")}  chunk ${e.chunkVisti}/${e.chunkTotali}
ombra del sole: ${M.ombra?"horizon mapping":"spenta"} \xB7 erba ${N.erba} \xB7 modelli ${eo.statistiche.istanze} istanze in ${eo.statistiche.disegni} disegni \xB7 acqua ${M.statistiche.disegniAcqua} disegni${M.statistiche.pelo!=null?` + specchio ${M.statistiche.disegniSpecchio} disegni (pelo ${M.statistiche.pelo.toFixed(2)}, scala ${M.specchio.scala})`:" (senza specchio)"} \xB7 erba ${M.statistiche.triangoliErba.toLocaleString("it")} fili in ${M.statistiche.disegniErba} disegni \xB7 costruzione ${So.toFixed(0)} ms
${ko(qo)}
?mondo=96 ?ora=0.95 ?finto ?raggio=${N.raggio} ?erba=${N.erba} ?ombra=${N.ombra?"s\xEC":"no"} ?specchio=${N.specchio||"no"} ?dpr=${N.dprMax} ?rampa ?tutto  \xB7  tocca lo schermo per girare`+(ce.length?`
RAMPA  fps  p50   p99   dis  triangoli
`+ce.map(a=>`r${a.raggio} e${a.erba}${a.tutto?" tutto":""}  ${String(a.fps).padStart(3)}  ${String(a.p50).padStart(5)}  ${String(a.p99).padStart(5)}  ${String(a.disegni).padStart(3)}  ${a.triangoli.toLocaleString("it")}`).join(`
`):"")+(N.rampa?`
rampa: gradino ${Ro+1}/${le.length}\u2026`:"")}requestAnimationFrame(Ma);var _t=new te(()=>({versione:(document.getElementById("versione")||{}).textContent||"nucleo in sviluppo",mobile:matchMedia("(pointer: coarse)").matches,tocco:navigator.maxTouchPoints>0,modoGui:"nucleo",ua:navigator.userAgent,cpu:navigator.hardwareConcurrency||null,memoriaGB:navigator.deviceMemory||null,css:[X.clientWidth,X.clientHeight],reso:[X.width,X.height],dpr:devicePixelRatio,livello:0,quantiLivelli:1,manuale:!0,profilo:{banco:N.mondo?"nucleo F1 mondo vero":"nucleo F0",mondo:N.mondo,raggio:N.raggio,erba:N.erba,ombra:M.ombra,specchio:N.specchio,disegniSpecchio:M.statistiche.disegniSpecchio,tutto:!!M.tutto,dprMax:N.dprMax,jsMs:+Y(vo,.5).toFixed(2),jsP99:+Y(vo,.99).toFixed(2),rampa:ce},ombreLampade:!1,antialias:!0,fps:Y(Q,.5)?1e3/Y(Q,.5):null,p50:Y(Q,.5),p99:Y(Q,.99),disegni:M.statistiche.disegni+eo.statistiche.disegni+M.statistiche.disegniAcqua+M.statistiche.disegniErba+M.statistiche.disegniSpecchio,triangoli:M.statistiche.triangoli+eo.statistiche.triangoli+M.statistiche.triangoliAcqua+M.statistiche.triangoliErba+M.statistiche.triangoliSpecchio,ombreMs:0,storiaFps:re,storiaLivelli:[],scheda:ko(qo),software:/swiftshader|llvmpipe/i.test(ko(qo)),chunk:M.statistiche.chunkTotali,blocchi:se,luci:0,decorazioni:eo.statistiche.istanze,erba:M.statistiche.triangoliErba,ora:`${Math.floor(ne*24)}h`,giorno:0,worldgenMs:So,meshMs:So}),()=>{let i=Aa();return M.disegna({occhio:i,centro:B.centro,fov:B.fov,rapporto:X.width/X.height},0),Promise.resolve(X.toDataURL("image/webp",.6))});globalThis.NUCLEO={resa:M,modelli:eo,cam:B,opz:N,statistiche:()=>({fps:1e3/(Y(Q,.5)||1),p50:Y(Q,.5),p99:Y(Q,.99),js:Y(vo,.5),...M.statistiche,modelli:{...eo.statistiche},costruzioneMs:So,fotogrammi:Ta}),diagnostica:_t};

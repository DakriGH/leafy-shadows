...
// \u26A0 L'OMBRA DELLA LAMPADA \xC8 VERA, come in Leafy: dal punto si marcia in sei
...
out vec2 vNdc;
void main() { vNdc = vec2((gl_VertexID == 1) ? 3.0 : -1.0, (gl_VertexID == 2) ? 3.0 : -1.0); gl_Position = vec4(vNdc, 0.999999, 1.0); }`,Ut=`#version 300 es
precision highp float;
in vec2 vNdc;
uniform mat4 uInvVP;
...
void main() { colore = vec4(texture(uTex, vUv).rgb, 1.0); }`),this.uQuad=e.getUniformLocation(this.programmaQuad,"uTex"),this.vaoQuad=e.createVertexArray()),e.useProgram(this.programmaQuad),e.activeTexture(e.TEXTURE0),e.bindTexture(e.TEXTURE_2D,a.tex),e.uniform1i(this.uQuad,0),e.bindVertexArray(this.vaoQuad),e.disable(e.DEPTH_TEST),e.drawArrays(e.TRIANGLE_STRIP,0,4),e.enable(e.DEPTH_TEST),e.bindVertexArray(null)}_preparaSpecchio(e,a){let o=this.gl,t=this.specchio;t.fbo||(t.fbo=o.createFramebuffer(),t.tex=o.createTexture(),t.rbo=o.createRenderbuffer()),o.bindTexture(o.TEXTURE_2D,t.tex),o.texImage2D(o.TEXTURE_2D,0,o.RGBA8,e,a,0,o.RGBA,o.UNSIGNED_BYTE,null),o.texParameteri(o.TEXTURE_2D,o.TEXTURE_MIN_FILTER,o.LINEAR),o.texParameteri(o.TEXTURE_2D,o.TEXTURE_MAG_FILTER,o.LINEAR),o.texParameteri(o.TEXTURE_2D,o.TEXTURE_WRAP_S,o.CLAMP_TO_EDGE),o.texParameteri(o.TEXTURE_2D,o.TEXTURE_WRAP_T,o.CLAMP_TO_EDGE),o.bindRenderbuffer(o.RENDERBUFFER,t.rbo),o.renderbufferStorage(o.RENDERBUFFER,o.DEPTH_COMPONENT16,e,a),o.bindFramebuffer(o.FRAMEBUFFER,t.fbo),o.framebufferTexture2D(o.FRAMEBUFFER,o.COLOR_ATTACHMENT0,o.TEXTURE_2D,t.tex,0),o.framebufferRenderbuffer(o.FRAMEBUFFER,o.DEPTH_ATTACHMENT,o.RENDERBUFFER,t.rbo),o.checkFramebufferStatus(o.FRAMEBUFFER)!==o.FRAMEBUFFER_COMPLETE&&(t.attivo=!1,console.warn("specchio: framebuffer incompleto, spento")),o.bindFramebuffer(o.FRAMEBUFFER,null),o.bindTexture(o.TEXTURE_2D,null),t.w=e,t.h=a}disegnaAcqua(){let e=this.gl,a=this.ua,o=this.sole,t=this._camera,r=this.specchio;if(!t||this._visibili.length===0){this.statistiche.disegniAcqua=0;return}e.useProgram(this.programmaAcqua),e.uniformMatrix4fv(a.uVP,!1,this.vp),e.uniform1f(a.uTempo,this.tempo),e.uniform3f(a.uCam,t.occhio[0],t.occhio[1],t.occhio[2]),e.uniform2f(a.uNebbia,this.nebbia.da,this.nebbia.a),e.uniform3f(a.uSoleVerso,o.verso[0],o.verso[1],o.verso[2]),e.uniform3f(a.uSoleCol,o.colore[0],o.colore[1],o.colore[2]),e.uniform1f(a.uSoleForza,o.forza),e.uniform3f(a.uCieloCol,o.cielo[0],o.cielo[1],o.cielo[2]),e.uniform3f(a.uNebbiaCol,this.nebbia.colore[0],this.nebbia.colore[1],this.nebbia.colore[2]);let n=r.pelo!=null&&r.tex;e.activeTexture(e.TEXTURE1),e.bindTexture(e.TEXTURE_2D,n?r.tex:null),e.uniform1i(a.uSpecchio,1),e.uniform3f(a.uSchermo,1/e.drawingBufferWidth,1/e.drawingBufferHeight,n?1:0),e.uniform1f(a.uMare,this.mare),e.enable(e.BLEND),e.blendFunc(e.SRC_ALPHA,e.ONE_MINUS_SRC_ALPHA),e.depthMask(!1),e.disable(e.CULL_FACE);let s=0,f=0;for(let l of this._visibili)e.uniform3f(a.uChunk,l.chunk[0],l.chunk[1],l.chunk[2]),e.bindVertexArray(l.vaoAcqua),e.drawElements(e.TRIANGLES,l.quadAcqua*6,e.UNSIGNED_SHORT,0),s++,f+=l.quadAcqua*2;e.bindVertexArray(null),e.depthMask(!0),e.enable(e.CULL_FACE),e.disable(e.BLEND),e.activeTexture(e.TEXTURE0),this.statistiche.disegniAcqua=s,this.statistiche.triangoliAcqua=f,r.mostra&&n&&this._mostraSpecchio()}};var he=class extends Ao{vertice(e,a,o,t,r,n,s,f=0,l=0){super.vertice(e,a,o,Re[t],r,n,s,f,l)}},eo={erba:1,terra:2,sabbia:3,roccia:4,filo:5,tronco:6,chioma:7,lampada:8},Yo=[0,6072381,8739896,14403468,9211013,5086771,6043679,2714414,16767347],Bt=1;function ue(i,e){let a=o=>Math.max(0,Math.min(255,Math.round(o*e)));return a(i>>16&255)<<16|a(i>>8&255)<<8|a(i&255)}function uo(i,e,a){let o=i*374761393+e*668265263+a*1442695041|0;return o=Math.imul(o^o>>>13,1274126177),((o^o>>>16)>>>0)/4294967296}function fe(i,e,a,o){let t=i/a,r=e/a,n=Math.floor(t),s=Math.floor(r),f=t-n,l=r-s,u=f*f*(3-2*f),m=l*l*(3-2*l),h=uo(n,s,o),c=uo(n+1,s,o),d=uo(n,s+1,o),b=uo(n+1,s+1,o);return h+(c-h)*u+(d+(b-d)*u-(h+(c-h)*u))*m}function zo(i,e,a=7){let o=fe(i,e,48,a)*14+fe(i,e,17,a+1)*5+fe(i,e,6,a+2)*1.5;return 8+Math.floor(o)}function Le(i){return i<11?eo.sabbia:i>24?eo.roccia:eo.erba}function Fe(i,e,a=7){let o=[];for(let t=0;t<2;t++){if(uo(i*3+t,e*5-t,a+9)<.35)continue;let n=i*16+Math.floor(uo(i,e,a+11+t)*15)+.5,s=e*16+Math.floor(uo(e,i,a+13+t)*15)+.5,f=zo(Math.floor(n),Math.floor(s),a);Le(f)===eo.erba&&o.push({x:n,y:f+3,z:s})}return o}function ye(i,e,a,o){let t=0;for(let r of o){let s=15-Math.sqrt((i-r.x)**2+(e-r.y)**2+(a-r.z)**2);s>t&&(t=s)}return Math.max(0,Math.min(15,Math.round(t)))}function Ie(i,e,{seme:a=7,erba:o=2,raggioLampade:t=2}={}){let r=new he(1600),n=i*16,s=e*16,f=255,l=0,u=[];for(let h=-t;h<=t;h++)for(let c=-t;c<=t;c++)u.push(...Fe(i+h,e+c,a));for(let h=0;h<16;h++)for(let c=0;c<16;c++){let d=n+h,b=s+c,p=zo(d,b,a);p<f&&(f=p),p+1>l&&(l=p+1);let g=Le(p),E=.94+.12*uo(d,b,a+3),v=ye(d+.5,p+1,b+.5,u),_=ue(Yo[g],E);r.quadDa([h,p+1,c,2,15,v,_],[h,p+1,c+1,2,15,v,_],[h+1,p+1,c+1,2,15,v,_],[h+1,p+1,c,2,15,v,_]);let S=[[1,0,0],[-1,0,1],[0,1,4],[0,-1,5]];for(let[R,C,x]of S){let A=zo(d+R,b+C,a);for(let T=A+1;T<=p;T++){let z=Math.max(6,15-(p-T)*2),N=T===p&&g===eo.erba?eo.erba:p>24?eo.roccia:eo.terra,I=ye(d+.5+R*.5,T+.5,b+.5+C*.5,u),O=T,Q=T+1,L=ue(Yo[N],E);R===1?r.quadDa([h+1,O,c,x,z,I,L],[h+1,Q,c,x,z,I,L],[h+1,Q,c+1,x,z,I,L],[h+1,O,c+1,x,z,I,L]):R===-1?r.quadDa([h,O,c+1,x,z,I,L],[h,Q,c+1,x,z,I,L],[h,Q,c,x,z,I,L],[h,O,c,x,z,I,L]):C===1?r.quadDa([h+1,O,c+1,x,z,I,L],[h+1,Q,c+1,x,z,I,L],[h,Q,c+1,x,z,I,L],[h,O,c+1,x,z,I,L]):r.quadDa([h,O,c,x,z,I,L],[h,Q,c,x,z,I,L],[h+1,Q,c,x,z,I,L],[h+1,O,c,x,z,I,L]),T<f&&(f=T)}}if(g===eo.erba)for(let R=0;R<o;R++){if(uo(d,b,a+20+R)<.25)continue;let x=1,A=h,T=c,z=ue(Yo[eo.filo],.94+.12*uo(d,b,a+30+R));r.quadDa([A,p+1,T,2,15,v,z],[A,p+1+x,T,2,15,v,z,1],[A+1,p+1+x,T+1,2,15,v,z,1],[A+1,p+1,T+1,2,15,v,z]),r.quadDa([A+1,p+1,T,2,15,v,z],[A+1,p+1+x,T,2,15,v,z,1],[A,p+1+x,T+1,2,15,v,z,1],[A,p+1,T+1,2,15,v,z]),p+2>l&&(l=p+2)}}for(let h of Fe(i,e,a)){let c=Math.floor(h.x)-n,d=Math.floor(h.z)-s,b=h.y-3;for(let p=b+1;p<=h.y;p++){let g=p===h.y?eo.lampada:eo.tronco,E=p===h.y?15:12,v=Yo[g],_=p===h.y?Bt:0,S=c+.5-.15,R=c+.5+.15,C=Math.floor(S),x=Math.min(16,Math.floor(S)+1),A=d,T=d+1;r.quadDa([x,p,A,0,12,E,v,0,_],[x,p+1,A,0,12,E,v,0,_],[x,p+1,T,0,12,E,v,0,_],[x,p,T,0,12,E,v,0,_]),r.quadDa([C,p,T,1,12,E,v,0,_],[C,p+1,T,1,12,E,v,0,_],[C,p+1,A,1,12,E,v,0,_],[C,p,A,1,12,E,v,0,_]),r.quadDa([x,p,T,4,12,E,v,0,_],[x,p+1,T,4,12,E,v,0,_],[C,p+1,T,4,12,E,v,0,_],[C,p,T,4,12,E,v,0,_]),r.quadDa([C,p,A,5,12,E,v,0,_],[C,p+1,A,5,12,E,v,0,_],[x,p+1,A,5,12,E,v,0,_],[x,p,A,5,12,E,v,0,_]),p===h.y&&r.quadDa([C,p+1,A,2,15,E,v,0,_],[C,p+1,T,2,15,E,v,0,_],[x,p+1,T,2,15,E,v,0,_],[x,p+1,A,2,15,E,v,0,_]),p+1>l&&(l=p+1)}}return{...r.dati(),minY:f,maxY:l,cx:i,cz:e}}var Ne={erba:{nome:"Erba",cima:5949008,lato:15047529,fondo:12546123,orlo:3446604,solido:!0,nav:10,cappello:!0,fam:"scavo"},terra:{nome:"Terra",cima:12546123,lato:12546123,fondo:11034431,solido:!0,nav:10,fam:"scavo"},sabbia:{nome:"Sabbia",cima:15324316,lato:14599048,fondo:13808246,solido:!0,nav:12,fam:"scavo"},ghiaia:{nome:"Ghiaia",cima:10130572,lato:9143677,fondo:8354162,solido:!0,nav:12,fam:"scavo"},neve:{nome:"Neve",cima:15923191,lato:14740202,fondo:13688028,solido:!0,nav:12,fam:"scavo"},roccia:{nome:"Roccia",cima:11054778,lato:9673384,fondo:8883868,solido:!0,nav:10,fam:"mina"},pietra:{nome:"Pietra liscia",cima:12436429,lato:11449535,fondo:10660019,solido:!0,nav:10,fam:"mina"},mattoni:{nome:"Mattoni",cima:11555645,lato:10570294,fondo:9650735,solido:!0,nav:10,fam:"mina"},legno:{nome:"Legno",cima:11568720,lato:10252866,fondo:9266489,solido:!0,nav:10,fam:"taglia"},tronco:{nome:"Tronco",cima:12622434,lato:8016432,fondo:12622434,solido:!0,nav:10,fam:"taglia"},asse:{nome:"Assi chiare",cima:14268798,lato:13150317,fondo:12163422,solido:!0,nav:10,fam:"taglia"},lanaBianca:{nome:"Lana bianca",cima:15724786,lato:14869478,fondo:14014170,solido:!0,nav:10,fam:"scavo"},lanaRossa:{nome:"Lana rossa",cima:14703182,lato:13388608,fondo:12206648,solido:!0,nav:10,fam:"scavo"},lanaBlu:{nome:"Lana blu",cima:4882388,lato:4157120,fondo:3629227,solido:!0,nav:10,fam:"scavo"},lanaGialla:{nome:"Lana gialla",cima:15911244,lato:14727230,fondo:13477428,solido:!0,nav:10,fam:"scavo"},lanaVerde:{nome:"Lana verde",cima:5813096,lato:4890714,fondo:4165454,solido:!0,nav:10,fam:"scavo"},ferro:{nome:"Ferro",cima:12174028,lato:10792376,fondo:9410723,solido:!0,nav:10,fam:"scavo",materia:"metallo"},fanghiglia:{nome:"Fanghiglia",cima:11569756,lato:10517842,fondo:9268551,solido:!0,nav:10,fam:"scavo",materia:"fango"},ghiaccio:{nome:"Ghiaccio",cima:12576498,lato:11131114,fondo:9685472,solido:!0,nav:10,fam:"scavo",materia:"ghiaccio"},cristallo:{nome:"Cristallo",cima:16771496,lato:16243851,fondo:15256437,solido:!0,nav:10,fam:"mina",salute:100,materia:"accesa",luce:{colore:16767370,raggio:6,intensita:1,ombra:!0}},ottone:{nome:"Ottone",cima:14267482,lato:12820556,fondo:11044927,solido:!0,nav:10,fam:"scavo",materia:"specchio"},lucciola:{nome:"Lucciola verde",cima:11075504,lato:6280814,fondo:4634967,solido:!0,nav:10,fam:"mina",salute:100,luce:{colore:8257440,raggio:5,intensita:1.1,ombra:!0}},lampadaPesante:{nome:"Lampada pesante (con ombra)",cima:16771764,lato:15777891,fondo:14264132,solido:!0,nav:10,fam:"mina",salute:100,luce:{colore:16767113,raggio:8,intensita:1.1,ombra:!0}},lampadaLeggera:{nome:"Lampada leggera (trapassa i muri)",cima:16771764,lato:15777891,fondo:14264132,solido:!0,nav:10,fam:"mina",salute:100,luce:{colore:16767113,raggio:8,intensita:1.1,ombra:!1}},lampadaRossa:{nome:"Lampada rossa",cima:16759213,lato:15224892,fondo:13187624,solido:!0,nav:10,fam:"mina",salute:100,luce:{colore:16722458,raggio:8,intensita:1.1,ombra:!0}},lampadaVerde:{nome:"Lampada verde",cima:11993028,lato:4183135,fondo:3124809,solido:!0,nav:10,fam:"mina",salute:100,luce:{colore:1769274,raggio:8,intensita:1.1,ombra:!0}},lampadaBlu:{nome:"Lampada blu",cima:11584767,lato:4220128,fondo:3099837,solido:!0,nav:10,fam:"mina",salute:100,luce:{colore:2771711,raggio:8,intensita:1.1,ombra:!0}},fuochiFatui:{nome:"Nido di fuochi fatui",cima:13498111,lato:5083048,fondo:3500413,solido:!0,nav:10,fam:"mina",salute:100,luce:{colore:9430271,raggio:3,intensita:.7,ombra:!1},fuochiFatui:{numero:7,raggio:3.2,quota:1.9,luce:{colore:10477823,raggio:4.2,intensita:1}}},acqua:{nome:"Acqua",cima:5227244,lato:4042208,fondo:3184332,solido:!1,nav:null,acqua:!0}},Pe=[{id:"naturali",nome:"Naturali",emoji:"\u{1F33F}",blocchi:["erba","terra","sabbia","ghiaia","neve","roccia","lucciola","acqua"]},{id:"costruzione",nome:"Costruzione",emoji:"\u{1F9F1}",blocchi:["legno","tronco","asse","pietra","mattoni"]},{id:"lane",nome:"Lane",emoji:"\u{1F3A8}",blocchi:["lanaBianca","lanaRossa","lanaBlu","lanaGialla","lanaVerde"]},{id:"luci",nome:"Luci",emoji:"\u{1F4A1}",blocchi:["lucciola","lampadaPesante","lampadaLeggera","lampadaRossa","lampadaVerde","lampadaBlu","fuochiFatui"]}],$o={id:"officina",nome:"Officina",emoji:"\u{1F6E0}\uFE0F",blocchi:[]};Pe.push($o);var Vt={id:"prove",nome:"Prove",emoji:"\u{1F317}",blocchi:[]};Pe.push(Vt);function we(i,e,a=$o){Ne[i]=e,a.blocchi.includes(i)||a.blocchi.push(i)}var kt={nome:"Blocco perduto",cima:12950225,lato:11305912,fondo:9924767,solido:!0,nav:10,fam:"mina"};function j(i){return Ne[i.charCodeAt(0)===97&&i.startsWith("acqua")?"acqua":i]||kt}function Ue(i){let e=i.indexOf("~");return e<0?i:i.slice(0,e)}function De(i){if(!i||!i.startsWith("acqua"))return null;let e=i.indexOf("~");return e<0?0:Number(i.slice(e+1))}var F=16,Gt=256,Ho=2048,qe=64,to=(i,e,a)=>((i+Ho)*4096+(a+Ho))*256+(e+qe),Co=i=>Math.floor(i/(256*4096))-Ho,Oo=i=>Math.floor(i/256)%4096-Ho,Fo=i=>i%256-qe;var vo=(i,e)=>Math.floor(i/F)+","+Math.floor(e/F),Ko=class{constructor(){this.chunks=new Map,this.sporchi=new Set,this.sporchiAcqua=new Set,this._rev=new Map,this.furni=new Map,this.ombreFurni=new Map,this.contaBlocchi=0,this.onEvento=null,this.cambiate=[],this.troppiCambi=!1,this._memoCx=0,this._memoCz=0,this._memoChunk=null,this.generati=new Set,this.modifiche=new Map,this.frontiera=null}segnaGenerato(e){this.generati.add(e)}_annotaModifica(e,a,o,t){if(!this.frontiera)return;let r=vo(e,o),n=this.modifiche.get(r);n||(n=new Map,this.modifiche.set(r,n)),n.set(to(e,a,o),t)}applicaModifiche(e){let a=this.modifiche.get(e);if(!a)return 0;for(let[o,t]of a){let r=Co(o),n=Fo(o),s=Oo(o);t===null?this.togli(r,n,s,!0):this.metti(r,n,s,t,!0)}return a.size}scaricaChunk(e){let a=this.chunks.get(e);if(!a)return this.generati.delete(e),[];let o=[];for(let[t,r]of a){let n=j(r);n&&n.forma==="modello"&&o.push([Co(t),Fo(t),Oo(t),r])}return this.contaBlocchi-=a.size,this.chunks.delete(e),this._scordaMemo(),this.generati.delete(e),this._tocca(e,this.sporchi),o}_cambiata(e,a,o){if(this.cambiate.length>=3*Gt){this.troppiCambi=!0;return}this.cambiate.push(e,a,o)}scordaCambi(){this.cambiate.length=0,this.troppiCambi=!1}_scordaMemo(){this._memoKc=null,this._memoChunk=null}_chunkDi(e,a){let o=Math.floor(e/F),t=Math.floor(a/F);if(this._memoChunk!==null&&this._memoCx===o&&this._memoCz===t)return this._memoChunk;let r=this.chunks.get(o+","+t)||null;return this._memoCx=o,this._memoCz=t,this._memoChunk=r,r}tipo(e,a,o){let t=this._chunkDi(e,o);return t&&t.get(to(e,a,o))||null}pieno(e,a,o){return this.tipo(e,a,o)!==null}solido(e,a,o){let t=this.tipo(e,a,o);if(t&&j(t).solido)return!0;let r=this.furni.get(to(e,a,o));return!!r&&!(r.def&&r.def.calpestabile)}calpestabile(e,a,o){if(!this.solido(e,a-1,o)||this.solido(e,a,o)||this.solido(e,a+1,o))return!1;let t=this.tipo(e,a,o);return!(t&&j(t).acqua)}_sporca(e,a,o=this.sporchi){let t=(e%F+F)%F,r=(a%F+F)%F;this._tocca(vo(e,a),o),t===0&&this._tocca(vo(e-1,a),o),t===F-1&&this._tocca(vo(e+1,a),o),r===0&&this._tocca(vo(e,a-1),o),r===F-1&&this._tocca(vo(e,a+1),o)}_tocca(e,a){a.add(e),this._rev.set(e,(this._rev.get(e)||0)+1)}revisione(e){return this._rev.get(e)||0}metti(e,a,o,t,r=!1){let n=vo(e,o),s=this.chunks.get(n);s||(s=new Map,this.chunks.set(n,s),this._scordaMemo());let f=to(e,a,o),l=s.get(f);l===void 0&&this.contaBlocchi++,s.set(f,t);let u=t.charCodeAt(0)===97&&t.startsWith("acqua")&&(l===void 0||l.startsWith("acqua"));this._sporca(e,o,u?this.sporchiAcqua:this.sporchi),u||this._cambiata(e,a,o),r||(this._annotaModifica(e,a,o,t),this.onEvento&&this.onEvento({tipo:"metti",cella:[e,a,o],blocco:t}))}togli(e,a,o,t=!1){let r=vo(e,o),n=this.chunks.get(r);if(!n)return!1;let s=to(e,a,o),f=n.get(s);if(!n.delete(s))return!1;this.contaBlocchi--,n.size===0&&(this.chunks.delete(r),this._scordaMemo());let l=!!(f&&f.startsWith("acqua"));return this._sporca(e,o,l?this.sporchiAcqua:this.sporchi),l||this._cambiata(e,a,o),t||(this._annotaModifica(e,a,o,null),this.onEvento&&this.onEvento({tipo:"togli",cella:[e,a,o]})),!0}occupaFurni(e,a){for(let[o,t,r]of e)this.furni.set(to(o,t,r),a)}liberaFurni(e){for(let[a,o,t]of e)this.furni.delete(to(a,o,t))}furniIn(e,a,o){return this.furni.get(to(e,a,o))||null}occupaOmbra(e,a=!1){for(let[o,t,r]of e){let n=to(o,t,r),s=this.ombreFurni.get(n);if(s){s.n++,a&&s.op++===0&&this._cambiata(o,t,r);continue}this.ombreFurni.set(n,{x:o,y:t,z:r,n:1,op:a?1:0}),this._cambiata(o,t,r)}}liberaOmbra(e,a=!1){for(let[o,t,r]of e){let n=to(o,t,r),s=this.ombreFurni.get(n);s&&(a&&s.op>0&&--s.op===0&&s.n>1&&this._cambiata(o,t,r),!(--s.n>0)&&(this.ombreFurni.delete(n),this._cambiata(o,t,r)))}}ombraFurniIn(e,a,o){let t=this.ombreFurni.get(to(e,a,o));return t?t.op>0?2:1:0}appoggioInColonna(e,a,o,t=8){for(let r=o;r>o-t;r--)if(this.calpestabile(e,r,a))return r;return null}svuota(){this.chunks.clear(),this._scordaMemo(),this.furni.clear(),this.sporchi.clear(),this.sporchiAcqua.clear();for(let e of this._rev.keys())this._rev.set(e,this._rev.get(e)+1);this.scordaCambi(),this.contaBlocchi=0}*tutti(){for(let e of this.chunks.values())for(let[a,o]of e)yield{x:Co(a),y:Fo(a),z:Oo(a),tipo:o}}perOgni(e){for(let a of this.chunks.values())for(let[o,t]of a)e(Co(o),Fo(o),Oo(o),t)}*blocchiDelChunk(e){let a=this.chunks.get(e);if(a)for(let[o,t]of a)yield{x:Co(o),y:Fo(o),z:Oo(o),tipo:t}}perOgniDelChunk(e,a){let o=this.chunks.get(e);if(o)for(let[t,r]of o)a(Co(t),Fo(t),Oo(t),r)}};var Xt={primavera:{nome:"Primavera",emoji:"\u{1F338}",erba:[6738010,6343509,5949008,5553995,5158983,4763971,4434495,4105019],fogliame:null},estate:{nome:"Estate secca",emoji:"\u{1F33E}",erba:[15060862,14534259,14073193,13546335,13019733,12558668,12032068,11571261],fogliame:{h:.128,sF:.72,l:i=>i*.92+.1}},autunno:{nome:"Autunno",emoji:"\u{1F342}",erba:[15506768,15045448,14584129,14122810,13661492,13200431,12739371,12278311],fogliame:{h:.045,sF:1.2,l:i=>i*1.05+.09}},inverno:{nome:"Inverno",emoji:"\u2744\uFE0F",erba:[15988722,15462890,14871523,14279900,13622740,13031117,12439751,11848128],sabbia:{cima:15722970,lato:14932934,fondo:14077364},fogliame:{h:.42,sF:.18,l:i=>i*.38+.58}}},Po="primavera";var jo=null;function Wo(i,e,a){let o=i>>16&255,t=i>>8&255,r=i&255,n=e>>16&255,s=e>>8&255,f=e&255,l=(u,m)=>Math.round(u+(m-u)*a);return l(o,n)<<16|l(t,s)<<8|l(r,f)}function Be(i,e){if(jo){let a=Po;Po=jo.da;let o=me(i,e);Po=jo.a;let t=me(i,e);Po=a;let r=jo.mix;return{cima:Zo(o.cima,t.cima,r),lato:Zo(o.lato,t.lato,r),fondo:Zo(o.fondo,t.fondo,r),facce:o.facce,orlo:o.orlo!=null&&t.orlo!=null?Zo(o.orlo,t.orlo,r):o.orlo}}return me(i,e)}function Zo(i,e,a){let o=Math.round((i>>16&255)+((e>>16&255)-(i>>16&255))*a),t=Math.round((i>>8&255)+((e>>8&255)-(i>>8&255))*a),r=Math.round((i&255)+((e&255)-(i&255))*a);return o<<16|t<<8|r}function me(i,e){let a=j(i),o=Xt[Po],{cima:t,lato:r,fondo:n}=a;if(a.cappello&&o.erba&&!a.override&&(t=o.erba[pe(e,o.erba.length)]),a.reagisce==="stagione"&&o.erba){let s=o.erba[pe(e,o.erba.length)],f=a.reagisceForza??1;t=Wo(t,s,f),r=Wo(r,s,f*.45),n=Wo(n,s,f*.3)}else if(a.reagisce==="quota"){let s=pe(e,8)/7,f=(a.reagisceForza??1)*.5,l=u=>Wo(u,16777215,s*f);t=l(t),r=l(r),n=l(n)}return i==="sabbia"&&o.sabbia&&({cima:t,lato:r,fondo:n}=o.sabbia),{cima:t,lato:r,fondo:n,facce:a.facce||null,orlo:a.orlo!=null?a.orlo:void 0}}function mo(i,e,a){if(i.facce){let o=e*2+(a>0?0:1),t=i.facce[o];if(t!=null)return t}return e===1?a>0?i.cima:i.fondo:i.lato}function pe(i,e=8){let a=(e-1)*2,o=(Math.round(i)%a+a)%a;return o>=e&&(o=a-o),o}function de(i,e,a){let o=(i|0)*374761393+(e|0)*668265263+(a|0)*2147483647;return o=(o^o>>>13)*1274126177,o=o^o>>>16,(o>>>0)%1e3/1e3}function Yt(i,e){let a=i>>16&255,o=i>>8&255,t=i&255,r=n=>Math.max(0,Math.min(255,Math.round(n*(1+e))));return r(a)<<16|r(o)<<8|r(t)}function $t(i,e,a,o,t,r){if(!e||e==="liscio"||!a)return i;let n=0;return e==="chiazze"?n=(de(o,t,r)-.5)*2:e==="venature"?n=(de(0,t,0)-.5)*2*.7+(de(o,t,r)-.5)*.3:e==="sfumato"&&(n=(t%16+16)%16/16-.5),Yt(i,n*a*.34)}function Ve(i,e,a,o,t,r){if(!e||e==="liscio"||!a)return i;let n=s=>$t(s,e,a,o,t,r);return{cima:n(i.cima),lato:n(i.lato),fondo:n(i.fondo),facce:i.facce?i.facce.map(n):null}}var ke={metallo:{tinta:.82,satura:.55,orlo:.18,curva:1,glintR:.34,emiss:0,bagna:.2,sotto:0,riflette:.15},fango:{tinta:.72,satura:1.35,orlo:0,curva:-1,glintR:.48,emiss:0,bagna:1,sotto:0,riflette:0},ghiaccio:{tinta:1.06,satura:.62,orlo:.12,curva:.6,glintR:.3,emiss:0,bagna:.4,sotto:.3,riflette:.25},accesa:{tinta:1,satura:1,orlo:0,curva:0,glintR:0,emiss:1,bagna:0,sotto:0,riflette:0},specchio:{tinta:.95,satura:.35,orlo:.1,curva:1,glintR:.3,emiss:0,bagna:0,sotto:0,riflette:.55}},Ht=Object.keys(ke);function Ge(i){return!i||!i.materia?null:ke[i.materia]||null}function go(i,e,a=0){if(!e)return i;let o=(i>>16&255)/255,t=(i>>8&255)/255,r=(i&255)/255,n=.2126*o+.7152*t+.0722*r,s=e.satura;o=n+(o-n)*s,t=n+(t-n)*s,r=n+(r-n)*s;let f=e.tinta*(1+a),l=u=>Math.max(0,Math.min(255,Math.round(u*f*255)));return l(o)<<16|l(t)<<8|l(r)}var Kt=16;function Xe(i){let e=Ht.indexOf(i);return e<0||e+1>=Kt?0:e+1}var be=1/16,Ye=8*be,ao=9*be;function $e(i,e,a,o,t,r,n,s){let f=(u,m,h)=>[e+u,a+m,o+h];i.quad(f(-s,n,-s),f(s,n,-s),f(s,n,s),f(-s,n,s),mo(t,1,1),[0,1,0]),i.quad(f(-s,r,-s),f(s,r,-s),f(s,r,s),f(-s,r,s),mo(t,1,-1),[0,-1,0]);let l=[{d:[1,0,0],asse:0,segno:1},{d:[-1,0,0],asse:0,segno:-1},{d:[0,0,1],asse:2,segno:1},{d:[0,0,-1],asse:2,segno:-1}];for(let u of l){let[m,,h]=u.d,c=-h,d=m,b=(p,g)=>f(m*s+c*g,p,h*s+d*g);i.quad(b(r,-s),b(n,-s),b(n,s),b(r,s),mo(t,u.asse,u.segno),u.d)}}function jt(i,e,a,o,t){$e(i,e,a,o,t,-ao,0,Ye)}function Wt(i,e,a,o,t){$e(i,e,a,o,t,-ao,ao,5*be)}function Zt(i,e,a,o,t){let r=(l,u,m)=>[e+l,a+u,o+m],n=mo(t,0,1),s=Ye,f=[[[-s,-ao,-s],[s,-ao,s],[s,ao,s],[-s,ao,-s],[1,0,-1]],[[-s,-ao,s],[s,-ao,-s],[s,ao,-s],[-s,ao,s],[1,0,1]]];for(let[l,u,m,h,c]of f)i.quad(r(...l),r(...u),r(...m),r(...h),n,c),i.quad(r(...l),r(...u),r(...m),r(...h),n,[-c[0],-c[1],-c[2]])}function Qt(){}var He={lastra:jt,pilastro:Wt,croce:Zt,modello:Qt},wo=new Set(["lastra","pilastro","croce","modello"]);var Uo=1/16,Jt=[[0,1],[0,2],[1,2]],oa=[[1,0],[-1,0],[0,1],[0,-1]];function xo(i,e,a,o,t,r,n,s,f){let l=[i,e,a];return l[o]+=t,l[r]+=n,l[s]+=f,l}var Ke={tinta:1,satura:1};function je(i,e,a,o,t,r,n=0){let s=8*Uo,f=9*Uo,l=(u,m)=>r(u===0?m:0,u===1?m:0,u===2?m:0);for(let u=0;u<3;u++)for(let m of[-1,1]){if(l(u,m))continue;let h=(u+1)%3,c=(u+2)%3,d=mo(t,u,m),b=[0,0,0];b[u]=m,i.quad(xo(e,a,o,u,m*f,h,-s,c,-s),xo(e,a,o,u,m*f,h,+s,c,-s),xo(e,a,o,u,m*f,h,+s,c,+s),xo(e,a,o,u,m*f,h,-s,c,+s),d,b)}for(let[u,m]of Jt){let h=3-u-m;for(let c of[-1,1])for(let d of[-1,1]){if(l(u,c)||l(m,d))continue;let b=u===1&&c>0||m===1&&d>0,p=u===1&&c<0||m===1&&d<0,g=b?t.cima:p?t.fondo:t.lato,E=n?go(g,Ke,n):g,v=[0,0,0];v[u]=c,v[m]=d,i.quad(xo(e,a,o,u,c*f,m,d*s,h,-s),xo(e,a,o,u,c*s,m,d*f,h,-s),xo(e,a,o,u,c*s,m,d*f,h,+s),xo(e,a,o,u,c*f,m,d*s,h,+s),E,v)}}for(let u of[-1,1])for(let m of[-1,1])for(let h of[-1,1])l(0,u)||l(1,m)||l(2,h)||i.tri([e+u*f,a+m*s,o+h*s],[e+u*s,a+m*f,o+h*s],[e+u*s,a+m*s,o+h*f],n?go(m>0?t.cima:t.fondo,Ke,n):m>0?t.cima:t.fondo,[u,m,h])}function We(i,e,a,o,t,r){let n=(c,d)=>r(c,0,d),s=r(0,-1,0),f=t.cima,l=t.lato,u=t.fondo,m=t.orlo??t.cima,h=(c,d,b)=>[e+c*Uo,a+d*Uo,o+b*Uo];s||i.quad(h(-8,-9,-8),h(8,-9,-8),h(8,-9,8),h(-8,-9,8),u,[0,-1,0]);for(let[c,d]of oa){if(n(c,d))continue;let b=-d,p=c,g=(v,_,S)=>h(v*c+S*b,_,v*d+S*p),E=[c,0,d];s||i.quad(g(8,-9,-8),g(9,-8,-8),g(9,-8,8),g(8,-9,8),u,[c,-1,d]),i.quad(g(9,-8,-8),g(9,2,-8),g(9,2,8),g(9,-8,8),l,E),i.quad(g(9,2,-8),g(10,3,-8),g(10,3,8),g(9,2,8),m,E),i.quad(g(10,3,-8),g(10,7,-8),g(10,7,8),g(10,3,8),m,E),i.quad(g(10,7,-8),g(9,8,-8),g(9,8,8),g(10,7,8),f,[c,1,d]),i.quad(g(8,8,-8),g(9,8,-8),g(9,8,8),g(8,8,8),f,[0,1,0])}for(let c of[-1,1])for(let d of[-1,1]){if(n(c,0)||n(0,d))continue;let b=(g,E,v)=>h(g*c,E,v*d),p=[c,0,d];s||i.tri(b(9,-8,8),b(8,-9,8),b(8,-8,9),u,[c,-1,d]),i.quad(b(9,-8,8),b(8,-8,9),b(8,2,9),b(9,2,8),l,p),i.quad(b(9,2,8),b(8,2,9),b(8,3,10),b(10,3,8),m,p),i.quad(b(10,3,8),b(8,3,10),b(8,7,10),b(10,7,8),m,p),i.quad(b(10,7,8),b(8,7,10),b(8,8,9),b(9,8,8),f,[c,1,d]),i.tri(b(8,8,8),b(9,8,8),b(8,8,9),f,[0,1,0])}i.quad(h(-8,8,-8),h(8,8,-8),h(8,8,8),h(-8,8,8),f,[0,1,0])}var ve={lampione:{nome:"Lampione",modello:"lampione",altezza:3,mezza:.45,cima:16771764,lato:5988976,fondo:4672856,luce:{colore:16767113,raggio:4.6,intensita:1,ombra:!0,quota:2.6},notte:!0},albero:{nome:"Albero",modello:"albero",altezza:4.2,mezza:.7,cima:5217862,lato:8016432,fondo:6964518}};function Ze(){for(let[i,e]of Object.entries(ve))we(i,{nome:e.nome,cima:e.cima,lato:e.lato,fondo:e.fondo,solido:!1,nav:10,fam:"taglia",forma:"modello",modello:e.modello},$o)}var ea=2,ge=6,ta=256;function Qe(i){if(!i)return!1;let e=j(i);return!e.acqua&&!e.vetro&&!wo.has(e.forma)}function ot(i,e,a,o){let t=e.indexOf(","),r=+e.slice(0,t),n=+e.slice(t+1),s=r*F-ge,f=n*F-ge,l=F+2*ge,u=o-a+1,m=l,h=l*u*m,c=new Uint8Array(h),d=new Uint8Array(h),b=new Uint8Array(h),p=(S,R,C)=>((S-s)*u+(R-a))*m+(C-f),g=(S,R,C)=>S>=s&&S<s+l&&R>=a&&R<=o&&C>=f&&C<f+m,E=[];for(let S=s;S<s+l;S++)for(let R=f;R<f+m;R++){let C=!1;for(let x=o;x>=a;x--){let A=i.tipo(S,x,R),T=p(S,x,R);if(Qe(A)){b[T]=1,C=!0;continue}if(!C&&x===o){for(let z=o+1;z<ta&&z<o+40;z++)if(Qe(i.tipo(S,z,R))){C=!0;break}}if(C||(c[T]=15),A){let N=j(A).forma==="modello"&&ve[A];N&&N.luce&&E.push([S,x+Math.round(N.luce.quota??1),R])}}}let v=[];for(let S=0;S<h;S++)c[S]===15&&v.push(S);Je(v,c,b,l,u,m,1);let _=[];for(let[S,R,C]of E){if(!g(S,R,C))continue;let x=p(S,R,C);d[x]=15,_.push(x)}return Je(_,d,b,l,u,m,ea),{x0:s,z0:f,yMin:a,yMax:o,W:l,H:u,D:m,cielo:c,blocco:d,leggi(S,R,C){if(!g(S,R,C))return R>o?[15,0]:[0,0];let x=p(S,R,C);return[c[x],d[x]]}}}function Je(i,e,a,o,t,r,n){let s=[t*r,-t*r,r,-r,1,-1],f=0;for(;f<i.length;){let l=i[f++],u=e[l]-n;if(u<=0)continue;let m=Math.floor(l/(t*r)),h=Math.floor(l/r)%t,c=l%r;for(let d=0;d<6;d++){if(d===0&&m===o-1||d===1&&m===0||d===2&&h===t-1||d===3&&h===0||d===4&&c===r-1||d===5&&c===0)continue;let b=l+s[d];a[b]||e[b]>=u||(e[b]=u,i.push(b))}}}var et=[{n:5,largo:.15,alto:.32,apri:.42},{n:4,largo:.12,alto:.5,apri:.34},{n:7,largo:.1,alto:.38,apri:.46},{n:3,largo:.18,alto:.28,apri:.3}];function fo(i,e,a){let o=i*374761393+e*668265263+a*1442695041|0;return o=Math.imul(o^o>>>13,1274126177),((o^o>>>16)>>>0)/4294967296}var Qo=class{constructor(e,a=512){this.yBase=e,this.byte=new Uint8Array(a*12),this.n=0}_lamella(e,a,o,t,r,n,s,f,l,u=0,m=8){if((this.n+1)*12>this.byte.length){let d=new Uint8Array(this.byte.length*2);d.set(this.byte),this.byte=d}let h=this.n*12,c=this.byte;c[h]=e,c[h+1]=a,c[h+2]=o,c[h+3]=t,c[h+4]=r>>16&255,c[h+5]=r>>8&255,c[h+6]=r&255,c[h+7]=(n&15)<<2,c[h+8]=Math.max(1,Math.min(255,s)),c[h+9]=Math.max(1,Math.min(255,f)),c[h+10]=Math.max(0,Math.min(255,l+128)),c[h+11]=u&15|(m&15)<<4,this.n++}ciuffo(e,a,o,t,r,n,s,f=1,l=0){let u=et[Math.floor(fo(e,o,3)*et.length)],m=Math.max(1,Math.round(u.n*f*(.82+.36*fo(e,o,5)))),h=a+1-this.yBase;if(h<0||h*8>247)return 0;for(let c=0;c<m;c++){let d=fo(e,o,c*17+5),b=fo(e,o,c*17+11),p=fo(e,o,c*17+41),g=fo(e,o,c*17+59),E=Math.min(.98,.66+u.apri),v=e+.5+(d-.5)*E,_=o+.5+(b-.5)*E,S=Math.min(.8,u.alto*(.62+.8*fo(e,o,c*17+71))*(.5+.6*Math.pow(p,1.5))),R=u.largo*(.8+.4*g),C=(fo(e,o,c*17+83)-.5)*.5,x=fo(e,o,c*17+89),A=x<.15?.9+.03*x:x>.85?1.07+.03*(x-.85):.97+.06*(x-.15)/.7,T=Math.max(0,Math.min(128,Math.round((v-t)*8))),z=Math.max(0,Math.min(128,Math.round((_-r)*8))),N=Math.floor(fo(e,o,c*17+97)*255);this._lamella(T,z,Math.round(h*8),N,n,s,Math.round(S*64),Math.round(R*128),Math.round(C*128),l,Math.round((A-.9)/.2*15))}return m}dati(){return{byte:this.byte.subarray(0,this.n*12),vertici:this.n*6,fili:this.n,yBase:this.yBase}}};var Eo=64,aa=[[1,0,0,K(1,0,0),0,1],[-1,0,0,K(-1,0,0),0,-1],[0,1,0,K(0,1,0),1,1],[0,-1,0,K(0,-1,0),1,-1],[0,0,1,K(0,0,1),2,1],[0,0,-1,K(0,0,-1),2,-1]],tt=(i,e,a)=>((e+1)*3+(a+1))*3+(i+1),Ee=class{constructor(e,a,o,t,r){this.c=e,this.ox=a,this.oz=o,this._materia=0,this.luceDi=t,this.aria=r,this._cielo=15,this._cella=null}materia(e){this._materia=e|0}cella(e,a,o){this._cella=[e,a,o]}_cieloFaccia(e){let[a,o,t]=this._cella,r=-1;for(let n=0;n<3;n++){if(!e[n])continue;let s=this.luceDi(a+(n===0?e[0]:0),o+(n===1?e[1]:0),t+(n===2?e[2]:0))[0];s>r&&(r=s)}return r<0?this.luceDi(a,o+1,t)[0]:r}_bloccoVertice(e,a){let o=Math.hypot(a[0],a[1],a[2])||1,t=e[0]+a[0]/o*.5,r=e[1]+a[1]/o*.5,n=e[2]+a[2]/o*.5,s=0,f=0;for(let l of[-.45,.45])for(let u of[-.45,.45])for(let m of[-.45,.45]){let h=Math.floor(t+l),c=Math.floor(r+u),d=Math.floor(n+m);this.aria(h,c,d)&&(s+=this.luceDi(h,c,d)[1],f++)}return f?Math.round(s/f):0}_v(e,a,o,t){return[e[0]-this.ox,e[1]+Eo,e[2]-this.oz,a,this._cielo,this._bloccoVertice(e,t),o,0,this._materia]}_giro(e,a,o,t){let r=a[0]-e[0],n=a[1]-e[1],s=a[2]-e[2],f=o[0]-e[0],l=o[1]-e[1],u=o[2]-e[2],m=n*u-s*l,h=s*f-r*u,c=r*l-n*f;return m*t[0]+h*t[1]+c*t[2]<0}tri(e,a,o,t,r){if(this._giro(e,a,o,r)){let s=a;a=o,o=s}let n=K(r[0],r[1],r[2]);this._cielo=this._cieloFaccia(r),this.c.quadDa(this._v(e,n,t,r),this._v(a,n,t,r),this._v(o,n,t,r),this._v(o,n,t,r))}quad(e,a,o,t,r,n){let s=K(n[0],n[1],n[2]);if(this._cielo=this._cieloFaccia(n),this._giro(e,a,o,n)){let f=a;a=t,t=f}this.c.quadDa(this._v(e,s,r,n),this._v(a,s,r,n),this._v(o,s,r,n),this._v(t,s,r,n))}};function xe(i){if(!i)return!1;let e=j(i);return!e.acqua&&!e.vetro&&!wo.has(e.forma)}function Do(i){return!!i&&i.charCodeAt(0)===97&&i.startsWith("acqua")}function at(i,e,{erba:a=2,luce:o=!0}={}){let t=e.indexOf(","),r=+e.slice(0,t),n=+e.slice(t+1),s=r*F,f=n*F,l=new Ao(1024),u=new Ao(64),m=-1/0,h=new Int16Array(F*F).fill(-1),c=255,d=0,b=1/0,p=-1/0;i.perOgniDelChunk(e,(x,A)=>{A<b&&(b=A),A>p&&(p=A)});let g=o&&b<=p?ot(i,e,b-2,p+3):null,E=new Qo(Number.isFinite(b)?b:0),v=(x,A,T)=>g?g.leggi(x,A,T):[15,0],_=new Ee(l,s,f,v,(x,A,T)=>!xe(i.tipo(x,A,T))),S=new Uint8Array(27),R=(x,A,T,z,N,I,O,Q)=>[x-s,A+Eo,T-f,z,I,O,N,Q?1:0,0];return i.perOgniDelChunk(e,(x,A,T,z)=>{let N=j(z);if(N.forma==="modello"&&N.modello==="albero")for(let U=-2;U<=2;U++)for(let q=-2;q<=2;q++){let G=U*U+q*q;if(G>4)continue;let Y=x+U-s,ro=T+q-f;if(Y<0||Y>=F||ro<0||ro>=F)continue;let $=Y*F+ro,V=A+(G===0?4:G<=2?3:2);V>h[$]&&(h[$]=V)}if(wo.has(N.forma))return;let I=Do(z),O=A+Eo;if(O<0||O>254)return;let Q=(x-s)*F+(T-f);!I&&A>h[Q]&&(h[Q]=A);let L=Be(Ue(z),A);N.motivo&&(L=Ve(L,N.motivo,N.motivoForza??1,x,A,T));let bo=Ge(N);bo&&(L={...L,cima:go(L.cima,bo),lato:go(L.lato,bo),fondo:go(L.fondo,bo)},L.facce&&(L.facce=L.facce.map(U=>U==null?U:go(U,bo))));let Tt=bo?Xe(N.materia):0;if(!I){S.fill(0);for(let $=-1;$<=1;$++)for(let V=-1;V<=1;V++)for(let H=-1;H<=1;H++)H===0&&$===0&&V===0||xe(i.tipo(x+H,A+$,T+V))&&(S[tt(H,$,V)]=1);let U=($,V,H)=>S[tt($,V,H)]===1;_.materia(Tt),_.cella(x,A,T);let q=x+.5,G=A+.5,Y=T+.5,ro=N.forma&&He[N.forma];ro?ro(_,q,G,Y,L,()=>!1):N.cappello&&!U(0,1,0)?We(_,q,G,Y,L,U):je(_,q,G,Y,L,(V,H,P)=>U(V,H,P)?H!==0?!0:!j(i.tipo(x+V,A,T+P)).cappello||U(V,1,P):!1,bo?bo.orlo:0),O-1<c&&(c=O-1),O+2>d&&(d=O+2)}let qo=0,So=0;if(I)for(So=Math.max(0,Math.min(15,De(z)||0));qo<15&&Do(i.tipo(x,A-1-qo,T));)qo++;let _t=(U,q)=>{if(!Do(i.tipo(U,A,q)))return-1;let G=0;for(;G<15&&Do(i.tipo(U,A-1-G,q));)G++;return G},Bo=(U,q)=>{let G=0,Y=0;for(let ro of[U-1,U])for(let $ of[q-1,q]){let V=_t(ro,$);V>=0&&(G+=V,Y++)}return Y?Math.round(G/Y):qo};if(I)for(let[U,q,G,Y,ro,$]of aa){let V=i.tipo(x+U,A+q,T+G);if(V&&(Do(V)||xe(V)))continue;let H=mo(L,ro,$),P=x,w=A,D=T,no,so,co,lo;if(U===1?(no=[P+1,w,D],so=[P+1,w+1,D],co=[P+1,w+1,D+1],lo=[P+1,w,D+1]):U===-1?(no=[P,w,D+1],so=[P,w+1,D+1],co=[P,w+1,D],lo=[P,w,D]):q===1?(no=[P,w+1,D],so=[P,w+1,D+1],co=[P+1,w+1,D+1],lo=[P+1,w+1,D]):q===-1?(no=[P,w,D+1],so=[P,w,D],co=[P+1,w,D],lo=[P+1,w,D+1]):G===1?(no=[P+1,w,D+1],so=[P+1,w+1,D+1],co=[P,w+1,D+1],lo=[P,w,D+1]):(no=[P,w,D],so=[P,w+1,D],co=[P+1,w+1,D],lo=[P+1,w,D]),q===1){let Te=A+(15-2*So)/16;Te>m&&(m=Te)}u.quadDa(R(...no,Y,H,Bo(no[0],no[2]),So,no[1]===w+1),R(...so,Y,H,Bo(so[0],so[2]),So,so[1]===w+1),R(...co,Y,H,Bo(co[0],co[2]),So,co[1]===w+1),R(...lo,Y,H,Bo(lo[0],lo[2]),So,lo[1]===w+1)),O<c&&(c=O),O+1>d&&(d=O+1)}if(N.cappello&&a>0&&!i.tipo(x,A+1,T)){let[U,q]=v(x,A+1,T);E.ciuffo(x,A,T,s,f,L.cima,U,a/2,q),A+2+Eo>d&&(d=A+2+Eo)}}),c>d&&(c=0,d=0),{...l.dati(),minY:c,maxY:d,y0:-Eo,cx:r,cz:n,altezze:h,acqua:{...u.dati(),pelo:m===-1/0?null:m},erba:E.dati()}}function it(i,e,a,o,t){let r=(o-e+1)*F,n=(t-a+1)*F,s=new Uint8Array(r*n);for(let f of i){if(!f.altezze)continue;let l=(f.cx-e)*F,u=(f.cz-a)*F;for(let m=0;m<F;m++)for(let h=0;h<F;h++){let c=f.altezze[m*F+h];s[(u+h)*r+(l+m)]=c<0?0:Math.max(0,Math.min(255,c+1))}}return{byte:s,x0:e*F,z0:a*F,larghezza:r,profondita:n}}function To(i,e,a){let o=i*374761393+e*668265263+a*1442695041|0;return o=Math.imul(o^o>>>13,1274126177),((o^o>>>16)>>>0)/4294967296}function rt(i){return i*i*(3-2*i)}function Ae(i,e,a){let o=Math.floor(i),t=Math.floor(e),r=rt(i-o),n=rt(e-t),s=To(o,t,a),f=To(o+1,t,a),l=To(o,t+1,a),u=To(o+1,t+1,a);return s+(f-s)*r+(l-s)*n+(s-f-l+u)*r*n}var yo=5;function nt(i,e=1,a=64){i.svuota();let o=[],t=[],r=new Map,n=[];for(let u=-a;u<=a;u++)for(let m=-a;m<=a;m++){let h=.55*Ae(u*.028,m*.028,e)+.3*Ae(u*.07,m*.07,e+11)+.15*Ae(u*.16,m*.16,e+29),c=Math.max(2,1+Math.round(Math.pow(Math.max(0,h),1.6)*22)),d=Math.max(Math.abs(u),Math.abs(m)),b=Math.min(1,Math.max(0,(a-2-d)/8)),p=b*b*(3-2*b);c=Math.round(c*p+(yo+1)*(1-p));let g=c<=yo+1;r.set(u+"|"+m,c);for(let E=0;E<c;E++){let _=E===c-1?g?"sabbia":"erba":E<c-3?"roccia":"terra";i.metti(u,E,m,_,!0)}if(c<=yo)for(let E=c;E<=yo;E++)i.metti(u,E,m,"acqua",!0);else if(!g){let E=To(u*3+1,m*3+7,e+101);if(E>.988&&o.length<90?o.push([u,c,m]):E<.004&&t.length<14&&t.push([u,c,m]),c>=yo+6){let v=To(u*5+3,m*5+11,e+57);v>.99&&n.push({x:u,z:m,h:c,r:v})}}}let s=ra(i,r,e,n,a),f=u=>!s.has(u[0]+"|"+u[2]),l=[...s].map(u=>{let[m,h]=u.split("|").map(Number);return[m,r.get(u)-2,h]});return{alberi:o.filter(f),lampioni:t.filter(f),fiume:l}}var ia=[[1,0],[-1,0],[0,1],[0,-1]];function ra(i,e,a,o,t=64){let r=new Set;o.sort((f,l)=>l.h-f.h||f.r-l.r);let n=[];for(let f of o){if(n.length>=5)break;n.every(l=>(l.x-f.x)**2+(l.z-f.z)**2>=784)&&n.push(f)}let s=(f,l)=>{let u=f+"|"+l;if(r.has(u))return;let m=e.get(u);i.togli(f,m-1,l,!0),i.togli(f,m-2,l,!0),i.metti(f,m-2,l,"acqua",!0),r.add(u)};for(let f of n){let l=f.x,u=f.z,m=null,h=0,c=new Set([l+"|"+u]);for(let d=0;d<500;d++){let b=e.get(l+"|"+u);if(s(l,u),m){let v=l+m[1],_=u-m[0];e.get(v+"|"+_)===b&&s(v,_)}let p=null,g=1/0,E=1/0;for(let v of ia){let _=l+v[0],S=u+v[1];if(c.has(_+"|"+S))continue;let R=e.get(_+"|"+S);if(R===void 0)continue;let C=(v===m?-.5:0)+To(_*7+5,S*7+13,a+71);(R<g||R===g&&C<E)&&(p=v,g=R,E=C)}if(!p||g>b||(h=g===b?h+1:0,h>24)||(l+=p[0],u+=p[1],c.add(l+"|"+u),m=p,e.get(l+"|"+u)<=yo)||Math.max(Math.abs(l),Math.abs(u))>=t-6)break}}for(let f of r){let[l,u]=f.split("|").map(Number),m=e.get(f);for(let h=-1;h<=1;h++)for(let c=-1;c<=1;c++){if(!h&&!c)continue;let d=l+h+"|"+(u+c);if(r.has(d))continue;let b=e.get(d);b===void 0||b<m||b>m+1||i.tipo(l+h,b-1,u+c)==="erba"&&(i.togli(l+h,b-1,u+c,!0),i.metti(l+h,b-1,u+c,"sabbia",!0))}}return r}function st(i){let e=new DataView(i);if(String.fromCharCode(e.getUint8(0),e.getUint8(1),e.getUint8(2),e.getUint8(3))!=="LNM1")throw new Error("non \xE8 un modello del nucleo");let a=e.getUint32(4,!0),o=a*3,t=new Uint8Array(i,8,o*16),r=new Uint8Array(i,8+o*16,o*4),n=new Uint8Array(o*20);for(let m=0;m<o;m++)n.set(t.subarray(m*16,m*16+16),m*20),n.set(r.subarray(m*4,m*4+4),m*20+16);let s=1/0,f=-1/0,l=0,u=new DataView(n.buffer);for(let m=0;m<o;m++){let h=u.getFloat32(m*20,!0),c=u.getFloat32(m*20+4,!0),d=u.getFloat32(m*20+8,!0);s=Math.min(s,c),f=Math.max(f,c),l=Math.max(l,Math.hypot(h,d))}return{byte:n,vertici:o,triangoli:a,minY:s,maxY:f,raggio:l}}var na=`#version 300 es
precision highp float;
...
mandami quello.`)}}};var k=document.getElementById("tela"),ba=document.getElementById("stato"),va=document.getElementById("fps"),Z=new URLSearchParams(location.search),y={raggio:+(Z.get("raggio")||5),erba:+(Z.get("erba")??8),ombra:Z.get("ombra")!=="no",specchio:Z.get("specchio")==="no"?0:Math.max(.2,Math.min(1,+(Z.get("specchio")??.5)||.5)),dprMax:+(Z.get("dpr")||1.5),rampa:Z.has("rampa"),tutto:Z.has("tutto"),mondo:Z.has("finto")||Z.has("rampa")?0:Math.max(16,Math.min(400,+(Z.get("mondo")||48))),ora:Z.has("ora")?Math.max(0,Math.min(1,+Z.get("ora"))):null},{gl:Io,dpr:ga,ridimensiona:xa}=_e(k,{antialias:!0,dprMax:y.dprMax}),M=new Xo(Io),oo=new Jo(Io);M.ombra=y.ombra;M.specchio.attivo=y.specchio>0;M.specchio.scala=y.specchio||.5;M.specchio.mostra=Z.has("vedi");var re=0,Ro=0;function bt(i,e){let a=performance.now();for(let r of[...M.chunks.keys()])M.rimuovi(r);re=0;for(let r=-i;r<i;r++)for(let n=-i;n<i;n++)M.carica(r+","+n,Ie(r,n,{erba:e})),re+=256;let o=i*2*16,t=new Uint8Array(o*o);for(let r=0;r<o;r++)for(let n=0;n<o;n++)t[r*o+n]=zo(n-i*16,r-i*16)+1;M.impostaAltezze(t,-i*16,-i*16,o,o),Ro=performance.now()-a}var io=null,vt=0,gt=0;function Ea(i,e){let a=performance.now();for(let h of[...M.chunks.keys()])M.rimuovi(h);Ze(),io=new Ko;let{alberi:o,lampioni:t}=nt(io,4242,i);for(let[h,c,d]of o)io.metti(h,c,d,"albero",!0);for(let[h,c,d]of t)io.metti(h,c,d,"lampione",!0);let r=performance.now()-a,n=[],s=1e9,f=1e9,l=-1e9,u=-1e9;for(let h of io.chunks.keys()){let c=at(io,h,{erba:e});M.carica(h,c),n.push(c),s=Math.min(s,c.cx),l=Math.max(l,c.cx),f=Math.min(f,c.cz),u=Math.max(u,c.cz)}let m=it(n,s,f,l,u);return M.impostaAltezze(m.byte,m.x0,m.z0,m.larghezza,m.profondita),re=vt=io.contaBlocchi,gt=n.length,Ro=performance.now()-a,{tGen:r,tMesh:Ro-r}}var Me=null;y.mondo?Me=Ea(y.mondo,y.erba):bt(y.raggio,y.erba);async function Aa(){if(!io)return;let i=new Map;io.perOgni((e,a,o,t)=>{let r=j(t);r.forma!=="modello"||!r.modello||(i.has(r.modello)||i.set(r.modello,[]),i.get(r.modello).push(e+.5,a,o+.5,1))});for(let[e,a]of i)try{let o=await fetch(`./modelli/nucleo/${e}.bin`);if(!o.ok)throw new Error(`${o.status}`);oo.registra(e,st(await o.arrayBuffer())),oo.istanze(e,a)}catch(o){console.warn(`modello ${e}: ${o.message}`)}}Aa();M.tutto=y.tutto;var Ma=()=>{if(!io)return zo(0,0)+2;for(let i=120;i>-Eo;i--)if(io.tipo(0,i,0))return i+2;return 8},B={alpha:-.8,beta:1.05,raggio:46,centro:[0,Ma(),0],fov:.9};function xt(){let i=Math.sin(B.beta),e=Math.cos(B.beta);return[B.centro[0]+B.raggio*i*Math.cos(B.alpha),B.centro[1]+B.raggio*e,B.centro[2]+B.raggio*i*Math.sin(B.alpha)]}var Lo=null,ee=0;k.addEventListener("pointerdown",i=>{Lo={x:i.clientX,y:i.clientY},k.setPointerCapture(i.pointerId)});k.addEventListener("pointermove",i=>{Lo&&(B.alpha+=(i.clientX-Lo.x)*.006,B.beta=Math.max(.15,Math.min(1.5,B.beta-(i.clientY-Lo.y)*.006)),Lo={x:i.clientX,y:i.clientY})});k.addEventListener("pointerup",()=>{Lo=null});k.addEventListener("wheel",i=>{B.raggio=Math.max(8,Math.min(140,B.raggio*(i.deltaY>0?1.1:.9))),i.preventDefault()},{passive:!1});k.addEventListener("touchstart",i=>{i.touches.length===2&&(ee=Math.hypot(i.touches[0].clientX-i.touches[1].clientX,i.touches[0].clientY-i.touches[1].clientY))},{passive:!0});k.addEventListener("touchmove",i=>{if(i.touches.length!==2)return;let e=Math.hypot(i.touches[0].clientX-i.touches[1].clientX,i.touches[0].clientY-i.touches[1].clientY);ee>0&&(B.raggio=Math.max(8,Math.min(140,B.raggio*ee/e))),ee=e},{passive:!0});var te=y.ora??.35;function Ta(i){y.ora===null&&(te=(te+i/300)%1);let e=te*Math.PI*2-Math.PI/2,a=.24+.5*Math.max(0,Math.sin(e)),o=e*.5;M.sole.verso=[-Math.cos(o)*Math.cos(Math.asin(a)),-a,-Math.sin(o)*Math.cos(Math.asin(a))];let t=Math.max(0,Math.min(1,(Math.sin(e)+.1)*2));M.sole.forza=t;let r=Math.min(1,Math.max(0,(a-.24)/.4));M.sole.colore=[1,.78+.22*r,.55+.45*r],M.sole.cielo=[.36+.64*t,.38+.62*t,.57+.43*t],M.nebbia.colore=[.25+.47*t,.35+.5*t,.5+.42*t],Io.clearColor(M.nebbia.colore[0],M.nebbia.colore[1],M.nebbia.colore[2],1)}var W=[],po=[],ae=[],mt=performance.now(),Et=0,pt=0;function At(i){let e=Math.min(.1,(i-mt)/1e3);mt=i;let a=performance.now();xa(),Ta(e);let t={occhio:xt(),centro:B.centro,fov:B.fov,rapporto:k.width/k.height};M.disegna(t,e,oo),oo.disegna(M,t),M.disegnaAcqua();let r=performance.now()-a;W.push(e*1e3),W.length>240&&W.shift(),po.push(r),po.length>240&&po.shift(),Et++,i-pt>500&&(pt=i,Mt()),y.rampa&&!y.mondo&&_a(i),requestAnimationFrame(At)}var ie=[{raggio:5,erba:2,tutto:!1},{raggio:6,erba:3,tutto:!1},{raggio:7,erba:4,tutto:!1},{raggio:6,erba:3,tutto:!0},{raggio:8,erba:4,tutto:!0}],ne=[],_o=-1,dt=0;function _a(i){if(_o>=0&&i-dt<6e3)return;if(_o>=0){let a=W.slice(-Math.min(W.length,200)),o=ie[_o];ne.push({...o,fps:+(1e3/(X(a,.5)||1)).toFixed(0),p50:+X(a,.5).toFixed(1),p99:+X(a,.99).toFixed(1),js:+X(po,.5).toFixed(2),disegni:M.statistiche.disegni,triangoli:M.statistiche.triangoli})}if(_o++,_o>=ie.length){y.rampa=!1,Mt();return}let e=ie[_o];bt(e.raggio,e.erba),M.tutto=e.tutto,y.erba=e.erba,y.raggio=e.raggio,W.length=0,po.length=0,dt=i}var X=(i,e)=>{if(!i.length)return 0;let a=i.slice().sort((o,t)=>o-t);return a[Math.min(a.length-1,Math.floor(a.length*e))]};function Mt(){let i=X(W,.5),e=X(W,.99),a=i?1e3/i:0;ae.push(Math.round(a)),ae.length>120&&ae.shift();let o={disegni:M.statistiche.disegni+oo.statistiche.disegni+M.statistiche.disegniAcqua+M.statistiche.disegniErba+M.statistiche.disegniSpecchio,triangoli:M.statistiche.triangoli+oo.statistiche.triangoli+M.statistiche.triangoliAcqua+M.statistiche.triangoliErba+M.statistiche.triangoliSpecchio,chunkVisti:M.statistiche.chunkVisti,chunkTotali:M.statistiche.chunkTotali};va.textContent=`${a.toFixed(0)} fps
${i.toFixed(1)} / ${e.toFixed(1)} ms
JS ${X(po,.5).toFixed(2)} ms`,ba.textContent=`NUCLEO ${y.mondo?`F1 \xB7 open world vero (semilato ${y.mondo}, ${gt} chunk, ${vt.toLocaleString("it")} blocchi, gen ${Me.tGen.toFixed(0)} ms + mesh ${Me.tMesh.toFixed(0)} ms)`:"F0"} \xB7 ${k.width}\xD7${k.height} (dpr ${ga.toFixed(2)})
disegni ${o.disegni}  triangoli ${o.triangoli.toLocaleString("it")}  chunk ${o.chunkVisti}/${o.chunkTotali}
ombra del sole: ${M.ombra?"horizon mapping":"spenta"} \xB7 erba ${y.erba} \xB7 modelli ${oo.statistiche.istanze} istanze in ${oo.statistiche.disegni} disegni \xB7 acqua ${M.statistiche.disegniAcqua} disegni${M.statistiche.pelo!=null?` + specchio ${M.statistiche.disegniSpecchio} disegni (pelo ${M.statistiche.pelo.toFixed(2)}, scala ${M.specchio.scala})`:" (senza specchio)"} \xB7 erba ${M.statistiche.triangoliErba.toLocaleString("it")} fili in ${M.statistiche.disegniErba} disegni \xB7 costruzione ${Ro.toFixed(0)} ms
${Vo(Io)}
...
`):"")+(y.rampa?`
rampa: gradino ${_o+1}/${ie.length}\u2026`:"")}requestAnimationFrame(At);var Ra=new oe(()=>({versione:(document.getElementById("versione")||{}).textContent||"nucleo in sviluppo",mobile:matchMedia("(pointer: coarse)").matches,tocco:navigator.maxTouchPoints>0,modoGui:"nucleo",ua:navigator.userAgent,cpu:navigator.hardwareConcurrency||null,memoriaGB:navigator.deviceMemory||null,css:[k.clientWidth,k.clientHeight],reso:[k.width,k.height],dpr:devicePixelRatio,livello:0,quantiLivelli:1,manuale:!0,profilo:{banco:y.mondo?"nucleo F1 mondo vero":"nucleo F0",mondo:y.mondo,raggio:y.raggio,erba:y.erba,ombra:M.ombra,specchio:y.specchio,disegniSpecchio:M.statistiche.disegniSpecchio,tutto:!!M.tutto,dprMax:y.dprMax,jsMs:+X(po,.5).toFixed(2),jsP99:+X(po,.99).toFixed(2),rampa:ne},ombreLampade:!1,antialias:!0,fps:X(W,.5)?1e3/X(W,.5):null,p50:X(W,.5),p99:X(W,.99),disegni:M.statistiche.disegni+oo.statistiche.disegni+M.statistiche.disegniAcqua+M.statistiche.disegniErba+M.statistiche.disegniSpecchio,triangoli:M.statistiche.triangoli+oo.statistiche.triangoli+M.statistiche.triangoliAcqua+M.statistiche.triangoliErba+M.statistiche.triangoliSpecchio,ombreMs:0,storiaFps:ae,storiaLivelli:[],scheda:Vo(Io),software:/swiftshader|llvmpipe/i.test(Vo(Io)),chunk:M.statistiche.chunkTotali,blocchi:re,luci:0,decorazioni:oo.statistiche.istanze,erba:M.statistiche.triangoliErba,ora:`${Math.floor(te*24)}h`,giorno:0,worldgenMs:Ro,meshMs:Ro}),()=>{let i=xt();return M.disegna({occhio:i,centro:B.centro,fov:B.fov,rapporto:k.width/k.height},0),Promise.resolve(k.toDataURL("image/webp",.6))});globalThis.NUCLEO={resa:M,modelli:oo,cam:B,opz:y,statistiche:()=>({fps:1e3/(X(W,.5)||1),p50:X(W,.5),p99:X(W,.99),js:X(po,.5),...M.statistiche,modelli:{...oo.statistiche},costruzioneMs:Ro,fotogrammi:Et}),diagnostica:Ra};

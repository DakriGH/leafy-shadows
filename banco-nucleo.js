...
${r.split(`
`).map((f,c)=>`${c+1}: ${f}`).join(`
`)}`);return l},a=i.createProgram();if(i.attachShader(a,o(i.VERTEX_SHADER,e)),i.attachShader(a,o(i.FRAGMENT_SHADER,t)),i.linkProgram(a),!i.getProgramParameter(a,i.LINK_STATUS))throw new Error(`programma: ${i.getProgramInfoLog(a)}`);return a}function ke(i){let e=i.getExtension("WEBGL_debug_renderer_info");return e?i.getParameter(e.UNMASKED_RENDERER_WEBGL):i.getParameter(i.RENDERER)}function K(i,e,t){return(Math.sign(i)+1)*9+(Math.sign(e)+1)*3+(Math.sign(t)+1)}var _a=K(1,0,0),Ia=K(-1,0,0),Na=K(0,1,0),ya=K(0,-1,0),qa=K(0,0,1),Fa=K(0,0,-1);var Oo=[_a,Ia,Na,ya,qa,Fa],ze=class{constructor(e=1024){this.byte=new Uint8Array(e*4*12),this.u32=new Uint32Array(this.byte.buffer),this.n=0,this.quad=0}_spazio(e){let t=(this.n+e)*12;if(t<=this.byte.length)return;let o=this.byte.length*2;for(;o<t;)o*=2;let a=new Uint8Array(o);a.set(this.byte),this.byte=a,this.u32=new Uint32Array(a.buffer)}vertice(e,t,o,a,n,r,l,f=0,c=0){let u=Math.round(e*16)+16,p=Math.round(o*16)+16,m=Math.round(t*16);if(u<0||u>511||p<0||p>511||m<0||m>65535)throw new RangeError(`vertice fuori dal chunk: ${e},${t},${o}`);if(a<0||a>26||a===13)throw new RangeError(`normale non valida: ${a}`);this._spazio(1);let s=this.n*3,d=this.byte,g=this.u32;g[s]=(u|p<<9|(a&31)<<18|(f&1)<<23|(c&15)<<24)>>>0,g[s+1]=(m|(n&15)<<16|(r&15)<<20)>>>0;let h=this.n*12+8;d[h]=l>>16&255,d[h+1]=l>>8&255,d[h+2]=l&255,d[h+3]=0,this.n++}quadDa(e,t,o,a){if(this.quad>=16384)throw new RangeError("troppi quad per un chunk");for(let n of[e,t,o,a])this.vertice(...n);this.quad++}dati(){return{byte:this.byte.subarray(0,this.n*12),quad:this.quad,vertici:this.n,triangoli:this.quad*2}}};function _o(i=16384){let e=new Uint16Array(i*6);for(let t=0,o=0,a=0;t<i;t++,a+=4)e[o++]=a,e[o++]=a+1,e[o++]=a+2,e[o++]=a,e[o++]=a+2,e[o++]=a+3;return e}function Io(i,e,t,o){let a=1/Math.tan(i/2),n=1/(t-o);return new Float32Array([a/e,0,0,0,0,a,0,0,0,0,(o+t)*n,-1,0,0,2*o*t*n,0])}function uo(i,e,t){let o=1/(t-e);return new Float32Array([1/i,0,0,0,0,1/i,0,0,0,0,-2*o,0,0,0,-(t+e)*o,1])}function Xe(i,e,t=[0,1,0]){let o=i[0]-e[0],a=i[1]-e[1],n=i[2]-e[2],r=Math.hypot(o,a,n)||1;o/=r,a/=r,n/=r;let l=t[1]*n-t[2]*a,f=t[2]*o-t[0]*n,c=t[0]*a-t[1]*o;r=Math.hypot(l,f,c)||1,l/=r,f/=r,c/=r;let u=a*c-n*f,p=n*l-o*c,m=o*f-a*l;return new Float32Array([l,u,o,0,f,p,a,0,c,m,n,0,-(l*i[0]+f*i[1]+c*i[2]),-(u*i[0]+p*i[1]+m*i[2]),-(o*i[0]+a*i[1]+n*i[2]),1])}function No(i,e=new Float32Array(16)){let[t,o,a,n,r,l,f,c,u,p,m,s,d,g,h,b]=i,x=t*l-o*r,v=t*f-a*r,z=t*c-n*r,L=o*f-a*l,R=o*c-n*l,C=a*c-n*f,A=u*g-p*d,I=u*h-m*d,O=u*b-s*d,E=p*h-m*g,M=p*b-s*g,S=m*b-s*h,N=x*S-v*M+z*E+L*O-R*I+C*A;return N?(N=1/N,e[0]=(l*S-f*M+c*E)*N,e[1]=(a*M-o*S-n*E)*N,e[2]=(g*C-h*R+b*L)*N,e[3]=(m*R-p*C-s*L)*N,e[4]=(f*O-r*S-c*I)*N,e[5]=(t*S-a*O+n*I)*N,e[6]=(h*z-d*C-b*v)*N,e[7]=(u*C-m*z+s*v)*N,e[8]=(r*M-l*O+c*A)*N,e[9]=(o*O-t*M-n*A)*N,e[10]=(d*R-g*z+b*x)*N,e[11]=(p*z-u*R-s*x)*N,e[12]=(l*I-r*E-f*A)*N,e[13]=(t*E-o*I+a*A)*N,e[14]=(g*v-d*L-h*x)*N,e[15]=(u*L-p*v+m*x)*N,e):null}function Pe(i,e,t=new Float32Array(16)){for(let o=0;o<4;o++)for(let a=0;a<4;a++)t[o*4+a]=i[a]*e[o*4]+i[4+a]*e[o*4+1]+i[8+a]*e[o*4+2]+i[12+a]*e[o*4+3];return t}function fo(i,e=new Float32Array(24)){let t=f=>[i[f],i[4+f],i[8+f],i[12+f]],o=t(0),a=t(1),n=t(2),r=t(3),l=[[r[0]+o[0],r[1]+o[1],r[2]+o[2],r[3]+o[3]],[r[0]-o[0],r[1]-o[1],r[2]-o[2],r[3]-o[3]],[r[0]+a[0],r[1]+a[1],r[2]+a[2],r[3]+a[3]],[r[0]-a[0],r[1]-a[1],r[2]-a[2],r[3]-a[3]],[r[0]+n[0],r[1]+n[1],r[2]+n[2],r[3]+n[3]],[r[0]-n[0],r[1]-n[1],r[2]-n[2],r[3]-n[3]]];for(let f=0;f<6;f++){let[c,u,p,m]=l[f],s=Math.hypot(c,u,p)||1;e[f*4]=c/s,e[f*4+1]=u/s,e[f*4+2]=p/s,e[f*4+3]=m/s}return e}function mo(i,e,t,o,a,n,r){for(let l=0;l<6;l++){let f=i[l*4],c=i[l*4+1],u=i[l*4+2],p=i[l*4+3],m=f>0?a:e,s=c>0?n:t,d=u>0?r:o;if(f*m+c*s+u*d+p<0)return!1}return!0}var po=2,Da=`#version 300 es
...
mandami quello.`)}}};var Y=document.getElementById("tela"),At=document.getElementById("stato"),Tt=document.getElementById("fps"),ee=new URLSearchParams(location.search),y={raggio:+(ee.get("raggio")||5),erba:+(ee.get("erba")??8),ombra:ee.get("ombra")!=="no",specchio:ee.get("specchio")==="no"?0:Math.max(.2,Math.min(1,+(ee.get("specchio")??.5)||.5)),dprMax:+(ee.get("dpr")||1.5),rampa:ee.has("rampa"),tutto:ee.has("tutto"),mondo:ee.has("finto")||ee.has("rampa")?0:Math.max(16,Math.min(400,+(ee.get("mondo")||48))),ora:ee.has("ora")?Math.max(0,Math.min(1,+ee.get("ora"))):null},{gl:Fe,dpr:zt,ridimensiona:Mt}=Co(Y,{antialias:!0,dprMax:y.dprMax}),T=new He(Fe),ae=new ao(Fe);T.ombra=y.ombra;T.specchio.attivo=y.specchio>0;T.specchio.scala=y.specchio||.5;T.specchio.mostra=ee.has("vedi");var so=0,Le=0;function Aa(i,e){let t=performance.now();for(let n of[...T.chunks.keys()])T.rimuovi(n);so=0;for(let n=-i;n<i;n++)for(let r=-i;r<i;r++)T.carica(n+","+r,Do(n,r,{erba:e})),so+=256;let o=i*2*16,a=new Uint8Array(o*o);for(let n=0;n<o;n++)for(let r=0;r<o;r++)a[n*o+r]=Oe(r-i*16,n-i*16)+1;T.impostaAltezze(a,-i*16,-i*16,o,o),Le=performance.now()-t}var re=null,Ta=0,za=0;function Rt(i,e){let t=performance.now();for(let m of[...T.chunks.keys()])T.rimuovi(m);oa(),re=new Ke;let{alberi:o,lampioni:a}=fa(re,4242,i);for(let[m,s,d]of o)re.metti(m,s,d,"albero",!0);for(let[m,s,d]of a)re.metti(m,s,d,"lampione",!0);let n=performance.now()-t,r=[],l=1e9,f=1e9,c=-1e9,u=-1e9;for(let m of re.chunks.keys()){let s=sa(re,m,{erba:e});T.carica(m,s),r.push(s),l=Math.min(l,s.cx),c=Math.max(c,s.cx),f=Math.min(f,s.cz),u=Math.max(u,s.cz)}let p=ca(r,l,f,c,u);return T.impostaAltezze(p.byte,p.x0,p.z0,p.larghezza,p.profondita),so=Ta=re.contaBlocchi,za=r.length,Le=performance.now()-t,{tGen:n,tMesh:Le-n}}var So=null;y.mondo?So=Rt(y.mondo,y.erba):Aa(y.raggio,y.erba);async function St(){if(!re)return;let i=new Map;re.perOgni((e,t,o,a)=>{let n=W(a);n.forma!=="modello"||!n.modello||(i.has(n.modello)||i.set(n.modello,[]),i.get(n.modello).push(e+.5,t,o+.5,1))});for(let[e,t]of i)try{let o=await fetch(`./modelli/nucleo/${e}.bin`);if(!o.ok)throw new Error(`${o.status}`);ae.registra(e,ma(await o.arrayBuffer())),ae.istanze(e,t)}catch(o){console.warn(`modello ${e}: ${o.message}`)}}St();T.tutto=y.tutto;var Lt=()=>{if(!re)return Oe(0,0)+2;for(let i=120;i>-Ae;i--)if(re.tipo(0,i,0))return i+2;return 8},G={alpha:-.8,beta:1.05,raggio:46,centro:[0,Lt(),0],fov:.9};function Ma(){let i=Math.sin(G.beta),e=Math.cos(G.beta);return[G.centro[0]+G.raggio*i*Math.cos(G.alpha),G.centro[1]+G.raggio*e,G.centro[2]+G.raggio*i*Math.sin(G.alpha)]}var qe=null,io=0;Y.addEventListener("pointerdown",i=>{qe={x:i.clientX,y:i.clientY},Y.setPointerCapture(i.pointerId)});Y.addEventListener("pointermove",i=>{qe&&(G.alpha+=(i.clientX-qe.x)*.006,G.beta=Math.max(.15,Math.min(1.5,G.beta-(i.clientY-qe.y)*.006)),qe={x:i.clientX,y:i.clientY})});Y.addEventListener("pointerup",()=>{qe=null});Y.addEventListener("wheel",i=>{G.raggio=Math.max(8,Math.min(140,G.raggio*(i.deltaY>0?1.1:.9))),i.preventDefault()},{passive:!1});Y.addEventListener("touchstart",i=>{i.touches.length===2&&(io=Math.hypot(i.touches[0].clientX-i.touches[1].clientX,i.touches[0].clientY-i.touches[1].clientY))},{passive:!0});Y.addEventListener("touchmove",i=>{if(i.touches.length!==2)return;let e=Math.hypot(i.touches[0].clientX-i.touches[1].clientX,i.touches[0].clientY-i.touches[1].clientY);io>0&&(G.raggio=Math.max(8,Math.min(140,G.raggio*io/e))),io=e},{passive:!0});var no=y.ora??.35;function Ct(i){y.ora===null&&(no=(no+i/300)%1);let e=no*Math.PI*2-Math.PI/2,t=.24+.5*Math.max(0,Math.sin(e)),o=e*.5;T.sole.verso=[-Math.cos(o)*Math.cos(Math.asin(t)),-t,-Math.sin(o)*Math.cos(Math.asin(t))];let a=Math.max(0,Math.min(1,(Math.sin(e)+.1)*2));T.sole.forza=a;let n=Math.min(1,Math.max(0,(t-.24)/.4));T.sole.colore=[1,.78+.22*n,.55+.45*n],T.sole.cielo=[.36+.64*a,.38+.62*a,.57+.43*a],T.nebbia.colore=[.25+.47*a,.35+.5*a,.5+.42*a],Fe.clearColor(T.nebbia.colore[0],T.nebbia.colore[1],T.nebbia.colore[2],1)}var Q=[],ge=[],ro=[],ba=performance.now(),Ra=0,xa=0;function Sa(i){let e=Math.min(.1,(i-ba)/1e3);ba=i;let t=performance.now();Mt(),Ct(e);let a={occhio:Ma(),centro:G.centro,fov:G.fov,rapporto:Y.width/Y.height};T.disegna(a,e,ae),ae.disegna(T,a),T.disegnaAcqua();let n=performance.now()-t;Q.push(e*1e3),Q.length>240&&Q.shift(),ge.push(n),ge.length>240&&ge.shift(),Ra++,i-xa>500&&(xa=i,La()),y.rampa&&!y.mondo&&Ot(i),requestAnimationFrame(Sa)}var lo=[{raggio:5,erba:2,tutto:!1},{raggio:6,erba:3,tutto:!1},{raggio:7,erba:4,tutto:!1},{raggio:6,erba:3,tutto:!0},{raggio:8,erba:4,tutto:!0}],co=[],Se=-1,Ea=0;function Ot(i){if(Se>=0&&i-Ea<6e3)return;if(Se>=0){let t=Q.slice(-Math.min(Q.length,200)),o=lo[Se];co.push({...o,fps:+(1e3/(H(t,.5)||1)).toFixed(0),p50:+H(t,.5).toFixed(1),p99:+H(t,.99).toFixed(1),js:+H(ge,.5).toFixed(2),disegni:T.statistiche.disegni,triangoli:T.statistiche.triangoli})}if(Se++,Se>=lo.length){y.rampa=!1,La();return}let e=lo[Se];Aa(e.raggio,e.erba),T.tutto=e.tutto,y.erba=e.erba,y.raggio=e.raggio,Q.length=0,ge.length=0,Ea=i}var H=(i,e)=>{if(!i.length)return 0;let t=i.slice().sort((o,a)=>o-a);return t[Math.min(t.length-1,Math.floor(t.length*e))]};function La(){let i=H(Q,.5),e=H(Q,.99),t=i?1e3/i:0;ro.push(Math.round(t)),ro.length>120&&ro.shift();let o={disegni:T.statistiche.disegni+ae.statistiche.disegni+T.statistiche.disegniAcqua+T.statistiche.disegniErba+T.statistiche.disegniSpecchio,triangoli:T.statistiche.triangoli+ae.statistiche.triangoli+T.statistiche.triangoliAcqua+T.statistiche.triangoliErba+T.statistiche.triangoliSpecchio,chunkVisti:T.statistiche.chunkVisti,chunkTotali:T.statistiche.chunkTotali};Tt.textContent=`${t.toFixed(0)} fps
${i.toFixed(1)} / ${e.toFixed(1)} ms
JS ${H(ge,.5).toFixed(2)} ms`,At.textContent=`NUCLEO ${y.mondo?`F1 \xB7 open world vero (semilato ${y.mondo}, ${za} chunk, ${Ta.toLocaleString("it")} blocchi, gen ${So.tGen.toFixed(0)} ms + mesh ${So.tMesh.toFixed(0)} ms)`:"F0"} \xB7 ${Y.width}\xD7${Y.height} (dpr ${zt.toFixed(2)})
disegni ${o.disegni}  triangoli ${o.triangoli.toLocaleString("it")}  chunk ${o.chunkVisti}/${o.chunkTotali}
ombra del sole: ${T.ombra?"horizon mapping":"spenta"} \xB7 erba ${y.erba} \xB7 modelli ${ae.statistiche.istanze} istanze in ${ae.statistiche.disegni} disegni \xB7 acqua ${T.statistiche.disegniAcqua} disegni${T.statistiche.pelo!=null?` + specchio ${T.statistiche.disegniSpecchio} disegni (pelo ${T.statistiche.pelo.toFixed(2)}, scala ${T.specchio.scala})`:" (senza specchio)"} \xB7 erba ${T.statistiche.triangoliErba.toLocaleString("it")} fili in ${T.statistiche.disegniErba} disegni \xB7 costruzione ${Le.toFixed(0)} ms
${ke(Fe)}

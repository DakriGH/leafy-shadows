...
${n.split(`
`).map((u,l)=>`${l+1}: ${u}`).join(`
`)}`);return s},t=i.createProgram();if(i.attachShader(t,o(i.VERTEX_SHADER,e)),i.attachShader(t,o(i.FRAGMENT_SHADER,a)),i.linkProgram(t),!i.getProgramParameter(t,i.LINK_STATUS))throw new Error(`programma: ${i.getProgramInfoLog(t)}`);return t}function Bo(i){let e=i.getExtension("WEBGL_debug_renderer_info");return e?i.getParameter(e.UNMASKED_RENDERER_WEBGL):i.getParameter(i.RENDERER)}function Y(i,e,a){return(Math.sign(i)+1)*9+(Math.sign(e)+1)*3+(Math.sign(a)+1)}var Tt=Y(1,0,0),_t=Y(-1,0,0),Rt=Y(0,1,0),St=Y(0,-1,0),Ct=Y(0,0,1),zt=Y(0,0,-1);var _e=[Tt,_t,Rt,St,Ct,zt],Mo=class{constructor(e=1024){this.byte=new Uint8Array(e*4*12),this.u32=new Uint32Array(this.byte.buffer),this.n=0,this.quad=0}_spazio(e){let a=(this.n+e)*12;if(a<=this.byte.length)return;let o=this.byte.length*2;for(;o<a;)o*=2;let t=new Uint8Array(o);t.set(this.byte),this.byte=t,this.u32=new Uint32Array(t.buffer)}vertice(e,a,o,t,r,n,s,u=0,l=0){let f=Math.round(e*16)+16,m=Math.round(o*16)+16,h=Math.round(a*16);if(f<0||f>511||m<0||m>511||h<0||h>65535)throw new RangeError(`vertice fuori dal chunk: ${e},${a},${o}`);if(t<0||t>26||t===13)throw new RangeError(`normale non valida: ${t}`);this._spazio(1);let c=this.n*3,d=this.byte,b=this.u32;b[c]=(f|m<<9|(t&31)<<18|(u&1)<<23|(l&15)<<24)>>>0,b[c+1]=(h|(r&15)<<16|(n&15)<<20)>>>0;let p=this.n*12+8;d[p]=s>>16&255,d[p+1]=s>>8&255,d[p+2]=s&255,d[p+3]=0,this.n++}quadDa(e,a,o,t){if(this.quad>=16384)throw new RangeError("troppi quad per un chunk");for(let r of[e,a,o,t])this.vertice(...r);this.quad++}dati(){return{byte:this.byte.subarray(0,this.n*12),quad:this.quad,vertici:this.n,triangoli:this.quad*2}}};function Re(i=16384){let e=new Uint16Array(i*6);for(let a=0,o=0,t=0;a<i;a++,t+=4)e[o++]=t,e[o++]=t+1,e[o++]=t+2,e[o++]=t,e[o++]=t+2,e[o++]=t+3;return e}function Se(i,e,a,o){let t=1/Math.tan(i/2),r=1/(a-o);return new Float32Array([t/e,0,0,0,0,t,0,0,0,0,(o+a)*r,-1,0,0,2*o*a*r,0])}function ie(i,e,a){let o=1/(a-e);return new Float32Array([1/i,0,0,0,0,1/i,0,0,0,0,-2*o,0,0,0,-(a+e)*o,1])}function qo(i,e,a=[0,1,0]){let o=i[0]-e[0],t=i[1]-e[1],r=i[2]-e[2],n=Math.hypot(o,t,r)||1;o/=n,t/=n,r/=n;let s=a[1]*r-a[2]*t,u=a[2]*o-a[0]*r,l=a[0]*t-a[1]*o;n=Math.hypot(s,u,l)||1,s/=n,u/=n,l/=n;let f=t*l-r*u,m=r*s-o*l,h=o*u-t*s;return new Float32Array([s,f,o,0,u,m,t,0,l,h,r,0,-(s*i[0]+u*i[1]+l*i[2]),-(f*i[0]+m*i[1]+h*i[2]),-(o*i[0]+t*i[1]+r*i[2]),1])}function Ce(i,e=new Float32Array(16)){let[a,o,t,r,n,s,u,l,f,m,h,c,d,b,p,T]=i,x=a*s-o*n,v=a*u-t*n,_=a*l-r*n,C=o*u-t*s,R=o*l-r*s,z=t*l-r*u,g=f*b-m*d,E=f*p-h*d,M=f*T-c*d,S=m*p-h*b,N=m*T-c*b,I=h*T-c*p,O=x*I-v*N+_*S+C*M-R*E+z*g;return O?(O=1/O,e[0]=(s*I-u*N+l*S)*O,e[1]=(t*N-o*I-r*S)*O,e[2]=(b*z-p*R+T*C)*O,e[3]=(h*R-m*z-c*C)*O,e[4]=(u*M-n*I-l*E)*O,e[5]=(a*I-t*M+r*E)*O,e[6]=(p*_-d*z-T*v)*O,e[7]=(f*z-h*_+c*v)*O,e[8]=(n*N-s*M+l*g)*O,e[9]=(o*M-a*N-r*g)*O,e[10]=(d*R-b*_+T*x)*O,e[11]=(m*_-f*R-c*x)*O,e[12]=(s*E-n*S-u*g)*O,e[13]=(a*S-o*E+t*g)*O,e[14]=(b*v-d*C-p*x)*O,e[15]=(f*C-m*v+h*x)*O,e):null}function Po(i,e,a=new Float32Array(16)){for(let o=0;o<4;o++)for(let t=0;t<4;t++)a[o*4+t]=i[t]*e[o*4]+i[4+t]*e[o*4+1]+i[8+t]*e[o*4+2]+i[12+t]*e[o*4+3];return a}function re(i,e=new Float32Array(24)){let a=u=>[i[u],i[4+u],i[8+u],i[12+u]],o=a(0),t=a(1),r=a(2),n=a(3),s=[[n[0]+o[0],n[1]+o[1],n[2]+o[2],n[3]+o[3]],[n[0]-o[0],n[1]-o[1],n[2]-o[2],n[3]-o[3]],[n[0]+t[0],n[1]+t[1],n[2]+t[2],n[3]+t[3]],[n[0]-t[0],n[1]-t[1],n[2]-t[2],n[3]-t[3]],[n[0]+r[0],n[1]+r[1],n[2]+r[2],n[3]+r[3]],[n[0]-r[0],n[1]-r[1],n[2]-r[2],n[3]-r[3]]];for(let u=0;u<6;u++){let[l,f,m,h]=s[u],c=Math.hypot(l,f,m)||1;e[u*4]=l/c,e[u*4+1]=f/c,e[u*4+2]=m/c,e[u*4+3]=h/c}return e}function ne(i,e,a,o,t,r,n){for(let s=0;s<6;s++){let u=i[s*4],l=i[s*4+1],f=i[s*4+2],m=i[s*4+3],h=u>0?t:e,c=l>0?r:a,d=f>0?n:o;if(u*h+l*c+f*d+m<0)return!1}return!0}var Ft=`#version 300 es
...
void main() {
  ...
  // tre volte dal committente: \xABa bordo dei blocchi vedo ancora un leggero
  // face shading e abbiamo detto di non farlo\xBB): tutte le facce, smussi
...
void main() {
  ...
  // la normale del pelo: onde lunghe pi\xF9 increspature, e il meteo decide quanto \xE8 mossa
...
void main() { colore = vec4(texture(uTex, vUv).rgb, 1.0); }`),this.uQuad=e.getUniformLocation(this.programmaQuad,"uTex"),this.vaoQuad=e.createVertexArray()),e.useProgram(this.programmaQuad),e.activeTexture(e.TEXTURE0),e.bindTexture(e.TEXTURE_2D,a.tex),e.uniform1i(this.uQuad,0),e.bindVertexArray(this.vaoQuad),e.disable(e.DEPTH_TEST),e.drawArrays(e.TRIANGLE_STRIP,0,4),e.enable(e.DEPTH_TEST),e.bindVertexArray(null)}_preparaSpecchio(e,a){let o=this.gl,t=this.specchio;t.fbo||(t.fbo=o.createFramebuffer(),t.tex=o.createTexture(),t.rbo=o.createRenderbuffer()),o.bindTexture(o.TEXTURE_2D,t.tex),o.texImage2D(o.TEXTURE_2D,0,o.RGBA8,e,a,0,o.RGBA,o.UNSIGNED_BYTE,null),o.texParameteri(o.TEXTURE_2D,o.TEXTURE_MIN_FILTER,o.LINEAR),o.texParameteri(o.TEXTURE_2D,o.TEXTURE_MAG_FILTER,o.LINEAR),o.texParameteri(o.TEXTURE_2D,o.TEXTURE_WRAP_S,o.CLAMP_TO_EDGE),o.texParameteri(o.TEXTURE_2D,o.TEXTURE_WRAP_T,o.CLAMP_TO_EDGE),o.bindRenderbuffer(o.RENDERBUFFER,t.rbo),o.renderbufferStorage(o.RENDERBUFFER,o.DEPTH_COMPONENT16,e,a),o.bindFramebuffer(o.FRAMEBUFFER,t.fbo),o.framebufferTexture2D(o.FRAMEBUFFER,o.COLOR_ATTACHMENT0,o.TEXTURE_2D,t.tex,0),o.framebufferRenderbuffer(o.FRAMEBUFFER,o.DEPTH_ATTACHMENT,o.RENDERBUFFER,t.rbo),o.checkFramebufferStatus(o.FRAMEBUFFER)!==o.FRAMEBUFFER_COMPLETE&&(t.attivo=!1,console.warn("specchio: framebuffer incompleto, spento")),o.bindFramebuffer(o.FRAMEBUFFER,null),o.bindTexture(o.TEXTURE_2D,null),t.w=e,t.h=a}disegnaAcqua(){let e=this.gl,a=this.ua,o=this.sole,t=this._camera,r=this.specchio;if(!t||this._visibili.length===0){this.statistiche.disegniAcqua=0;return}e.useProgram(this.programmaAcqua),e.uniformMatrix4fv(a.uVP,!1,this.vp),e.uniform1f(a.uTempo,this.tempo),e.uniform3f(a.uCam,t.occhio[0],t.occhio[1],t.occhio[2]),e.uniform2f(a.uNebbia,this.nebbia.da,this.nebbia.a),e.uniform3f(a.uSoleVerso,o.verso[0],o.verso[1],o.verso[2]),e.uniform3f(a.uSoleCol,o.colore[0],o.colore[1],o.colore[2]),e.uniform1f(a.uSoleForza,o.forza),e.uniform3f(a.uCieloCol,o.cielo[0],o.cielo[1],o.cielo[2]),e.uniform3f(a.uNebbiaCol,this.nebbia.colore[0],this.nebbia.colore[1],this.nebbia.colore[2]);let n=r.pelo!=null&&r.tex;e.activeTexture(e.TEXTURE1),e.bindTexture(e.TEXTURE_2D,n?r.tex:null),e.uniform1i(a.uSpecchio,1),e.uniform3f(a.uSchermo,1/e.drawingBufferWidth,1/e.drawingBufferHeight,n?1:0),e.uniform1f(a.uMare,this.mare),e.enable(e.BLEND),e.blendFunc(e.SRC_ALPHA,e.ONE_MINUS_SRC_ALPHA),e.depthMask(!1),e.disable(e.CULL_FACE);let s=0,u=0;for(let l of this._visibili)e.uniform3f(a.uChunk,l.chunk[0],l.chunk[1],l.chunk[2]),e.bindVertexArray(l.vaoAcqua),e.drawElements(e.TRIANGLES,l.quadAcqua*6,e.UNSIGNED_SHORT,0),s++,u+=l.quadAcqua*2;e.bindVertexArray(null),e.depthMask(!0),e.enable(e.CULL_FACE),e.disable(e.BLEND),e.activeTexture(e.TEXTURE0),this.statistiche.disegniAcqua=s,this.statistiche.triangoliAcqua=u,r.mostra&&n&&this._mostraSpecchio()}};var le=class extends Mo{vertice(e,a,o,t,r,n,s,u=0,l=0){super.vertice(e,a,o,_e[t],r,n,s,u,l)}},oo={erba:1,terra:2,sabbia:3,roccia:4,filo:5,tronco:6,chioma:7,lampada:8},Go=[0,6072381,8739896,14403468,9211013,5086771,6043679,2714414,16767347],Ut=1;function se(i,e){let a=o=>Math.max(0,Math.min(255,Math.round(o*e)));return a(i>>16&255)<<16|a(i>>8&255)<<8|a(i&255)}function ro(i,e,a){let o=i*374761393+e*668265263+a*1442695041|0;return o=Math.imul(o^o>>>13,1274126177),((o^o>>>16)>>>0)/4294967296}function ce(i,e,a,o){let t=i/a,r=e/a,n=Math.floor(t),s=Math.floor(r),u=t-n,l=r-s,f=u*u*(3-2*u),m=l*l*(3-2*l),h=ro(n,s,o),c=ro(n+1,s,o),d=ro(n,s+1,o),b=ro(n+1,s+1,o);return h+(c-h)*f+(d+(b-d)*f-(h+(c-h)*f))*m}function zo(i,e,a=7){let o=ce(i,e,48,a)*14+ce(i,e,17,a+1)*5+ce(i,e,6,a+2)*1.5;return 8+Math.floor(o)}function ye(i){return i<11?oo.sabbia:i>24?oo.roccia:oo.erba}function Oe(i,e,a=7){let o=[];for(let t=0;t<2;t++){if(ro(i*3+t,e*5-t,a+9)<.35)continue;let n=i*16+Math.floor(ro(i,e,a+11+t)*15)+.5,s=e*16+Math.floor(ro(e,i,a+13+t)*15)+.5,u=zo(Math.floor(n),Math.floor(s),a);ye(u)===oo.erba&&o.push({x:n,y:u+3,z:s})}return o}function Fe(i,e,a,o){let t=0;for(let r of o){let s=15-Math.sqrt((i-r.x)**2+(e-r.y)**2+(a-r.z)**2);s>t&&(t=s)}return Math.max(0,Math.min(15,Math.round(t)))}function Le(i,e,{seme:a=7,erba:o=2,raggioLampade:t=2}={}){let r=new le(1600),n=i*16,s=e*16,u=255,l=0,f=[];for(let h=-t;h<=t;h++)for(let c=-t;c<=t;c++)f.push(...Oe(i+h,e+c,a));for(let h=0;h<16;h++)for(let c=0;c<16;c++){let d=n+h,b=s+c,p=zo(d,b,a);p<u&&(u=p),p+1>l&&(l=p+1);let T=ye(p),x=.94+.12*ro(d,b,a+3),v=Fe(d+.5,p+1,b+.5,f),_=se(Go[T],x);r.quadDa([h,p+1,c,2,15,v,_],[h,p+1,c+1,2,15,v,_],[h+1,p+1,c+1,2,15,v,_],[h+1,p+1,c,2,15,v,_]);let C=[[1,0,0],[-1,0,1],[0,1,4],[0,-1,5]];for(let[R,z,g]of C){let E=zo(d+R,b+z,a);for(let M=E+1;M<=p;M++){let S=Math.max(6,15-(p-M)*2),N=M===p&&T===oo.erba?oo.erba:p>24?oo.roccia:oo.terra,I=Fe(d+.5+R*.5,M+.5,b+.5+z*.5,f),O=M,j=M+1,L=se(Go[N],x);R===1?r.quadDa([h+1,O,c,g,S,I,L],[h+1,j,c,g,S,I,L],[h+1,j,c+1,g,S,I,L],[h+1,O,c+1,g,S,I,L]):R===-1?r.quadDa([h,O,c+1,g,S,I,L],[h,j,c+1,g,S,I,L],[h,j,c,g,S,I,L],[h,O,c,g,S,I,L]):z===1?r.quadDa([h+1,O,c+1,g,S,I,L],[h+1,j,c+1,g,S,I,L],[h,j,c+1,g,S,I,L],[h,O,c+1,g,S,I,L]):r.quadDa([h,O,c,g,S,I,L],[h,j,c,g,S,I,L],[h+1,j,c,g,S,I,L],[h+1,O,c,g,S,I,L]),M<u&&(u=M)}}if(T===oo.erba)for(let R=0;R<o;R++){if(ro(d,b,a+20+R)<.25)continue;let g=1,E=h,M=c,S=se(Go[oo.filo],.94+.12*ro(d,b,a+30+R));r.quadDa([E,p+1,M,2,15,v,S],[E,p+1+g,M,2,15,v,S,1],[E+1,p+1+g,M+1,2,15,v,S,1],[E+1,p+1,M+1,2,15,v,S]),r.quadDa([E+1,p+1,M,2,15,v,S],[E+1,p+1+g,M,2,15,v,S,1],[E,p+1+g,M+1,2,15,v,S,1],[E,p+1,M+1,2,15,v,S]),p+2>l&&(l=p+2)}}for(let h of Oe(i,e,a)){let c=Math.floor(h.x)-n,d=Math.floor(h.z)-s,b=h.y-3;for(let p=b+1;p<=h.y;p++){let T=p===h.y?oo.lampada:oo.tronco,x=p===h.y?15:12,v=Go[T],_=p===h.y?Ut:0,C=c+.5-.15,R=c+.5+.15,z=Math.floor(C),g=Math.min(16,Math.floor(C)+1),E=d,M=d+1;r.quadDa([g,p,E,0,12,x,v,0,_],[g,p+1,E,0,12,x,v,0,_],[g,p+1,M,0,12,x,v,0,_],[g,p,M,0,12,x,v,0,_]),r.quadDa([z,p,M,1,12,x,v,0,_],[z,p+1,M,1,12,x,v,0,_],[z,p+1,E,1,12,x,v,0,_],[z,p,E,1,12,x,v,0,_]),r.quadDa([g,p,M,4,12,x,v,0,_],[g,p+1,M,4,12,x,v,0,_],[z,p+1,M,4,12,x,v,0,_],[z,p,M,4,12,x,v,0,_]),r.quadDa([z,p,E,5,12,x,v,0,_],[z,p+1,E,5,12,x,v,0,_],[g,p+1,E,5,12,x,v,0,_],[g,p,E,5,12,x,v,0,_]),p===h.y&&r.quadDa([z,p+1,E,2,15,x,v,0,_],[z,p+1,M,2,15,x,v,0,_],[g,p+1,M,2,15,x,v,0,_],[g,p+1,E,2,15,x,v,0,_]),p+1>l&&(l=p+1)}}return{...r.dati(),minY:u,maxY:l,cx:i,cz:e}}var Ie={erba:{nome:"Erba",cima:6601551,lato:13209440,fondo:11894352,solido:!0,nav:10,cappello:!0,fam:"scavo"},terra:{nome:"Terra",cima:13209440,lato:12353875,fondo:11894352,solido:!0,nav:10,fam:"scavo"},sabbia:{nome:"Sabbia",cima:15324316,lato:14599048,fondo:13808246,solido:!0,nav:12,fam:"scavo"},ghiaia:{nome:"Ghiaia",cima:10130572,lato:9143677,fondo:8354162,solido:!0,nav:12,fam:"scavo"},neve:{nome:"Neve",cima:15923191,lato:14740202,fondo:13688028,solido:!0,nav:12,fam:"scavo"},roccia:{nome:"Roccia",cima:11054778,lato:9673384,fondo:8883868,solido:!0,nav:10,fam:"mina"},pietra:{nome:"Pietra liscia",cima:12436429,lato:11449535,fondo:10660019,solido:!0,nav:10,fam:"mina"},mattoni:{nome:"Mattoni",cima:11555645,lato:10570294,fondo:9650735,solido:!0,nav:10,fam:"mina"},legno:{nome:"Legno",cima:11568720,lato:10252866,fondo:9266489,solido:!0,nav:10,fam:"taglia"},tronco:{nome:"Tronco",cima:12622434,lato:8016432,fondo:12622434,solido:!0,nav:10,fam:"taglia"},asse:{nome:"Assi chiare",cima:14268798,lato:13150317,fondo:12163422,solido:!0,nav:10,fam:"taglia"},lanaBianca:{nome:"Lana bianca",cima:15724786,lato:14869478,fondo:14014170,solido:!0,nav:10,fam:"scavo"},lanaRossa:{nome:"Lana rossa",cima:14703182,lato:13388608,fondo:12206648,solido:!0,nav:10,fam:"scavo"},lanaBlu:{nome:"Lana blu",cima:4882388,lato:4157120,fondo:3629227,solido:!0,nav:10,fam:"scavo"},lanaGialla:{nome:"Lana gialla",cima:15911244,lato:14727230,fondo:13477428,solido:!0,nav:10,fam:"scavo"},lanaVerde:{nome:"Lana verde",cima:5813096,lato:4890714,fondo:4165454,solido:!0,nav:10,fam:"scavo"},ferro:{nome:"Ferro",cima:12174028,lato:10792376,fondo:9410723,solido:!0,nav:10,fam:"scavo",materia:"metallo"},fanghiglia:{nome:"Fanghiglia",cima:11569756,lato:10517842,fondo:9268551,solido:!0,nav:10,fam:"scavo",materia:"fango"},ghiaccio:{nome:"Ghiaccio",cima:12576498,lato:11131114,fondo:9685472,solido:!0,nav:10,fam:"scavo",materia:"ghiaccio"},cristallo:{nome:"Cristallo",cima:16771496,lato:16243851,fondo:15256437,solido:!0,nav:10,fam:"mina",salute:100,materia:"accesa",luce:{colore:16767370,raggio:6,intensita:1,ombra:!0}},ottone:{nome:"Ottone",cima:14267482,lato:12820556,fondo:11044927,solido:!0,nav:10,fam:"scavo",materia:"specchio"},lucciola:{nome:"Lucciola verde",cima:11075504,lato:6280814,fondo:4634967,solido:!0,nav:10,fam:"mina",salute:100,luce:{colore:8257440,raggio:5,intensita:1.1,ombra:!0}},lampadaPesante:{nome:"Lampada pesante (con ombra)",cima:16771764,lato:15777891,fondo:14264132,solido:!0,nav:10,fam:"mina",salute:100,luce:{colore:16767113,raggio:8,intensita:1.1,ombra:!0}},lampadaLeggera:{nome:"Lampada leggera (trapassa i muri)",cima:16771764,lato:15777891,fondo:14264132,solido:!0,nav:10,fam:"mina",salute:100,luce:{colore:16767113,raggio:8,intensita:1.1,ombra:!1}},lampadaRossa:{nome:"Lampada rossa",cima:16759213,lato:15224892,fondo:13187624,solido:!0,nav:10,fam:"mina",salute:100,luce:{colore:16722458,raggio:8,intensita:1.1,ombra:!0}},lampadaVerde:{nome:"Lampada verde",cima:11993028,lato:4183135,fondo:3124809,solido:!0,nav:10,fam:"mina",salute:100,luce:{colore:1769274,raggio:8,intensita:1.1,ombra:!0}},lampadaBlu:{nome:"Lampada blu",cima:11584767,lato:4220128,fondo:3099837,solido:!0,nav:10,fam:"mina",salute:100,luce:{colore:2771711,raggio:8,intensita:1.1,ombra:!0}},fuochiFatui:{nome:"Nido di fuochi fatui",cima:13498111,lato:5083048,fondo:3500413,solido:!0,nav:10,fam:"mina",salute:100,luce:{colore:9430271,raggio:3,intensita:.7,ombra:!1},fuochiFatui:{numero:7,raggio:3.2,quota:1.9,luce:{colore:10477823,raggio:4.2,intensita:1}}},acqua:{nome:"Acqua",cima:5227244,lato:4042208,fondo:3184332,solido:!1,nav:null,acqua:!0}},Ne=[{id:"naturali",nome:"Naturali",emoji:"\u{1F33F}",blocchi:["erba","terra","sabbia","ghiaia","neve","roccia","lucciola","acqua"]},{id:"costruzione",nome:"Costruzione",emoji:"\u{1F9F1}",blocchi:["legno","tronco","asse","pietra","mattoni"]},{id:"lane",nome:"Lane",emoji:"\u{1F3A8}",blocchi:["lanaBianca","lanaRossa","lanaBlu","lanaGialla","lanaVerde"]},{id:"luci",nome:"Luci",emoji:"\u{1F4A1}",blocchi:["lucciola","lampadaPesante","lampadaLeggera","lampadaRossa","lampadaVerde","lampadaBlu","fuochiFatui"]}],Xo={id:"officina",nome:"Officina",emoji:"\u{1F6E0}\uFE0F",blocchi:[]};Ne.push(Xo);var Bt={id:"prove",nome:"Prove",emoji:"\u{1F317}",blocchi:[]};Ne.push(Bt);function Pe(i,e,a=Xo){Ie[i]=e,a.blocchi.includes(i)||a.blocchi.push(i)}var qt={nome:"Blocco perduto",cima:12950225,lato:11305912,fondo:9924767,solido:!0,nav:10,fam:"mina"};function $(i){return Ie[i.charCodeAt(0)===97&&i.startsWith("acqua")?"acqua":i]||qt}function we(i){let e=i.indexOf("~");return e<0?i:i.slice(0,e)}function De(i){if(!i||!i.startsWith("acqua"))return null;let e=i.indexOf("~");return e<0?0:Number(i.slice(e+1))}var F=16,Vt=256,Yo=2048,Ue=64,eo=(i,e,a)=>((i+Yo)*4096+(a+Yo))*256+(e+Ue),Oo=i=>Math.floor(i/(256*4096))-Yo,Fo=i=>Math.floor(i/256)%4096-Yo,yo=i=>i%256-Ue;var vo=(i,e)=>Math.floor(i/F)+","+Math.floor(e/F),$o=class{constructor(){this.chunks=new Map,this.sporchi=new Set,this.sporchiAcqua=new Set,this._rev=new Map,this.furni=new Map,this.ombreFurni=new Map,this.contaBlocchi=0,this.onEvento=null,this.cambiate=[],this.troppiCambi=!1,this._memoCx=0,this._memoCz=0,this._memoChunk=null,this.generati=new Set,this.modifiche=new Map,this.frontiera=null}segnaGenerato(e){this.generati.add(e)}_annotaModifica(e,a,o,t){if(!this.frontiera)return;let r=vo(e,o),n=this.modifiche.get(r);n||(n=new Map,this.modifiche.set(r,n)),n.set(eo(e,a,o),t)}applicaModifiche(e){let a=this.modifiche.get(e);if(!a)return 0;for(let[o,t]of a){let r=Oo(o),n=yo(o),s=Fo(o);t===null?this.togli(r,n,s,!0):this.metti(r,n,s,t,!0)}return a.size}scaricaChunk(e){let a=this.chunks.get(e);if(!a)return this.generati.delete(e),[];let o=[];for(let[t,r]of a){let n=$(r);n&&n.forma==="modello"&&o.push([Oo(t),yo(t),Fo(t),r])}return this.contaBlocchi-=a.size,this.chunks.delete(e),this._scordaMemo(),this.generati.delete(e),this._tocca(e,this.sporchi),o}_cambiata(e,a,o){if(this.cambiate.length>=3*Vt){this.troppiCambi=!0;return}this.cambiate.push(e,a,o)}scordaCambi(){this.cambiate.length=0,this.troppiCambi=!1}_scordaMemo(){this._memoKc=null,this._memoChunk=null}_chunkDi(e,a){let o=Math.floor(e/F),t=Math.floor(a/F);if(this._memoChunk!==null&&this._memoCx===o&&this._memoCz===t)return this._memoChunk;let r=this.chunks.get(o+","+t)||null;return this._memoCx=o,this._memoCz=t,this._memoChunk=r,r}tipo(e,a,o){let t=this._chunkDi(e,o);return t&&t.get(eo(e,a,o))||null}pieno(e,a,o){return this.tipo(e,a,o)!==null}solido(e,a,o){let t=this.tipo(e,a,o);if(t&&$(t).solido)return!0;let r=this.furni.get(eo(e,a,o));return!!r&&!(r.def&&r.def.calpestabile)}calpestabile(e,a,o){if(!this.solido(e,a-1,o)||this.solido(e,a,o)||this.solido(e,a+1,o))return!1;let t=this.tipo(e,a,o);return!(t&&$(t).acqua)}_sporca(e,a,o=this.sporchi){let t=(e%F+F)%F,r=(a%F+F)%F;this._tocca(vo(e,a),o),t===0&&this._tocca(vo(e-1,a),o),t===F-1&&this._tocca(vo(e+1,a),o),r===0&&this._tocca(vo(e,a-1),o),r===F-1&&this._tocca(vo(e,a+1),o)}_tocca(e,a){a.add(e),this._rev.set(e,(this._rev.get(e)||0)+1)}revisione(e){return this._rev.get(e)||0}metti(e,a,o,t,r=!1){let n=vo(e,o),s=this.chunks.get(n);s||(s=new Map,this.chunks.set(n,s),this._scordaMemo());let u=eo(e,a,o),l=s.get(u);l===void 0&&this.contaBlocchi++,s.set(u,t);let f=t.charCodeAt(0)===97&&t.startsWith("acqua")&&(l===void 0||l.startsWith("acqua"));this._sporca(e,o,f?this.sporchiAcqua:this.sporchi),f||this._cambiata(e,a,o),r||(this._annotaModifica(e,a,o,t),this.onEvento&&this.onEvento({tipo:"metti",cella:[e,a,o],blocco:t}))}togli(e,a,o,t=!1){let r=vo(e,o),n=this.chunks.get(r);if(!n)return!1;let s=eo(e,a,o),u=n.get(s);if(!n.delete(s))return!1;this.contaBlocchi--,n.size===0&&(this.chunks.delete(r),this._scordaMemo());let l=!!(u&&u.startsWith("acqua"));return this._sporca(e,o,l?this.sporchiAcqua:this.sporchi),l||this._cambiata(e,a,o),t||(this._annotaModifica(e,a,o,null),this.onEvento&&this.onEvento({tipo:"togli",cella:[e,a,o]})),!0}occupaFurni(e,a){for(let[o,t,r]of e)this.furni.set(eo(o,t,r),a)}liberaFurni(e){for(let[a,o,t]of e)this.furni.delete(eo(a,o,t))}furniIn(e,a,o){return this.furni.get(eo(e,a,o))||null}occupaOmbra(e,a=!1){for(let[o,t,r]of e){let n=eo(o,t,r),s=this.ombreFurni.get(n);if(s){s.n++,a&&s.op++===0&&this._cambiata(o,t,r);continue}this.ombreFurni.set(n,{x:o,y:t,z:r,n:1,op:a?1:0}),this._cambiata(o,t,r)}}liberaOmbra(e,a=!1){for(let[o,t,r]of e){let n=eo(o,t,r),s=this.ombreFurni.get(n);s&&(a&&s.op>0&&--s.op===0&&s.n>1&&this._cambiata(o,t,r),!(--s.n>0)&&(this.ombreFurni.delete(n),this._cambiata(o,t,r)))}}ombraFurniIn(e,a,o){let t=this.ombreFurni.get(eo(e,a,o));return t?t.op>0?2:1:0}appoggioInColonna(e,a,o,t=8){for(let r=o;r>o-t;r--)if(this.calpestabile(e,r,a))return r;return null}svuota(){this.chunks.clear(),this._scordaMemo(),this.furni.clear(),this.sporchi.clear(),this.sporchiAcqua.clear();for(let e of this._rev.keys())this._rev.set(e,this._rev.get(e)+1);this.scordaCambi(),this.contaBlocchi=0}*tutti(){for(let e of this.chunks.values())for(let[a,o]of e)yield{x:Oo(a),y:yo(a),z:Fo(a),tipo:o}}perOgni(e){for(let a of this.chunks.values())for(let[o,t]of a)e(Oo(o),yo(o),Fo(o),t)}*blocchiDelChunk(e){let a=this.chunks.get(e);if(a)for(let[o,t]of a)yield{x:Oo(o),y:yo(o),z:Fo(o),tipo:t}}perOgniDelChunk(e,a){let o=this.chunks.get(e);if(o)for(let[t,r]of o)a(Oo(t),yo(t),Fo(t),r)}};var kt={primavera:{nome:"Primavera",emoji:"\u{1F338}",erba:[8310112,7652440,6994769,6337098,5679173,5021248,4428860,3836472],fogliame:null},estate:{nome:"Estate secca",emoji:"\u{1F33E}",erba:[15060862,14534259,14073193,13546335,13019733,12558668,12032068,11571261],fogliame:{h:.128,sF:.72,l:i=>i*.92+.1}},autunno:{nome:"Autunno",emoji:"\u{1F342}",erba:[15506768,15045448,14584129,14122810,13661492,13200431,12739371,12278311],fogliame:{h:.045,sF:1.2,l:i=>i*1.05+.09}},inverno:{nome:"Inverno",emoji:"\u2744\uFE0F",erba:[15988722,15462890,14871523,14279900,13622740,13031117,12439751,11848128],sabbia:{cima:15722970,lato:14932934,fondo:14077364},fogliame:{h:.42,sF:.18,l:i=>i*.38+.58}}},wo="primavera";var Ho=null;function Zo(i,e,a){let o=i>>16&255,t=i>>8&255,r=i&255,n=e>>16&255,s=e>>8&255,u=e&255,l=(f,m)=>Math.round(f+(m-f)*a);return l(o,n)<<16|l(t,s)<<8|l(r,u)}function Be(i,e){if(Ho){let a=wo;wo=Ho.da;let o=fe(i,e);wo=Ho.a;let t=fe(i,e);wo=a;let r=Ho.mix;return{cima:ue(o.cima,t.cima,r),lato:ue(o.lato,t.lato,r),fondo:ue(o.fondo,t.fondo,r),facce:o.facce}}return fe(i,e)}function ue(i,e,a){let o=Math.round((i>>16&255)+((e>>16&255)-(i>>16&255))*a),t=Math.round((i>>8&255)+((e>>8&255)-(i>>8&255))*a),r=Math.round((i&255)+((e&255)-(i&255))*a);return o<<16|t<<8|r}function fe(i,e){let a=$(i),o=kt[wo],{cima:t,lato:r,fondo:n}=a;if(a.cappello&&o.erba&&!a.override&&(t=o.erba[he(e,o.erba.length)]),a.reagisce==="stagione"&&o.erba){let s=o.erba[he(e,o.erba.length)],u=a.reagisceForza??1;t=Zo(t,s,u),r=Zo(r,s,u*.45),n=Zo(n,s,u*.3)}else if(a.reagisce==="quota"){let s=he(e,8)/7,u=(a.reagisceForza??1)*.5,l=f=>Zo(f,16777215,s*u);t=l(t),r=l(r),n=l(n)}return i==="sabbia"&&o.sabbia&&({cima:t,lato:r,fondo:n}=o.sabbia),{cima:t,lato:r,fondo:n,facce:a.facce||null}}function co(i,e,a){if(i.facce){let o=e*2+(a>0?0:1),t=i.facce[o];if(t!=null)return t}return e===1?a>0?i.cima:i.fondo:i.lato}function he(i,e=8){let a=(e-1)*2,o=(Math.round(i)%a+a)%a;return o>=e&&(o=a-o),o}function me(i,e,a){let o=(i|0)*374761393+(e|0)*668265263+(a|0)*2147483647;return o=(o^o>>>13)*1274126177,o=o^o>>>16,(o>>>0)%1e3/1e3}function Gt(i,e){let a=i>>16&255,o=i>>8&255,t=i&255,r=n=>Math.max(0,Math.min(255,Math.round(n*(1+e))));return r(a)<<16|r(o)<<8|r(t)}function Xt(i,e,a,o,t,r){if(!e||e==="liscio"||!a)return i;let n=0;return e==="chiazze"?n=(me(o,t,r)-.5)*2:e==="venature"?n=(me(0,t,0)-.5)*2*.7+(me(o,t,r)-.5)*.3:e==="sfumato"&&(n=(t%16+16)%16/16-.5),Gt(i,n*a*.34)}function qe(i,e,a,o,t,r){if(!e||e==="liscio"||!a)return i;let n=s=>Xt(s,e,a,o,t,r);return{cima:n(i.cima),lato:n(i.lato),fondo:n(i.fondo),facce:i.facce?i.facce.map(n):null}}var Ve={metallo:{tinta:.82,satura:.55,orlo:.18,curva:1,glintR:.34,emiss:0,bagna:.2,sotto:0,riflette:.15},fango:{tinta:.72,satura:1.35,orlo:0,curva:-1,glintR:.48,emiss:0,bagna:1,sotto:0,riflette:0},ghiaccio:{tinta:1.06,satura:.62,orlo:.12,curva:.6,glintR:.3,emiss:0,bagna:.4,sotto:.3,riflette:.25},accesa:{tinta:1,satura:1,orlo:0,curva:0,glintR:0,emiss:1,bagna:0,sotto:0,riflette:0},specchio:{tinta:.95,satura:.35,orlo:.1,curva:1,glintR:.3,emiss:0,bagna:0,sotto:0,riflette:.55}},Yt=Object.keys(Ve);function ke(i){return!i||!i.materia?null:Ve[i.materia]||null}function go(i,e,a=0){if(!e)return i;let o=(i>>16&255)/255,t=(i>>8&255)/255,r=(i&255)/255,n=.2126*o+.7152*t+.0722*r,s=e.satura;o=n+(o-n)*s,t=n+(t-n)*s,r=n+(r-n)*s;let u=e.tinta*(1+a),l=f=>Math.max(0,Math.min(255,Math.round(f*u*255)));return l(o)<<16|l(t)<<8|l(r)}var $t=16;function Ge(i){let e=Yt.indexOf(i);return e<0||e+1>=$t?0:e+1}var pe=1/16,Xe=8*pe,to=9*pe;function Ye(i,e,a,o,t,r,n,s){let u=(f,m,h)=>[e+f,a+m,o+h];i.quad(u(-s,n,-s),u(s,n,-s),u(s,n,s),u(-s,n,s),co(t,1,1),[0,1,0]),i.quad(u(-s,r,-s),u(s,r,-s),u(s,r,s),u(-s,r,s),co(t,1,-1),[0,-1,0]);let l=[{d:[1,0,0],asse:0,segno:1},{d:[-1,0,0],asse:0,segno:-1},{d:[0,0,1],asse:2,segno:1},{d:[0,0,-1],asse:2,segno:-1}];for(let f of l){let[m,,h]=f.d,c=-h,d=m,b=(p,T)=>u(m*s+c*T,p,h*s+d*T);i.quad(b(r,-s),b(n,-s),b(n,s),b(r,s),co(t,f.asse,f.segno),f.d)}}function Ht(i,e,a,o,t){Ye(i,e,a,o,t,-to,0,Xe)}function Zt(i,e,a,o,t){Ye(i,e,a,o,t,-to,to,5*pe)}function jt(i,e,a,o,t){let r=(l,f,m)=>[e+l,a+f,o+m],n=co(t,0,1),s=Xe,u=[[[-s,-to,-s],[s,-to,s],[s,to,s],[-s,to,-s],[1,0,-1]],[[-s,-to,s],[s,-to,-s],[s,to,-s],[-s,to,s],[1,0,1]]];for(let[l,f,m,h,c]of u)i.quad(r(...l),r(...f),r(...m),r(...h),n,c),i.quad(r(...l),r(...f),r(...m),r(...h),n,[-c[0],-c[1],-c[2]])}function Kt(){}var $e={lastra:Ht,pilastro:Zt,croce:jt,modello:Kt},Do=new Set(["lastra","pilastro","croce","modello"]);var Uo=1/16,Wt=[[0,1],[0,2],[1,2]],Qt=[[1,0],[-1,0],[0,1],[0,-1]];function xo(i,e,a,o,t,r,n,s,u){let l=[i,e,a];return l[o]+=t,l[r]+=n,l[s]+=u,l}var He={tinta:1,satura:1};function Ze(i,e,a,o,t,r,n=0){let s=8*Uo,u=9*Uo,l=(f,m)=>r(f===0?m:0,f===1?m:0,f===2?m:0);for(let f=0;f<3;f++)for(let m of[-1,1]){if(l(f,m))continue;let h=(f+1)%3,c=(f+2)%3,d=co(t,f,m),b=[0,0,0];b[f]=m,i.quad(xo(e,a,o,f,m*u,h,-s,c,-s),xo(e,a,o,f,m*u,h,+s,c,-s),xo(e,a,o,f,m*u,h,+s,c,+s),xo(e,a,o,f,m*u,h,-s,c,+s),d,b)}for(let[f,m]of Wt){let h=3-f-m;for(let c of[-1,1])for(let d of[-1,1]){if(l(f,c)||l(m,d))continue;let b=f===1&&c>0||m===1&&d>0,p=f===1&&c<0||m===1&&d<0,T=b?t.cima:p?t.fondo:t.lato,x=n?go(T,He,n):T,v=[0,0,0];v[f]=c,v[m]=d,i.quad(xo(e,a,o,f,c*u,m,d*s,h,-s),xo(e,a,o,f,c*s,m,d*u,h,-s),xo(e,a,o,f,c*s,m,d*u,h,+s),xo(e,a,o,f,c*u,m,d*s,h,+s),x,v)}}for(let f of[-1,1])for(let m of[-1,1])for(let h of[-1,1])l(0,f)||l(1,m)||l(2,h)||i.tri([e+f*u,a+m*s,o+h*s],[e+f*s,a+m*u,o+h*s],[e+f*s,a+m*s,o+h*u],n?go(m>0?t.cima:t.fondo,He,n):m>0?t.cima:t.fondo,[f,m,h])}function je(i,e,a,o,t,r){let n=(h,c)=>r(h,0,c),s=r(0,-1,0),u=t.cima,l=t.lato,f=t.fondo,m=(h,c,d)=>[e+h*Uo,a+c*Uo,o+d*Uo];s||i.quad(m(-8,-9,-8),m(8,-9,-8),m(8,-9,8),m(-8,-9,8),f,[0,-1,0]);for(let[h,c]of Qt){if(n(h,c))continue;let d=-c,b=h,p=(x,v,_)=>m(x*h+_*d,v,x*c+_*b),T=[h,0,c];s||i.quad(p(8,-9,-8),p(9,-8,-8),p(9,-8,8),p(8,-9,8),f,[h,-1,c]),i.quad(p(9,-8,-8),p(9,2,-8),p(9,2,8),p(9,-8,8),l,T),i.quad(p(9,2,-8),p(10,3,-8),p(10,3,8),p(9,2,8),u,T),i.quad(p(10,3,-8),p(10,7,-8),p(10,7,8),p(10,3,8),u,T),i.quad(p(10,7,-8),p(9,8,-8),p(9,8,8),p(10,7,8),u,[h,1,c]),i.quad(p(8,8,-8),p(9,8,-8),p(9,8,8),p(8,8,8),u,[0,1,0])}for(let h of[-1,1])for(let c of[-1,1]){if(n(h,0)||n(0,c))continue;let d=(p,T,x)=>m(p*h,T,x*c),b=[h,0,c];s||i.tri(d(9,-8,8),d(8,-9,8),d(8,-8,9),f,[h,-1,c]),i.quad(d(9,-8,8),d(8,-8,9),d(8,2,9),d(9,2,8),l,b),i.quad(d(9,2,8),d(8,2,9),d(8,3,10),d(10,3,8),u,b),i.quad(d(10,3,8),d(8,3,10),d(8,7,10),d(10,7,8),u,b),i.quad(d(10,7,8),d(8,7,10),d(8,8,9),d(9,8,8),u,[h,1,c]),i.tri(d(8,8,8),d(9,8,8),d(8,8,9),u,[0,1,0])}i.quad(m(-8,8,-8),m(8,8,-8),m(8,8,8),m(-8,8,8),u,[0,1,0])}var de={lampione:{nome:"Lampione",modello:"lampione",altezza:3,mezza:.45,cima:16771764,lato:5988976,fondo:4672856,luce:{colore:16767113,raggio:4.6,intensita:1,ombra:!0,quota:2.6},notte:!0},albero:{nome:"Albero",modello:"albero",altezza:4.2,mezza:.7,cima:5217862,lato:8016432,fondo:6964518}};function Ke(){for(let[i,e]of Object.entries(de))Pe(i,{nome:e.nome,cima:e.cima,lato:e.lato,fondo:e.fondo,solido:!1,nav:10,fam:"taglia",forma:"modello",modello:e.modello},Xo)}var Jt=2,be=6,oa=256;function We(i){if(!i)return!1;let e=$(i);return!e.acqua&&!e.vetro&&!Do.has(e.forma)}function Je(i,e,a,o){let t=e.indexOf(","),r=+e.slice(0,t),n=+e.slice(t+1),s=r*F-be,u=n*F-be,l=F+2*be,f=o-a+1,m=l,h=l*f*m,c=new Uint8Array(h),d=new Uint8Array(h),b=new Uint8Array(h),p=(C,R,z)=>((C-s)*f+(R-a))*m+(z-u),T=(C,R,z)=>C>=s&&C<s+l&&R>=a&&R<=o&&z>=u&&z<u+m,x=[];for(let C=s;C<s+l;C++)for(let R=u;R<u+m;R++){let z=!1;for(let g=o;g>=a;g--){let E=i.tipo(C,g,R),M=p(C,g,R);if(We(E)){b[M]=1,z=!0;continue}if(!z&&g===o){for(let S=o+1;S<oa&&S<o+40;S++)if(We(i.tipo(C,S,R))){z=!0;break}}if(z||(c[M]=15),E){let N=$(E).forma==="modello"&&de[E];N&&N.luce&&x.push([C,g+Math.round(N.luce.quota??1),R])}}}let v=[];for(let C=0;C<h;C++)c[C]===15&&v.push(C);Qe(v,c,b,l,f,m,1);let _=[];for(let[C,R,z]of x){if(!T(C,R,z))continue;let g=p(C,R,z);d[g]=15,_.push(g)}return Qe(_,d,b,l,f,m,Jt),{x0:s,z0:u,yMin:a,yMax:o,W:l,H:f,D:m,cielo:c,blocco:d,leggi(C,R,z){if(!T(C,R,z))return R>o?[15,0]:[0,0];let g=p(C,R,z);return[c[g],d[g]]}}}function Qe(i,e,a,o,t,r,n){let s=[t*r,-t*r,r,-r,1,-1],u=0;for(;u<i.length;){let l=i[u++],f=e[l]-n;if(f<=0)continue;let m=Math.floor(l/(t*r)),h=Math.floor(l/r)%t,c=l%r;for(let d=0;d<6;d++){if(d===0&&m===o-1||d===1&&m===0||d===2&&h===t-1||d===3&&h===0||d===4&&c===r-1||d===5&&c===0)continue;let b=l+s[d];a[b]||e[b]>=f||(e[b]=f,i.push(b))}}}var ot=[{n:5,largo:.15,alto:.32,apri:.42},{n:4,largo:.12,alto:.5,apri:.34},{n:7,largo:.1,alto:.38,apri:.46},{n:3,largo:.18,alto:.28,apri:.3}];function no(i,e,a){let o=i*374761393+e*668265263+a*1442695041|0;return o=Math.imul(o^o>>>13,1274126177),((o^o>>>16)>>>0)/4294967296}var jo=class{constructor(e,a=512){this.yBase=e,this.byte=new Uint8Array(a*12),this.n=0}_lamella(e,a,o,t,r,n,s,u,l,f=0,m=8){if((this.n+1)*12>this.byte.length){let d=new Uint8Array(this.byte.length*2);d.set(this.byte),this.byte=d}let h=this.n*12,c=this.byte;c[h]=e,c[h+1]=a,c[h+2]=o,c[h+3]=t,c[h+4]=r>>16&255,c[h+5]=r>>8&255,c[h+6]=r&255,c[h+7]=(n&15)<<2,c[h+8]=Math.max(1,Math.min(255,s)),c[h+9]=Math.max(1,Math.min(255,u)),c[h+10]=Math.max(0,Math.min(255,l+128)),c[h+11]=f&15|(m&15)<<4,this.n++}ciuffo(e,a,o,t,r,n,s,u=1,l=0){let f=ot[Math.floor(no(e,o,3)*ot.length)],m=Math.max(1,Math.round(f.n*u*(.82+.36*no(e,o,5)))),h=a+1-this.yBase;if(h<0||h*8>247)return 0;for(let c=0;c<m;c++){let d=no(e,o,c*17+5),b=no(e,o,c*17+11),p=no(e,o,c*17+41),T=no(e,o,c*17+59),x=Math.min(.98,.66+f.apri),v=e+.5+(d-.5)*x,_=o+.5+(b-.5)*x,C=Math.min(.8,f.alto*(.62+.8*no(e,o,c*17+71))*(.5+.6*Math.pow(p,1.5))),R=f.largo*(.8+.4*T),z=(no(e,o,c*17+83)-.5)*.5,g=no(e,o,c*17+89),E=g<.15?.9+.03*g:g>.85?1.07+.03*(g-.85):.97+.06*(g-.15)/.7,M=Math.max(0,Math.min(128,Math.round((v-t)*8))),S=Math.max(0,Math.min(128,Math.round((_-r)*8))),N=Math.floor(no(e,o,c*17+97)*255);this._lamella(M,S,Math.round(h*8),N,n,s,Math.round(C*64),Math.round(R*128),Math.round(z*128),l,Math.round((E-.9)/.2*15))}return m}dati(){return{byte:this.byte.subarray(0,this.n*12),vertici:this.n*6,fili:this.n,yBase:this.yBase}}};var Eo=64,ea=[[1,0,0,Y(1,0,0),0,1],[-1,0,0,Y(-1,0,0),0,-1],[0,1,0,Y(0,1,0),1,1],[0,-1,0,Y(0,-1,0),1,-1],[0,0,1,Y(0,0,1),2,1],[0,0,-1,Y(0,0,-1),2,-1]],et=(i,e,a)=>((e+1)*3+(a+1))*3+(i+1),xe=class{constructor(e,a,o,t,r){this.c=e,this.ox=a,this.oz=o,this._materia=0,this.luceDi=t,this.aria=r,this._cielo=15,this._cella=null}materia(e){this._materia=e|0}cella(e,a,o){this._cella=[e,a,o]}_cieloFaccia(e){let[a,o,t]=this._cella,r=-1;for(let n=0;n<3;n++){if(!e[n])continue;let s=this.luceDi(a+(n===0?e[0]:0),o+(n===1?e[1]:0),t+(n===2?e[2]:0))[0];s>r&&(r=s)}return r<0?this.luceDi(a,o+1,t)[0]:r}_bloccoVertice(e,a){let o=Math.hypot(a[0],a[1],a[2])||1,t=e[0]+a[0]/o*.5,r=e[1]+a[1]/o*.5,n=e[2]+a[2]/o*.5,s=0,u=0;for(let l of[-.45,.45])for(let f of[-.45,.45])for(let m of[-.45,.45]){let h=Math.floor(t+l),c=Math.floor(r+f),d=Math.floor(n+m);this.aria(h,c,d)&&(s+=this.luceDi(h,c,d)[1],u++)}return u?Math.round(s/u):0}_v(e,a,o,t){return[e[0]-this.ox,e[1]+Eo,e[2]-this.oz,a,this._cielo,this._bloccoVertice(e,t),o,0,this._materia]}_giro(e,a,o,t){let r=a[0]-e[0],n=a[1]-e[1],s=a[2]-e[2],u=o[0]-e[0],l=o[1]-e[1],f=o[2]-e[2],m=n*f-s*l,h=s*u-r*f,c=r*l-n*u;return m*t[0]+h*t[1]+c*t[2]<0}tri(e,a,o,t,r){if(this._giro(e,a,o,r)){let s=a;a=o,o=s}let n=Y(r[0],r[1],r[2]);this._cielo=this._cieloFaccia(r),this.c.quadDa(this._v(e,n,t,r),this._v(a,n,t,r),this._v(o,n,t,r),this._v(o,n,t,r))}quad(e,a,o,t,r,n){let s=Y(n[0],n[1],n[2]);if(this._cielo=this._cieloFaccia(n),this._giro(e,a,o,n)){let u=a;a=t,t=u}this.c.quadDa(this._v(e,s,r,n),this._v(a,s,r,n),this._v(o,s,r,n),this._v(t,s,r,n))}};function ve(i){if(!i)return!1;let e=$(i);return!e.acqua&&!e.vetro&&!Do.has(e.forma)}function ge(i){return!!i&&i.charCodeAt(0)===97&&i.startsWith("acqua")}function tt(i,e,{erba:a=2,luce:o=!0}={}){let t=e.indexOf(","),r=+e.slice(0,t),n=+e.slice(t+1),s=r*F,u=n*F,l=new Mo(1024),f=new Mo(64),m=-1/0,h=new Int16Array(F*F).fill(-1),c=255,d=0,b=1/0,p=-1/0;i.perOgniDelChunk(e,(g,E)=>{E<b&&(b=E),E>p&&(p=E)});let T=o&&b<=p?Je(i,e,b-2,p+3):null,x=new jo(Number.isFinite(b)?b:0),v=(g,E,M)=>T?T.leggi(g,E,M):[15,0],_=new xe(l,s,u,v,(g,E,M)=>!ve(i.tipo(g,E,M))),C=new Uint8Array(27),R=(g,E,M,S,N,I,O,j)=>[g-s,E+Eo,M-u,S,I,O,N,j?1:0,0];return i.perOgniDelChunk(e,(g,E,M,S)=>{let N=$(S);if(N.forma==="modello"&&N.modello==="albero")for(let B=-2;B<=2;B++)for(let G=-2;G<=2;G++){let io=B*B+G*G;if(io>4)continue;let J=g+B-s,fo=M+G-u;if(J<0||J>=F||fo<0||fo>=F)continue;let K=J*F+fo,V=E+(io===0?4:io<=2?3:2);V>h[K]&&(h[K]=V)}if(Do.has(N.forma))return;let I=ge(S),O=E+Eo;if(O<0||O>254)return;let j=(g-s)*F+(M-u);!I&&E>h[j]&&(h[j]=E);let L=Be(we(S),E);N.motivo&&(L=qe(L,N.motivo,N.motivoForza??1,g,E,M));let uo=ke(N);uo&&(L={...L,cima:go(L.cima,uo),lato:go(L.lato,uo),fondo:go(L.fondo,uo)},L.facce&&(L.facce=L.facce.map(B=>B==null?B:go(B,uo))));let Mt=uo?Ge(N.materia):0;if(!I){C.fill(0);for(let K=-1;K<=1;K++)for(let V=-1;V<=1;V++)for(let X=-1;X<=1;X++)X===0&&K===0&&V===0||ve(i.tipo(g+X,E+K,M+V))&&(C[et(X,K,V)]=1);let B=(K,V,X)=>C[et(K,V,X)]===1;_.materia(Mt),_.cella(g,E,M);let G=g+.5,io=E+.5,J=M+.5,fo=N.forma&&$e[N.forma];fo?fo(_,G,io,J,L,()=>!1):N.cappello&&!B(0,1,0)?je(_,G,io,J,L,B):Ze(_,G,io,J,L,(V,X,P)=>B(V,X,P)?X!==0?!0:!$(i.tipo(g+V,E,M+P)).cappello||B(V,1,P):!1,uo?uo.orlo:0),O-1<c&&(c=O-1),O+2>d&&(d=O+2)}let Ao=0,Co=0;if(I)for(Co=Math.max(0,Math.min(15,De(S)||0));Ao<15&&ge(i.tipo(g,E-1-Ao,M));)Ao++;if(I)for(let[B,G,io,J,fo,K]of ea){let V=i.tipo(g+B,E+G,M+io);if(V&&(ge(V)||ve(V)))continue;let X=co(L,fo,K),P=g,w=E,D=M,ho,mo,po,bo;if(B===1?(ho=[P+1,w,D],mo=[P+1,w+1,D],po=[P+1,w+1,D+1],bo=[P+1,w,D+1]):B===-1?(ho=[P,w,D+1],mo=[P,w+1,D+1],po=[P,w+1,D],bo=[P,w,D]):G===1?(ho=[P,w+1,D],mo=[P,w+1,D+1],po=[P+1,w+1,D+1],bo=[P+1,w+1,D]):G===-1?(ho=[P,w,D+1],mo=[P,w,D],po=[P+1,w,D],bo=[P+1,w,D+1]):io===1?(ho=[P+1,w,D+1],mo=[P+1,w+1,D+1],po=[P,w+1,D+1],bo=[P,w,D+1]):(ho=[P,w,D],mo=[P,w+1,D],po=[P+1,w+1,D],bo=[P+1,w,D]),G===1){let Me=E+(15-2*Co)/16;Me>m&&(m=Me)}f.quadDa(R(...ho,J,X,Ao,Co,ho[1]===w+1),R(...mo,J,X,Ao,Co,mo[1]===w+1),R(...po,J,X,Ao,Co,po[1]===w+1),R(...bo,J,X,Ao,Co,bo[1]===w+1)),O<c&&(c=O),O+1>d&&(d=O+1)}if(N.cappello&&a>0&&!i.tipo(g,E+1,M)){let[B,G]=v(g,E+1,M);x.ciuffo(g,E,M,s,u,L.cima,B,a/2,G),E+2+Eo>d&&(d=E+2+Eo)}}),c>d&&(c=0,d=0),{...l.dati(),minY:c,maxY:d,y0:-Eo,cx:r,cz:n,altezze:h,acqua:{...f.dati(),pelo:m===-1/0?null:m},erba:x.dati()}}function at(i,e,a,o,t){let r=(o-e+1)*F,n=(t-a+1)*F,s=new Uint8Array(r*n);for(let u of i){if(!u.altezze)continue;let l=(u.cx-e)*F,f=(u.cz-a)*F;for(let m=0;m<F;m++)for(let h=0;h<F;h++){let c=u.altezze[m*F+h];s[(f+h)*r+(l+m)]=c<0?0:Math.max(0,Math.min(255,c+1))}}return{byte:s,x0:e*F,z0:a*F,larghezza:r,profondita:n}}function _o(i,e,a){let o=i*374761393+e*668265263+a*1442695041|0;return o=Math.imul(o^o>>>13,1274126177),((o^o>>>16)>>>0)/4294967296}function it(i){return i*i*(3-2*i)}function Ee(i,e,a){let o=Math.floor(i),t=Math.floor(e),r=it(i-o),n=it(e-t),s=_o(o,t,a),u=_o(o+1,t,a),l=_o(o,t+1,a),f=_o(o+1,t+1,a);return s+(u-s)*r+(l-s)*n+(s-u-l+f)*r*n}var Lo=5;function rt(i,e=1,a=64){i.svuota();let o=[],t=[],r=new Map,n=[];for(let f=-a;f<=a;f++)for(let m=-a;m<=a;m++){let h=.55*Ee(f*.028,m*.028,e)+.3*Ee(f*.07,m*.07,e+11)+.15*Ee(f*.16,m*.16,e+29),c=Math.max(2,1+Math.round(Math.pow(Math.max(0,h),1.6)*22)),d=Math.max(Math.abs(f),Math.abs(m)),b=Math.min(1,Math.max(0,(a-2-d)/8)),p=b*b*(3-2*b);c=Math.round(c*p+(Lo+1)*(1-p));let T=c<=Lo+1;r.set(f+"|"+m,c);for(let x=0;x<c;x++){let _=x===c-1?T?"sabbia":"erba":x<c-3?"roccia":"terra";i.metti(f,x,m,_,!0)}if(c<=Lo)for(let x=c;x<=Lo;x++)i.metti(f,x,m,"acqua",!0);else if(!T){let x=_o(f*3+1,m*3+7,e+101);if(x>.988&&o.length<90?o.push([f,c,m]):x<.004&&t.length<14&&t.push([f,c,m]),c>=Lo+6){let v=_o(f*5+3,m*5+11,e+57);v>.99&&n.push({x:f,z:m,h:c,r:v})}}}let s=aa(i,r,e,n,a),u=f=>!s.has(f[0]+"|"+f[2]),l=[...s].map(f=>{let[m,h]=f.split("|").map(Number);return[m,r.get(f)-2,h]});return{alberi:o.filter(u),lampioni:t.filter(u),fiume:l}}var ta=[[1,0],[-1,0],[0,1],[0,-1]];function aa(i,e,a,o,t=64){let r=new Set;o.sort((u,l)=>l.h-u.h||u.r-l.r);let n=[];for(let u of o){if(n.length>=5)break;n.every(l=>(l.x-u.x)**2+(l.z-u.z)**2>=784)&&n.push(u)}let s=(u,l)=>{let f=u+"|"+l;if(r.has(f))return;let m=e.get(f);i.togli(u,m-1,l,!0),i.togli(u,m-2,l,!0),i.metti(u,m-2,l,"acqua",!0),r.add(f)};for(let u of n){let l=u.x,f=u.z,m=null,h=0,c=new Set([l+"|"+f]);for(let d=0;d<500;d++){let b=e.get(l+"|"+f);if(s(l,f),m){let v=l+m[1],_=f-m[0];e.get(v+"|"+_)===b&&s(v,_)}let p=null,T=1/0,x=1/0;for(let v of ta){let _=l+v[0],C=f+v[1];if(c.has(_+"|"+C))continue;let R=e.get(_+"|"+C);if(R===void 0)continue;let z=(v===m?-.5:0)+_o(_*7+5,C*7+13,a+71);(R<T||R===T&&z<x)&&(p=v,T=R,x=z)}if(!p||T>b||(h=T===b?h+1:0,h>24)||(l+=p[0],f+=p[1],c.add(l+"|"+f),m=p,e.get(l+"|"+f)<=Lo)||Math.max(Math.abs(l),Math.abs(f))>=t-6)break}}for(let u of r){let[l,f]=u.split("|").map(Number),m=e.get(u);for(let h=-1;h<=1;h++)for(let c=-1;c<=1;c++){if(!h&&!c)continue;let d=l+h+"|"+(f+c);if(r.has(d))continue;let b=e.get(d);b===void 0||b<m||b>m+1||i.tipo(l+h,b-1,f+c)==="erba"&&(i.togli(l+h,b-1,f+c,!0),i.metti(l+h,b-1,f+c,"sabbia",!0))}}return r}function nt(i){let e=new DataView(i);if(String.fromCharCode(e.getUint8(0),e.getUint8(1),e.getUint8(2),e.getUint8(3))!=="LNM1")throw new Error("non \xE8 un modello del nucleo");let a=e.getUint32(4,!0),o=a*3,t=new Uint8Array(i,8,o*16),r=new Uint8Array(i,8+o*16,o*4),n=new Uint8Array(o*20);for(let m=0;m<o;m++)n.set(t.subarray(m*16,m*16+16),m*20),n.set(r.subarray(m*4,m*4+4),m*20+16);let s=1/0,u=-1/0,l=0,f=new DataView(n.buffer);for(let m=0;m<o;m++){let h=f.getFloat32(m*20,!0),c=f.getFloat32(m*20+4,!0),d=f.getFloat32(m*20+8,!0);s=Math.min(s,c),u=Math.max(u,c),l=Math.max(l,Math.hypot(h,d))}return{byte:n,vertici:o,triangoli:a,minY:s,maxY:u,raggio:l}}var ia=`#version 300 es
precision highp float;
...
mandami quello.`)}}};var q=document.getElementById("tela"),pa=document.getElementById("stato"),da=document.getElementById("fps"),Z=new URLSearchParams(location.search),y={raggio:+(Z.get("raggio")||5),erba:+(Z.get("erba")??8),ombra:Z.get("ombra")!=="no",specchio:Z.get("specchio")==="no"?0:Math.max(.2,Math.min(1,+(Z.get("specchio")??.5)||.5)),dprMax:+(Z.get("dpr")||1.5),rampa:Z.has("rampa"),tutto:Z.has("tutto"),mondo:Z.has("finto")||Z.has("rampa")?0:Math.max(16,Math.min(400,+(Z.get("mondo")||48))),ora:Z.has("ora")?Math.max(0,Math.min(1,+Z.get("ora"))):null},{gl:No,dpr:ba,ridimensiona:va}=Te(q,{antialias:!0,dprMax:y.dprMax}),A=new ko(No),Q=new Ko(No);A.ombra=y.ombra;A.specchio.attivo=y.specchio>0;A.specchio.scala=y.specchio||.5;A.specchio.mostra=Z.has("vedi");var te=0,So=0;function dt(i,e){let a=performance.now();for(let r of[...A.chunks.keys()])A.rimuovi(r);te=0;for(let r=-i;r<i;r++)for(let n=-i;n<i;n++)A.carica(r+","+n,Le(r,n,{erba:e})),te+=256;let o=i*2*16,t=new Uint8Array(o*o);for(let r=0;r<o;r++)for(let n=0;n<o;n++)t[r*o+n]=zo(n-i*16,r-i*16)+1;A.impostaAltezze(t,-i*16,-i*16,o,o),So=performance.now()-a}var ao=null,bt=0,vt=0;function ga(i,e){let a=performance.now();for(let h of[...A.chunks.keys()])A.rimuovi(h);Ke(),ao=new $o;let{alberi:o,lampioni:t}=rt(ao,4242,i);for(let[h,c,d]of o)ao.metti(h,c,d,"albero",!0);for(let[h,c,d]of t)ao.metti(h,c,d,"lampione",!0);let r=performance.now()-a,n=[],s=1e9,u=1e9,l=-1e9,f=-1e9;for(let h of ao.chunks.keys()){let c=tt(ao,h,{erba:e});A.carica(h,c),n.push(c),s=Math.min(s,c.cx),l=Math.max(l,c.cx),u=Math.min(u,c.cz),f=Math.max(f,c.cz)}let m=at(n,s,u,l,f);return A.impostaAltezze(m.byte,m.x0,m.z0,m.larghezza,m.profondita),te=bt=ao.contaBlocchi,vt=n.length,So=performance.now()-a,{tGen:r,tMesh:So-r}}var Ae=null;y.mondo?Ae=ga(y.mondo,y.erba):dt(y.raggio,y.erba);async function xa(){if(!ao)return;let i=new Map;ao.perOgni((e,a,o,t)=>{let r=$(t);r.forma!=="modello"||!r.modello||(i.has(r.modello)||i.set(r.modello,[]),i.get(r.modello).push(e+.5,a,o+.5,1))});for(let[e,a]of i)try{let o=await fetch(`./modelli/nucleo/${e}.bin`);if(!o.ok)throw new Error(`${o.status}`);Q.registra(e,nt(await o.arrayBuffer())),Q.istanze(e,a)}catch(o){console.warn(`modello ${e}: ${o.message}`)}}xa();A.tutto=y.tutto;var Ea=()=>{if(!ao)return zo(0,0)+2;for(let i=120;i>-Eo;i--)if(ao.tipo(0,i,0))return i+2;return 8},U={alpha:-.8,beta:1.05,raggio:46,centro:[0,Ea(),0],fov:.9};function gt(){let i=Math.sin(U.beta),e=Math.cos(U.beta);return[U.centro[0]+U.raggio*i*Math.cos(U.alpha),U.centro[1]+U.raggio*e,U.centro[2]+U.raggio*i*Math.sin(U.alpha)]}var Io=null,Qo=0;q.addEventListener("pointerdown",i=>{Io={x:i.clientX,y:i.clientY},q.setPointerCapture(i.pointerId)});q.addEventListener("pointermove",i=>{Io&&(U.alpha+=(i.clientX-Io.x)*.006,U.beta=Math.max(.15,Math.min(1.5,U.beta-(i.clientY-Io.y)*.006)),Io={x:i.clientX,y:i.clientY})});q.addEventListener("pointerup",()=>{Io=null});q.addEventListener("wheel",i=>{U.raggio=Math.max(8,Math.min(140,U.raggio*(i.deltaY>0?1.1:.9))),i.preventDefault()},{passive:!1});q.addEventListener("touchstart",i=>{i.touches.length===2&&(Qo=Math.hypot(i.touches[0].clientX-i.touches[1].clientX,i.touches[0].clientY-i.touches[1].clientY))},{passive:!0});q.addEventListener("touchmove",i=>{if(i.touches.length!==2)return;let e=Math.hypot(i.touches[0].clientX-i.touches[1].clientX,i.touches[0].clientY-i.touches[1].clientY);Qo>0&&(U.raggio=Math.max(8,Math.min(140,U.raggio*Qo/e))),Qo=e},{passive:!0});var Jo=y.ora??.35;function Aa(i){y.ora===null&&(Jo=(Jo+i/300)%1);let e=Jo*Math.PI*2-Math.PI/2,a=.24+.5*Math.max(0,Math.sin(e)),o=e*.5;A.sole.verso=[-Math.cos(o)*Math.cos(Math.asin(a)),-a,-Math.sin(o)*Math.cos(Math.asin(a))];let t=Math.max(0,Math.min(1,(Math.sin(e)+.1)*2));A.sole.forza=t;let r=Math.min(1,Math.max(0,(a-.24)/.4));A.sole.colore=[1,.78+.22*r,.55+.45*r],A.sole.cielo=[.36+.64*t,.38+.62*t,.57+.43*t],A.nebbia.colore=[.25+.47*t,.35+.5*t,.5+.42*t],No.clearColor(A.nebbia.colore[0],A.nebbia.colore[1],A.nebbia.colore[2],1)}var H=[],lo=[],oe=[],ht=performance.now(),xt=0,mt=0;function Et(i){let e=Math.min(.1,(i-ht)/1e3);ht=i;let a=performance.now();va(),Aa(e);let t={occhio:gt(),centro:U.centro,fov:U.fov,rapporto:q.width/q.height};A.disegna(t,e,Q),Q.disegna(A,t),A.disegnaAcqua();let r=performance.now()-a;H.push(e*1e3),H.length>240&&H.shift(),lo.push(r),lo.length>240&&lo.shift(),xt++,i-mt>500&&(mt=i,At()),y.rampa&&!y.mondo&&Ma(i),requestAnimationFrame(Et)}var ee=[{raggio:5,erba:2,tutto:!1},{raggio:6,erba:3,tutto:!1},{raggio:7,erba:4,tutto:!1},{raggio:6,erba:3,tutto:!0},{raggio:8,erba:4,tutto:!0}],ae=[],Ro=-1,pt=0;function Ma(i){if(Ro>=0&&i-pt<6e3)return;if(Ro>=0){let a=H.slice(-Math.min(H.length,200)),o=ee[Ro];ae.push({...o,fps:+(1e3/(k(a,.5)||1)).toFixed(0),p50:+k(a,.5).toFixed(1),p99:+k(a,.99).toFixed(1),js:+k(lo,.5).toFixed(2),disegni:A.statistiche.disegni,triangoli:A.statistiche.triangoli})}if(Ro++,Ro>=ee.length){y.rampa=!1,At();return}let e=ee[Ro];dt(e.raggio,e.erba),A.tutto=e.tutto,y.erba=e.erba,y.raggio=e.raggio,H.length=0,lo.length=0,pt=i}var k=(i,e)=>{if(!i.length)return 0;let a=i.slice().sort((o,t)=>o-t);return a[Math.min(a.length-1,Math.floor(a.length*e))]};function At(){let i=k(H,.5),e=k(H,.99),a=i?1e3/i:0;oe.push(Math.round(a)),oe.length>120&&oe.shift();let o={disegni:A.statistiche.disegni+Q.statistiche.disegni+A.statistiche.disegniAcqua+A.statistiche.disegniErba+A.statistiche.disegniSpecchio,triangoli:A.statistiche.triangoli+Q.statistiche.triangoli+A.statistiche.triangoliAcqua+A.statistiche.triangoliErba+A.statistiche.triangoliSpecchio,chunkVisti:A.statistiche.chunkVisti,chunkTotali:A.statistiche.chunkTotali};da.textContent=`${a.toFixed(0)} fps
...
ombra del sole: ${A.ombra?"horizon mapping":"spenta"} \xB7 erba ${y.erba} \xB7 modelli ${Q.statistiche.istanze} istanze in ${Q.statistiche.disegni} disegni \xB7 acqua ${A.statistiche.disegniAcqua} disegni${A.statistiche.pelo!=null?` + specchio ${A.statistiche.disegniSpecchio} disegni (pelo ${A.statistiche.pelo.toFixed(2)}, scala ${A.specchio.scala})`:" (senza specchio)"} \xB7 erba ${A.statistiche.triangoliErba.toLocaleString("it")} fili in ${A.statistiche.disegniErba} disegni \xB7 costruzione ${So.toFixed(0)} ms
${Bo(No)}
?mondo=96 ?ora=0.95 ?finto ?raggio=${y.raggio} ?erba=${y.erba} ?ombra=${y.ombra?"s\xEC":"no"} ?specchio=${y.specchio||"no"} ?dpr=${y.dprMax} ?rampa ?tutto  \xB7  tocca lo schermo per girare`+(ae.length?`
RAMPA  fps  p50   p99   dis  triangoli
`+ae.map(t=>`r${t.raggio} e${t.erba}${t.tutto?" tutto":""}  ${String(t.fps).padStart(3)}  ${String(t.p50).padStart(5)}  ${String(t.p99).padStart(5)}  ${String(t.disegni).padStart(3)}  ${t.triangoli.toLocaleString("it")}`).join(`
`):"")+(y.rampa?`
rampa: gradino ${Ro+1}/${ee.length}\u2026`:"")}requestAnimationFrame(Et);var Ta=new Wo(()=>({versione:(document.getElementById("versione")||{}).textContent||"nucleo in sviluppo",mobile:matchMedia("(pointer: coarse)").matches,tocco:navigator.maxTouchPoints>0,modoGui:"nucleo",ua:navigator.userAgent,cpu:navigator.hardwareConcurrency||null,memoriaGB:navigator.deviceMemory||null,css:[q.clientWidth,q.clientHeight],reso:[q.width,q.height],dpr:devicePixelRatio,livello:0,quantiLivelli:1,manuale:!0,profilo:{banco:y.mondo?"nucleo F1 mondo vero":"nucleo F0",mondo:y.mondo,raggio:y.raggio,erba:y.erba,ombra:A.ombra,specchio:y.specchio,disegniSpecchio:A.statistiche.disegniSpecchio,tutto:!!A.tutto,dprMax:y.dprMax,jsMs:+k(lo,.5).toFixed(2),jsP99:+k(lo,.99).toFixed(2),rampa:ae},ombreLampade:!1,antialias:!0,fps:k(H,.5)?1e3/k(H,.5):null,p50:k(H,.5),p99:k(H,.99),disegni:A.statistiche.disegni+Q.statistiche.disegni+A.statistiche.disegniAcqua+A.statistiche.disegniErba+A.statistiche.disegniSpecchio,triangoli:A.statistiche.triangoli+Q.statistiche.triangoli+A.statistiche.triangoliAcqua+A.statistiche.triangoliErba+A.statistiche.triangoliSpecchio,ombreMs:0,storiaFps:oe,storiaLivelli:[],scheda:Bo(No),software:/swiftshader|llvmpipe/i.test(Bo(No)),chunk:A.statistiche.chunkTotali,blocchi:te,luci:0,decorazioni:Q.statistiche.istanze,erba:A.statistiche.triangoliErba,ora:`${Math.floor(Jo*24)}h`,giorno:0,worldgenMs:So,meshMs:So}),()=>{let i=gt();return A.disegna({occhio:i,centro:U.centro,fov:U.fov,rapporto:q.width/q.height},0),Promise.resolve(q.toDataURL("image/webp",.6))});globalThis.NUCLEO={resa:A,modelli:Q,cam:U,opz:y,statistiche:()=>({fps:1e3/(k(H,.5)||1),p50:k(H,.5),p99:k(H,.99),js:k(lo,.5),...A.statistiche,modelli:{...Q.statistiche},costruzioneMs:So,fotogrammi:xt}),diagnostica:Ta};

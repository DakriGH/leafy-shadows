function Co(i,{antialias:e=!0,dprMax:t=1.5}={}){let o=i.getContext("webgl2",{antialias:e,alpha:!1,depth:!0,stencil:!1,preserveDrawingBuffer:!1,powerPreference:"high-performance",desynchronized:!1});if(!o)throw new Error("WebGL2 non disponibile");let a=Math.min(t,devicePixelRatio||1),n=()=>{let l=Math.max(1,Math.round(i.clientWidth*a)),r=Math.max(1,Math.round(i.clientHeight*a));return i.width!==l||i.height!==r?(i.width=l,i.height=r,o.viewport(0,0,l,r),!0):!1};return n(),{gl:o,dpr:a,ridimensiona:n}}function oe(i,e,t){let o=(n,l)=>{let r=i.createShader(n);if(i.shaderSource(r,l),i.compileShader(r),!i.getShaderParameter(r,i.COMPILE_STATUS))throw new Error(`shader: ${i.getShaderInfoLog(r)}
${l.split(`
`).map((f,c)=>`${c+1}: ${f}`).join(`
`)}`);return r},a=i.createProgram();if(i.attachShader(a,o(i.VERTEX_SHADER,e)),i.attachShader(a,o(i.FRAGMENT_SHADER,t)),i.linkProgram(a),!i.getProgramParameter(a,i.LINK_STATUS))throw new Error(`programma: ${i.getProgramInfoLog(a)}`);return a}function ke(i){let e=i.getExtension("WEBGL_debug_renderer_info");return e?i.getParameter(e.UNMASKED_RENDERER_WEBGL):i.getParameter(i.RENDERER)}function K(i,e,t){return(Math.sign(i)+1)*9+(Math.sign(e)+1)*3+(Math.sign(t)+1)}var Oa=K(1,0,0),La=K(-1,0,0),Ia=K(0,1,0),Na=K(0,-1,0),ya=K(0,0,1),Fa=K(0,0,-1);var _o=[Oa,La,Ia,Na,ya,Fa],ze=class{constructor(e=1024){this.byte=new Uint8Array(e*4*12),this.u32=new Uint32Array(this.byte.buffer),this.n=0,this.quad=0}_spazio(e){let t=(this.n+e)*12;if(t<=this.byte.length)return;let o=this.byte.length*2;for(;o<t;)o*=2;let a=new Uint8Array(o);a.set(this.byte),this.byte=a,this.u32=new Uint32Array(a.buffer)}vertice(e,t,o,a,n,l,r,f=0,c=0){let u=Math.round(e*16)+16,p=Math.round(o*16)+16,m=Math.round(t*16);if(u<0||u>511||p<0||p>511||m<0||m>65535)throw new RangeError(`vertice fuori dal chunk: ${e},${t},${o}`);if(a<0||a>26||a===13)throw new RangeError(`normale non valida: ${a}`);this._spazio(1);let s=this.n*3,d=this.byte,v=this.u32;v[s]=(u|p<<9|(a&31)<<18|(f&1)<<23|(c&15)<<24)>>>0,v[s+1]=(m|(n&15)<<16|(l&15)<<20)>>>0;let h=this.n*12+8;d[h]=r>>16&255,d[h+1]=r>>8&255,d[h+2]=r&255,d[h+3]=0,this.n++}quadDa(e,t,o,a){if(this.quad>=16384)throw new RangeError("troppi quad per un chunk");for(let n of[e,t,o,a])this.vertice(...n);this.quad++}dati(){return{byte:this.byte.subarray(0,this.n*12),quad:this.quad,vertici:this.n,triangoli:this.quad*2}}};function Oo(i=16384){let e=new Uint16Array(i*6);for(let t=0,o=0,a=0;t<i;t++,a+=4)e[o++]=a,e[o++]=a+1,e[o++]=a+2,e[o++]=a,e[o++]=a+2,e[o++]=a+3;return e}function Lo(i,e,t,o){let a=1/Math.tan(i/2),n=1/(t-o);return new Float32Array([a/e,0,0,0,0,a,0,0,0,0,(o+t)*n,-1,0,0,2*o*t*n,0])}function uo(i,e,t){let o=1/(t-e);return new Float32Array([1/i,0,0,0,0,1/i,0,0,0,0,-2*o,0,0,0,-(t+e)*o,1])}function Xe(i,e,t=[0,1,0]){let o=i[0]-e[0],a=i[1]-e[1],n=i[2]-e[2],l=Math.hypot(o,a,n)||1;o/=l,a/=l,n/=l;let r=t[1]*n-t[2]*a,f=t[2]*o-t[0]*n,c=t[0]*a-t[1]*o;l=Math.hypot(r,f,c)||1,r/=l,f/=l,c/=l;let u=a*c-n*f,p=n*r-o*c,m=o*f-a*r;return new Float32Array([r,u,o,0,f,p,a,0,c,m,n,0,-(r*i[0]+f*i[1]+c*i[2]),-(u*i[0]+p*i[1]+m*i[2]),-(o*i[0]+a*i[1]+n*i[2]),1])}function Io(i,e=new Float32Array(16)){let[t,o,a,n,l,r,f,c,u,p,m,s,d,v,h,b]=i,x=t*r-o*l,g=t*f-a*l,z=t*c-n*l,C=o*f-a*r,R=o*c-n*r,_=a*c-n*f,A=u*v-p*d,I=u*h-m*d,O=u*b-s*d,E=p*h-m*v,M=p*b-s*v,S=m*b-s*h,N=x*S-g*M+z*E+C*O-R*I+_*A;return N?(N=1/N,e[0]=(r*S-f*M+c*E)*N,e[1]=(a*M-o*S-n*E)*N,e[2]=(v*_-h*R+b*C)*N,e[3]=(m*R-p*_-s*C)*N,e[4]=(f*O-l*S-c*I)*N,e[5]=(t*S-a*O+n*I)*N,e[6]=(h*z-d*_-b*g)*N,e[7]=(u*_-m*z+s*g)*N,e[8]=(l*M-r*O+c*A)*N,e[9]=(o*O-t*M-n*A)*N,e[10]=(d*R-v*z+b*x)*N,e[11]=(p*z-u*R-s*x)*N,e[12]=(r*I-l*E-f*A)*N,e[13]=(t*E-o*I+a*A)*N,e[14]=(v*g-d*C-h*x)*N,e[15]=(u*C-p*g+m*x)*N,e):null}function Pe(i,e,t=new Float32Array(16)){for(let o=0;o<4;o++)for(let a=0;a<4;a++)t[o*4+a]=i[a]*e[o*4]+i[4+a]*e[o*4+1]+i[8+a]*e[o*4+2]+i[12+a]*e[o*4+3];return t}function fo(i,e=new Float32Array(24)){let t=f=>[i[f],i[4+f],i[8+f],i[12+f]],o=t(0),a=t(1),n=t(2),l=t(3),r=[[l[0]+o[0],l[1]+o[1],l[2]+o[2],l[3]+o[3]],[l[0]-o[0],l[1]-o[1],l[2]-o[2],l[3]-o[3]],[l[0]+a[0],l[1]+a[1],l[2]+a[2],l[3]+a[3]],[l[0]-a[0],l[1]-a[1],l[2]-a[2],l[3]-a[3]],[l[0]+n[0],l[1]+n[1],l[2]+n[2],l[3]+n[3]],[l[0]-n[0],l[1]-n[1],l[2]-n[2],l[3]-n[3]]];for(let f=0;f<6;f++){let[c,u,p,m]=r[f],s=Math.hypot(c,u,p)||1;e[f*4]=c/s,e[f*4+1]=u/s,e[f*4+2]=p/s,e[f*4+3]=m/s}return e}function mo(i,e,t,o,a,n,l){for(let r=0;r<6;r++){let f=i[r*4],c=i[r*4+1],u=i[r*4+2],p=i[r*4+3],m=f>0?a:e,s=c>0?n:t,d=u>0?l:o;if(f*m+c*s+u*d+p<0)return!1}return!0}var Pa=`#version 300 es
...
}`),this.uOmbre={};for(let n of["uAltezze","uAltRett","uSole","uCodifica"])this.uOmbre[n]=o.getUniformLocation(this.programmaOmbre,n);this.vaoOmbre=o.createVertexArray()}}_calcolaOmbre(){let e=this.gl,t=this.ombre,o=this.sole;if(!this.altezze||!t.tex||(o.verso[0]*t.sole[0]+o.verso[1]*t.sole[1]+o.verso[2]*t.sole[2]<.99996&&(t.sole=o.verso.slice(),t.sporco=[0,0,t.w,t.h]),!t.sporco))return;let n=96,[l,r,f,c]=t.sporco;if(f<=l||c<=r){t.sporco=null;return}let u=Math.min(c,r+n);t.sporco=u>=c?null:[l,u,f,c];let p=Math.hypot(o.verso[0],o.verso[2])||1e-4,m=[-o.verso[0]/p,-o.verso[2]/p],s=Math.max(.05,-o.verso[1]/p);e.bindFramebuffer(e.FRAMEBUFFER,t.fbo),e.viewport(0,0,t.w,t.h),e.enable(e.SCISSOR_TEST),e.scissor(l,r,f-l,u-r),e.disable(e.DEPTH_TEST),e.disable(e.CULL_FACE),e.useProgram(this.programmaOmbre),e.activeTexture(e.TEXTURE0),e.bindTexture(e.TEXTURE_2D,this.altezze),e.uniform1i(this.uOmbre.uAltezze,0),e.uniform4f(this.uOmbre.uAltRett,0,0,1/t.w,1/t.h),e.uniform3f(this.uOmbre.uSole,m[0],m[1],s),e.uniform2f(this.uOmbre.uCodifica,t.scala,t.offset),e.bindVertexArray(this.vaoOmbre),e.drawArrays(e.TRIANGLES,0,3),e.bindVertexArray(null),e.disable(e.SCISSOR_TEST),e.enable(e.DEPTH_TEST),e.enable(e.CULL_FACE),e.bindFramebuffer(e.FRAMEBUFFER,null),e.viewport(0,0,e.drawingBufferWidth,e.drawingBufferHeight),t.calcoli++,this.statistiche.calcoliOmbre=t.calcoli}_disegnaCielo(e,t){let o=this.gl,a=this.uc,n=this.sole;if(this.cieloNero||!Io(e,this._invVP))return;o.useProgram(this.programmaCielo),o.uniformMatrix4fv(a.uInvVP,!1,this._invVP),o.uniform3f(a.uOcchio,t[0],t[1],t[2]),o.uniform3f(a.uSoleVerso,n.verso[0],n.verso[1],n.verso[2]),o.uniform1f(a.uSoleForza,n.forza),o.uniform3f(a.uNebbiaCol,this.nebbia.colore[0],this.nebbia.colore[1],this.nebbia.colore[2]);let l=n.forza;o.uniform3f(a.uZenit,.04+.32*l,.06+.56*l,.14+.82*l),o.disable(o.DEPTH_TEST),o.depthMask(!1),o.disable(o.CULL_FACE),o.bindVertexArray(this.vaoVuoto),o.drawArrays(o.TRIANGLES,0,3),o.bindVertexArray(null),o.enable(o.CULL_FACE),o.depthMask(!0),o.enable(o.DEPTH_TEST)}_preparaMappa(){let e=this.gl,t=this.mappa,o=a=>{let n=e.createTexture();e.bindTexture(e.TEXTURE_2D,n),e.texImage2D(e.TEXTURE_2D,0,e.DEPTH_COMPONENT24,a,a,0,e.DEPTH_COMPONENT,e.UNSIGNED_INT,null),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MIN_FILTER,e.LINEAR),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MAG_FILTER,e.LINEAR),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_S,e.CLAMP_TO_EDGE),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_T,e.CLAMP_TO_EDGE),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_COMPARE_MODE,e.COMPARE_REF_TO_TEXTURE),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_COMPARE_FUNC,e.LEQUAL);let l=e.createFramebuffer();e.bindFramebuffer(e.FRAMEBUFFER,l),e.framebufferTexture2D(e.FRAMEBUFFER,e.DEPTH_ATTACHMENT,e.TEXTURE_2D,n,0),e.drawBuffers([e.NONE]),e.readBuffer(e.NONE);let r=e.checkFramebufferStatus(e.FRAMEBUFFER)===e.FRAMEBUFFER_COMPLETE;return e.bindFramebuffer(e.FRAMEBUFFER,null),{tex:n,fbo:l,lato:a,ok:r}};t.stat=o(t.lato),t.din=o(t.latoDin),(!t.stat.ok||!t.din.ok)&&(t.attiva=!1)}legaMappa(e){let t=this.gl,o=this.mappa;t.activeTexture(t.TEXTURE1),t.bindTexture(t.TEXTURE_2D,o.stat.tex),t.uniform1i(e.uMappaStat,1),t.activeTexture(t.TEXTURE2),t.bindTexture(t.TEXTURE_2D,o.din.tex),t.uniform1i(e.uMappaDin,2),t.activeTexture(t.TEXTURE0),t.uniform1f(e.uMappaOn,o.on?1:0),t.uniformMatrix4fv(e.uLuceVP,!1,o.vp),t.uniformMatrix4fv(e.uLuceVPDin,!1,o.vpDin),t.uniform2f(e.uMappaTexel,.5/o.lato,.5/o.latoDin),t.uniform2f(e.uMappaSbieco,1.5*(2*o.raggio/o.lato),.1/220),t.uniform4fv(e.uLampade,this.lampade),t.uniform1i(e.uNLampade,this.nLampade),t.uniform3f(e.uStile,this.stile.tinta,this.stile.saturazione,this.stile.valore),this.altezze&&(t.activeTexture(t.TEXTURE3),t.bindTexture(t.TEXTURE_2D,this.altezze),t.uniform1i(e.uAltezze,3),t.activeTexture(t.TEXTURE0))}_aggiornaMappa(e,t){let o=this.gl,a=this.mappa,n=this.sole,l=this.statistiche;if(a.on=!1,!a.attiva||!this.ombra)return;let r=typeof performance<"u"?performance.now():0,f=e.centro[0],c=e.centro[2],u=!1;Math.hypot(f-a.centro[0],c-a.centro[2])>10&&(a.centro=[Math.round(f/2)*2,Math.round(e.centro[1]),Math.round(c/2)*2],u=!0);{let h=n.verso,b=e.centro,x=[b[0]-h[0]*120,b[1]-h[1]*120,b[2]-h[2]*120],g=Math.abs(h[1])>.95?[0,0,1]:[0,1,0];Pe(uo(a.raggioDin,10,230),Xe(x,b,g),a.vpDin)}n.verso[0]*a.sole[0]+n.verso[1]*a.sole[1]+n.verso[2]*a.sole[2]<.99985&&(a.soleMosso=!0);let m=a.sporca||a.soleMosso||t&&t.mappaSporca,s=u||m&&r-(a.ultimo||0)>=500;if(s){a.sole=n.verso.slice(),a.soleMosso=!1,a.ultimo=r;let h=n.verso,b=a.centro,x=[b[0]-h[0]*120,b[1]-h[1]*120,b[2]-h[2]*120],g=Math.abs(h[1])>.95?[0,0,1]:[0,1,0];Pe(uo(a.raggio,10,230),Xe(x,b,g),a.vp)}if(o.enable(o.POLYGON_OFFSET_FILL),o.polygonOffset(1.5,4),s){o.bindFramebuffer(o.FRAMEBUFFER,a.stat.fbo),o.viewport(0,0,a.stat.lato,a.stat.lato),o.clear(o.DEPTH_BUFFER_BIT),o.useProgram(this.programmaOmbra),o.uniformMatrix4fv(this.uo.uVP,!1,a.vp);let h=0,b=0,x=a.raggio+12;for(let g of this.chunks.values())g.quad!==0&&(Math.hypot(g.x0+8-a.centro[0],g.z0+8-a.centro[2])>x||(o.uniform3f(this.uo.uChunk,g.chunk[0],g.chunk[1],g.chunk[2]),o.bindVertexArray(g.vao),o.drawElements(o.TRIANGLES,g.quad*6,o.UNSIGNED_SHORT,0),h++,b+=g.quad*2));if(o.bindVertexArray(null),t){let[g,z]=t.disegnaOmbra(a.vp,!1);h+=g,b+=z,t.mappaSporca=!1}a.sporca=!1,a.calcoli++,a.disegni=h,a.triangoli=b}o.bindFramebuffer(o.FRAMEBUFFER,a.din.fbo),o.viewport(0,0,a.din.lato,a.din.lato),o.clear(o.DEPTH_BUFFER_BIT);let d=0,v=0;t&&([d,v]=t.disegnaOmbra(a.vpDin,!0)),o.disable(o.POLYGON_OFFSET_FILL),o.bindFramebuffer(o.FRAMEBUFFER,null),o.viewport(0,0,o.drawingBufferWidth,o.drawingBufferHeight),a.on=!0,l.calcoliMappa=a.calcoli,l.disegniOmbra=d+(s?a.disegni:0),l.triangoliOmbra=v+(s?a.triangoli:0)}impostaAltezze(e,t,o,a,n,l=null){let r=this.gl;this.altezze||(this.altezze=r.createTexture()),r.bindTexture(r.TEXTURE_2D,this.altezze),r.pixelStorei(r.UNPACK_ALIGNMENT,1);let f=new Uint8Array(a*n*4);for(let c=0;c<a*n;c++)f[c*4]=e[c],f[c*4+1]=l?l[c]:e[c];r.texImage2D(r.TEXTURE_2D,0,r.RGBA8,a,n,0,r.RGBA,r.UNSIGNED_BYTE,f),r.texParameteri(r.TEXTURE_2D,r.TEXTURE_MIN_FILTER,r.NEAREST),r.texParameteri(r.TEXTURE_2D,r.TEXTURE_MAG_FILTER,r.NEAREST),r.texParameteri(r.TEXTURE_2D,r.TEXTURE_WRAP_S,r.CLAMP_TO_EDGE),r.texParameteri(r.TEXTURE_2D,r.TEXTURE_WRAP_T,r.CLAMP_TO_EDGE),this.altRett=[t,o,1/a,1/n],this._preparaOmbre(a,n)}impostaMaterie(e){let t=new Float32Array(64);for(let o=0;o<16&&o<e.length;o++)for(let a=0;a<4;a++)t[o*4+a]=e[o][a]||0;this.materie=t}disegna(e,t,o=null){let a=this.gl,n=this.statistiche;this.tempo+=t;let l=Lo(e.fov,e.rapporto,.3,400),r=Xe(e.occhio,e.centro);Pe(l,r,this.vp),fo(this.vp,this.piani),this._camera=e,this._visibili.length=0,this._visibiliErba.length=0;let f=0;for(let s of this.chunks.values())s.quad===0&&s.quadAcqua===0||(s.visto=this.tutto||mo(this.piani,s.x0,s.y0+s.minY,s.z0,s.x0+16,s.y0+s.maxY+1,s.z0+16),s.visto&&(f++,s.quadAcqua>0&&this._visibili.push(s),s.verticiErba>0&&Math.hypot(s.x0+8-e.occhio[0],s.z0+8-e.occhio[2])<=this.erbaFinoA&&this._visibiliErba.push(s)));this.ombra&&this.altezze&&this._calcolaOmbre(),this._aggiornaMappa(e,o),n.disegniSpecchio=0,n.triangoliSpecchio=0,n.pelo=null,this.specchio.pelo=null,this.specchio.attivo&&this._visibili.length&&this._specchia(e,o),a.clear(a.COLOR_BUFFER_BIT|a.DEPTH_BUFFER_BIT),this._disegnaCielo(this.vp,e.occhio),this.taglio=-1e9,this.vpCorrente=this.vp;let[c,u]=this._solidi(this.vp,this.piani,e.occhio,!1),p=0,m=0;if(this._visibiliErba.length){let s=this.ue,d=this.sole;a.useProgram(this.programmaErba),a.uniformMatrix4fv(s.uVP,!1,this.vp),a.uniform1f(s.uTempo,this.tempo),a.uniform3f(s.uSoleVerso,d.verso[0],d.verso[1],d.verso[2]),a.uniform3f(s.uSoleCol,d.colore[0],d.colore[1],d.colore[2]),a.uniform1f(s.uSoleForza,d.forza),a.uniform3f(s.uCieloCol,d.cielo[0],d.cielo[1],d.cielo[2]),a.uniform2f(s.uNebbia,this.nebbia.da,this.nebbia.a),a.uniform3f(s.uNebbiaCol,this.nebbia.colore[0],this.nebbia.colore[1],this.nebbia.colore[2]),a.uniform3f(s.uCam,e.occhio[0],e.occhio[1],e.occhio[2]),a.uniform2f(s.uVento,Math.cos(this.tempo*.045),Math.sin(this.tempo*.045)),a.uniform1f(s.uOmbra,this.ombra&&this.altezze?1:0),a.uniform1f(s.uTaglio,-1e9),a.uniform1f(s.uErbaFinoA,this.erbaFinoA),a.uniform4f(s.uBuco,this.buco[0],this.buco[1],this.buco[2],this.buco[3]),a.uniform3f(s.uOcchio,e.occhio[0],e.occhio[1],e.occhio[2]),this.altezze&&(a.activeTexture(a.TEXTURE0),a.bindTexture(a.TEXTURE_2D,this.ombre.tex),a.uniform1i(s.uOmbre,0),a.uniform2f(s.uOmbreScala,this.ombre.scala,this.ombre.offset),a.uniform4f(s.uAltRett,this.altRett[0],this.altRett[1],this.altRett[2],this.altRett[3])),this.legaMappa(s),a.disable(a.CULL_FACE);for(let v of this._visibiliErba)a.uniform3f(s.uChunk,v.chunk[0],v.yBaseErba,v.chunk[2]),a.bindVertexArray(v.vaoErba),a.drawArraysInstanced(a.TRIANGLES,0,6,v.lamelle),p++,m+=v.lamelle*2;a.enable(a.CULL_FACE),a.bindVertexArray(null)}n.disegni=c,n.triangoli=u,n.chunkVisti=f,n.chunkTotali=this.chunks.size,n.disegniErba=p,n.triangoliErba=m}_solidi(e,t,o,a){let n=this.gl,l=this.u,r=this.sole;n.useProgram(this.programma),n.uniformMatrix4fv(l.uVP,!1,e),n.uniform1f(l.uTempo,this.tempo),n.uniform3f(l.uSoleVerso,r.verso[0],r.verso[1],r.verso[2]),n.uniform3f(l.uSoleCol,r.colore[0],r.colore[1],r.colore[2]),n.uniform1f(l.uSoleForza,r.forza),n.uniform3f(l.uCieloCol,r.cielo[0],r.cielo[1],r.cielo[2]),n.uniform4fv(l.uMaterie,this.materie),n.uniform2f(l.uNebbia,this.nebbia.da,this.nebbia.a),n.uniform3f(l.uNebbiaCol,this.nebbia.colore[0],this.nebbia.colore[1],this.nebbia.colore[2]),n.uniform3f(l.uCam,o[0],o[1],o[2]),n.uniform1f(l.uOmbra,this.ombra&&this.altezze?1:0),n.uniform1f(l.uTaglio,this.taglio);let f=a?[0,0,0,0]:this.buco;n.uniform4f(l.uBuco,f[0],f[1],f[2],f[3]),n.uniform3f(l.uOcchio,o[0],o[1],o[2]),this.altezze&&(n.activeTexture(n.TEXTURE0),n.bindTexture(n.TEXTURE_2D,this.ombre.tex),n.uniform1i(l.uOmbre,0),n.uniform2f(l.uOmbreScala,this.ombre.scala,this.ombre.offset),n.uniform4f(l.uAltRett,this.altRett[0],this.altRett[1],this.altRett[2],this.altRett[3])),this.legaMappa(l);let c=0,u=0;for(let p of this.chunks.values())if(p.quad!==0){if(a){if(!this.tutto&&!mo(t,p.x0,p.y0+p.minY,p.z0,p.x0+16,p.y0+p.maxY+1,p.z0+16))continue}else if(!p.visto)continue;n.uniform3f(l.uChunk,p.chunk[0],p.chunk[1],p.chunk[2]),n.bindVertexArray(p.vao),n.drawElements(n.TRIANGLES,p.quad*6,n.UNSIGNED_SHORT,0),c++,u+=p.quad*2}return n.bindVertexArray(null),[c,u]}_peloVicino(e){let t=this._voti;t.clear();for(let n of this._visibili){if(n.peloAcqua==null)continue;let l=Math.hypot(n.x0+8-e[0],n.z0+8-e[2])+2.2*Math.abs(n.peloAcqua-e[1]);t.set(n.peloAcqua,(t.get(n.peloAcqua)||0)+n.quadAcqua/(1+l))}let o=null,a=0;for(let[n,l]of t)l>a&&(a=l,o=n);return o}_specchia(e,t){let o=this.gl,a=this.specchio,n=this.statistiche,l=this._peloVicino(e.occhio);if(l==null||e.occhio[1]<=l+.2)return;let r=Math.max(1,Math.round(o.drawingBufferWidth*a.scala)),f=Math.max(1,Math.round(o.drawingBufferHeight*a.scala));(!a.fbo||a.w!==r||a.h!==f)&&this._preparaSpecchio(r,f);let c=this._riflessione;c.fill(0),c[0]=1,c[5]=-1,c[10]=1,c[13]=2*l,c[15]=1,Pe(this.vp,c,this.vpSpecchio),fo(this.vpSpecchio,this.pianiSpecchio);let u=[e.occhio[0],2*l-e.occhio[1],e.occhio[2]];o.bindFramebuffer(o.FRAMEBUFFER,a.fbo),o.viewport(0,0,r,f),o.clear(o.COLOR_BUFFER_BIT|o.DEPTH_BUFFER_BIT),this._disegnaCielo(this.vpSpecchio,u),o.cullFace(o.FRONT),this.taglio=l-.05,this.vpCorrente=this.vpSpecchio;let[p,m]=this._solidi(this.vpSpecchio,this.pianiSpecchio,u,!0);n.disegniSpecchio=p,n.triangoliSpecchio=m,t&&(t.disegna(this,{occhio:u,centro:e.centro,fov:e.fov,rapporto:e.rapporto}),n.disegniSpecchio+=t.statistiche.disegni,n.triangoliSpecchio+=t.statistiche.triangoli),o.cullFace(o.BACK),o.bindFramebuffer(o.FRAMEBUFFER,null),o.viewport(0,0,o.drawingBufferWidth,o.drawingBufferHeight),this.taglio=-1e9,a.pelo=l,n.pelo=l}_mostraSpecchio(){let e=this.gl,t=this.specchio;this.programmaQuad||(this.programmaQuad=oe(e,`#version 300 es
out vec2 vUv;
...
void main() { colore = vec4(texture(uTex, vUv).rgb, 1.0); }`),this.uQuad=e.getUniformLocation(this.programmaQuad,"uTex"),this.vaoQuad=e.createVertexArray()),e.useProgram(this.programmaQuad),e.activeTexture(e.TEXTURE0),e.bindTexture(e.TEXTURE_2D,t.tex),e.uniform1i(this.uQuad,0),e.bindVertexArray(this.vaoQuad),e.disable(e.DEPTH_TEST),e.drawArrays(e.TRIANGLE_STRIP,0,4),e.enable(e.DEPTH_TEST),e.bindVertexArray(null)}_preparaSpecchio(e,t){let o=this.gl,a=this.specchio;a.fbo||(a.fbo=o.createFramebuffer(),a.tex=o.createTexture(),a.rbo=o.createRenderbuffer()),o.bindTexture(o.TEXTURE_2D,a.tex),o.texImage2D(o.TEXTURE_2D,0,o.RGBA8,e,t,0,o.RGBA,o.UNSIGNED_BYTE,null),o.texParameteri(o.TEXTURE_2D,o.TEXTURE_MIN_FILTER,o.LINEAR),o.texParameteri(o.TEXTURE_2D,o.TEXTURE_MAG_FILTER,o.LINEAR),o.texParameteri(o.TEXTURE_2D,o.TEXTURE_WRAP_S,o.CLAMP_TO_EDGE),o.texParameteri(o.TEXTURE_2D,o.TEXTURE_WRAP_T,o.CLAMP_TO_EDGE),o.bindRenderbuffer(o.RENDERBUFFER,a.rbo),o.renderbufferStorage(o.RENDERBUFFER,o.DEPTH_COMPONENT16,e,t),o.bindFramebuffer(o.FRAMEBUFFER,a.fbo),o.framebufferTexture2D(o.FRAMEBUFFER,o.COLOR_ATTACHMENT0,o.TEXTURE_2D,a.tex,0),o.framebufferRenderbuffer(o.FRAMEBUFFER,o.DEPTH_ATTACHMENT,o.RENDERBUFFER,a.rbo),o.checkFramebufferStatus(o.FRAMEBUFFER)!==o.FRAMEBUFFER_COMPLETE&&(a.attivo=!1,console.warn("specchio: framebuffer incompleto, spento")),o.bindFramebuffer(o.FRAMEBUFFER,null),o.bindTexture(o.TEXTURE_2D,null),a.w=e,a.h=t}disegnaAcqua(){let e=this.gl,t=this.ua,o=this.sole,a=this._camera,n=this.specchio;if(!a||this._visibili.length===0){this.statistiche.disegniAcqua=0;return}e.useProgram(this.programmaAcqua),e.uniformMatrix4fv(t.uVP,!1,this.vp),e.uniform1f(t.uTempo,this.tempo),e.uniform3f(t.uCam,a.occhio[0],a.occhio[1],a.occhio[2]),e.uniform2f(t.uNebbia,this.nebbia.da,this.nebbia.a),e.uniform3f(t.uSoleVerso,o.verso[0],o.verso[1],o.verso[2]),e.uniform3f(t.uSoleCol,o.colore[0],o.colore[1],o.colore[2]),e.uniform1f(t.uSoleForza,o.forza),e.uniform3f(t.uCieloCol,o.cielo[0],o.cielo[1],o.cielo[2]),e.uniform3f(t.uNebbiaCol,this.nebbia.colore[0],this.nebbia.colore[1],this.nebbia.colore[2]);let l=n.pelo!=null&&n.tex;e.activeTexture(e.TEXTURE1),e.bindTexture(e.TEXTURE_2D,l?n.tex:null),e.uniform1i(t.uSpecchio,1),e.uniform3f(t.uSchermo,1/e.drawingBufferWidth,1/e.drawingBufferHeight,l?1:0),e.uniform1f(t.uMare,this.mare),e.uniform4fv(t.uGalleggianti,this.galleggianti),e.uniform1i(t.uNGalleggianti,this.nGalleggianti),this.altezze&&this.altRett?(e.activeTexture(e.TEXTURE2),e.bindTexture(e.TEXTURE_2D,this.altezze),e.uniform1i(t.uAltezze,2),e.bindSampler(2,this.campionatoreLiscio),e.uniform4f(t.uAltRett,this.altRett[0],this.altRett[1],this.altRett[2],this.altRett[3])):e.uniform4f(t.uAltRett,0,0,0,0),e.enable(e.BLEND),e.blendFunc(e.SRC_ALPHA,e.ONE_MINUS_SRC_ALPHA),e.depthMask(!1),e.disable(e.CULL_FACE);let r=0,f=0;for(let c of this._visibili)e.uniform3f(t.uChunk,c.chunk[0],c.chunk[1],c.chunk[2]),e.bindVertexArray(c.vaoAcqua),e.drawElements(e.TRIANGLES,c.quadAcqua*6,e.UNSIGNED_SHORT,0),r++,f+=c.quadAcqua*2;e.bindVertexArray(null),e.depthMask(!0),e.enable(e.CULL_FACE),e.disable(e.BLEND),e.bindSampler(2,null),e.activeTexture(e.TEXTURE0),this.statistiche.disegniAcqua=r,this.statistiche.triangoliAcqua=f,n.mostra&&l&&this._mostraSpecchio()}};var vo=class extends ze{vertice(e,t,o,a,n,l,r,f=0,c=0){super.vertice(e,t,o,_o[a],n,l,r,f,c)}},ie={erba:1,terra:2,sabbia:3,roccia:4,filo:5,tronco:6,chioma:7,lampada:8},He=[0,6072381,8739896,14403468,9211013,5086771,6043679,2714414,16767347],Xa=1;function po(i,e){let t=o=>Math.max(0,Math.min(255,Math.round(o*e)));return t(i>>16&255)<<16|t(i>>8&255)<<8|t(i&255)}function me(i,e,t){let o=i*374761393+e*668265263+t*1442695041|0;return o=Math.imul(o^o>>>13,1274126177),((o^o>>>16)>>>0)/4294967296}function ho(i,e,t,o){let a=i/t,n=e/t,l=Math.floor(a),r=Math.floor(n),f=a-l,c=n-r,u=f*f*(3-2*f),p=c*c*(3-2*c),m=me(l,r,o),s=me(l+1,r,o),d=me(l,r+1,o),v=me(l+1,r+1,o);return m+(s-m)*u+(d+(v-d)*u-(m+(s-m)*u))*p}function Oe(i,e,t=7){let o=ho(i,e,48,t)*14+ho(i,e,17,t+1)*5+ho(i,e,6,t+2)*1.5;return 8+Math.floor(o)}function qo(i){return i<11?ie.sabbia:i>24?ie.roccia:ie.erba}function yo(i,e,t=7){let o=[];for(let a=0;a<2;a++){if(me(i*3+a,e*5-a,t+9)<.35)continue;let l=i*16+Math.floor(me(i,e,t+11+a)*15)+.5,r=e*16+Math.floor(me(e,i,t+13+a)*15)+.5,f=Oe(Math.floor(l),Math.floor(r),t);qo(f)===ie.erba&&o.push({x:l,y:f+3,z:r})}return o}function Fo(i,e,t,o){let a=0;for(let n of o){let r=15-Math.sqrt((i-n.x)**2+(e-n.y)**2+(t-n.z)**2);r>a&&(a=r)}return Math.max(0,Math.min(15,Math.round(a)))}function Po(i,e,{seme:t=7,erba:o=2,raggioLampade:a=2}={}){let n=new vo(1600),l=i*16,r=e*16,f=255,c=0,u=[];for(let m=-a;m<=a;m++)for(let s=-a;s<=a;s++)u.push(...yo(i+m,e+s,t));for(let m=0;m<16;m++)for(let s=0;s<16;s++){let d=l+m,v=r+s,h=Oe(d,v,t);h<f&&(f=h),h+1>c&&(c=h+1);let b=qo(h),x=.94+.12*me(d,v,t+3),g=Fo(d+.5,h+1,v+.5,u),z=po(He[b],x);n.quadDa([m,h+1,s,2,15,g,z],[m,h+1,s+1,2,15,g,z],[m+1,h+1,s+1,2,15,g,z],[m+1,h+1,s,2,15,g,z]);let C=[[1,0,0],[-1,0,1],[0,1,4],[0,-1,5]];for(let[R,_,A]of C){let I=Oe(d+R,v+_,t);for(let O=I+1;O<=h;O++){let E=Math.max(6,15-(h-O)*2),M=O===h&&b===ie.erba?ie.erba:h>24?ie.roccia:ie.terra,S=Fo(d+.5+R*.5,O+.5,v+.5+_*.5,u),N=O,U=O+1,w=po(He[M],x);R===1?n.quadDa([m+1,N,s,A,E,S,w],[m+1,U,s,A,E,S,w],[m+1,U,s+1,A,E,S,w],[m+1,N,s+1,A,E,S,w]):R===-1?n.quadDa([m,N,s+1,A,E,S,w],[m,U,s+1,A,E,S,w],[m,U,s,A,E,S,w],[m,N,s,A,E,S,w]):_===1?n.quadDa([m+1,N,s+1,A,E,S,w],[m+1,U,s+1,A,E,S,w],[m,U,s+1,A,E,S,w],[m,N,s+1,A,E,S,w]):n.quadDa([m,N,s,A,E,S,w],[m,U,s,A,E,S,w],[m+1,U,s,A,E,S,w],[m+1,N,s,A,E,S,w]),O<f&&(f=O)}}if(b===ie.erba)for(let R=0;R<o;R++){if(me(d,v,t+20+R)<.25)continue;let A=1,I=m,O=s,E=po(He[ie.filo],.94+.12*me(d,v,t+30+R));n.quadDa([I,h+1,O,2,15,g,E],[I,h+1+A,O,2,15,g,E,1],[I+1,h+1+A,O+1,2,15,g,E,1],[I+1,h+1,O+1,2,15,g,E]),n.quadDa([I+1,h+1,O,2,15,g,E],[I+1,h+1+A,O,2,15,g,E,1],[I,h+1+A,O+1,2,15,g,E,1],[I,h+1,O+1,2,15,g,E]),h+2>c&&(c=h+2)}}for(let m of yo(i,e,t)){let s=Math.floor(m.x)-l,d=Math.floor(m.z)-r,v=m.y-3;for(let h=v+1;h<=m.y;h++){let b=h===m.y?ie.lampada:ie.tronco,x=h===m.y?15:12,g=He[b],z=h===m.y?Xa:0,C=s+.5-.15,R=s+.5+.15,_=Math.floor(C),A=Math.min(16,Math.floor(C)+1),I=d,O=d+1;n.quadDa([A,h,I,0,12,x,g,0,z],[A,h+1,I,0,12,x,g,0,z],[A,h+1,O,0,12,x,g,0,z],[A,h,O,0,12,x,g,0,z]),n.quadDa([_,h,O,1,12,x,g,0,z],[_,h+1,O,1,12,x,g,0,z],[_,h+1,I,1,12,x,g,0,z],[_,h,I,1,12,x,g,0,z]),n.quadDa([A,h,O,4,12,x,g,0,z],[A,h+1,O,4,12,x,g,0,z],[_,h+1,O,4,12,x,g,0,z],[_,h,O,4,12,x,g,0,z]),n.quadDa([_,h,I,5,12,x,g,0,z],[_,h+1,I,5,12,x,g,0,z],[A,h+1,I,5,12,x,g,0,z],[A,h,I,5,12,x,g,0,z]),h===m.y&&n.quadDa([_,h+1,I,2,15,x,g,0,z],[_,h+1,O,2,15,x,g,0,z],[A,h+1,O,2,15,x,g,0,z],[A,h+1,I,2,15,x,g,0,z]),h+1>c&&(c=h+1)}}return{...n.dati(),minY:f,maxY:c,cx:i,cz:e}}var Do={erba:{nome:"Erba",cima:5949008,lato:15047529,fondo:12546123,orlo:3446604,solido:!0,nav:10,cappello:!0,fam:"scavo"},terra:{nome:"Terra",cima:12546123,lato:12546123,fondo:11034431,solido:!0,nav:10,fam:"scavo"},sabbia:{nome:"Sabbia",cima:15324316,lato:14599048,fondo:13808246,solido:!0,nav:12,fam:"scavo"},ghiaia:{nome:"Ghiaia",cima:10130572,lato:9143677,fondo:8354162,solido:!0,nav:12,fam:"scavo"},neve:{nome:"Neve",cima:15923191,lato:14740202,fondo:13688028,solido:!0,nav:12,fam:"scavo"},roccia:{nome:"Roccia",cima:11054778,lato:9673384,fondo:8883868,solido:!0,nav:10,fam:"mina"},pietra:{nome:"Pietra liscia",cima:12436429,lato:11449535,fondo:10660019,solido:!0,nav:10,fam:"mina"},mattoni:{nome:"Mattoni",cima:11555645,lato:10570294,fondo:9650735,solido:!0,nav:10,fam:"mina"},legno:{nome:"Legno",cima:11568720,lato:10252866,fondo:9266489,solido:!0,nav:10,fam:"taglia"},tronco:{nome:"Tronco",cima:12622434,lato:8016432,fondo:12622434,solido:!0,nav:10,fam:"taglia"},asse:{nome:"Assi chiare",cima:14268798,lato:13150317,fondo:12163422,solido:!0,nav:10,fam:"taglia"},lanaBianca:{nome:"Lana bianca",cima:15724786,lato:14869478,fondo:14014170,solido:!0,nav:10,fam:"scavo"},lanaRossa:{nome:"Lana rossa",cima:14703182,lato:13388608,fondo:12206648,solido:!0,nav:10,fam:"scavo"},lanaBlu:{nome:"Lana blu",cima:4882388,lato:4157120,fondo:3629227,solido:!0,nav:10,fam:"scavo"},lanaGialla:{nome:"Lana gialla",cima:15911244,lato:14727230,fondo:13477428,solido:!0,nav:10,fam:"scavo"},lanaVerde:{nome:"Lana verde",cima:5813096,lato:4890714,fondo:4165454,solido:!0,nav:10,fam:"scavo"},ferro:{nome:"Ferro",cima:12174028,lato:10792376,fondo:9410723,solido:!0,nav:10,fam:"scavo",materia:"metallo"},fanghiglia:{nome:"Fanghiglia",cima:11569756,lato:10517842,fondo:9268551,solido:!0,nav:10,fam:"scavo",materia:"fango"},ghiaccio:{nome:"Ghiaccio",cima:12576498,lato:11131114,fondo:9685472,solido:!0,nav:10,fam:"scavo",materia:"ghiaccio"},cristallo:{nome:"Cristallo",cima:16771496,lato:16243851,fondo:15256437,solido:!0,nav:10,fam:"mina",salute:100,materia:"accesa",luce:{colore:16767370,raggio:6,intensita:1,ombra:!0}},ottone:{nome:"Ottone",cima:14267482,lato:12820556,fondo:11044927,solido:!0,nav:10,fam:"scavo",materia:"specchio"},lucciola:{nome:"Lucciola verde",cima:11075504,lato:6280814,fondo:4634967,solido:!0,nav:10,fam:"mina",salute:100,luce:{colore:8257440,raggio:5,intensita:1.1,ombra:!0}},lampadaPesante:{nome:"Lampada pesante (con ombra)",cima:16771764,lato:15777891,fondo:14264132,solido:!0,nav:10,fam:"mina",salute:100,luce:{colore:16767113,raggio:8,intensita:1.1,ombra:!0}},lampadaLeggera:{nome:"Lampada leggera (trapassa i muri)",cima:16771764,lato:15777891,fondo:14264132,solido:!0,nav:10,fam:"mina",salute:100,luce:{colore:16767113,raggio:8,intensita:1.1,ombra:!1}},lampadaRossa:{nome:"Lampada rossa",cima:16759213,lato:15224892,fondo:13187624,solido:!0,nav:10,fam:"mina",salute:100,luce:{colore:16722458,raggio:8,intensita:1.1,ombra:!0}},lampadaVerde:{nome:"Lampada verde",cima:11993028,lato:4183135,fondo:3124809,solido:!0,nav:10,fam:"mina",salute:100,luce:{colore:1769274,raggio:8,intensita:1.1,ombra:!0}},lampadaBlu:{nome:"Lampada blu",cima:11584767,lato:4220128,fondo:3099837,solido:!0,nav:10,fam:"mina",salute:100,luce:{colore:2771711,raggio:8,intensita:1.1,ombra:!0}},fuochiFatui:{nome:"Nido di fuochi fatui",cima:13498111,lato:5083048,fondo:3500413,solido:!0,nav:10,fam:"mina",salute:100,luce:{colore:9430271,raggio:3,intensita:.7,ombra:!1},fuochiFatui:{numero:7,raggio:3.2,quota:1.9,luce:{colore:10477823,raggio:4.2,intensita:1}}},acqua:{nome:"Acqua",cima:5227244,lato:4042208,fondo:3184332,solido:!1,nav:null,acqua:!0}},Uo=[{id:"naturali",nome:"Naturali",emoji:"\u{1F33F}",blocchi:["erba","terra","sabbia","ghiaia","neve","roccia","lucciola","acqua"]},{id:"costruzione",nome:"Costruzione",emoji:"\u{1F9F1}",blocchi:["legno","tronco","asse","pietra","mattoni"]},{id:"lane",nome:"Lane",emoji:"\u{1F3A8}",blocchi:["lanaBianca","lanaRossa","lanaBlu","lanaGialla","lanaVerde"]},{id:"luci",nome:"Luci",emoji:"\u{1F4A1}",blocchi:["lucciola","lampadaPesante","lampadaLeggera","lampadaRossa","lampadaVerde","lampadaBlu","fuochiFatui"]}],Ze={id:"officina",nome:"Officina",emoji:"\u{1F6E0}\uFE0F",blocchi:[]};Uo.push(Ze);var Ya={id:"prove",nome:"Prove",emoji:"\u{1F317}",blocchi:[]};Uo.push(Ya);function wo(i,e,t=Ze){Do[i]=e,t.blocchi.includes(i)||t.blocchi.push(i)}var $a={nome:"Blocco perduto",cima:12950225,lato:11305912,fondo:9924767,solido:!0,nav:10,fam:"mina"};function W(i){return Do[i.charCodeAt(0)===97&&i.startsWith("acqua")?"acqua":i]||$a}function Bo(i){let e=i.indexOf("~");return e<0?i:i.slice(0,e)}function Vo(i){if(!i||!i.startsWith("acqua"))return null;let e=i.indexOf("~");return e<0?0:Number(i.slice(e+1))}var L=16,Ha=256,je=2048,Go=64,J=(i,e,t)=>((i+je)*4096+(t+je))*256+(e+Go),Le=i=>Math.floor(i/(256*4096))-je,Ie=i=>Math.floor(i/256)%4096-je,Ne=i=>i%256-Go;var be=(i,e)=>Math.floor(i/L)+","+Math.floor(e/L),Ke=class{constructor(){this.chunks=new Map,this.sporchi=new Set,this.sporchiAcqua=new Set,this.bagnate=new Map,this._rev=new Map,this.furni=new Map,this.ombreFurni=new Map,this.contaBlocchi=0,this.onEvento=null,this.cambiate=[],this.troppiCambi=!1,this._memoCx=0,this._memoCz=0,this._memoChunk=null,this.generati=new Set,this.modifiche=new Map,this.frontiera=null}segnaGenerato(e){this.generati.add(e)}_annotaModifica(e,t,o,a){if(!this.frontiera)return;let n=be(e,o),l=this.modifiche.get(n);l||(l=new Map,this.modifiche.set(n,l)),l.set(J(e,t,o),a)}applicaModifiche(e){let t=this.modifiche.get(e);if(!t)return 0;for(let[o,a]of t){let n=Le(o),l=Ne(o),r=Ie(o);a===null?this.togli(n,l,r,!0):this.metti(n,l,r,a,!0)}return t.size}scaricaChunk(e){let t=this.chunks.get(e);if(!t)return this.generati.delete(e),[];let o=[];for(let[a,n]of t){let l=W(n);l&&l.forma==="modello"&&o.push([Le(a),Ne(a),Ie(a),n])}return this.contaBlocchi-=t.size,this.chunks.delete(e),this._scordaMemo(),this.generati.delete(e),this._tocca(e,this.sporchi),o}_cambiata(e,t,o){if(this.cambiate.length>=3*Ha){this.troppiCambi=!0;return}this.cambiate.push(e,t,o)}scordaCambi(){this.cambiate.length=0,this.troppiCambi=!1}_scordaMemo(){this._memoKc=null,this._memoChunk=null}_chunkDi(e,t){let o=Math.floor(e/L),a=Math.floor(t/L);if(this._memoChunk!==null&&this._memoCx===o&&this._memoCz===a)return this._memoChunk;let n=this.chunks.get(o+","+a)||null;return this._memoCx=o,this._memoCz=a,this._memoChunk=n,n}tipo(e,t,o){let a=this._chunkDi(e,o);return a&&a.get(J(e,t,o))||null}pieno(e,t,o){return this.tipo(e,t,o)!==null}solido(e,t,o){let a=this.tipo(e,t,o);if(a&&W(a).solido)return!0;let n=this.furni.get(J(e,t,o));return!!n&&!(n.def&&n.def.calpestabile)}calpestabile(e,t,o){if(!this.solido(e,t-1,o)||this.solido(e,t,o)||this.solido(e,t+1,o))return!1;let a=this.tipo(e,t,o);return!(a&&W(a).acqua)}_sporca(e,t,o=this.sporchi){let a=(e%L+L)%L,n=(t%L+L)%L;this._tocca(be(e,t),o),a===0&&this._tocca(be(e-1,t),o),a===L-1&&this._tocca(be(e+1,t),o),n===0&&this._tocca(be(e,t-1),o),n===L-1&&this._tocca(be(e,t+1),o)}_tocca(e,t){t.add(e),this._rev.set(e,(this._rev.get(e)||0)+1)}revisione(e){return this._rev.get(e)||0}metti(e,t,o,a,n=!1){let l=be(e,o),r=this.chunks.get(l);r||(r=new Map,this.chunks.set(l,r),this._scordaMemo());let f=J(e,t,o),c=r.get(f);c===void 0&&this.contaBlocchi++,r.set(f,a);let u=a.charCodeAt(0)===97&&a.startsWith("acqua")&&(c===void 0||c.startsWith("acqua"));this._sporca(e,o,u?this.sporchiAcqua:this.sporchi),u||this._cambiata(e,t,o),n||(this._annotaModifica(e,t,o,a),this.onEvento&&this.onEvento({tipo:"metti",cella:[e,t,o],blocco:a}))}togli(e,t,o,a=!1){let n=be(e,o),l=this.chunks.get(n);if(!l)return!1;let r=J(e,t,o),f=l.get(r);if(!l.delete(r))return!1;this.bagnate.delete(r),this.contaBlocchi--,l.size===0&&(this.chunks.delete(n),this._scordaMemo());let c=!!(f&&f.startsWith("acqua"));return this._sporca(e,o,c?this.sporchiAcqua:this.sporchi),c||this._cambiata(e,t,o),a||(this._annotaModifica(e,t,o,null),this.onEvento&&this.onEvento({tipo:"togli",cella:[e,t,o]})),!0}bagna(e,t,o,a=0){this.bagnate.set(J(e,t,o),Math.max(0,Math.min(15,a|0))),this._sporca(e,o,this.sporchiAcqua)}asciuga(e,t,o){return this.bagnate.delete(J(e,t,o))?(this._sporca(e,o,this.sporchiAcqua),!0):!1}bagnata(e,t,o){let a=this.bagnate.get(J(e,t,o));return a===void 0?null:a}occupaFurni(e,t){for(let[o,a,n]of e)this.furni.set(J(o,a,n),t)}liberaFurni(e){for(let[t,o,a]of e)this.furni.delete(J(t,o,a))}furniIn(e,t,o){return this.furni.get(J(e,t,o))||null}occupaOmbra(e,t=!1){for(let[o,a,n]of e){let l=J(o,a,n),r=this.ombreFurni.get(l);if(r){r.n++,t&&r.op++===0&&this._cambiata(o,a,n);continue}this.ombreFurni.set(l,{x:o,y:a,z:n,n:1,op:t?1:0}),this._cambiata(o,a,n)}}liberaOmbra(e,t=!1){for(let[o,a,n]of e){let l=J(o,a,n),r=this.ombreFurni.get(l);r&&(t&&r.op>0&&--r.op===0&&r.n>1&&this._cambiata(o,a,n),!(--r.n>0)&&(this.ombreFurni.delete(l),this._cambiata(o,a,n)))}}ombraFurniIn(e,t,o){let a=this.ombreFurni.get(J(e,t,o));return a?a.op>0?2:1:0}appoggioInColonna(e,t,o,a=8){for(let n=o;n>o-a;n--)if(this.calpestabile(e,n,t))return n;return null}svuota(){this.chunks.clear(),this._scordaMemo(),this.furni.clear(),this.sporchi.clear(),this.sporchiAcqua.clear();for(let e of this._rev.keys())this._rev.set(e,this._rev.get(e)+1);this.scordaCambi(),this.contaBlocchi=0}*tutti(){for(let e of this.chunks.values())for(let[t,o]of e)yield{x:Le(t),y:Ne(t),z:Ie(t),tipo:o}}perOgni(e){for(let t of this.chunks.values())for(let[o,a]of t)e(Le(o),Ne(o),Ie(o),a)}*blocchiDelChunk(e){let t=this.chunks.get(e);if(t)for(let[o,a]of t)yield{x:Le(o),y:Ne(o),z:Ie(o),tipo:a}}perOgniDelChunk(e,t){let o=this.chunks.get(e);if(o)for(let[a,n]of o)t(Le(a),Ne(a),Ie(a),n)}};var Za={primavera:{nome:"Primavera",emoji:"\u{1F338}",erba:[6738010,6343509,5949008,5553995,5158983,4763971,4434495,4105019],fogliame:null},estate:{nome:"Estate secca",emoji:"\u{1F33E}",erba:[15060862,14534259,14073193,13546335,13019733,12558668,12032068,11571261],fogliame:{h:.128,sF:.72,l:i=>i*.92+.1}},autunno:{nome:"Autunno",emoji:"\u{1F342}",erba:[15506768,15045448,14584129,14122810,13661492,13200431,12739371,12278311],fogliame:{h:.045,sF:1.2,l:i=>i*1.05+.09}},inverno:{nome:"Inverno",emoji:"\u2744\uFE0F",erba:[15988722,15462890,14871523,14279900,13622740,13031117,12439751,11848128],sabbia:{cima:15722970,lato:14932934,fondo:14077364},fogliame:{h:.42,sF:.18,l:i=>i*.38+.58}}},De="primavera";var We=null;function Qe(i,e,t){let o=i>>16&255,a=i>>8&255,n=i&255,l=e>>16&255,r=e>>8&255,f=e&255,c=(u,p)=>Math.round(u+(p-u)*t);return c(o,l)<<16|c(a,r)<<8|c(n,f)}function ko(i,e){if(We){let t=De;De=We.da;let o=go(i,e);De=We.a;let a=go(i,e);De=t;let n=We.mix;return{cima:Je(o.cima,a.cima,n),lato:Je(o.lato,a.lato,n),fondo:Je(o.fondo,a.fondo,n),facce:o.facce,orlo:o.orlo!=null&&a.orlo!=null?Je(o.orlo,a.orlo,n):o.orlo}}return go(i,e)}function Je(i,e,t){let o=Math.round((i>>16&255)+((e>>16&255)-(i>>16&255))*t),a=Math.round((i>>8&255)+((e>>8&255)-(i>>8&255))*t),n=Math.round((i&255)+((e&255)-(i&255))*t);return o<<16|a<<8|n}function go(i,e){let t=W(i),o=Za[De],{cima:a,lato:n,fondo:l}=t;if(t.cappello&&o.erba&&!t.override&&(a=o.erba[bo(e,o.erba.length)]),t.reagisce==="stagione"&&o.erba){let r=o.erba[bo(e,o.erba.length)],f=t.reagisceForza??1;a=Qe(a,r,f),n=Qe(n,r,f*.45),l=Qe(l,r,f*.3)}else if(t.reagisce==="quota"){let r=bo(e,8)/7,f=(t.reagisceForza??1)*.5,c=u=>Qe(u,16777215,r*f);a=c(a),n=c(n),l=c(l)}return i==="sabbia"&&o.sabbia&&({cima:a,lato:n,fondo:l}=o.sabbia),{cima:a,lato:n,fondo:l,facce:t.facce||null,orlo:t.orlo!=null?t.orlo:void 0}}function de(i,e,t){if(i.facce){let o=e*2+(t>0?0:1),a=i.facce[o];if(a!=null)return a}return e===1?t>0?i.cima:i.fondo:i.lato}function bo(i,e=8){let t=(e-1)*2,o=(Math.round(i)%t+t)%t;return o>=e&&(o=t-o),o}function xo(i,e,t){let o=(i|0)*374761393+(e|0)*668265263+(t|0)*2147483647;return o=(o^o>>>13)*1274126177,o=o^o>>>16,(o>>>0)%1e3/1e3}function ja(i,e){let t=i>>16&255,o=i>>8&255,a=i&255,n=l=>Math.max(0,Math.min(255,Math.round(l*(1+e))));return n(t)<<16|n(o)<<8|n(a)}function Ka(i,e,t,o,a,n){if(!e||e==="liscio"||!t)return i;let l=0;return e==="chiazze"?l=(xo(o,a,n)-.5)*2:e==="venature"?l=(xo(0,a,0)-.5)*2*.7+(xo(o,a,n)-.5)*.3:e==="sfumato"&&(l=(a%16+16)%16/16-.5),ja(i,l*t*.34)}function Xo(i,e,t,o,a,n){if(!e||e==="liscio"||!t)return i;let l=r=>Ka(r,e,t,o,a,n);return{cima:l(i.cima),lato:l(i.lato),fondo:l(i.fondo),facce:i.facce?i.facce.map(l):null}}var Yo={metallo:{tinta:.82,satura:.55,orlo:.18,curva:1,glintR:.34,emiss:0,bagna:.2,sotto:0,riflette:.15},fango:{tinta:.72,satura:1.35,orlo:0,curva:-1,glintR:.48,emiss:0,bagna:1,sotto:0,riflette:0},ghiaccio:{tinta:1.06,satura:.62,orlo:.12,curva:.6,glintR:.3,emiss:0,bagna:.4,sotto:.3,riflette:.25},accesa:{tinta:1,satura:1,orlo:0,curva:0,glintR:0,emiss:1,bagna:0,sotto:0,riflette:0},specchio:{tinta:.95,satura:.35,orlo:.1,curva:1,glintR:.3,emiss:0,bagna:0,sotto:0,riflette:.55}},Wa=Object.keys(Yo);function $o(i){return!i||!i.materia?null:Yo[i.materia]||null}function xe(i,e,t=0){if(!e)return i;let o=(i>>16&255)/255,a=(i>>8&255)/255,n=(i&255)/255,l=.2126*o+.7152*a+.0722*n,r=e.satura;o=l+(o-l)*r,a=l+(a-l)*r,n=l+(n-l)*r;let f=e.tinta*(1+t),c=u=>Math.max(0,Math.min(255,Math.round(u*f*255)));return c(o)<<16|c(a)<<8|c(n)}var Qa=16;function Ho(i){let e=Wa.indexOf(i);return e<0||e+1>=Qa?0:e+1}var Eo=1/16,Zo=8*Eo,ne=9*Eo;function jo(i,e,t,o,a,n,l,r){let f=(u,p,m)=>[e+u,t+p,o+m];i.quad(f(-r,l,-r),f(r,l,-r),f(r,l,r),f(-r,l,r),de(a,1,1),[0,1,0]),i.quad(f(-r,n,-r),f(r,n,-r),f(r,n,r),f(-r,n,r),de(a,1,-1),[0,-1,0]);let c=[{d:[1,0,0],asse:0,segno:1},{d:[-1,0,0],asse:0,segno:-1},{d:[0,0,1],asse:2,segno:1},{d:[0,0,-1],asse:2,segno:-1}];for(let u of c){let[p,,m]=u.d,s=-m,d=p,v=(h,b)=>f(p*r+s*b,h,m*r+d*b);i.quad(v(n,-r),v(l,-r),v(l,r),v(n,r),de(a,u.asse,u.segno),u.d)}}function Ja(i,e,t,o,a){jo(i,e,t,o,a,-ne,0,Zo)}function et(i,e,t,o,a){jo(i,e,t,o,a,-ne,ne,5*Eo)}function ot(i,e,t,o,a){let n=(c,u,p)=>[e+c,t+u,o+p],l=de(a,0,1),r=Zo,f=[[[-r,-ne,-r],[r,-ne,r],[r,ne,r],[-r,ne,-r],[1,0,-1]],[[-r,-ne,r],[r,-ne,-r],[r,ne,-r],[-r,ne,r],[1,0,1]]];for(let[c,u,p,m,s]of f)i.quad(n(...c),n(...u),n(...p),n(...m),l,s),i.quad(n(...c),n(...u),n(...p),n(...m),l,[-s[0],-s[1],-s[2]])}function at(){}var Ko={lastra:Ja,pilastro:et,croce:ot,modello:at},Ue=new Set(["lastra","pilastro","croce","modello"]);var we=1/16,tt=[[0,1],[0,2],[1,2]],it=[[1,0],[-1,0],[0,1],[0,-1]];function Ee(i,e,t,o,a,n,l,r,f){let c=[i,e,t];return c[o]+=a,c[n]+=l,c[r]+=f,c}var Wo={tinta:1,satura:1};function Qo(i,e,t,o,a,n,l=0){let r=8*we,f=9*we,c=(u,p)=>n(u===0?p:0,u===1?p:0,u===2?p:0);for(let u=0;u<3;u++)for(let p of[-1,1]){if(c(u,p))continue;let m=(u+1)%3,s=(u+2)%3,d=de(a,u,p),v=[0,0,0];v[u]=p,i.quad(Ee(e,t,o,u,p*f,m,-r,s,-r),Ee(e,t,o,u,p*f,m,+r,s,-r),Ee(e,t,o,u,p*f,m,+r,s,+r),Ee(e,t,o,u,p*f,m,-r,s,+r),d,v)}for(let[u,p]of tt){let m=3-u-p;for(let s of[-1,1])for(let d of[-1,1]){if(c(u,s)||c(p,d))continue;let v=u===1&&s>0||p===1&&d>0,h=u===1&&s<0||p===1&&d<0,b=v?a.cima:h?a.fondo:a.lato,x=l?xe(b,Wo,l):b,g=[0,0,0];g[u]=s,g[p]=d,i.quad(Ee(e,t,o,u,s*f,p,d*r,m,-r),Ee(e,t,o,u,s*r,p,d*f,m,-r),Ee(e,t,o,u,s*r,p,d*f,m,+r),Ee(e,t,o,u,s*f,p,d*r,m,+r),x,g)}}for(let u of[-1,1])for(let p of[-1,1])for(let m of[-1,1])c(0,u)||c(1,p)||c(2,m)||i.tri([e+u*f,t+p*r,o+m*r],[e+u*r,t+p*f,o+m*r],[e+u*r,t+p*r,o+m*f],l?xe(p>0?a.cima:a.fondo,Wo,l):p>0?a.cima:a.fondo,[u,p,m])}function Jo(i,e,t,o,a,n){let l=(s,d)=>n(s,0,d),r=n(0,-1,0),f=a.cima,c=a.lato,u=a.fondo,p=a.orlo??a.cima,m=(s,d,v)=>[e+s*we,t+d*we,o+v*we];r||i.quad(m(-8,-9,-8),m(8,-9,-8),m(8,-9,8),m(-8,-9,8),u,[0,-1,0]);for(let[s,d]of it){if(l(s,d))continue;let v=-d,h=s,b=(g,z,C)=>m(g*s+C*v,z,g*d+C*h),x=[s,0,d];r||i.quad(b(8,-9,-8),b(9,-8,-8),b(9,-8,8),b(8,-9,8),u,[s,-1,d]),i.quad(b(9,-8,-8),b(9,2,-8),b(9,2,8),b(9,-8,8),c,x),i.quad(b(9,2,-8),b(10,3,-8),b(10,3,8),b(9,2,8),p,x),i.quad(b(10,3,-8),b(10,7,-8),b(10,7,8),b(10,3,8),p,x),i.quad(b(10,7,-8),b(9,8,-8),b(9,8,8),b(10,7,8),f,[s,1,d]),i.quad(b(8,8,-8),b(9,8,-8),b(9,8,8),b(8,8,8),f,[0,1,0])}for(let s of[-1,1])for(let d of[-1,1]){if(l(s,0)||l(0,d))continue;let v=(b,x,g)=>m(b*s,x,g*d),h=[s,0,d];r||i.tri(v(9,-8,8),v(8,-9,8),v(8,-8,9),u,[s,-1,d]),i.quad(v(9,-8,8),v(8,-8,9),v(8,2,9),v(9,2,8),c,h),i.quad(v(9,2,8),v(8,2,9),v(8,3,10),v(10,3,8),p,h),i.quad(v(10,3,8),v(8,3,10),v(8,7,10),v(10,7,8),p,h),i.quad(v(10,7,8),v(8,7,10),v(8,8,9),v(9,8,8),f,[s,1,d]),i.tri(v(8,8,8),v(9,8,8),v(8,8,9),f,[0,1,0])}i.quad(m(-8,8,-8),m(8,8,-8),m(8,8,8),m(-8,8,8),f,[0,1,0])}var Ao={lampione:{nome:"Lampione",modello:"lampione",altezza:3,mezza:.45,cima:16771764,lato:5988976,fondo:4672856,luce:{colore:16767113,raggio:4.6,intensita:1,ombra:!0,quota:2.6},notte:!0},albero:{nome:"Albero",modello:"albero",altezza:4.2,mezza:.7,cima:5217862,lato:8016432,fondo:6964518}};function ea(){for(let[i,e]of Object.entries(Ao))wo(i,{nome:e.nome,cima:e.cima,lato:e.lato,fondo:e.fondo,solido:!1,nav:10,fam:"taglia",forma:"modello",modello:e.modello,altezza:e.altezza,mezza:e.mezza},Ze)}var nt=2,To=6,rt=256;function oa(i){if(!i)return!1;let e=W(i);return!e.acqua&&!e.vetro&&!Ue.has(e.forma)}function ta(i,e,t,o){let a=e.indexOf(","),n=+e.slice(0,a),l=+e.slice(a+1),r=n*L-To,f=l*L-To,c=L+2*To,u=o-t+1,p=c,m=c*u*p,s=new Uint8Array(m),d=new Uint8Array(m),v=new Uint8Array(m),h=(C,R,_)=>((C-r)*u+(R-t))*p+(_-f),b=(C,R,_)=>C>=r&&C<r+c&&R>=t&&R<=o&&_>=f&&_<f+p,x=[];for(let C=r;C<r+c;C++)for(let R=f;R<f+p;R++){let _=!1;for(let A=o;A>=t;A--){let I=i.tipo(C,A,R),O=h(C,A,R);if(oa(I)){v[O]=1,_=!0;continue}if(!_&&A===o){for(let E=o+1;E<rt&&E<o+40;E++)if(oa(i.tipo(C,E,R))){_=!0;break}}if(_||(s[O]=15),I){let M=W(I).forma==="modello"&&Ao[I];M&&M.luce&&x.push([C,A+Math.round(M.luce.quota??1),R])}}}let g=[];for(let C=0;C<m;C++)s[C]===15&&g.push(C);aa(g,s,v,c,u,p,1);let z=[];for(let[C,R,_]of x){if(!b(C,R,_))continue;let A=h(C,R,_);d[A]=15,z.push(A)}return aa(z,d,v,c,u,p,nt),{x0:r,z0:f,yMin:t,yMax:o,W:c,H:u,D:p,cielo:s,blocco:d,leggi(C,R,_){if(!b(C,R,_))return R>o?[15,0]:[0,0];let A=h(C,R,_);return[s[A],d[A]]}}}function aa(i,e,t,o,a,n,l){let r=[a*n,-a*n,n,-n,1,-1],f=0;for(;f<i.length;){let c=i[f++],u=e[c]-l;if(u<=0)continue;let p=Math.floor(c/(a*n)),m=Math.floor(c/n)%a,s=c%n;for(let d=0;d<6;d++){if(d===0&&p===o-1||d===1&&p===0||d===2&&m===a-1||d===3&&m===0||d===4&&s===n-1||d===5&&s===0)continue;let v=c+r[d];t[v]||e[v]>=u||(e[v]=u,i.push(v))}}}var ia=[{n:5,largo:.15,alto:.32,apri:.42},{n:4,largo:.12,alto:.5,apri:.34},{n:7,largo:.1,alto:.38,apri:.46},{n:3,largo:.18,alto:.28,apri:.3}];function pe(i,e,t){let o=i*374761393+e*668265263+t*1442695041|0;return o=Math.imul(o^o>>>13,1274126177),((o^o>>>16)>>>0)/4294967296}var eo=class{constructor(e,t=512){this.yBase=e,this.byte=new Uint8Array(t*12),this.n=0}_lamella(e,t,o,a,n,l,r,f,c,u=0,p=8){if((this.n+1)*12>this.byte.length){let d=new Uint8Array(this.byte.length*2);d.set(this.byte),this.byte=d}let m=this.n*12,s=this.byte;s[m]=e,s[m+1]=t,s[m+2]=o,s[m+3]=a,s[m+4]=n>>16&255,s[m+5]=n>>8&255,s[m+6]=n&255,s[m+7]=(l&15)<<2,s[m+8]=Math.max(1,Math.min(255,r)),s[m+9]=Math.max(1,Math.min(255,f)),s[m+10]=Math.max(0,Math.min(255,c+128)),s[m+11]=u&15|(p&15)<<4,this.n++}ciuffo(e,t,o,a,n,l,r,f=1,c=0){let u=ia[Math.floor(pe(e,o,3)*ia.length)],p=Math.max(1,Math.round(u.n*f*(.82+.36*pe(e,o,5)))),m=t+1-this.yBase;if(m<0||m*8>247)return 0;for(let s=0;s<p;s++){let d=pe(e,o,s*17+5),v=pe(e,o,s*17+11),h=pe(e,o,s*17+41),b=pe(e,o,s*17+59),x=Math.min(.98,.66+u.apri),g=e+.5+(d-.5)*x,z=o+.5+(v-.5)*x,C=Math.min(.8,u.alto*(.62+.8*pe(e,o,s*17+71))*(.5+.6*Math.pow(h,1.5))),R=u.largo*(.8+.4*b),_=(pe(e,o,s*17+83)-.5)*.5,A=pe(e,o,s*17+89),I=A<.15?.9+.03*A:A>.85?1.07+.03*(A-.85):.97+.06*(A-.15)/.7,O=Math.max(0,Math.min(128,Math.round((g-a)*8))),E=Math.max(0,Math.min(128,Math.round((z-n)*8))),M=Math.floor(pe(e,o,s*17+97)*255);this._lamella(O,E,Math.round(m*8),M,l,r,Math.round(C*64),Math.round(R*128),Math.round(_*128),c,Math.round((I-.9)/.2*15))}return p}dati(){return{byte:this.byte.subarray(0,this.n*12),vertici:this.n*6,fili:this.n,yBase:this.yBase}}};var Ae=64,lt=[[1,0,0,K(1,0,0),0,1],[-1,0,0,K(-1,0,0),0,-1],[0,1,0,K(0,1,0),1,1],[0,-1,0,K(0,-1,0),1,-1],[0,0,1,K(0,0,1),2,1],[0,0,-1,K(0,0,-1),2,-1]],na=(i,e,t)=>((e+1)*3+(t+1))*3+(i+1),zo=class{constructor(e,t,o,a,n){this.c=e,this.ox=t,this.oz=o,this._materia=0,this.luceDi=a,this.aria=n,this._cielo=15,this._cella=null}materia(e){this._materia=e|0}cella(e,t,o){this._cella=[e,t,o]}_cieloFaccia(e){let[t,o,a]=this._cella,n=-1;for(let l=0;l<3;l++){if(!e[l])continue;let r=this.luceDi(t+(l===0?e[0]:0),o+(l===1?e[1]:0),a+(l===2?e[2]:0))[0];r>n&&(n=r)}return n<0?this.luceDi(t,o+1,a)[0]:n}_bloccoVertice(e,t){let o=Math.hypot(t[0],t[1],t[2])||1,a=e[0]+t[0]/o*.5,n=e[1]+t[1]/o*.5,l=e[2]+t[2]/o*.5,r=0,f=0;for(let c of[-.45,.45])for(let u of[-.45,.45])for(let p of[-.45,.45]){let m=Math.floor(a+c),s=Math.floor(n+u),d=Math.floor(l+p);this.aria(m,s,d)&&(r+=this.luceDi(m,s,d)[1],f++)}return f?Math.round(r/f):0}_v(e,t,o,a){return[e[0]-this.ox,e[1]+Ae,e[2]-this.oz,t,this._cielo,this._bloccoVertice(e,a),o,0,this._materia]}_giro(e,t,o,a){let n=t[0]-e[0],l=t[1]-e[1],r=t[2]-e[2],f=o[0]-e[0],c=o[1]-e[1],u=o[2]-e[2],p=l*u-r*c,m=r*f-n*u,s=n*c-l*f;return p*a[0]+m*a[1]+s*a[2]<0}tri(e,t,o,a,n){if(this._giro(e,t,o,n)){let r=t;t=o,o=r}let l=K(n[0],n[1],n[2]);this._cielo=this._cieloFaccia(n),this.c.quadDa(this._v(e,l,a,n),this._v(t,l,a,n),this._v(o,l,a,n),this._v(o,l,a,n))}quad(e,t,o,a,n,l){let r=K(l[0],l[1],l[2]);if(this._cielo=this._cieloFaccia(l),this._giro(e,t,o,l)){let f=t;t=a,a=f}this.c.quadDa(this._v(e,r,n,l),this._v(t,r,n,l),this._v(o,r,n,l),this._v(a,r,n,l))}};function oo(i){if(!i)return!1;let e=W(i);return!e.acqua&&!e.vetro&&!Ue.has(e.forma)}function ra(i){return!!i&&i.charCodeAt(0)===97&&i.startsWith("acqua")}function la(i,e,{erba:t=2,luce:o=!0}={}){let a=e.indexOf(","),n=+e.slice(0,a),l=+e.slice(a+1),r=n*L,f=l*L,c=new ze(1024),u=new ze(64),p=-1/0,m=new Int16Array(L*L).fill(-1),s=new Int16Array(L*L).fill(-1),d=new Int16Array(L*L).fill(-1),v=255,h=0,b=1/0,x=-1/0;i.perOgniDelChunk(e,(E,M)=>{M<b&&(b=M),M>x&&(x=M)});let g=o&&b<=x?ta(i,e,b-2,x+3):null,z=new eo(Number.isFinite(b)?b:0),C=(E,M,S)=>g?g.leggi(E,M,S):[15,0],R=new zo(c,r,f,C,(E,M,S)=>!oo(i.tipo(E,M,S))),_=new Uint8Array(27),A=(E,M,S,N,U,w,Te,te)=>[E-r,M+Ae,S-f,N,w,Te,U,te?1:0,0],I=(E,M,S)=>ra(i.tipo(E,M,S))||(i.bagnate?i.bagnata(E,M,S)!==null:!1);return i.perOgniDelChunk(e,(E,M,S,N)=>{let U=W(N),w=i.bagnate?i.bagnata(E,M,S):null;if(U.forma==="modello"&&U.modello==="albero")for(let F=-2;F<=2;F++)for(let D=-2;D<=2;D++){let V=F*F+D*D;if(V>4)continue;let X=E+F-r,le=S+D-f;if(X<0||X>=L||le<0||le>=L)continue;let Z=X*L+le,k=M+(V===0?4:V<=2?3:2);k>m[Z]&&(m[Z]=k)}if(U.forma==="modello"){let F=E-r,D=S-f;if(F>=0&&F<L&&D>=0&&D<L){let V=F*L+D,X=M+Math.max(1,Math.round(U.altezza||1));X>d[V]&&(d[V]=X)}}if(Ue.has(U.forma)&&w===null)return;let Te=ra(N)||w!==null,te=M+Ae;if(te<0||te>254)return;let Be=(E-r)*L+(S-f);!Te&&M>m[Be]&&(m[Be]=M),!Te&&oo(N)&&M>s[Be]&&(s[Be]=M);let H=ko(w!==null?"acqua":Bo(N),M);U.motivo&&(H=Xo(H,U.motivo,U.motivoForza??1,E,M,S));let ge=$o(U);ge&&(H={...H,cima:xe(H.cima,ge),lato:xe(H.lato,ge),fondo:xe(H.fondo,ge)},H.facce&&(H.facce=H.facce.map(F=>F==null?F:xe(F,ge))));let Ca=ge?Ho(U.materia):0;if(!Te){_.fill(0);for(let Z=-1;Z<=1;Z++)for(let k=-1;k<=1;k++)for(let j=-1;j<=1;j++)j===0&&Z===0&&k===0||oo(i.tipo(E+j,M+Z,S+k))&&(_[na(j,Z,k)]=1);let F=(Z,k,j)=>_[na(Z,k,j)]===1;R.materia(Ca),R.cella(E,M,S);let D=E+.5,V=M+.5,X=S+.5,le=U.forma&&Ko[U.forma];le?le(R,D,V,X,H,()=>!1):U.cappello&&!F(0,1,0)?Jo(R,D,V,X,H,F):Qo(R,D,V,X,H,(k,j,q)=>F(k,j,q)?j!==0?!0:!W(i.tipo(E+k,M,S+q)).cappello||F(k,1,q):!1,ge?ge.orlo:0),te-1<v&&(v=te-1),te+2>h&&(h=te+2)}let Ve=0,_e=0;if(Te)for(_e=Math.max(0,Math.min(15,w!==null?w:Vo(N)||0));Ve<15&&I(E,M-1-Ve,S);)Ve++;let _a=(F,D)=>{if(!I(F,M,D))return-1;let V=0;for(;V<15&&I(F,M-1-V,D);)V++;return V},Ge=(F,D)=>{let V=0,X=0;for(let le of[F-1,F])for(let Z of[D-1,D]){let k=_a(le,Z);k>=0&&(V+=k,X++)}return X?Math.round(V/X):Ve};if(Te)for(let[F,D,V,X,le,Z]of lt){let k=i.tipo(E+F,M+D,S+V);if(I(E+F,M+D,S+V)||k&&oo(k))continue;let j=de(H,le,Z),q=E,P=M,B=S,se,ce,ue,fe;if(F===1?(se=[q+1,P,B],ce=[q+1,P+1,B],ue=[q+1,P+1,B+1],fe=[q+1,P,B+1]):F===-1?(se=[q,P,B+1],ce=[q,P+1,B+1],ue=[q,P+1,B],fe=[q,P,B]):D===1?(se=[q,P+1,B],ce=[q,P+1,B+1],ue=[q+1,P+1,B+1],fe=[q+1,P+1,B]):D===-1?(se=[q,P,B+1],ce=[q,P,B],ue=[q+1,P,B],fe=[q+1,P,B+1]):V===1?(se=[q+1,P,B+1],ce=[q+1,P+1,B+1],ue=[q,P+1,B+1],fe=[q,P,B+1]):(se=[q,P,B],ce=[q,P+1,B],ue=[q+1,P+1,B],fe=[q+1,P,B]),D===1){let So=M+(15-2*_e)/16;So>p&&(p=So)}u.quadDa(A(...se,X,j,Ge(se[0],se[2]),_e,se[1]===P+1),A(...ce,X,j,Ge(ce[0],ce[2]),_e,ce[1]===P+1),A(...ue,X,j,Ge(ue[0],ue[2]),_e,ue[1]===P+1),A(...fe,X,j,Ge(fe[0],fe[2]),_e,fe[1]===P+1)),te<v&&(v=te),te+1>h&&(h=te+1)}if(U.cappello&&t>0&&!i.tipo(E,M+1,S)){let[F,D]=C(E,M+1,S);z.ciuffo(E,M,S,r,f,H.cima,F,t/2,D),M+2+Ae>h&&(h=M+2+Ae)}}),v>h&&(v=0,h=0),{...c.dati(),minY:v,maxY:h,y0:-Ae,cx:n,cz:l,altezze:m,solide:s,impronte:d,acqua:{...u.dati(),pelo:p===-1/0?null:p},erba:z.dati()}}function sa(i,e,t,o,a){let n=(o-e+1)*L,l=(a-t+1)*L,r=new Uint8Array(n*l);for(let f of i){if(!f.altezze)continue;let c=(f.cx-e)*L,u=(f.cz-t)*L;for(let p=0;p<L;p++)for(let m=0;m<L;m++){let s=f.altezze[p*L+m];r[(u+m)*n+(c+p)]=s<0?0:Math.max(0,Math.min(255,s+1))}}return{byte:r,x0:e*L,z0:t*L,larghezza:n,profondita:l}}function Re(i,e,t){let o=i*374761393+e*668265263+t*1442695041|0;return o=Math.imul(o^o>>>13,1274126177),((o^o>>>16)>>>0)/4294967296}function ca(i){return i*i*(3-2*i)}function Mo(i,e,t){let o=Math.floor(i),a=Math.floor(e),n=ca(i-o),l=ca(e-a),r=Re(o,a,t),f=Re(o+1,a,t),c=Re(o,a+1,t),u=Re(o+1,a+1,t);return r+(f-r)*n+(c-r)*l+(r-f-c+u)*n*l}var ye=5;function ua(i,e=1,t=64){i.svuota();let o=[],a=[],n=new Map,l=[];for(let u=-t;u<=t;u++)for(let p=-t;p<=t;p++){let m=.55*Mo(u*.028,p*.028,e)+.3*Mo(u*.07,p*.07,e+11)+.15*Mo(u*.16,p*.16,e+29),s=Math.max(2,1+Math.round(Math.pow(Math.max(0,m),1.6)*22)),d=Math.max(Math.abs(u),Math.abs(p)),v=Math.min(1,Math.max(0,(t-2-d)/8)),h=v*v*(3-2*v);s=Math.round(s*h+(ye+1)*(1-h));let b=s<=ye+1;n.set(u+"|"+p,s);for(let x=0;x<s;x++){let z=x===s-1?b?"sabbia":"erba":x<s-3?"roccia":"terra";i.metti(u,x,p,z,!0)}if(s<=ye)for(let x=s;x<=ye;x++)i.metti(u,x,p,"acqua",!0);else if(!b){let x=Re(u*3+1,p*3+7,e+101);if(x>.988&&o.length<90?o.push([u,s,p]):x<.004&&a.length<14&&a.push([u,s,p]),s>=ye+6){let g=Re(u*5+3,p*5+11,e+57);g>.99&&l.push({x:u,z:p,h:s,r:g})}}}let r=ct(i,n,e,l,t),f=u=>!r.has(u[0]+"|"+u[2]),c=[...r].map(u=>{let[p,m]=u.split("|").map(Number);return[p,n.get(u)-2,m]});return{alberi:o.filter(f),lampioni:a.filter(f),fiume:c}}var st=[[1,0],[-1,0],[0,1],[0,-1]];function ct(i,e,t,o,a=64){let n=new Set;o.sort((f,c)=>c.h-f.h||f.r-c.r);let l=[];for(let f of o){if(l.length>=5)break;l.every(c=>(c.x-f.x)**2+(c.z-f.z)**2>=784)&&l.push(f)}let r=(f,c)=>{let u=f+"|"+c;if(n.has(u))return;let p=e.get(u);i.togli(f,p-1,c,!0),i.togli(f,p-2,c,!0),i.metti(f,p-2,c,"acqua",!0),n.add(u)};for(let f of l){let c=f.x,u=f.z,p=null,m=0,s=new Set([c+"|"+u]);for(let d=0;d<500;d++){let v=e.get(c+"|"+u);if(r(c,u),p){let g=c+p[1],z=u-p[0];e.get(g+"|"+z)===v&&r(g,z)}let h=null,b=1/0,x=1/0;for(let g of st){let z=c+g[0],C=u+g[1];if(s.has(z+"|"+C))continue;let R=e.get(z+"|"+C);if(R===void 0)continue;let _=(g===p?-.5:0)+Re(z*7+5,C*7+13,t+71);(R<b||R===b&&_<x)&&(h=g,b=R,x=_)}if(!h||b>v||(m=b===v?m+1:0,m>24)||(c+=h[0],u+=h[1],s.add(c+"|"+u),p=h,e.get(c+"|"+u)<=ye)||Math.max(Math.abs(c),Math.abs(u))>=a-6)break}}for(let f of n){let[c,u]=f.split("|").map(Number),p=e.get(f);for(let m=-1;m<=1;m++)for(let s=-1;s<=1;s++){if(!m&&!s)continue;let d=c+m+"|"+(u+s);if(n.has(d))continue;let v=e.get(d);v===void 0||v<p||v>p+1||i.tipo(c+m,v-1,u+s)==="erba"&&(i.togli(c+m,v-1,u+s,!0),i.metti(c+m,v-1,u+s,"sabbia",!0))}}return n}function fa(i){let e=new DataView(i);if(String.fromCharCode(e.getUint8(0),e.getUint8(1),e.getUint8(2),e.getUint8(3))!=="LNM1")throw new Error("non \xE8 un modello del nucleo");let t=e.getUint32(4,!0),o=t*3,a=new Uint8Array(i,8,o*16),n=new Uint8Array(i,8+o*16,o*4),l=new Uint8Array(o*20);for(let p=0;p<o;p++)l.set(a.subarray(p*16,p*16+16),p*20),l.set(n.subarray(p*4,p*4+4),p*20+16);let r=1/0,f=-1/0,c=0,u=new DataView(l.buffer);for(let p=0;p<o;p++){let m=u.getFloat32(p*20,!0),s=u.getFloat32(p*20+4,!0),d=u.getFloat32(p*20+8,!0);r=Math.min(r,s),f=Math.max(f,s),c=Math.max(c,Math.hypot(m,d))}return{byte:l,vertici:o,triangoli:t,minY:r,maxY:f,raggio:c}}var ut=`#version 300 es
precision highp float;
...
void main() {
  ...
  colore = vec4(c, 1.0);
}`;function mt(i,e=4){if(e===8)return i instanceof Float32Array?i:new Float32Array(i);let t=i.length/4,o=new Float32Array(t*8);for(let a=0;a<t;a++)o.set([i[a*4],i[a*4+1],i[a*4+2],i[a*4+3],1,1,1,0],a*8);return o}var pt=`#version 300 es
layout(location = 0) in vec3 aPos;
...
`,to=class{constructor(e,t){this.leggi=e,this.scatta=t,this.errori=[],addEventListener("error",a=>this._errore(a.error||a.message)),addEventListener("unhandledrejection",a=>this._errore(a.reason));let o=document.createElement("style");o.textContent=xt,document.head.appendChild(o),this.nodo=document.createElement("div"),this.nodo.id="diag",this.nodo.innerHTML="<b>\u{1FA7A}</b> diagnosi",this.nodo.title="Manda la diagnostica",document.body.appendChild(this.nodo),this.nodo.addEventListener("click",()=>this.apri()),this.pannello=document.createElement("div"),this.pannello.id="diagPanel",document.body.appendChild(this.pannello)}_errore(e){let t=e&&e.stack?e.stack:String(e);this.errori.push(t),this.errori.length>40&&this.errori.shift()}get chiave(){try{return localStorage.getItem(va)||""}catch{return""}}set chiave(e){try{localStorage.setItem(va,e)}catch{}}apri(){let e=this.pannello;e.classList.add("aperto"),e.innerHTML=`
...
mandami quello.`)}}};var Y=document.getElementById("tela"),Et=document.getElementById("stato"),At=document.getElementById("fps"),ee=new URLSearchParams(location.search),y={raggio:+(ee.get("raggio")||5),erba:+(ee.get("erba")??8),ombra:ee.get("ombra")!=="no",specchio:ee.get("specchio")==="no"?0:Math.max(.2,Math.min(1,+(ee.get("specchio")??.5)||.5)),dprMax:+(ee.get("dpr")||1.5),rampa:ee.has("rampa"),tutto:ee.has("tutto"),mondo:ee.has("finto")||ee.has("rampa")?0:Math.max(16,Math.min(400,+(ee.get("mondo")||48))),ora:ee.has("ora")?Math.max(0,Math.min(1,+ee.get("ora"))):null},{gl:qe,dpr:Tt,ridimensiona:zt}=Co(Y,{antialias:!0,dprMax:y.dprMax}),T=new $e(qe),ae=new ao(qe);T.ombra=y.ombra;T.specchio.attivo=y.specchio>0;T.specchio.scala=y.specchio||.5;T.specchio.mostra=ee.has("vedi");var so=0,Ce=0;function Ea(i,e){let t=performance.now();for(let n of[...T.chunks.keys()])T.rimuovi(n);so=0;for(let n=-i;n<i;n++)for(let l=-i;l<i;l++)T.carica(n+","+l,Po(n,l,{erba:e})),so+=256;let o=i*2*16,a=new Uint8Array(o*o);for(let n=0;n<o;n++)for(let l=0;l<o;l++)a[n*o+l]=Oe(l-i*16,n-i*16)+1;T.impostaAltezze(a,-i*16,-i*16,o,o),Ce=performance.now()-t}var re=null,Aa=0,Ta=0;function Mt(i,e){let t=performance.now();for(let m of[...T.chunks.keys()])T.rimuovi(m);ea(),re=new Ke;let{alberi:o,lampioni:a}=ua(re,4242,i);for(let[m,s,d]of o)re.metti(m,s,d,"albero",!0);for(let[m,s,d]of a)re.metti(m,s,d,"lampione",!0);let n=performance.now()-t,l=[],r=1e9,f=1e9,c=-1e9,u=-1e9;for(let m of re.chunks.keys()){let s=la(re,m,{erba:e});T.carica(m,s),l.push(s),r=Math.min(r,s.cx),c=Math.max(c,s.cx),f=Math.min(f,s.cz),u=Math.max(u,s.cz)}let p=sa(l,r,f,c,u);return T.impostaAltezze(p.byte,p.x0,p.z0,p.larghezza,p.profondita),so=Aa=re.contaBlocchi,Ta=l.length,Ce=performance.now()-t,{tGen:n,tMesh:Ce-n}}var Ro=null;y.mondo?Ro=Mt(y.mondo,y.erba):Ea(y.raggio,y.erba);async function Rt(){if(!re)return;let i=new Map;re.perOgni((e,t,o,a)=>{let n=W(a);n.forma!=="modello"||!n.modello||(i.has(n.modello)||i.set(n.modello,[]),i.get(n.modello).push(e+.5,t,o+.5,1))});for(let[e,t]of i)try{let o=await fetch(`./modelli/nucleo/${e}.bin`);if(!o.ok)throw new Error(`${o.status}`);ae.registra(e,fa(await o.arrayBuffer())),ae.istanze(e,t)}catch(o){console.warn(`modello ${e}: ${o.message}`)}}Rt();T.tutto=y.tutto;var St=()=>{if(!re)return Oe(0,0)+2;for(let i=120;i>-Ae;i--)if(re.tipo(0,i,0))return i+2;return 8},G={alpha:-.8,beta:1.05,raggio:46,centro:[0,St(),0],fov:.9};function za(){let i=Math.sin(G.beta),e=Math.cos(G.beta);return[G.centro[0]+G.raggio*i*Math.cos(G.alpha),G.centro[1]+G.raggio*e,G.centro[2]+G.raggio*i*Math.sin(G.alpha)]}var Fe=null,io=0;Y.addEventListener("pointerdown",i=>{Fe={x:i.clientX,y:i.clientY},Y.setPointerCapture(i.pointerId)});Y.addEventListener("pointermove",i=>{Fe&&(G.alpha+=(i.clientX-Fe.x)*.006,G.beta=Math.max(.15,Math.min(1.5,G.beta-(i.clientY-Fe.y)*.006)),Fe={x:i.clientX,y:i.clientY})});Y.addEventListener("pointerup",()=>{Fe=null});Y.addEventListener("wheel",i=>{G.raggio=Math.max(8,Math.min(140,G.raggio*(i.deltaY>0?1.1:.9))),i.preventDefault()},{passive:!1});Y.addEventListener("touchstart",i=>{i.touches.length===2&&(io=Math.hypot(i.touches[0].clientX-i.touches[1].clientX,i.touches[0].clientY-i.touches[1].clientY))},{passive:!0});Y.addEventListener("touchmove",i=>{if(i.touches.length!==2)return;let e=Math.hypot(i.touches[0].clientX-i.touches[1].clientX,i.touches[0].clientY-i.touches[1].clientY);io>0&&(G.raggio=Math.max(8,Math.min(140,G.raggio*io/e))),io=e},{passive:!0});var no=y.ora??.35;function Ct(i){y.ora===null&&(no=(no+i/300)%1);let e=no*Math.PI*2-Math.PI/2,t=.24+.5*Math.max(0,Math.sin(e)),o=e*.5;T.sole.verso=[-Math.cos(o)*Math.cos(Math.asin(t)),-t,-Math.sin(o)*Math.cos(Math.asin(t))];let a=Math.max(0,Math.min(1,(Math.sin(e)+.1)*2));T.sole.forza=a;let n=Math.min(1,Math.max(0,(t-.24)/.4));T.sole.colore=[1,.78+.22*n,.55+.45*n],T.sole.cielo=[.36+.64*a,.38+.62*a,.57+.43*a],T.nebbia.colore=[.25+.47*a,.35+.5*a,.5+.42*a],qe.clearColor(T.nebbia.colore[0],T.nebbia.colore[1],T.nebbia.colore[2],1)}var Q=[],ve=[],ro=[],ga=performance.now(),Ma=0,ba=0;function Ra(i){let e=Math.min(.1,(i-ga)/1e3);ga=i;let t=performance.now();zt(),Ct(e);let a={occhio:za(),centro:G.centro,fov:G.fov,rapporto:Y.width/Y.height};T.disegna(a,e,ae),ae.disegna(T,a),T.disegnaAcqua();let n=performance.now()-t;Q.push(e*1e3),Q.length>240&&Q.shift(),ve.push(n),ve.length>240&&ve.shift(),Ma++,i-ba>500&&(ba=i,Sa()),y.rampa&&!y.mondo&&_t(i),requestAnimationFrame(Ra)}var lo=[{raggio:5,erba:2,tutto:!1},{raggio:6,erba:3,tutto:!1},{raggio:7,erba:4,tutto:!1},{raggio:6,erba:3,tutto:!0},{raggio:8,erba:4,tutto:!0}],co=[],Se=-1,xa=0;function _t(i){if(Se>=0&&i-xa<6e3)return;if(Se>=0){let t=Q.slice(-Math.min(Q.length,200)),o=lo[Se];co.push({...o,fps:+(1e3/($(t,.5)||1)).toFixed(0),p50:+$(t,.5).toFixed(1),p99:+$(t,.99).toFixed(1),js:+$(ve,.5).toFixed(2),disegni:T.statistiche.disegni,triangoli:T.statistiche.triangoli})}if(Se++,Se>=lo.length){y.rampa=!1,Sa();return}let e=lo[Se];Ea(e.raggio,e.erba),T.tutto=e.tutto,y.erba=e.erba,y.raggio=e.raggio,Q.length=0,ve.length=0,xa=i}var $=(i,e)=>{if(!i.length)return 0;let t=i.slice().sort((o,a)=>o-a);return t[Math.min(t.length-1,Math.floor(t.length*e))]};function Sa(){let i=$(Q,.5),e=$(Q,.99),t=i?1e3/i:0;ro.push(Math.round(t)),ro.length>120&&ro.shift();let o={disegni:T.statistiche.disegni+ae.statistiche.disegni+T.statistiche.disegniAcqua+T.statistiche.disegniErba+T.statistiche.disegniSpecchio,triangoli:T.statistiche.triangoli+ae.statistiche.triangoli+T.statistiche.triangoliAcqua+T.statistiche.triangoliErba+T.statistiche.triangoliSpecchio,chunkVisti:T.statistiche.chunkVisti,chunkTotali:T.statistiche.chunkTotali};At.textContent=`${t.toFixed(0)} fps
${i.toFixed(1)} / ${e.toFixed(1)} ms
JS ${$(ve,.5).toFixed(2)} ms`,Et.textContent=`NUCLEO ${y.mondo?`F1 \xB7 open world vero (semilato ${y.mondo}, ${Ta} chunk, ${Aa.toLocaleString("it")} blocchi, gen ${Ro.tGen.toFixed(0)} ms + mesh ${Ro.tMesh.toFixed(0)} ms)`:"F0"} \xB7 ${Y.width}\xD7${Y.height} (dpr ${Tt.toFixed(2)})
...
`):"")+(y.rampa?`
rampa: gradino ${Se+1}/${lo.length}\u2026`:"")}requestAnimationFrame(Ra);var Ot=new to(()=>({versione:(document.getElementById("versione")||{}).textContent||"nucleo in sviluppo",mobile:matchMedia("(pointer: coarse)").matches,tocco:navigator.maxTouchPoints>0,modoGui:"nucleo",ua:navigator.userAgent,cpu:navigator.hardwareConcurrency||null,memoriaGB:navigator.deviceMemory||null,css:[Y.clientWidth,Y.clientHeight],reso:[Y.width,Y.height],dpr:devicePixelRatio,livello:0,quantiLivelli:1,manuale:!0,profilo:{banco:y.mondo?"nucleo F1 mondo vero":"nucleo F0",mondo:y.mondo,raggio:y.raggio,erba:y.erba,ombra:T.ombra,specchio:y.specchio,disegniSpecchio:T.statistiche.disegniSpecchio,tutto:!!T.tutto,dprMax:y.dprMax,jsMs:+$(ve,.5).toFixed(2),jsP99:+$(ve,.99).toFixed(2),rampa:co},ombreLampade:!1,antialias:!0,fps:$(Q,.5)?1e3/$(Q,.5):null,p50:$(Q,.5),p99:$(Q,.99),disegni:T.statistiche.disegni+ae.statistiche.disegni+T.statistiche.disegniAcqua+T.statistiche.disegniErba+T.statistiche.disegniSpecchio,triangoli:T.statistiche.triangoli+ae.statistiche.triangoli+T.statistiche.triangoliAcqua+T.statistiche.triangoliErba+T.statistiche.triangoliSpecchio,ombreMs:0,storiaFps:ro,storiaLivelli:[],scheda:ke(qe),software:/swiftshader|llvmpipe/i.test(ke(qe)),chunk:T.statistiche.chunkTotali,blocchi:so,luci:0,decorazioni:ae.statistiche.istanze,erba:T.statistiche.triangoliErba,ora:`${Math.floor(no*24)}h`,giorno:0,worldgenMs:Ce,meshMs:Ce}),()=>{let i=za();return T.disegna({occhio:i,centro:G.centro,fov:G.fov,rapporto:Y.width/Y.height},0),Promise.resolve(Y.toDataURL("image/webp",.6))});globalThis.NUCLEO={resa:T,modelli:ae,cam:G,opz:y,statistiche:()=>({fps:1e3/($(Q,.5)||1),p50:$(Q,.5),p99:$(Q,.99),js:$(ve,.5),...T.statistiche,modelli:{...ae.statistiche},costruzioneMs:Ce,fotogrammi:Ma}),diagnostica:Ot};
